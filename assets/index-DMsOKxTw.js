 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Hv;function SS(){if(Hv)return se;Hv=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.for("react.activity"),_=Symbol.iterator;function S(L){return L===null||typeof L!="object"?null:(L=_&&L[_]||L["@@iterator"],typeof L=="function"?L:null)}var E={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},A=Object.assign,M={};function x(L,W,ft){this.props=L,this.context=W,this.refs=M,this.updater=ft||E}x.prototype.isReactComponent={},x.prototype.setState=function(L,W){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,W,"setState")},x.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function P(){}P.prototype=x.prototype;function U(L,W,ft){this.props=L,this.context=W,this.refs=M,this.updater=ft||E}var w=U.prototype=new P;w.constructor=U,A(w,x.prototype),w.isPureReactComponent=!0;var k=Array.isArray;function F(){}var z={H:null,A:null,T:null,S:null},X=Object.prototype.hasOwnProperty;function D(L,W,ft){var V=ft.ref;return{$$typeof:s,type:L,key:W,ref:V!==void 0?V:null,props:ft}}function C(L,W){return D(L.type,W,L.props)}function H(L){return typeof L=="object"&&L!==null&&L.$$typeof===s}function nt(L){var W={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(ft){return W[ft]})}var J=/\/+/g;function lt(L,W){return typeof L=="object"&&L!==null&&L.key!=null?nt(""+L.key):W.toString(36)}function vt(L){switch(L.status){case"fulfilled":return L.value;case"rejected":throw L.reason;default:switch(typeof L.status=="string"?L.then(F,F):(L.status="pending",L.then(function(W){L.status==="pending"&&(L.status="fulfilled",L.value=W)},function(W){L.status==="pending"&&(L.status="rejected",L.reason=W)})),L.status){case"fulfilled":return L.value;case"rejected":throw L.reason}}throw L}function O(L,W,ft,V,ut){var St=typeof L;(St==="undefined"||St==="boolean")&&(L=null);var mt=!1;if(L===null)mt=!0;else switch(St){case"bigint":case"string":case"number":mt=!0;break;case"object":switch(L.$$typeof){case s:case t:mt=!0;break;case g:return mt=L._init,O(mt(L._payload),W,ft,V,ut)}}if(mt)return ut=ut(L),mt=V===""?"."+lt(L,0):V,k(ut)?(ft="",mt!=null&&(ft=mt.replace(J,"$&/")+"/"),O(ut,W,ft,"",function(Vt){return Vt})):ut!=null&&(H(ut)&&(ut=C(ut,ft+(ut.key==null||L&&L.key===ut.key?"":(""+ut.key).replace(J,"$&/")+"/")+mt)),W.push(ut)),1;mt=0;var Pt=V===""?".":V+":";if(k(L))for(var Nt=0;Nt<L.length;Nt++)V=L[Nt],St=Pt+lt(V,Nt),mt+=O(V,W,ft,St,ut);else if(Nt=S(L),typeof Nt=="function")for(L=Nt.call(L),Nt=0;!(V=L.next()).done;)V=V.value,St=Pt+lt(V,Nt++),mt+=O(V,W,ft,St,ut);else if(St==="object"){if(typeof L.then=="function")return O(vt(L),W,ft,V,ut);throw W=String(L),Error("Objects are not valid as a React child (found: "+(W==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":W)+"). If you meant to render a collection of children, use an array instead.")}return mt}function $(L,W,ft){if(L==null)return L;var V=[],ut=0;return O(L,V,"","",function(St){return W.call(ft,St,ut++)}),V}function Q(L){if(L._status===-1){var W=L._result;W=W(),W.then(function(ft){(L._status===0||L._status===-1)&&(L._status=1,L._result=ft)},function(ft){(L._status===0||L._status===-1)&&(L._status=2,L._result=ft)}),L._status===-1&&(L._status=0,L._result=W)}if(L._status===1)return L._result.default;throw L._result}var Mt=typeof reportError=="function"?reportError:function(L){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var W=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof L=="object"&&L!==null&&typeof L.message=="string"?String(L.message):String(L),error:L});if(!window.dispatchEvent(W))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",L);return}console.error(L)},ot={map:$,forEach:function(L,W,ft){$(L,function(){W.apply(this,arguments)},ft)},count:function(L){var W=0;return $(L,function(){W++}),W},toArray:function(L){return $(L,function(W){return W})||[]},only:function(L){if(!H(L))throw Error("React.Children.only expected to receive a single React element child.");return L}};return se.Activity=v,se.Children=ot,se.Component=x,se.Fragment=i,se.Profiler=o,se.PureComponent=U,se.StrictMode=a,se.Suspense=p,se.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,se.__COMPILER_RUNTIME={__proto__:null,c:function(L){return z.H.useMemoCache(L)}},se.cache=function(L){return function(){return L.apply(null,arguments)}},se.cacheSignal=function(){return null},se.cloneElement=function(L,W,ft){if(L==null)throw Error("The argument must be a React element, but you passed "+L+".");var V=A({},L.props),ut=L.key;if(W!=null)for(St in W.key!==void 0&&(ut=""+W.key),W)!X.call(W,St)||St==="key"||St==="__self"||St==="__source"||St==="ref"&&W.ref===void 0||(V[St]=W[St]);var St=arguments.length-2;if(St===1)V.children=ft;else if(1<St){for(var mt=Array(St),Pt=0;Pt<St;Pt++)mt[Pt]=arguments[Pt+2];V.children=mt}return D(L.type,ut,V)},se.createContext=function(L){return L={$$typeof:f,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null},L.Provider=L,L.Consumer={$$typeof:c,_context:L},L},se.createElement=function(L,W,ft){var V,ut={},St=null;if(W!=null)for(V in W.key!==void 0&&(St=""+W.key),W)X.call(W,V)&&V!=="key"&&V!=="__self"&&V!=="__source"&&(ut[V]=W[V]);var mt=arguments.length-2;if(mt===1)ut.children=ft;else if(1<mt){for(var Pt=Array(mt),Nt=0;Nt<mt;Nt++)Pt[Nt]=arguments[Nt+2];ut.children=Pt}if(L&&L.defaultProps)for(V in mt=L.defaultProps,mt)ut[V]===void 0&&(ut[V]=mt[V]);return D(L,St,ut)},se.createRef=function(){return{current:null}},se.forwardRef=function(L){return{$$typeof:h,render:L}},se.isValidElement=H,se.lazy=function(L){return{$$typeof:g,_payload:{_status:-1,_result:L},_init:Q}},se.memo=function(L,W){return{$$typeof:m,type:L,compare:W===void 0?null:W}},se.startTransition=function(L){var W=z.T,ft={};z.T=ft;try{var V=L(),ut=z.S;ut!==null&&ut(ft,V),typeof V=="object"&&V!==null&&typeof V.then=="function"&&V.then(F,Mt)}catch(St){Mt(St)}finally{W!==null&&ft.types!==null&&(W.types=ft.types),z.T=W}},se.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},se.use=function(L){return z.H.use(L)},se.useActionState=function(L,W,ft){return z.H.useActionState(L,W,ft)},se.useCallback=function(L,W){return z.H.useCallback(L,W)},se.useContext=function(L){return z.H.useContext(L)},se.useDebugValue=function(){},se.useDeferredValue=function(L,W){return z.H.useDeferredValue(L,W)},se.useEffect=function(L,W){return z.H.useEffect(L,W)},se.useEffectEvent=function(L){return z.H.useEffectEvent(L)},se.useId=function(){return z.H.useId()},se.useImperativeHandle=function(L,W,ft){return z.H.useImperativeHandle(L,W,ft)},se.useInsertionEffect=function(L,W){return z.H.useInsertionEffect(L,W)},se.useLayoutEffect=function(L,W){return z.H.useLayoutEffect(L,W)},se.useMemo=function(L,W){return z.H.useMemo(L,W)},se.useOptimistic=function(L,W){return z.H.useOptimistic(L,W)},se.useReducer=function(L,W,ft){return z.H.useReducer(L,W,ft)},se.useRef=function(L){return z.H.useRef(L)},se.useState=function(L){return z.H.useState(L)},se.useSyncExternalStore=function(L,W,ft){return z.H.useSyncExternalStore(L,W,ft)},se.useTransition=function(){return z.H.useTransition()},se.version="19.2.7",se}var Gv;function zd(){return Gv||(Gv=1,eh.exports=SS()),eh.exports}var Gt=zd(),nh={exports:{}},Ro={},ih={exports:{}},ah={};/**
 * @license React
...
}`;function qA(s,t,i){let a=new Wd;const o=new te,c=new te,f=new en,h=new mE({depthPacking:fM}),p=new gE,m={},g=i.maxTextureSize,v={[Wa]:Xn,[Xn]:Wa,[Li]:Li},_=new qa({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new te},radius:{value:4}},vertexShader:XA,fragmentShader:WA}),S=_.clone();S.defines.HORIZONTAL_PASS=1;const E=new zi;E.setAttribute("position",new Oi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const A=new ei(E,_),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=f0;let x=this.type;this.render=function(F,z,X){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||F.length===0)return;const D=s.getRenderTarget(),C=s.getActiveCubeFace(),H=s.getActiveMipmapLevel(),nt=s.state;nt.setBlending(Va),nt.buffers.color.setClear(1,1,1,1),nt.buffers.depth.setTest(!0),nt.setScissorTest(!1);const J=x!==ra&&this.type===ra,lt=x===ra&&this.type!==ra;for(let vt=0,O=F.length;vt<O;vt++){const $=F[vt],Q=$.shadow;if(Q===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(Q.autoUpdate===!1&&Q.needsUpdate===!1)continue;o.copy(Q.mapSize);const Mt=Q.getFrameExtents();if(o.multiply(Mt),c.copy(Q.mapSize),(o.x>g||o.y>g)&&(o.x>g&&(c.x=Math.floor(g/Mt.x),o.x=c.x*Mt.x,Q.mapSize.x=c.x),o.y>g&&(c.y=Math.floor(g/Mt.y),o.y=c.y*Mt.y,Q.mapSize.y=c.y)),Q.map===null||J===!0||lt===!0){const L=this.type!==ra?{minFilter:bi,magFilter:bi}:{};Q.map!==null&&Q.map.dispose(),Q.map=new Ar(o.x,o.y,L),Q.map.texture.name=$.name+".shadowMap",Q.camera.updateProjectionMatrix()}s.setRenderTarget(Q.map),s.clear();const ot=Q.getViewportCount();for(let L=0;L<ot;L++){const W=Q.getViewport(L);f.set(c.x*W.x,c.y*W.y,c.x*W.z,c.y*W.w),nt.viewport(f),Q.updateMatrices($,L),a=Q.getFrustum(),w(z,X,Q.camera,$,this.type)}Q.isPointLightShadow!==!0&&this.type===ra&&P(Q,X),Q.needsUpdate=!1}x=this.type,M.needsUpdate=!1,s.setRenderTarget(D,C,H)};function P(F,z){const X=t.update(A);_.defines.VSM_SAMPLES!==F.blurSamples&&(_.defines.VSM_SAMPLES=F.blurSamples,S.defines.VSM_SAMPLES=F.blurSamples,_.needsUpdate=!0,S.needsUpdate=!0),F.mapPass===null&&(F.mapPass=new Ar(o.x,o.y)),_.uniforms.shadow_pass.value=F.map.texture,_.uniforms.resolution.value=F.mapSize,_.uniforms.radius.value=F.radius,s.setRenderTarget(F.mapPass),s.clear(),s.renderBufferDirect(z,null,X,_,A,null),S.uniforms.shadow_pass.value=F.mapPass.texture,S.uniforms.resolution.value=F.mapSize,S.uniforms.radius.value=F.radius,s.setRenderTarget(F.map),s.clear(),s.renderBufferDirect(z,null,X,S,A,null)}function U(F,z,X,D){let C=null;const H=X.isPointLight===!0?F.customDistanceMaterial:F.customDepthMaterial;if(H!==void 0)C=H;else if(C=X.isPointLight===!0?p:h,s.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0){const nt=C.uuid,J=z.uuid;let lt=m[nt];lt===void 0&&(lt={},m[nt]=lt);let vt=lt[J];vt===void 0&&(vt=C.clone(),lt[J]=vt,z.addEventListener("dispose",k)),C=vt}if(C.visible=z.visible,C.wireframe=z.wireframe,D===ra?C.side=z.shadowSide!==null?z.shadowSide:z.side:C.side=z.shadowSide!==null?z.shadowSide:v[z.side],C.alphaMap=z.alphaMap,C.alphaTest=z.alphaTest,C.map=z.map,C.clipShadows=z.clipShadows,C.clippingPlanes=z.clippingPlanes,C.clipIntersection=z.clipIntersection,C.displacementMap=z.displacementMap,C.displacementScale=z.displacementScale,C.displacementBias=z.displacementBias,C.wireframeLinewidth=z.wireframeLinewidth,C.linewidth=z.linewidth,X.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const nt=s.properties.get(C);nt.light=X}return C}function w(F,z,X,D,C){if(F.visible===!1)return;if(F.layers.test(z.layers)&&(F.isMesh||F.isLine||F.isPoints)&&(F.castShadow||F.receiveShadow&&C===ra)&&(!F.frustumCulled||a.intersectsObject(F))){F.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,F.matrixWorld);const J=t.update(F),lt=F.material;if(Array.isArray(lt)){const vt=J.groups;for(let O=0,$=vt.length;O<$;O++){const Q=vt[O],Mt=lt[Q.materialIndex];if(Mt&&Mt.visible){const ot=U(F,Mt,D,C);F.onBeforeShadow(s,F,z,X,J,ot,Q),s.renderBufferDirect(X,null,J,ot,F,Q),F.onAfterShadow(s,F,z,X,J,ot,Q)}}}else if(lt.visible){const vt=U(F,lt,D,C);F.onBeforeShadow(s,F,z,X,J,vt,null),s.renderBufferDirect(X,null,J,vt,F,null),F.onAfterShadow(s,F,z,X,J,vt,null)}}const nt=F.children;for(let J=0,lt=nt.length;J<lt;J++)w(nt[J],z,X,D,C)}function k(F){F.target.removeEventListener("dispose",k);for(const X in m){const D=m[X],C=F.target.uuid;C in D&&(D[C].dispose(),delete D[C])}}}const YA={[Zh]:Kh,[Qh]:td,[Jh]:ed,[Ts]:$h,[Kh]:Zh,[td]:Qh,[ed]:Jh,[$h]:Ts};function jA(s,t){function i(){let Y=!1;const wt=new en;let ht=null;const yt=new en(0,0,0,0);return{setMask:function(Rt){ht!==Rt&&!Y&&(s.colorMask(Rt,Rt,Rt,Rt),ht=Rt)},setLocked:function(Rt){Y=Rt},setClear:function(Rt,Dt,ne,je,un){un===!0&&(Rt*=je,Dt*=je,ne*=je),wt.set(Rt,Dt,ne,je),yt.equals(wt)===!1&&(s.clearColor(Rt,Dt,ne,je),yt.copy(wt))},reset:function(){Y=!1,ht=null,yt.set(-1,0,0,0)}}}function a(){let Y=!1,wt=!1,ht=null,yt=null,Rt=null;return{setReversed:function(Dt){if(wt!==Dt){const ne=t.get("EXT_clip_control");Dt?ne.clipControlEXT(ne.LOWER_LEFT_EXT,ne.ZERO_TO_ONE_EXT):ne.clipControlEXT(ne.LOWER_LEFT_EXT,ne.NEGATIVE_ONE_TO_ONE_EXT),wt=Dt;const je=Rt;Rt=null,this.setClear(je)}},getReversed:function(){return wt},setTest:function(Dt){Dt?mt(s.DEPTH_TEST):Pt(s.DEPTH_TEST)},setMask:function(Dt){ht!==Dt&&!Y&&(s.depthMask(Dt),ht=Dt)},setFunc:function(Dt){if(wt&&(Dt=YA[Dt]),yt!==Dt){switch(Dt){case Zh:s.depthFunc(s.NEVER);break;case Kh:s.depthFunc(s.ALWAYS);break;case Qh:s.depthFunc(s.LESS);break;case Ts:s.depthFunc(s.LEQUAL);break;case Jh:s.depthFunc(s.EQUAL);break;case $h:s.depthFunc(s.GEQUAL);break;case td:s.depthFunc(s.GREATER);break;case ed:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}yt=Dt}},setLocked:function(Dt){Y=Dt},setClear:function(Dt){Rt!==Dt&&(wt&&(Dt=1-Dt),s.clearDepth(Dt),Rt=Dt)},reset:function(){Y=!1,ht=null,yt=null,Rt=null,wt=!1}}}function o(){let Y=!1,wt=null,ht=null,yt=null,Rt=null,Dt=null,ne=null,je=null,un=null;return{setTest:function(Ae){Y||(Ae?mt(s.STENCIL_TEST):Pt(s.STENCIL_TEST))},setMask:function(Ae){wt!==Ae&&!Y&&(s.stencilMask(Ae),wt=Ae)},setFunc:function(Ae,_n,pi){(ht!==Ae||yt!==_n||Rt!==pi)&&(s.stencilFunc(Ae,_n,pi),ht=Ae,yt=_n,Rt=pi)},setOp:function(Ae,_n,pi){(Dt!==Ae||ne!==_n||je!==pi)&&(s.stencilOp(Ae,_n,pi),Dt=Ae,ne=_n,je=pi)},setLocked:function(Ae){Y=Ae},setClear:function(Ae){un!==Ae&&(s.clearStencil(Ae),un=Ae)},reset:function(){Y=!1,wt=null,ht=null,yt=null,Rt=null,Dt=null,ne=null,je=null,un=null}}}const c=new i,f=new a,h=new o,p=new WeakMap,m=new WeakMap;let g={},v={},_=new WeakMap,S=[],E=null,A=!1,M=null,x=null,P=null,U=null,w=null,k=null,F=null,z=new ze(0,0,0),X=0,D=!1,C=null,H=null,nt=null,J=null,lt=null;const vt=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,$=0;const Q=s.getParameter(s.VERSION);Q.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(Q)[1]),O=$>=1):Q.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),O=$>=2);let Mt=null,ot={};const L=s.getParameter(s.SCISSOR_BOX),W=s.getParameter(s.VIEWPORT),ft=new en().fromArray(L),V=new en().fromArray(W);function ut(Y,wt,ht,yt){const Rt=new Uint8Array(4),Dt=s.createTexture();s.bindTexture(Y,Dt),s.texParameteri(Y,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(Y,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let ne=0;ne<ht;ne++)Y===s.TEXTURE_3D||Y===s.TEXTURE_2D_ARRAY?s.texImage3D(wt,0,s.RGBA,1,1,yt,0,s.RGBA,s.UNSIGNED_BYTE,Rt):s.texImage2D(wt+ne,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Rt);return Dt}const St={};St[s.TEXTURE_2D]=ut(s.TEXTURE_2D,s.TEXTURE_2D,1),St[s.TEXTURE_CUBE_MAP]=ut(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),St[s.TEXTURE_2D_ARRAY]=ut(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),St[s.TEXTURE_3D]=ut(s.TEXTURE_3D,s.TEXTURE_3D,1,1),c.setClear(0,0,0,1),f.setClear(1),h.setClear(0),mt(s.DEPTH_TEST),f.setFunc(Ts),ue(!1),pe(Zv),mt(s.CULL_FACE),I(Va);function mt(Y){g[Y]!==!0&&(s.enable(Y),g[Y]=!0)}function Pt(Y){g[Y]!==!1&&(s.disable(Y),g[Y]=!1)}function Nt(Y,wt){return v[Y]!==wt?(s.bindFramebuffer(Y,wt),v[Y]=wt,Y===s.DRAW_FRAMEBUFFER&&(v[s.FRAMEBUFFER]=wt),Y===s.FRAMEBUFFER&&(v[s.DRAW_FRAMEBUFFER]=wt),!0):!1}function Vt(Y,wt){let ht=S,yt=!1;if(Y){ht=_.get(wt),ht===void 0&&(ht=[],_.set(wt,ht));const Rt=Y.textures;if(ht.length!==Rt.length||ht[0]!==s.COLOR_ATTACHMENT0){for(let Dt=0,ne=Rt.length;Dt<ne;Dt++)ht[Dt]=s.COLOR_ATTACHMENT0+Dt;ht.length=Rt.length,yt=!0}}else ht[0]!==s.BACK&&(ht[0]=s.BACK,yt=!0);yt&&s.drawBuffers(ht)}function oe(Y){return E!==Y?(s.useProgram(Y),E=Y,!0):!1}const Le={[yr]:s.FUNC_ADD,[FS]:s.FUNC_SUBTRACT,[BS]:s.FUNC_REVERSE_SUBTRACT};Le[IS]=s.MIN,Le[HS]=s.MAX;const ae={[GS]:s.ZERO,[VS]:s.ONE,[kS]:s.SRC_COLOR,[Yh]:s.SRC_ALPHA,[ZS]:s.SRC_ALPHA_SATURATE,[YS]:s.DST_COLOR,[WS]:s.DST_ALPHA,[XS]:s.ONE_MINUS_SRC_COLOR,[jh]:s.ONE_MINUS_SRC_ALPHA,[jS]:s.ONE_MINUS_DST_COLOR,[qS]:s.ONE_MINUS_DST_ALPHA,[KS]:s.CONSTANT_COLOR,[QS]:s.ONE_MINUS_CONSTANT_COLOR,[JS]:s.CONSTANT_ALPHA,[$S]:s.ONE_MINUS_CONSTANT_ALPHA};function I(Y,wt,ht,yt,Rt,Dt,ne,je,un,Ae){if(Y===Va){A===!0&&(Pt(s.BLEND),A=!1);return}if(A===!1&&(mt(s.BLEND),A=!0),Y!==PS){if(Y!==M||Ae!==D){if((x!==yr||w!==yr)&&(s.blendEquation(s.FUNC_ADD),x=yr,w=yr),Ae)switch(Y){case Ms:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Kv:s.blendFunc(s.ONE,s.ONE);break;case Qv:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Jv:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",Y);break}else switch(Y){case Ms:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Kv:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case Qv:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Jv:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",Y);break}P=null,U=null,k=null,F=null,z.set(0,0,0),X=0,M=Y,D=Ae}return}Rt=Rt||wt,Dt=Dt||ht,ne=ne||yt,(wt!==x||Rt!==w)&&(s.blendEquationSeparate(Le[wt],Le[Rt]),x=wt,w=Rt),(ht!==P||yt!==U||Dt!==k||ne!==F)&&(s.blendFuncSeparate(ae[ht],ae[yt],ae[Dt],ae[ne]),P=ht,U=yt,k=Dt,F=ne),(je.equals(z)===!1||un!==X)&&(s.blendColor(je.r,je.g,je.b,un),z.copy(je),X=un),M=Y,D=!1}function Xe(Y,wt){Y.side===Li?Pt(s.CULL_FACE):mt(s.CULL_FACE);let ht=Y.side===Xn;wt&&(ht=!ht),ue(ht),Y.blending===Ms&&Y.transparent===!1?I(Va):I(Y.blending,Y.blendEquation,Y.blendSrc,Y.blendDst,Y.blendEquationAlpha,Y.blendSrcAlpha,Y.blendDstAlpha,Y.blendColor,Y.blendAlpha,Y.premultipliedAlpha),f.setFunc(Y.depthFunc),f.setTest(Y.depthTest),f.setMask(Y.depthWrite),c.setMask(Y.colorWrite);const yt=Y.stencilWrite;h.setTest(yt),yt&&(h.setMask(Y.stencilWriteMask),h.setFunc(Y.stencilFunc,Y.stencilRef,Y.stencilFuncMask),h.setOp(Y.stencilFail,Y.stencilZFail,Y.stencilZPass)),_e(Y.polygonOffset,Y.polygonOffsetFactor,Y.polygonOffsetUnits),Y.alphaToCoverage===!0?mt(s.SAMPLE_ALPHA_TO_COVERAGE):Pt(s.SAMPLE_ALPHA_TO_COVERAGE)}function ue(Y){C!==Y&&(Y?s.frontFace(s.CW):s.frontFace(s.CCW),C=Y)}function pe(Y){Y!==NS?(mt(s.CULL_FACE),Y!==H&&(Y===Zv?s.cullFace(s.BACK):Y===OS?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Pt(s.CULL_FACE),H=Y}function Yt(Y){Y!==nt&&(O&&s.lineWidth(Y),nt=Y)}function _e(Y,wt,ht){Y?(mt(s.POLYGON_OFFSET_FILL),(J!==wt||lt!==ht)&&(s.polygonOffset(wt,ht),J=wt,lt=ht)):Pt(s.POLYGON_OFFSET_FILL)}function Xt(Y){Y?mt(s.SCISSOR_TEST):Pt(s.SCISSOR_TEST)}function N(Y){Y===void 0&&(Y=s.TEXTURE0+vt-1),Mt!==Y&&(s.activeTexture(Y),Mt=Y)}function b(Y,wt,ht){ht===void 0&&(Mt===null?ht=s.TEXTURE0+vt-1:ht=Mt);let yt=ot[ht];yt===void 0&&(yt={type:void 0,texture:void 0},ot[ht]=yt),(yt.type!==Y||yt.texture!==wt)&&(Mt!==ht&&(s.activeTexture(ht),Mt=ht),s.bindTexture(Y,wt||St[Y]),yt.type=Y,yt.texture=wt)}function at(){const Y=ot[Mt];Y!==void 0&&Y.type!==void 0&&(s.bindTexture(Y.type,null),Y.type=void 0,Y.texture=void 0)}function pt(){try{s.compressedTexImage2D(...arguments)}catch(Y){console.error("THREE.WebGLState:",Y)}}function Et(){try{s.compressedTexImage3D(...arguments)}catch(Y){console.error("THREE.WebGLState:",Y)}}function _t(){try{s.texSubImage2D(...arguments)}catch(Y){console.error("THREE.WebGLState:",Y)}}function Wt(){try{s.texSubImage3D(...arguments)}catch(Y){console.error("THREE.WebGLState:",Y)}}function Ct(){try{s.compressedTexSubImage2D(...arguments)}catch(Y){console.error("THREE.WebGLState:",Y)}}function Bt(){try{s.compressedTexSubImage3D(...arguments)}catch(Y){console.error("THREE.WebGLState:",Y)}}function xe(){try{s.texStorage2D(...arguments)}catch(Y){console.error("THREE.WebGLState:",Y)}}function bt(){try{s.texStorage3D(...arguments)}catch(Y){console.error("THREE.WebGLState:",Y)}}function It(){try{s.texImage2D(...arguments)}catch(Y){console.error("THREE.WebGLState:",Y)}}function Qt(){try{s.texImage3D(...arguments)}catch(Y){console.error("THREE.WebGLState:",Y)}}function qt(Y){ft.equals(Y)===!1&&(s.scissor(Y.x,Y.y,Y.z,Y.w),ft.copy(Y))}function zt(Y){V.equals(Y)===!1&&(s.viewport(Y.x,Y.y,Y.z,Y.w),V.copy(Y))}function ee(Y,wt){let ht=m.get(wt);ht===void 0&&(ht=new WeakMap,m.set(wt,ht));let yt=ht.get(Y);yt===void 0&&(yt=s.getUniformBlockIndex(wt,Y.name),ht.set(Y,yt))}function le(Y,wt){const yt=m.get(wt).get(Y);p.get(wt)!==yt&&(s.uniformBlockBinding(wt,yt,Y.__bindingPointIndex),p.set(wt,yt))}function Pe(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),f.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),g={},Mt=null,ot={},v={},_=new WeakMap,S=[],E=null,A=!1,M=null,x=null,P=null,U=null,w=null,k=null,F=null,z=new ze(0,0,0),X=0,D=!1,C=null,H=null,nt=null,J=null,lt=null,ft.set(0,0,s.canvas.width,s.canvas.height),V.set(0,0,s.canvas.width,s.canvas.height),c.reset(),f.reset(),h.reset()}return{buffers:{color:c,depth:f,stencil:h},enable:mt,disable:Pt,bindFramebuffer:Nt,drawBuffers:Vt,useProgram:oe,setBlending:I,setMaterial:Xe,setFlipSided:ue,setCullFace:pe,setLineWidth:Yt,setPolygonOffset:_e,setScissorTest:Xt,activeTexture:N,bindTexture:b,unbindTexture:at,compressedTexImage2D:pt,compressedTexImage3D:Et,texImage2D:It,texImage3D:Qt,updateUBOMapping:ee,uniformBlockBinding:le,texStorage2D:xe,texStorage3D:bt,texSubImage2D:_t,texSubImage3D:Wt,compressedTexSubImage2D:Ct,compressedTexSubImage3D:Bt,scissor:qt,viewport:zt,reset:Pe}}function ZA(s,t,i,a,o,c,f){const h=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),m=new te,g=new WeakMap;let v;const _=new WeakMap;let S=!1;try{S=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(N,b){return S?new OffscreenCanvas(N,b):Hc("canvas")}function A(N,b,at){let pt=1;const Et=Xt(N);if((Et.width>at||Et.height>at)&&(pt=at/Math.max(Et.width,Et.height)),pt<1)if(typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&N instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&N instanceof ImageBitmap||typeof VideoFrame<"u"&&N instanceof VideoFrame){const _t=Math.floor(pt*Et.width),Wt=Math.floor(pt*Et.height);v===void 0&&(v=E(_t,Wt));const Ct=b?E(_t,Wt):v;return Ct.width=_t,Ct.height=Wt,Ct.getContext("2d").drawImage(N,0,0,_t,Wt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Et.width+"x"+Et.height+") to ("+_t+"x"+Wt+")."),Ct}else return"data"in N&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Et.width+"x"+Et.height+")."),N;return N}function M(N){return N.generateMipmaps}function x(N){s.generateMipmap(N)}function P(N){return N.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:N.isWebGL3DRenderTarget?s.TEXTURE_3D:N.isWebGLArrayRenderTarget||N.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function U(N,b,at,pt,Et=!1){if(N!==null){if(s[N]!==void 0)return s[N];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+N+"'")}let _t=b;if(b===s.RED&&(at===s.FLOAT&&(_t=s.R32F),at===s.HALF_FLOAT&&(_t=s.R16F),at===s.UNSIGNED_BYTE&&(_t=s.R8)),b===s.RED_INTEGER&&(at===s.UNSIGNED_BYTE&&(_t=s.R8UI),at===s.UNSIGNED_SHORT&&(_t=s.R16UI),at===s.UNSIGNED_INT&&(_t=s.R32UI),at===s.BYTE&&(_t=s.R8I),at===s.SHORT&&(_t=s.R16I),at===s.INT&&(_t=s.R32I)),b===s.RG&&(at===s.FLOAT&&(_t=s.RG32F),at===s.HALF_FLOAT&&(_t=s.RG16F),at===s.UNSIGNED_BYTE&&(_t=s.RG8)),b===s.RG_INTEGER&&(at===s.UNSIGNED_BYTE&&(_t=s.RG8UI),at===s.UNSIGNED_SHORT&&(_t=s.RG16UI),at===s.UNSIGNED_INT&&(_t=s.RG32UI),at===s.BYTE&&(_t=s.RG8I),at===s.SHORT&&(_t=s.RG16I),at===s.INT&&(_t=s.RG32I)),b===s.RGB_INTEGER&&(at===s.UNSIGNED_BYTE&&(_t=s.RGB8UI),at===s.UNSIGNED_SHORT&&(_t=s.RGB16UI),at===s.UNSIGNED_INT&&(_t=s.RGB32UI),at===s.BYTE&&(_t=s.RGB8I),at===s.SHORT&&(_t=s.RGB16I),at===s.INT&&(_t=s.RGB32I)),b===s.RGBA_INTEGER&&(at===s.UNSIGNED_BYTE&&(_t=s.RGBA8UI),at===s.UNSIGNED_SHORT&&(_t=s.RGBA16UI),at===s.UNSIGNED_INT&&(_t=s.RGBA32UI),at===s.BYTE&&(_t=s.RGBA8I),at===s.SHORT&&(_t=s.RGBA16I),at===s.INT&&(_t=s.RGBA32I)),b===s.RGB&&at===s.UNSIGNED_INT_5_9_9_9_REV&&(_t=s.RGB9_E5),b===s.RGBA){const Wt=Et?Bc:De.getTransfer(pt);at===s.FLOAT&&(_t=s.RGBA32F),at===s.HALF_FLOAT&&(_t=s.RGBA16F),at===s.UNSIGNED_BYTE&&(_t=Wt===Ge?s.SRGB8_ALPHA8:s.RGBA8),at===s.UNSIGNED_SHORT_4_4_4_4&&(_t=s.RGBA4),at===s.UNSIGNED_SHORT_5_5_5_1&&(_t=s.RGB5_A1)}return(_t===s.R16F||_t===s.R32F||_t===s.RG16F||_t===s.RG32F||_t===s.RGBA16F||_t===s.RGBA32F)&&t.get("EXT_color_buffer_float"),_t}function w(N,b){let at;return N?b===null||b===br||b===Io?at=s.DEPTH24_STENCIL8:b===sa?at=s.DEPTH32F_STENCIL8:b===Bo&&(at=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===br||b===Io?at=s.DEPTH_COMPONENT24:b===sa?at=s.DEPTH_COMPONENT32F:b===Bo&&(at=s.DEPTH_COMPONENT16),at}function k(N,b){return M(N)===!0||N.isFramebufferTexture&&N.minFilter!==bi&&N.minFilter!==Ni?Math.log2(Math.max(b.width,b.height))+1:N.mipmaps!==void 0&&N.mipmaps.length>0?N.mipmaps.length:N.isCompressedTexture&&Array.isArray(N.image)?b.mipmaps.length:1}function F(N){const b=N.target;b.removeEventListener("dispose",F),X(b),b.isVideoTexture&&g.delete(b)}function z(N){const b=N.target;b.removeEventListener("dispose",z),C(b)}function X(N){const b=a.get(N);if(b.__webglInit===void 0)return;const at=N.source,pt=_.get(at);if(pt){const Et=pt[b.__cacheKey];Et.usedTimes--,Et.usedTimes===0&&D(N),Object.keys(pt).length===0&&_.delete(at)}a.remove(N)}function D(N){const b=a.get(N);s.deleteTexture(b.__webglTexture);const at=N.source,pt=_.get(at);delete pt[b.__cacheKey],f.memory.textures--}function C(N){const b=a.get(N);if(N.depthTexture&&(N.depthTexture.dispose(),a.remove(N.depthTexture)),N.isWebGLCubeRenderTarget)for(let pt=0;pt<6;pt++){if(Array.isArray(b.__webglFramebuffer[pt]))for(let Et=0;Et<b.__webglFramebuffer[pt].length;Et++)s.deleteFramebuffer(b.__webglFramebuffer[pt][Et]);else s.deleteFramebuffer(b.__webglFramebuffer[pt]);b.__webglDepthbuffer&&s.deleteRenderbuffer(b.__webglDepthbuffer[pt])}else{if(Array.isArray(b.__webglFramebuffer))for(let pt=0;pt<b.__webglFramebuffer.length;pt++)s.deleteFramebuffer(b.__webglFramebuffer[pt]);else s.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&s.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&s.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let pt=0;pt<b.__webglColorRenderbuffer.length;pt++)b.__webglColorRenderbuffer[pt]&&s.deleteRenderbuffer(b.__webglColorRenderbuffer[pt]);b.__webglDepthRenderbuffer&&s.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const at=N.textures;for(let pt=0,Et=at.length;pt<Et;pt++){const _t=a.get(at[pt]);_t.__webglTexture&&(s.deleteTexture(_t.__webglTexture),f.memory.textures--),a.remove(at[pt])}a.remove(N)}let H=0;function nt(){H=0}function J(){const N=H;return N>=o.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+N+" texture units while this GPU supports only "+o.maxTextures),H+=1,N}function lt(N){const b=[];return b.push(N.wrapS),b.push(N.wrapT),b.push(N.wrapR||0),b.push(N.magFilter),b.push(N.minFilter),b.push(N.anisotropy),b.push(N.internalFormat),b.push(N.format),b.push(N.type),b.push(N.generateMipmaps),b.push(N.premultiplyAlpha),b.push(N.flipY),b.push(N.unpackAlignment),b.push(N.colorSpace),b.join()}function vt(N,b){const at=a.get(N);if(N.isVideoTexture&&Yt(N),N.isRenderTargetTexture===!1&&N.version>0&&at.__version!==N.version){const pt=N.image;if(pt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(pt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{V(at,N,b);return}}i.bindTexture(s.TEXTURE_2D,at.__webglTexture,s.TEXTURE0+b)}function O(N,b){const at=a.get(N);if(N.version>0&&at.__version!==N.version){V(at,N,b);return}i.bindTexture(s.TEXTURE_2D_ARRAY,at.__webglTexture,s.TEXTURE0+b)}function $(N,b){const at=a.get(N);if(N.version>0&&at.__version!==N.version){V(at,N,b);return}i.bindTexture(s.TEXTURE_3D,at.__webglTexture,s.TEXTURE0+b)}function Q(N,b){const at=a.get(N);if(N.version>0&&at.__version!==N.version){ut(at,N,b);return}i.bindTexture(s.TEXTURE_CUBE_MAP,at.__webglTexture,s.TEXTURE0+b)}const Mt={[ad]:s.REPEAT,[Mr]:s.CLAMP_TO_EDGE,[rd]:s.MIRRORED_REPEAT},ot={[bi]:s.NEAREST,[cM]:s.NEAREST_MIPMAP_NEAREST,[rc]:s.NEAREST_MIPMAP_LINEAR,[Ni]:s.LINEAR,[sh]:s.LINEAR_MIPMAP_NEAREST,[Er]:s.LINEAR_MIPMAP_LINEAR},L={[pM]:s.NEVER,[yM]:s.ALWAYS,[mM]:s.LESS,[T0]:s.LEQUAL,[gM]:s.EQUAL,[xM]:s.GEQUAL,[vM]:s.GREATER,[_M]:s.NOTEQUAL};function W(N,b){if(b.type===sa&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===Ni||b.magFilter===sh||b.magFilter===rc||b.magFilter===Er||b.minFilter===Ni||b.minFilter===sh||b.minFilter===rc||b.minFilter===Er)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(N,s.TEXTURE_WRAP_S,Mt[b.wrapS]),s.texParameteri(N,s.TEXTURE_WRAP_T,Mt[b.wrapT]),(N===s.TEXTURE_3D||N===s.TEXTURE_2D_ARRAY)&&s.texParameteri(N,s.TEXTURE_WRAP_R,Mt[b.wrapR]),s.texParameteri(N,s.TEXTURE_MAG_FILTER,ot[b.magFilter]),s.texParameteri(N,s.TEXTURE_MIN_FILTER,ot[b.minFilter]),b.compareFunction&&(s.texParameteri(N,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(N,s.TEXTURE_COMPARE_FUNC,L[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===bi||b.minFilter!==rc&&b.minFilter!==Er||b.type===sa&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||a.get(b).__currentAnisotropy){const at=t.get("EXT_texture_filter_anisotropic");s.texParameterf(N,at.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,o.getMaxAnisotropy())),a.get(b).__currentAnisotropy=b.anisotropy}}}function ft(N,b){let at=!1;N.__webglInit===void 0&&(N.__webglInit=!0,b.addEventListener("dispose",F));const pt=b.source;let Et=_.get(pt);Et===void 0&&(Et={},_.set(pt,Et));const _t=lt(b);if(_t!==N.__cacheKey){Et[_t]===void 0&&(Et[_t]={texture:s.createTexture(),usedTimes:0},f.memory.textures++,at=!0),Et[_t].usedTimes++;const Wt=Et[N.__cacheKey];Wt!==void 0&&(Et[N.__cacheKey].usedTimes--,Wt.usedTimes===0&&D(b)),N.__cacheKey=_t,N.__webglTexture=Et[_t].texture}return at}function V(N,b,at){let pt=s.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(pt=s.TEXTURE_2D_ARRAY),b.isData3DTexture&&(pt=s.TEXTURE_3D);const Et=ft(N,b),_t=b.source;i.bindTexture(pt,N.__webglTexture,s.TEXTURE0+at);const Wt=a.get(_t);if(_t.version!==Wt.__version||Et===!0){i.activeTexture(s.TEXTURE0+at);const Ct=De.getPrimaries(De.workingColorSpace),Bt=b.colorSpace===Ga?null:De.getPrimaries(b.colorSpace),xe=b.colorSpace===Ga||Ct===Bt?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,b.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,b.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);let bt=A(b.image,!1,o.maxTextureSize);bt=_e(b,bt);const It=c.convert(b.format,b.colorSpace),Qt=c.convert(b.type);let qt=U(b.internalFormat,It,Qt,b.colorSpace,b.isVideoTexture);W(pt,b);let zt;const ee=b.mipmaps,le=b.isVideoTexture!==!0,Pe=Wt.__version===void 0||Et===!0,Y=_t.dataReady,wt=k(b,bt);if(b.isDepthTexture)qt=w(b.format===Go,b.type),Pe&&(le?i.texStorage2D(s.TEXTURE_2D,1,qt,bt.width,bt.height):i.texImage2D(s.TEXTURE_2D,0,qt,bt.width,bt.height,0,It,Qt,null));else if(b.isDataTexture)if(ee.length>0){le&&Pe&&i.texStorage2D(s.TEXTURE_2D,wt,qt,ee[0].width,ee[0].height);for(let ht=0,yt=ee.length;ht<yt;ht++)zt=ee[ht],le?Y&&i.texSubImage2D(s.TEXTURE_2D,ht,0,0,zt.width,zt.height,It,Qt,zt.data):i.texImage2D(s.TEXTURE_2D,ht,qt,zt.width,zt.height,0,It,Qt,zt.data);b.generateMipmaps=!1}else le?(Pe&&i.texStorage2D(s.TEXTURE_2D,wt,qt,bt.width,bt.height),Y&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,bt.width,bt.height,It,Qt,bt.data)):i.texImage2D(s.TEXTURE_2D,0,qt,bt.width,bt.height,0,It,Qt,bt.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){le&&Pe&&i.texStorage3D(s.TEXTURE_2D_ARRAY,wt,qt,ee[0].width,ee[0].height,bt.depth);for(let ht=0,yt=ee.length;ht<yt;ht++)if(zt=ee[ht],b.format!==Ti)if(It!==null)if(le){if(Y)if(b.layerUpdates.size>0){const Rt=M_(zt.width,zt.height,b.format,b.type);for(const Dt of b.layerUpdates){const ne=zt.data.subarray(Dt*Rt/zt.data.BYTES_PER_ELEMENT,(Dt+1)*Rt/zt.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ht,0,0,Dt,zt.width,zt.height,1,It,ne)}b.clearLayerUpdates()}else i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ht,0,0,0,zt.width,zt.height,bt.depth,It,zt.data)}else i.compressedTexImage3D(s.TEXTURE_2D_ARRAY,ht,qt,zt.width,zt.height,bt.depth,0,zt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else le?Y&&i.texSubImage3D(s.TEXTURE_2D_ARRAY,ht,0,0,0,zt.width,zt.height,bt.depth,It,Qt,zt.data):i.texImage3D(s.TEXTURE_2D_ARRAY,ht,qt,zt.width,zt.height,bt.depth,0,It,Qt,zt.data)}else{le&&Pe&&i.texStorage2D(s.TEXTURE_2D,wt,qt,ee[0].width,ee[0].height);for(let ht=0,yt=ee.length;ht<yt;ht++)zt=ee[ht],b.format!==Ti?It!==null?le?Y&&i.compressedTexSubImage2D(s.TEXTURE_2D,ht,0,0,zt.width,zt.height,It,zt.data):i.compressedTexImage2D(s.TEXTURE_2D,ht,qt,zt.width,zt.height,0,zt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):le?Y&&i.texSubImage2D(s.TEXTURE_2D,ht,0,0,zt.width,zt.height,It,Qt,zt.data):i.texImage2D(s.TEXTURE_2D,ht,qt,zt.width,zt.height,0,It,Qt,zt.data)}else if(b.isDataArrayTexture)if(le){if(Pe&&i.texStorage3D(s.TEXTURE_2D_ARRAY,wt,qt,bt.width,bt.height,bt.depth),Y)if(b.layerUpdates.size>0){const ht=M_(bt.width,bt.height,b.format,b.type);for(const yt of b.layerUpdates){const Rt=bt.data.subarray(yt*ht/bt.data.BYTES_PER_ELEMENT,(yt+1)*ht/bt.data.BYTES_PER_ELEMENT);i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,yt,bt.width,bt.height,1,It,Qt,Rt)}b.clearLayerUpdates()}else i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,bt.width,bt.height,bt.depth,It,Qt,bt.data)}else i.texImage3D(s.TEXTURE_2D_ARRAY,0,qt,bt.width,bt.height,bt.depth,0,It,Qt,bt.data);else if(b.isData3DTexture)le?(Pe&&i.texStorage3D(s.TEXTURE_3D,wt,qt,bt.width,bt.height,bt.depth),Y&&i.texSubImage3D(s.TEXTURE_3D,0,0,0,0,bt.width,bt.height,bt.depth,It,Qt,bt.data)):i.texImage3D(s.TEXTURE_3D,0,qt,bt.width,bt.height,bt.depth,0,It,Qt,bt.data);else if(b.isFramebufferTexture){if(Pe)if(le)i.texStorage2D(s.TEXTURE_2D,wt,qt,bt.width,bt.height);else{let ht=bt.width,yt=bt.height;for(let Rt=0;Rt<wt;Rt++)i.texImage2D(s.TEXTURE_2D,Rt,qt,ht,yt,0,It,Qt,null),ht>>=1,yt>>=1}}else if(ee.length>0){if(le&&Pe){const ht=Xt(ee[0]);i.texStorage2D(s.TEXTURE_2D,wt,qt,ht.width,ht.height)}for(let ht=0,yt=ee.length;ht<yt;ht++)zt=ee[ht],le?Y&&i.texSubImage2D(s.TEXTURE_2D,ht,0,0,It,Qt,zt):i.texImage2D(s.TEXTURE_2D,ht,qt,It,Qt,zt);b.generateMipmaps=!1}else if(le){if(Pe){const ht=Xt(bt);i.texStorage2D(s.TEXTURE_2D,wt,qt,ht.width,ht.height)}Y&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,It,Qt,bt)}else i.texImage2D(s.TEXTURE_2D,0,qt,It,Qt,bt);M(b)&&x(pt),Wt.__version=_t.version,b.onUpdate&&b.onUpdate(b)}N.__version=b.version}function ut(N,b,at){if(b.image.length!==6)return;const pt=ft(N,b),Et=b.source;i.bindTexture(s.TEXTURE_CUBE_MAP,N.__webglTexture,s.TEXTURE0+at);const _t=a.get(Et);if(Et.version!==_t.__version||pt===!0){i.activeTexture(s.TEXTURE0+at);const Wt=De.getPrimaries(De.workingColorSpace),Ct=b.colorSpace===Ga?null:De.getPrimaries(b.colorSpace),Bt=b.colorSpace===Ga||Wt===Ct?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,b.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,b.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Bt);const xe=b.isCompressedTexture||b.image[0].isCompressedTexture,bt=b.image[0]&&b.image[0].isDataTexture,It=[];for(let yt=0;yt<6;yt++)!xe&&!bt?It[yt]=A(b.image[yt],!0,o.maxCubemapSize):It[yt]=bt?b.image[yt].image:b.image[yt],It[yt]=_e(b,It[yt]);const Qt=It[0],qt=c.convert(b.format,b.colorSpace),zt=c.convert(b.type),ee=U(b.internalFormat,qt,zt,b.colorSpace),le=b.isVideoTexture!==!0,Pe=_t.__version===void 0||pt===!0,Y=Et.dataReady;let wt=k(b,Qt);W(s.TEXTURE_CUBE_MAP,b);let ht;if(xe){le&&Pe&&i.texStorage2D(s.TEXTURE_CUBE_MAP,wt,ee,Qt.width,Qt.height);for(let yt=0;yt<6;yt++){ht=It[yt].mipmaps;for(let Rt=0;Rt<ht.length;Rt++){const Dt=ht[Rt];b.format!==Ti?qt!==null?le?Y&&i.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt,0,0,Dt.width,Dt.height,qt,Dt.data):i.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt,ee,Dt.width,Dt.height,0,Dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):le?Y&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt,0,0,Dt.width,Dt.height,qt,zt,Dt.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt,ee,Dt.width,Dt.height,0,qt,zt,Dt.data)}}}else{if(ht=b.mipmaps,le&&Pe){ht.length>0&&wt++;const yt=Xt(It[0]);i.texStorage2D(s.TEXTURE_CUBE_MAP,wt,ee,yt.width,yt.height)}for(let yt=0;yt<6;yt++)if(bt){le?Y&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,0,0,It[yt].width,It[yt].height,qt,zt,It[yt].data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,ee,It[yt].width,It[yt].height,0,qt,zt,It[yt].data);for(let Rt=0;Rt<ht.length;Rt++){const ne=ht[Rt].image[yt].image;le?Y&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt+1,0,0,ne.width,ne.height,qt,zt,ne.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt+1,ee,ne.width,ne.height,0,qt,zt,ne.data)}}else{le?Y&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,0,0,qt,zt,It[yt]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,ee,qt,zt,It[yt]);for(let Rt=0;Rt<ht.length;Rt++){const Dt=ht[Rt];le?Y&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt+1,0,0,qt,zt,Dt.image[yt]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt+1,ee,qt,zt,Dt.image[yt])}}}M(b)&&x(s.TEXTURE_CUBE_MAP),_t.__version=Et.version,b.onUpdate&&b.onUpdate(b)}N.__version=b.version}function St(N,b,at,pt,Et,_t){const Wt=c.convert(at.format,at.colorSpace),Ct=c.convert(at.type),Bt=U(at.internalFormat,Wt,Ct,at.colorSpace),xe=a.get(b),bt=a.get(at);if(bt.__renderTarget=b,!xe.__hasExternalTextures){const It=Math.max(1,b.width>>_t),Qt=Math.max(1,b.height>>_t);Et===s.TEXTURE_3D||Et===s.TEXTURE_2D_ARRAY?i.texImage3D(Et,_t,Bt,It,Qt,b.depth,0,Wt,Ct,null):i.texImage2D(Et,_t,Bt,It,Qt,0,Wt,Ct,null)}i.bindFramebuffer(s.FRAMEBUFFER,N),pe(b)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,pt,Et,bt.__webglTexture,0,ue(b)):(Et===s.TEXTURE_2D||Et>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Et<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,pt,Et,bt.__webglTexture,_t),i.bindFramebuffer(s.FRAMEBUFFER,null)}function mt(N,b,at){if(s.bindRenderbuffer(s.RENDERBUFFER,N),b.depthBuffer){const pt=b.depthTexture,Et=pt&&pt.isDepthTexture?pt.type:null,_t=w(b.stencilBuffer,Et),Wt=b.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Ct=ue(b);pe(b)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ct,_t,b.width,b.height):at?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ct,_t,b.width,b.height):s.renderbufferStorage(s.RENDERBUFFER,_t,b.width,b.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Wt,s.RENDERBUFFER,N)}else{const pt=b.textures;for(let Et=0;Et<pt.length;Et++){const _t=pt[Et],Wt=c.convert(_t.format,_t.colorSpace),Ct=c.convert(_t.type),Bt=U(_t.internalFormat,Wt,Ct,_t.colorSpace),xe=ue(b);at&&pe(b)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,xe,Bt,b.width,b.height):pe(b)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,xe,Bt,b.width,b.height):s.renderbufferStorage(s.RENDERBUFFER,Bt,b.width,b.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Pt(N,b){if(b&&b.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(s.FRAMEBUFFER,N),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const pt=a.get(b.depthTexture);pt.__renderTarget=b,(!pt.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),vt(b.depthTexture,0);const Et=pt.__webglTexture,_t=ue(b);if(b.depthTexture.format===Ho)pe(b)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Et,0,_t):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Et,0);else if(b.depthTexture.format===Go)pe(b)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Et,0,_t):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Et,0);else throw new Error("Unknown depthTexture format")}function Nt(N){const b=a.get(N),at=N.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==N.depthTexture){const pt=N.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),pt){const Et=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,pt.removeEventListener("dispose",Et)};pt.addEventListener("dispose",Et),b.__depthDisposeCallback=Et}b.__boundDepthTexture=pt}if(N.depthTexture&&!b.__autoAllocateDepthBuffer){if(at)throw new Error("target.depthTexture not supported in Cube render targets");Pt(b.__webglFramebuffer,N)}else if(at){b.__webglDepthbuffer=[];for(let pt=0;pt<6;pt++)if(i.bindFramebuffer(s.FRAMEBUFFER,b.__webglFramebuffer[pt]),b.__webglDepthbuffer[pt]===void 0)b.__webglDepthbuffer[pt]=s.createRenderbuffer(),mt(b.__webglDepthbuffer[pt],N,!1);else{const Et=N.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,_t=b.__webglDepthbuffer[pt];s.bindRenderbuffer(s.RENDERBUFFER,_t),s.framebufferRenderbuffer(s.FRAMEBUFFER,Et,s.RENDERBUFFER,_t)}}else if(i.bindFramebuffer(s.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=s.createRenderbuffer(),mt(b.__webglDepthbuffer,N,!1);else{const pt=N.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Et=b.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,Et),s.framebufferRenderbuffer(s.FRAMEBUFFER,pt,s.RENDERBUFFER,Et)}i.bindFramebuffer(s.FRAMEBUFFER,null)}function Vt(N,b,at){const pt=a.get(N);b!==void 0&&St(pt.__webglFramebuffer,N,N.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),at!==void 0&&Nt(N)}function oe(N){const b=N.texture,at=a.get(N),pt=a.get(b);N.addEventListener("dispose",z);const Et=N.textures,_t=N.isWebGLCubeRenderTarget===!0,Wt=Et.length>1;if(Wt||(pt.__webglTexture===void 0&&(pt.__webglTexture=s.createTexture()),pt.__version=b.version,f.memory.textures++),_t){at.__webglFramebuffer=[];for(let Ct=0;Ct<6;Ct++)if(b.mipmaps&&b.mipmaps.length>0){at.__webglFramebuffer[Ct]=[];for(let Bt=0;Bt<b.mipmaps.length;Bt++)at.__webglFramebuffer[Ct][Bt]=s.createFramebuffer()}else at.__webglFramebuffer[Ct]=s.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){at.__webglFramebuffer=[];for(let Ct=0;Ct<b.mipmaps.length;Ct++)at.__webglFramebuffer[Ct]=s.createFramebuffer()}else at.__webglFramebuffer=s.createFramebuffer();if(Wt)for(let Ct=0,Bt=Et.length;Ct<Bt;Ct++){const xe=a.get(Et[Ct]);xe.__webglTexture===void 0&&(xe.__webglTexture=s.createTexture(),f.memory.textures++)}if(N.samples>0&&pe(N)===!1){at.__webglMultisampledFramebuffer=s.createFramebuffer(),at.__webglColorRenderbuffer=[],i.bindFramebuffer(s.FRAMEBUFFER,at.__webglMultisampledFramebuffer);for(let Ct=0;Ct<Et.length;Ct++){const Bt=Et[Ct];at.__webglColorRenderbuffer[Ct]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,at.__webglColorRenderbuffer[Ct]);const xe=c.convert(Bt.format,Bt.colorSpace),bt=c.convert(Bt.type),It=U(Bt.internalFormat,xe,bt,Bt.colorSpace,N.isXRRenderTarget===!0),Qt=ue(N);s.renderbufferStorageMultisample(s.RENDERBUFFER,Qt,It,N.width,N.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ct,s.RENDERBUFFER,at.__webglColorRenderbuffer[Ct])}s.bindRenderbuffer(s.RENDERBUFFER,null),N.depthBuffer&&(at.__webglDepthRenderbuffer=s.createRenderbuffer(),mt(at.__webglDepthRenderbuffer,N,!0)),i.bindFramebuffer(s.FRAMEBUFFER,null)}}if(_t){i.bindTexture(s.TEXTURE_CUBE_MAP,pt.__webglTexture),W(s.TEXTURE_CUBE_MAP,b);for(let Ct=0;Ct<6;Ct++)if(b.mipmaps&&b.mipmaps.length>0)for(let Bt=0;Bt<b.mipmaps.length;Bt++)St(at.__webglFramebuffer[Ct][Bt],N,b,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ct,Bt);else St(at.__webglFramebuffer[Ct],N,b,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ct,0);M(b)&&x(s.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Wt){for(let Ct=0,Bt=Et.length;Ct<Bt;Ct++){const xe=Et[Ct],bt=a.get(xe);i.bindTexture(s.TEXTURE_2D,bt.__webglTexture),W(s.TEXTURE_2D,xe),St(at.__webglFramebuffer,N,xe,s.COLOR_ATTACHMENT0+Ct,s.TEXTURE_2D,0),M(xe)&&x(s.TEXTURE_2D)}i.unbindTexture()}else{let Ct=s.TEXTURE_2D;if((N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Ct=N.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Ct,pt.__webglTexture),W(Ct,b),b.mipmaps&&b.mipmaps.length>0)for(let Bt=0;Bt<b.mipmaps.length;Bt++)St(at.__webglFramebuffer[Bt],N,b,s.COLOR_ATTACHMENT0,Ct,Bt);else St(at.__webglFramebuffer,N,b,s.COLOR_ATTACHMENT0,Ct,0);M(b)&&x(Ct),i.unbindTexture()}N.depthBuffer&&Nt(N)}function Le(N){const b=N.textures;for(let at=0,pt=b.length;at<pt;at++){const Et=b[at];if(M(Et)){const _t=P(N),Wt=a.get(Et).__webglTexture;i.bindTexture(_t,Wt),x(_t),i.unbindTexture()}}}const ae=[],I=[];function Xe(N){if(N.samples>0){if(pe(N)===!1){const b=N.textures,at=N.width,pt=N.height;let Et=s.COLOR_BUFFER_BIT;const _t=N.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Wt=a.get(N),Ct=b.length>1;if(Ct)for(let Bt=0;Bt<b.length;Bt++)i.bindFramebuffer(s.FRAMEBUFFER,Wt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Bt,s.RENDERBUFFER,null),i.bindFramebuffer(s.FRAMEBUFFER,Wt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Bt,s.TEXTURE_2D,null,0);i.bindFramebuffer(s.READ_FRAMEBUFFER,Wt.__webglMultisampledFramebuffer),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Wt.__webglFramebuffer);for(let Bt=0;Bt<b.length;Bt++){if(N.resolveDepthBuffer&&(N.depthBuffer&&(Et|=s.DEPTH_BUFFER_BIT),N.stencilBuffer&&N.resolveStencilBuffer&&(Et|=s.STENCIL_BUFFER_BIT)),Ct){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Wt.__webglColorRenderbuffer[Bt]);const xe=a.get(b[Bt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,xe,0)}s.blitFramebuffer(0,0,at,pt,0,0,at,pt,Et,s.NEAREST),p===!0&&(ae.length=0,I.length=0,ae.push(s.COLOR_ATTACHMENT0+Bt),N.depthBuffer&&N.resolveDepthBuffer===!1&&(ae.push(_t),I.push(_t),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,I)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,ae))}if(i.bindFramebuffer(s.READ_FRAMEBUFFER,null),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),Ct)for(let Bt=0;Bt<b.length;Bt++){i.bindFramebuffer(s.FRAMEBUFFER,Wt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Bt,s.RENDERBUFFER,Wt.__webglColorRenderbuffer[Bt]);const xe=a.get(b[Bt]).__webglTexture;i.bindFramebuffer(s.FRAMEBUFFER,Wt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Bt,s.TEXTURE_2D,xe,0)}i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Wt.__webglMultisampledFramebuffer)}else if(N.depthBuffer&&N.resolveDepthBuffer===!1&&p){const b=N.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[b])}}}function ue(N){return Math.min(o.maxSamples,N.samples)}function pe(N){const b=a.get(N);return N.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Yt(N){const b=f.render.frame;g.get(N)!==b&&(g.set(N,b),N.update())}function _e(N,b){const at=N.colorSpace,pt=N.format,Et=N.type;return N.isCompressedTexture===!0||N.isVideoTexture===!0||at!==Rs&&at!==Ga&&(De.getTransfer(at)===Ge?(pt!==Ti||Et!==ca)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",at)),b}function Xt(N){return typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement?(m.width=N.naturalWidth||N.width,m.height=N.naturalHeight||N.height):typeof VideoFrame<"u"&&N instanceof VideoFrame?(m.width=N.displayWidth,m.height=N.displayHeight):(m.width=N.width,m.height=N.height),m}this.allocateTextureUnit=J,this.resetTextureUnits=nt,this.setTexture2D=vt,this.setTexture2DArray=O,this.setTexture3D=$,this.setTextureCube=Q,this.rebindTextures=Vt,this.setupRenderTarget=oe,this.updateRenderTargetMipmap=Le,this.updateMultisampleRenderTarget=Xe,this.setupDepthRenderbuffer=Nt,this.setupFrameBufferTexture=St,this.useMultisampledRTT=pe}function KA(s,t){function i(a,o=Ga){let c;const f=De.getTransfer(o);if(a===ca)return s.UNSIGNED_BYTE;if(a===Bd)return s.UNSIGNED_SHORT_4_4_4_4;if(a===Id)return s.UNSIGNED_SHORT_5_5_5_1;if(a===g0)return s.UNSIGNED_INT_5_9_9_9_REV;if(a===p0)return s.BYTE;if(a===m0)return s.SHORT;if(a===Bo)return s.UNSIGNED_SHORT;if(a===Fd)return s.INT;if(a===br)return s.UNSIGNED_INT;if(a===sa)return s.FLOAT;if(a===Vo)return s.HALF_FLOAT;if(a===v0)return s.ALPHA;if(a===_0)return s.RGB;if(a===Ti)return s.RGBA;if(a===x0)return s.LUMINANCE;if(a===y0)return s.LUMINANCE_ALPHA;if(a===Ho)return s.DEPTH_COMPONENT;if(a===Go)return s.DEPTH_STENCIL;if(a===S0)return s.RED;if(a===Hd)return s.RED_INTEGER;if(a===M0)return s.RG;if(a===Gd)return s.RG_INTEGER;if(a===Vd)return s.RGBA_INTEGER;if(a===Dc||a===Uc||a===Lc||a===Nc)if(f===Ge)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(a===Dc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(a===Uc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(a===Lc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(a===Nc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(a===Dc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===Uc)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===Lc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===Nc)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(a===sd||a===od||a===ld||a===cd)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(a===sd)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(a===od)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(a===ld)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(a===cd)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(a===ud||a===fd||a===hd)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(a===ud||a===fd)return f===Ge?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(a===hd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(a===dd||a===pd||a===md||a===gd||a===vd||a===_d||a===xd||a===yd||a===Sd||a===Md||a===Ed||a===Td||a===bd||a===Ad)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(a===dd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(a===pd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(a===md)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(a===gd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(a===vd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(a===_d)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(a===xd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(a===yd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(a===Sd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(a===Md)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(a===Ed)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(a===Td)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(a===bd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(a===Ad)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(a===Oc||a===Rd||a===Cd)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(a===Oc)return f===Ge?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(a===Rd)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(a===Cd)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(a===E0||a===wd||a===Dd||a===Ud)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(a===Oc)return c.COMPRESSED_RED_RGTC1_EXT;if(a===wd)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(a===Dd)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(a===Ud)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return a===Io?s.UNSIGNED_INT_24_8:s[a]!==void 0?s[a]:null}return{convert:i}}const QA=`
void main() {
