...
#define LOW_PRECISION`),t}function g1(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===a0?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===AS?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===sa&&(t="SHADOWMAP_TYPE_VSM"),t}function _1(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Rs:case Cs:t="ENVMAP_TYPE_CUBE";break;case Gc:t="ENVMAP_TYPE_CUBE_UV";break}return t}function v1(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Cs:t="ENVMAP_MODE_REFRACTION";break}return t}function y1(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case r0:t="ENVMAP_BLENDING_MULTIPLY";break;case WS:t="ENVMAP_BLENDING_MIX";break;case qS:t="ENVMAP_BLENDING_ADD";break}return t}function x1(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,a=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:a,maxMip:i}}function S1(s,t,i,a){const l=s.getContext(),c=i.defines;let f=i.vertexShader,h=i.fragmentShader;const p=g1(i),m=_1(i),g=v1(i),_=y1(i),v=x1(i),S=l1(i),E=c1(c),T=l.createProgram();let M,y,P=i.glslVersion?"#version "+i.glslVersion+`
