...
`].filter(Do).join(`
`)),h=md(h),h=mv(h,i),h=gv(h,i),d=md(d),d=mv(d,i),d=gv(d,i),h=_v(h),d=_v(d),i.isRawShaderMaterial!==!0&&(B=`#version 300 es
...
`)+`
`+x);const D=B+M+h,C=B+x+d,H=hv(l,l.VERTEX_SHADER,D),P=hv(l,l.FRAGMENT_SHADER,C);l.attachShader(R,H),l.attachShader(R,P),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function N(G){if(o.debug.checkShaderErrors){const it=l.getProgramInfoLog(R).trim(),tt=l.getShaderInfoLog(H).trim(),lt=l.getShaderInfoLog(P).trim();let gt=!0,z=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if(gt=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,R,H,P);else{const J=pv(l,H,"vertex"),K=pv(l,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
