 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var P_;function _S(){if(P_)return re;P_=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.for("react.activity"),v=Symbol.iterator;function S(O){return O===null||typeof O!="object"?null:(O=v&&O[v]||O["@@iterator"],typeof O=="function"?O:null)}var E={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,M={};function y(O,J,ht){this.props=O,this.context=J,this.refs=M,this.updater=ht||E}y.prototype.isReactComponent={},y.prototype.setState=function(O,J){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,J,"setState")},y.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function P(){}P.prototype=y.prototype;function L(O,J,ht){this.props=O,this.context=J,this.refs=M,this.updater=ht||E}var w=L.prototype=new P;w.constructor=L,T(w,y.prototype),w.isPureReactComponent=!0;var X=Array.isArray;function F(){}var z={H:null,A:null,T:null,S:null},W=Object.prototype.hasOwnProperty;function D(O,J,ht){var q=ht.ref;return{$$typeof:s,type:O,key:J,ref:q!==void 0?q:null,props:ht}}function R(O,J){return D(O.type,J,O.props)}function G(O){return typeof O=="object"&&O!==null&&O.$$typeof===s}function nt(O){var J={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(ht){return J[ht]})}var $=/\/+/g;function lt(O,J){return typeof O=="object"&&O!==null&&O.key!=null?nt(""+O.key):J.toString(36)}function gt(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(F,F):(O.status="pending",O.then(function(J){O.status==="pending"&&(O.status="fulfilled",O.value=J)},function(J){O.status==="pending"&&(O.status="rejected",O.reason=J)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function U(O,J,ht,q,ct){var St=typeof O;(St==="undefined"||St==="boolean")&&(O=null);var Mt=!1;if(O===null)Mt=!0;else switch(St){case"bigint":case"string":case"number":Mt=!0;break;case"object":switch(O.$$typeof){case s:case t:Mt=!0;break;case g:return Mt=O._init,U(Mt(O._payload),J,ht,q,ct)}}if(Mt)return ct=ct(O),Mt=q===""?"."+lt(O,0):q,X(ct)?(ht="",Mt!=null&&(ht=Mt.replace($,"$&/")+"/"),U(ct,J,ht,"",function(qt){return qt})):ct!=null&&(G(ct)&&(ct=R(ct,ht+(ct.key==null||O&&O.key===ct.key?"":(""+ct.key).replace($,"$&/")+"/")+Mt)),J.push(ct)),1;Mt=0;var Pt=q===""?".":q+":";if(X(O))for(var Ht=0;Ht<O.length;Ht++)q=O[Ht],St=Pt+lt(q,Ht),Mt+=U(q,J,ht,St,ct);else if(Ht=S(O),typeof Ht=="function")for(O=Ht.call(O),Ht=0;!(q=O.next()).done;)q=q.value,St=Pt+lt(q,Ht++),Mt+=U(q,J,ht,St,ct);else if(St==="object"){if(typeof O.then=="function")return U(gt(O),J,ht,q,ct);throw J=String(O),Error("Objects are not valid as a React child (found: "+(J==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":J)+"). If you meant to render a collection of children, use an array instead.")}return Mt}function V(O,J,ht){if(O==null)return O;var q=[],ct=0;return U(O,q,"","",function(St){return J.call(ht,St,ct++)}),q}function I(O){if(O._status===-1){var J=O._result;J=J(),J.then(function(ht){(O._status===0||O._status===-1)&&(O._status=1,O._result=ht)},function(ht){(O._status===0||O._status===-1)&&(O._status=2,O._result=ht)}),O._status===-1&&(O._status=0,O._result=J)}if(O._status===1)return O._result.default;throw O._result}var ft=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var J=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(J))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)},xt={map:V,forEach:function(O,J,ht){V(O,function(){J.apply(this,arguments)},ht)},count:function(O){var J=0;return V(O,function(){J++}),J},toArray:function(O){return V(O,function(J){return J})||[]},only:function(O){if(!G(O))throw Error("React.Children.only expected to receive a single React element child.");return O}};return re.Activity=_,re.Children=xt,re.Component=y,re.Fragment=i,re.Profiler=l,re.PureComponent=L,re.StrictMode=a,re.Suspense=p,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,re.__COMPILER_RUNTIME={__proto__:null,c:function(O){return z.H.useMemoCache(O)}},re.cache=function(O){return function(){return O.apply(null,arguments)}},re.cacheSignal=function(){return null},re.cloneElement=function(O,J,ht){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var q=T({},O.props),ct=O.key;if(J!=null)for(St in J.key!==void 0&&(ct=""+J.key),J)!W.call(J,St)||St==="key"||St==="__self"||St==="__source"||St==="ref"&&J.ref===void 0||(q[St]=J[St]);var St=arguments.length-2;if(St===1)q.children=ht;else if(1<St){for(var Mt=Array(St),Pt=0;Pt<St;Pt++)Mt[Pt]=arguments[Pt+2];q.children=Mt}return D(O.type,ct,q)},re.createContext=function(O){return O={$$typeof:f,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:c,_context:O},O},re.createElement=function(O,J,ht){var q,ct={},St=null;if(J!=null)for(q in J.key!==void 0&&(St=""+J.key),J)W.call(J,q)&&q!=="key"&&q!=="__self"&&q!=="__source"&&(ct[q]=J[q]);var Mt=arguments.length-2;if(Mt===1)ct.children=ht;else if(1<Mt){for(var Pt=Array(Mt),Ht=0;Ht<Mt;Ht++)Pt[Ht]=arguments[Ht+2];ct.children=Pt}if(O&&O.defaultProps)for(q in Mt=O.defaultProps,Mt)ct[q]===void 0&&(ct[q]=Mt[q]);return D(O,St,ct)},re.createRef=function(){return{current:null}},re.forwardRef=function(O){return{$$typeof:h,render:O}},re.isValidElement=G,re.lazy=function(O){return{$$typeof:g,_payload:{_status:-1,_result:O},_init:I}},re.memo=function(O,J){return{$$typeof:m,type:O,compare:J===void 0?null:J}},re.startTransition=function(O){var J=z.T,ht={};z.T=ht;try{var q=O(),ct=z.S;ct!==null&&ct(ht,q),typeof q=="object"&&q!==null&&typeof q.then=="function"&&q.then(F,ft)}catch(St){ft(St)}finally{J!==null&&ht.types!==null&&(J.types=ht.types),z.T=J}},re.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},re.use=function(O){return z.H.use(O)},re.useActionState=function(O,J,ht){return z.H.useActionState(O,J,ht)},re.useCallback=function(O,J){return z.H.useCallback(O,J)},re.useContext=function(O){return z.H.useContext(O)},re.useDebugValue=function(){},re.useDeferredValue=function(O,J){return z.H.useDeferredValue(O,J)},re.useEffect=function(O,J){return z.H.useEffect(O,J)},re.useEffectEvent=function(O){return z.H.useEffectEvent(O)},re.useId=function(){return z.H.useId()},re.useImperativeHandle=function(O,J,ht){return z.H.useImperativeHandle(O,J,ht)},re.useInsertionEffect=function(O,J){return z.H.useInsertionEffect(O,J)},re.useLayoutEffect=function(O,J){return z.H.useLayoutEffect(O,J)},re.useMemo=function(O,J){return z.H.useMemo(O,J)},re.useOptimistic=function(O,J){return z.H.useOptimistic(O,J)},re.useReducer=function(O,J,ht){return z.H.useReducer(O,J,ht)},re.useRef=function(O){return z.H.useRef(O)},re.useState=function(O){return z.H.useState(O)},re.useSyncExternalStore=function(O,J,ht){return z.H.useSyncExternalStore(O,J,ht)},re.useTransition=function(){return z.H.useTransition()},re.version="19.2.7",re}var F_;function Nd(){return F_||(F_=1,$f.exports=_S()),$f.exports}var Vt=Nd(),th={exports:{}},Ro={},eh={exports:{}},nh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var B_;function vS(){return B_||(B_=1,(function(s){function t(U,V){var I=U.length;U.push(V);t:for(;0<I;){var ft=I-1>>>1,xt=U[ft];if(0<l(xt,V))U[ft]=V,U[I]=xt,I=ft;else break t}}function i(U){return U.length===0?null:U[0]}function a(U){if(U.length===0)return null;var V=U[0],I=U.pop();if(I!==V){U[0]=I;t:for(var ft=0,xt=U.length,O=xt>>>1;ft<O;){var J=2*(ft+1)-1,ht=U[J],q=J+1,ct=U[q];if(0>l(ht,I))q<xt&&0>l(ct,ht)?(U[ft]=ct,U[q]=I,ft=q):(U[ft]=ht,U[J]=I,ft=J);else if(q<xt&&0>l(ct,I))U[ft]=ct,U[q]=I,ft=q;else break t}}return V}function l(U,V){var I=U.sortIndex-V.sortIndex;return I!==0?I:U.id-V.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;s.unstable_now=function(){return c.now()}}else{var f=Date,h=f.now();s.unstable_now=function(){return f.now()-h}}var p=[],m=[],g=1,_=null,v=3,S=!1,E=!1,T=!1,M=!1,y=typeof setTimeout=="function"?setTimeout:null,P=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;function w(U){for(var V=i(m);V!==null;){if(V.callback===null)a(m);else if(V.startTime<=U)a(m),V.sortIndex=V.expirationTime,t(p,V);else break;V=i(m)}}function X(U){if(T=!1,w(U),!E)if(i(p)!==null)E=!0,F||(F=!0,nt());else{var V=i(m);V!==null&&gt(X,V.startTime-U)}}var F=!1,z=-1,W=5,D=-1;function R(){return M?!0:!(s.unstable_now()-D<W)}function G(){if(M=!1,F){var U=s.unstable_now();D=U;var V=!0;try{t:{E=!1,T&&(T=!1,P(z),z=-1),S=!0;var I=v;try{e:{for(w(U),_=i(p);_!==null&&!(_.expirationTime>U&&R());){var ft=_.callback;if(typeof ft=="function"){_.callback=null,v=_.priorityLevel;var xt=ft(_.expirationTime<=U);if(U=s.unstable_now(),typeof xt=="function"){_.callback=xt,w(U),V=!0;break e}_===i(p)&&a(p),w(U)}else a(p);_=i(p)}if(_!==null)V=!0;else{var O=i(m);O!==null&&gt(X,O.startTime-U),V=!1}}break t}finally{_=null,v=I,S=!1}V=void 0}}finally{V?nt():F=!1}}}var nt;if(typeof L=="function")nt=function(){L(G)};else if(typeof MessageChannel<"u"){var $=new MessageChannel,lt=$.port2;$.port1.onmessage=G,nt=function(){lt.postMessage(null)}}else nt=function(){y(G,0)};function gt(U,V){z=y(function(){U(s.unstable_now())},V)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(U){U.callback=null},s.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<U?Math.floor(1e3/U):5},s.unstable_getCurrentPriorityLevel=function(){return v},s.unstable_next=function(U){switch(v){case 1:case 2:case 3:var V=3;break;default:V=v}var I=v;v=V;try{return U()}finally{v=I}},s.unstable_requestPaint=function(){M=!0},s.unstable_runWithPriority=function(U,V){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var I=v;v=U;try{return V()}finally{v=I}},s.unstable_scheduleCallback=function(U,V,I){var ft=s.unstable_now();switch(typeof I=="object"&&I!==null?(I=I.delay,I=typeof I=="number"&&0<I?ft+I:ft):I=ft,U){case 1:var xt=-1;break;case 2:xt=250;break;case 5:xt=1073741823;break;case 4:xt=1e4;break;default:xt=5e3}return xt=I+xt,U={id:g++,callback:V,priorityLevel:U,startTime:I,expirationTime:xt,sortIndex:-1},I>ft?(U.sortIndex=I,t(m,U),i(p)===null&&U===i(m)&&(T?(P(z),z=-1):T=!0,gt(X,I-ft))):(U.sortIndex=xt,t(p,U),E||S||(E=!0,F||(F=!0,nt()))),U},s.unstable_shouldYield=R,s.unstable_wrapCallback=function(U){var V=v;return function(){var I=v;v=V;try{return U.apply(this,arguments)}finally{v=I}}}})(nh)),nh}var I_;function yS(){return I_||(I_=1,eh.exports=vS()),eh.exports}var ih={exports:{}},An={};/**
 * @license React
...
void main() {
	...
	`}function cA(s){let t=new WeakMap,i=null;function a(h){if(h&&h.isTexture){const p=h.mapping,m=p===td||p===ed,g=p===bs||p===As;if(m||g){let _=t.get(h);const v=_!==void 0?_.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==v)return i===null&&(i=new Mv(s)),_=m?i.fromEquirectangular(h,_):i.fromCubemap(h,_),_.texture.pmremVersion=h.pmremVersion,t.set(h,_),_.texture;if(_!==void 0)return _.texture;{const S=h.image;return m&&S&&S.height>0||g&&S&&l(S)?(i===null&&(i=new Mv(s)),_=m?i.fromEquirectangular(h):i.fromCubemap(h),_.texture.pmremVersion=h.pmremVersion,t.set(h,_),h.addEventListener("dispose",c),_.texture):null}}}return h}function l(h){let p=0;const m=6;for(let g=0;g<m;g++)h[g]!==void 0&&p++;return p===m}function c(h){const p=h.target;p.removeEventListener("dispose",c);const m=t.get(p);m!==void 0&&(t.delete(p),m.dispose())}function f(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:a,dispose:f}}function uA(s){const t={};function i(a){if(t[a]!==void 0)return t[a];let l;switch(a){case"WEBGL_depth_texture":l=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":l=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":l=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":l=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:l=s.getExtension(a)}return t[a]=l,l}return{has:function(a){return i(a)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(a){const l=i(a);return l===null&&Oc("THREE.WebGLRenderer: "+a+" extension not supported."),l}}}function fA(s,t,i,a){const l={},c=new WeakMap;function f(_){const v=_.target;v.index!==null&&t.remove(v.index);for(const E in v.attributes)t.remove(v.attributes[E]);v.removeEventListener("dispose",f),delete l[v.id];const S=c.get(v);S&&(t.remove(S),c.delete(v)),a.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,i.memory.geometries--}function h(_,v){return l[v.id]===!0||(v.addEventListener("dispose",f),l[v.id]=!0,i.memory.geometries++),v}function p(_){const v=_.attributes;for(const S in v)t.update(v[S],s.ARRAY_BUFFER)}function m(_){const v=[],S=_.index,E=_.attributes.position;let T=0;if(S!==null){const P=S.array;T=S.version;for(let L=0,w=P.length;L<w;L+=3){const X=P[L+0],F=P[L+1],z=P[L+2];v.push(X,F,F,z,z,X)}}else if(E!==void 0){const P=E.array;T=E.version;for(let L=0,w=P.length/3-1;L<w;L+=3){const X=L+0,F=L+1,z=L+2;v.push(X,F,F,z,z,X)}}else return;const M=new(v0(v)?E0:M0)(v,1);M.version=T;const y=c.get(_);y&&t.remove(y),c.set(_,M)}function g(_){const v=c.get(_);if(v){const S=_.index;S!==null&&v.version<S.version&&m(_)}else m(_);return c.get(_)}return{get:h,update:p,getWireframeAttribute:g}}function hA(s,t,i){let a;function l(v){a=v}let c,f;function h(v){c=v.type,f=v.bytesPerElement}function p(v,S){s.drawElements(a,S,c,v*f),i.update(S,a,1)}function m(v,S,E){E!==0&&(s.drawElementsInstanced(a,S,c,v*f,E),i.update(S,a,E))}function g(v,S,E){if(E===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(a,S,0,c,v,0,E);let M=0;for(let y=0;y<E;y++)M+=S[y];i.update(M,a,1)}function _(v,S,E,T){if(E===0)return;const M=t.get("WEBGL_multi_draw");if(M===null)for(let y=0;y<v.length;y++)m(v[y]/f,S[y],T[y]);else{M.multiDrawElementsInstancedWEBGL(a,S,0,c,v,0,T,0,E);let y=0;for(let P=0;P<E;P++)y+=S[P]*T[P];i.update(y,a,1)}}this.setMode=l,this.setIndex=h,this.render=p,this.renderInstances=m,this.renderMultiDraw=g,this.renderMultiDrawInstances=_}function dA(s){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function a(c,f,h){switch(i.calls++,f){case s.TRIANGLES:i.triangles+=h*(c/3);break;case s.LINES:i.lines+=h*(c/2);break;case s.LINE_STRIP:i.lines+=h*(c-1);break;case s.LINE_LOOP:i.lines+=h*c;break;case s.POINTS:i.points+=h*c;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:a}}function pA(s,t,i){const a=new WeakMap,l=new tn;function c(f,h,p){const m=f.morphTargetInfluences,g=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,_=g!==void 0?g.length:0;let v=a.get(h);if(v===void 0||v.count!==_){let D=function(){z.dispose(),a.delete(h),h.removeEventListener("dispose",D)};v!==void 0&&v.texture.dispose();const S=h.morphAttributes.position!==void 0,E=h.morphAttributes.normal!==void 0,T=h.morphAttributes.color!==void 0,M=h.morphAttributes.position||[],y=h.morphAttributes.normal||[],P=h.morphAttributes.color||[];let L=0;S===!0&&(L=1),E===!0&&(L=2),T===!0&&(L=3);let w=h.attributes.position.count*L,X=1;w>t.maxTextureSize&&(X=Math.ceil(w/t.maxTextureSize),w=t.maxTextureSize);const F=new Float32Array(w*X*4*_),z=new y0(F,w,X,_);z.type=sa,z.needsUpdate=!0;const W=L*4;for(let R=0;R<_;R++){const G=M[R],nt=y[R],$=P[R],lt=w*X*4*R;for(let gt=0;gt<G.count;gt++){const U=gt*W;S===!0&&(l.fromBufferAttribute(G,gt),F[lt+U+0]=l.x,F[lt+U+1]=l.y,F[lt+U+2]=l.z,F[lt+U+3]=0),E===!0&&(l.fromBufferAttribute(nt,gt),F[lt+U+4]=l.x,F[lt+U+5]=l.y,F[lt+U+6]=l.z,F[lt+U+7]=0),T===!0&&(l.fromBufferAttribute($,gt),F[lt+U+8]=l.x,F[lt+U+9]=l.y,F[lt+U+10]=l.z,F[lt+U+11]=$.itemSize===4?l.w:1)}}v={count:_,texture:z,size:new te(w,X)},a.set(h,v),h.addEventListener("dispose",D)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)p.getUniforms().setValue(s,"morphTexture",f.morphTexture,i);else{let S=0;for(let T=0;T<m.length;T++)S+=m[T];const E=h.morphTargetsRelative?1:1-S;p.getUniforms().setValue(s,"morphTargetBaseInfluence",E),p.getUniforms().setValue(s,"morphTargetInfluences",m)}p.getUniforms().setValue(s,"morphTargetsTexture",v.texture,i),p.getUniforms().setValue(s,"morphTargetsTextureSize",v.size)}return{update:c}}function mA(s,t,i,a){let l=new WeakMap;function c(p){const m=a.render.frame,g=p.geometry,_=t.get(p,g);if(l.get(_)!==m&&(t.update(_),l.set(_,m)),p.isInstancedMesh&&(p.hasEventListener("dispose",h)===!1&&p.addEventListener("dispose",h),l.get(p)!==m&&(i.update(p.instanceMatrix,s.ARRAY_BUFFER),p.instanceColor!==null&&i.update(p.instanceColor,s.ARRAY_BUFFER),l.set(p,m))),p.isSkinnedMesh){const v=p.skeleton;l.get(v)!==m&&(v.update(),l.set(v,m))}return _}function f(){l=new WeakMap}function h(p){const m=p.target;m.removeEventListener("dispose",h),i.remove(m.instanceMatrix),m.instanceColor!==null&&i.remove(m.instanceColor)}return{update:c,dispose:f}}const O0=new Wn,Av=new R0(1,1),z0=new y0,P0=new RM,F0=new A0,Rv=[],Cv=[],wv=new Float32Array(16),Dv=new Float32Array(9),Uv=new Float32Array(4);function Us(s,t,i){const a=s[0];if(a<=0||a>0)return s;const l=t*i;let c=Rv[l];if(c===void 0&&(c=new Float32Array(l),Rv[l]=c),t!==0){a.toArray(c,0);for(let f=1,h=0;f!==t;++f)h+=i,s[f].toArray(c,h)}return c}function hn(s,t){if(s.length!==t.length)return!1;for(let i=0,a=s.length;i<a;i++)if(s[i]!==t[i])return!1;return!0}function dn(s,t){for(let i=0,a=t.length;i<a;i++)s[i]=t[i]}function kc(s,t){let i=Cv[t];i===void 0&&(i=new Int32Array(t),Cv[t]=i);for(let a=0;a!==t;++a)i[a]=s.allocateTextureUnit();return i}function gA(s,t){const i=this.cache;i[0]!==t&&(s.uniform1f(this.addr,t),i[0]=t)}function _A(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2f(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(hn(i,t))return;s.uniform2fv(this.addr,t),dn(i,t)}}function vA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3f(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else if(t.r!==void 0)(i[0]!==t.r||i[1]!==t.g||i[2]!==t.b)&&(s.uniform3f(this.addr,t.r,t.g,t.b),i[0]=t.r,i[1]=t.g,i[2]=t.b);else{if(hn(i,t))return;s.uniform3fv(this.addr,t),dn(i,t)}}function yA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4f(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(hn(i,t))return;s.uniform4fv(this.addr,t),dn(i,t)}}function xA(s,t){const i=this.cache,a=t.elements;if(a===void 0){if(hn(i,t))return;s.uniformMatrix2fv(this.addr,!1,t),dn(i,t)}else{if(hn(i,a))return;Uv.set(a),s.uniformMatrix2fv(this.addr,!1,Uv),dn(i,a)}}function SA(s,t){const i=this.cache,a=t.elements;if(a===void 0){if(hn(i,t))return;s.uniformMatrix3fv(this.addr,!1,t),dn(i,t)}else{if(hn(i,a))return;Dv.set(a),s.uniformMatrix3fv(this.addr,!1,Dv),dn(i,a)}}function MA(s,t){const i=this.cache,a=t.elements;if(a===void 0){if(hn(i,t))return;s.uniformMatrix4fv(this.addr,!1,t),dn(i,t)}else{if(hn(i,a))return;wv.set(a),s.uniformMatrix4fv(this.addr,!1,wv),dn(i,a)}}function EA(s,t){const i=this.cache;i[0]!==t&&(s.uniform1i(this.addr,t),i[0]=t)}function TA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2i(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(hn(i,t))return;s.uniform2iv(this.addr,t),dn(i,t)}}function bA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3i(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(hn(i,t))return;s.uniform3iv(this.addr,t),dn(i,t)}}function AA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4i(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(hn(i,t))return;s.uniform4iv(this.addr,t),dn(i,t)}}function RA(s,t){const i=this.cache;i[0]!==t&&(s.uniform1ui(this.addr,t),i[0]=t)}function CA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2ui(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(hn(i,t))return;s.uniform2uiv(this.addr,t),dn(i,t)}}function wA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3ui(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(hn(i,t))return;s.uniform3uiv(this.addr,t),dn(i,t)}}function DA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4ui(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(hn(i,t))return;s.uniform4uiv(this.addr,t),dn(i,t)}}function UA(s,t,i){const a=this.cache,l=i.allocateTextureUnit();a[0]!==l&&(s.uniform1i(this.addr,l),a[0]=l);let c;this.type===s.SAMPLER_2D_SHADOW?(Av.compareFunction=_0,c=Av):c=O0,i.setTexture2D(t||c,l)}function LA(s,t,i){const a=this.cache,l=i.allocateTextureUnit();a[0]!==l&&(s.uniform1i(this.addr,l),a[0]=l),i.setTexture3D(t||P0,l)}function NA(s,t,i){const a=this.cache,l=i.allocateTextureUnit();a[0]!==l&&(s.uniform1i(this.addr,l),a[0]=l),i.setTextureCube(t||F0,l)}function OA(s,t,i){const a=this.cache,l=i.allocateTextureUnit();a[0]!==l&&(s.uniform1i(this.addr,l),a[0]=l),i.setTexture2DArray(t||z0,l)}function zA(s){switch(s){case 5126:return gA;case 35664:return _A;case 35665:return vA;case 35666:return yA;case 35674:return xA;case 35675:return SA;case 35676:return MA;case 5124:case 35670:return EA;case 35667:case 35671:return TA;case 35668:case 35672:return bA;case 35669:case 35673:return AA;case 5125:return RA;case 36294:return CA;case 36295:return wA;case 36296:return DA;case 35678:case 36198:case 36298:case 36306:case 35682:return UA;case 35679:case 36299:case 36307:return LA;case 35680:case 36300:case 36308:case 36293:return NA;case 36289:case 36303:case 36311:case 36292:return OA}}function PA(s,t){s.uniform1fv(this.addr,t)}function FA(s,t){const i=Us(t,this.size,2);s.uniform2fv(this.addr,i)}function BA(s,t){const i=Us(t,this.size,3);s.uniform3fv(this.addr,i)}function IA(s,t){const i=Us(t,this.size,4);s.uniform4fv(this.addr,i)}function HA(s,t){const i=Us(t,this.size,4);s.uniformMatrix2fv(this.addr,!1,i)}function GA(s,t){const i=Us(t,this.size,9);s.uniformMatrix3fv(this.addr,!1,i)}function VA(s,t){const i=Us(t,this.size,16);s.uniformMatrix4fv(this.addr,!1,i)}function kA(s,t){s.uniform1iv(this.addr,t)}function XA(s,t){s.uniform2iv(this.addr,t)}function WA(s,t){s.uniform3iv(this.addr,t)}function qA(s,t){s.uniform4iv(this.addr,t)}function YA(s,t){s.uniform1uiv(this.addr,t)}function jA(s,t){s.uniform2uiv(this.addr,t)}function ZA(s,t){s.uniform3uiv(this.addr,t)}function KA(s,t){s.uniform4uiv(this.addr,t)}function QA(s,t,i){const a=this.cache,l=t.length,c=kc(i,l);hn(a,c)||(s.uniform1iv(this.addr,c),dn(a,c));for(let f=0;f!==l;++f)i.setTexture2D(t[f]||O0,c[f])}function JA(s,t,i){const a=this.cache,l=t.length,c=kc(i,l);hn(a,c)||(s.uniform1iv(this.addr,c),dn(a,c));for(let f=0;f!==l;++f)i.setTexture3D(t[f]||P0,c[f])}function $A(s,t,i){const a=this.cache,l=t.length,c=kc(i,l);hn(a,c)||(s.uniform1iv(this.addr,c),dn(a,c));for(let f=0;f!==l;++f)i.setTextureCube(t[f]||F0,c[f])}function t1(s,t,i){const a=this.cache,l=t.length,c=kc(i,l);hn(a,c)||(s.uniform1iv(this.addr,c),dn(a,c));for(let f=0;f!==l;++f)i.setTexture2DArray(t[f]||z0,c[f])}function e1(s){switch(s){case 5126:return PA;case 35664:return FA;case 35665:return BA;case 35666:return IA;case 35674:return HA;case 35675:return GA;case 35676:return VA;case 5124:case 35670:return kA;case 35667:case 35671:return XA;case 35668:case 35672:return WA;case 35669:case 35673:return qA;case 5125:return YA;case 36294:return jA;case 36295:return ZA;case 36296:return KA;case 35678:case 36198:case 36298:case 36306:case 35682:return QA;case 35679:case 36299:case 36307:return JA;case 35680:case 36300:case 36308:case 36293:return $A;case 36289:case 36303:case 36311:case 36292:return t1}}class n1{constructor(t,i,a){this.id=t,this.addr=a,this.cache=[],this.type=i.type,this.setValue=zA(i.type)}}class i1{constructor(t,i,a){this.id=t,this.addr=a,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=e1(i.type)}}class a1{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,i,a){const l=this.seq;for(let c=0,f=l.length;c!==f;++c){const h=l[c];h.setValue(t,i[h.id],a)}}}const Fh=/(\w+)(\])?(\[|\.)?/g;function Lv(s,t){s.seq.push(t),s.map[t.id]=t}function r1(s,t,i){const a=s.name,l=a.length;for(Fh.lastIndex=0;;){const c=Fh.exec(a),f=Fh.lastIndex;let h=c[1];const p=c[2]==="]",m=c[3];if(p&&(h=h|0),m===void 0||m==="["&&f+2===l){Lv(i,m===void 0?new n1(h,s,t):new i1(h,s,t));break}else{let _=i.map[h];_===void 0&&(_=new a1(h),Lv(i,_)),i=_}}}class zc{constructor(t,i){this.seq=[],this.map={};const a=t.getProgramParameter(i,t.ACTIVE_UNIFORMS);for(let l=0;l<a;++l){const c=t.getActiveUniform(i,l),f=t.getUniformLocation(i,c.name);r1(c,f,this)}}setValue(t,i,a,l){const c=this.map[i];c!==void 0&&c.setValue(t,a,l)}setOptional(t,i,a){const l=i[a];l!==void 0&&this.setValue(t,a,l)}static upload(t,i,a,l){for(let c=0,f=i.length;c!==f;++c){const h=i[c],p=a[h.id];p.needsUpdate!==!1&&h.setValue(t,p.value,l)}}static seqWithValue(t,i){const a=[];for(let l=0,c=t.length;l!==c;++l){const f=t[l];f.id in i&&a.push(f)}return a}}function Nv(s,t,i){const a=s.createShader(t);return s.shaderSource(a,i),s.compileShader(a),a}const s1=37297;let o1=0;function l1(s,t){const i=s.split(`
`),a=[],l=Math.max(t-6,0),c=Math.min(t+6,i.length);for(let f=l;f<c;f++){const h=f+1;a.push(`${h===t?">":" "} ${h}: ${i[f]}`)}return a.join(`
`)}const Ov=new ce;function c1(s){we._getMatrix(Ov,we.workingColorSpace,s);const t=`mat3( ${Ov.elements.map(i=>i.toFixed(4))} )`;switch(we.getTransfer(s)){case Pc:return[t,"LinearTransferOETF"];case Ge:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[t,"LinearTransferOETF"]}}function zv(s,t,i){const a=s.getShaderParameter(t,s.COMPILE_STATUS),l=s.getShaderInfoLog(t).trim();if(a&&l==="")return"";const c=/ERROR: 0:(\d+)/.exec(l);if(c){const f=parseInt(c[1]);return i.toUpperCase()+`

`+l+`

`+l1(s.getShaderSource(t),f)}else return l}function u1(s,t){const i=c1(t);return[`vec4 ${s}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}function f1(s,t){let i;switch(t){case JS:i="Linear";break;case $S:i="Reinhard";break;case tM:i="Cineon";break;case eM:i="ACESFilmic";break;case iM:i="AgX";break;case aM:i="Neutral";break;case nM:i="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),i="Linear"}return"vec3 "+s+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Ac=new Q;function h1(){we.getLuminanceCoefficients(Ac);const s=Ac.x.toFixed(4),t=Ac.y.toFixed(4),i=Ac.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${t}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function p1(s){const t=[];for(const i in s){const a=s[i];a!==!1&&t.push("#define "+i+" "+a)}return t.join(`
`)}function m1(s,t){const i={},a=s.getProgramParameter(t,s.ACTIVE_ATTRIBUTES);for(let l=0;l<a;l++){const c=s.getActiveAttrib(t,l),f=c.name;let h=1;c.type===s.FLOAT_MAT2&&(h=2),c.type===s.FLOAT_MAT3&&(h=3),c.type===s.FLOAT_MAT4&&(h=4),i[f]={type:c.type,location:s.getAttribLocation(t,f),locationSize:h}}return i}function No(s){return s!==""}function Pv(s,t){const i=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Fv(s,t){return s.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const g1=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ud(s){return s.replace(g1,v1)}const _1=new Map;function v1(s,t){let i=ue[t];if(i===void 0){const a=_1.get(t);if(a!==void 0)i=ue[a],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,a);else throw new Error("Can not resolve #include <"+t+">")}return Ud(i)}const y1=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Bv(s){return s.replace(y1,x1)}function x1(s,t,i,a){let l="";for(let c=parseInt(t);c<parseInt(i);c++)l+=a.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function Iv(s){let t=`precision ${s.precision} float;
...
#define LOW_PRECISION`),t}function S1(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===a0?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===US?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ra&&(t="SHADOWMAP_TYPE_VSM"),t}function M1(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case bs:case As:t="ENVMAP_TYPE_CUBE";break;case Hc:t="ENVMAP_TYPE_CUBE_UV";break}return t}function E1(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case As:t="ENVMAP_MODE_REFRACTION";break}return t}function T1(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case r0:t="ENVMAP_BLENDING_MULTIPLY";break;case KS:t="ENVMAP_BLENDING_MIX";break;case QS:t="ENVMAP_BLENDING_ADD";break}return t}function b1(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,a=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:a,maxMip:i}}function A1(s,t,i,a){const l=s.getContext(),c=i.defines;let f=i.vertexShader,h=i.fragmentShader;const p=S1(i),m=M1(i),g=E1(i),_=T1(i),v=b1(i),S=d1(i),E=p1(c),T=l.createProgram();let M,y,P=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+y);const L=P+M+f,w=P+y+h,X=Nv(l,l.VERTEX_SHADER,L),F=Nv(l,l.FRAGMENT_SHADER,w);l.attachShader(T,X),l.attachShader(T,F),i.index0AttributeName!==void 0?l.bindAttribLocation(T,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(T,0,"position"),l.linkProgram(T);function z(G){if(s.debug.checkShaderErrors){const nt=l.getProgramInfoLog(T).trim(),$=l.getShaderInfoLog(X).trim(),lt=l.getShaderInfoLog(F).trim();let gt=!0,U=!0;if(l.getProgramParameter(T,l.LINK_STATUS)===!1)if(gt=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,T,X,F);else{const V=zv(l,X,"vertex"),I=zv(l,F,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(T,l.VALIDATE_STATUS)+`
...
}`;function V1(s,t,i){let a=new kd;const l=new te,c=new te,f=new tn,h=new fE({depthPacking:oM}),p=new hE,m={},g=i.maxTextureSize,_={[Wa]:Xn,[Xn]:Wa,[Li]:Li},v=new qa({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new te},radius:{value:4}},vertexShader:H1,fragmentShader:G1}),S=v.clone();S.defines.HORIZONTAL_PASS=1;const E=new zi;E.setAttribute("position",new Oi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const T=new ei(E,v),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=a0;let y=this.type;this.render=function(F,z,W){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||F.length===0)return;const D=s.getRenderTarget(),R=s.getActiveCubeFace(),G=s.getActiveMipmapLevel(),nt=s.state;nt.setBlending(Va),nt.buffers.color.setClear(1,1,1,1),nt.buffers.depth.setTest(!0),nt.setScissorTest(!1);const $=y!==ra&&this.type===ra,lt=y===ra&&this.type!==ra;for(let gt=0,U=F.length;gt<U;gt++){const V=F[gt],I=V.shadow;if(I===void 0){console.warn("THREE.WebGLShadowMap:",V,"has no shadow.");continue}if(I.autoUpdate===!1&&I.needsUpdate===!1)continue;l.copy(I.mapSize);const ft=I.getFrameExtents();if(l.multiply(ft),c.copy(I.mapSize),(l.x>g||l.y>g)&&(l.x>g&&(c.x=Math.floor(g/ft.x),l.x=c.x*ft.x,I.mapSize.x=c.x),l.y>g&&(c.y=Math.floor(g/ft.y),l.y=c.y*ft.y,I.mapSize.y=c.y)),I.map===null||$===!0||lt===!0){const O=this.type!==ra?{minFilter:bi,magFilter:bi}:{};I.map!==null&&I.map.dispose(),I.map=new Ar(l.x,l.y,O),I.map.texture.name=V.name+".shadowMap",I.camera.updateProjectionMatrix()}s.setRenderTarget(I.map),s.clear();const xt=I.getViewportCount();for(let O=0;O<xt;O++){const J=I.getViewport(O);f.set(c.x*J.x,c.y*J.y,c.x*J.z,c.y*J.w),nt.viewport(f),I.updateMatrices(V,O),a=I.getFrustum(),w(z,W,I.camera,V,this.type)}I.isPointLightShadow!==!0&&this.type===ra&&P(I,W),I.needsUpdate=!1}y=this.type,M.needsUpdate=!1,s.setRenderTarget(D,R,G)};function P(F,z){const W=t.update(T);v.defines.VSM_SAMPLES!==F.blurSamples&&(v.defines.VSM_SAMPLES=F.blurSamples,S.defines.VSM_SAMPLES=F.blurSamples,v.needsUpdate=!0,S.needsUpdate=!0),F.mapPass===null&&(F.mapPass=new Ar(l.x,l.y)),v.uniforms.shadow_pass.value=F.map.texture,v.uniforms.resolution.value=F.mapSize,v.uniforms.radius.value=F.radius,s.setRenderTarget(F.mapPass),s.clear(),s.renderBufferDirect(z,null,W,v,T,null),S.uniforms.shadow_pass.value=F.mapPass.texture,S.uniforms.resolution.value=F.mapSize,S.uniforms.radius.value=F.radius,s.setRenderTarget(F.map),s.clear(),s.renderBufferDirect(z,null,W,S,T,null)}function L(F,z,W,D){let R=null;const G=W.isPointLight===!0?F.customDistanceMaterial:F.customDepthMaterial;if(G!==void 0)R=G;else if(R=W.isPointLight===!0?p:h,s.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0){const nt=R.uuid,$=z.uuid;let lt=m[nt];lt===void 0&&(lt={},m[nt]=lt);let gt=lt[$];gt===void 0&&(gt=R.clone(),lt[$]=gt,z.addEventListener("dispose",X)),R=gt}if(R.visible=z.visible,R.wireframe=z.wireframe,D===ra?R.side=z.shadowSide!==null?z.shadowSide:z.side:R.side=z.shadowSide!==null?z.shadowSide:_[z.side],R.alphaMap=z.alphaMap,R.alphaTest=z.alphaTest,R.map=z.map,R.clipShadows=z.clipShadows,R.clippingPlanes=z.clippingPlanes,R.clipIntersection=z.clipIntersection,R.displacementMap=z.displacementMap,R.displacementScale=z.displacementScale,R.displacementBias=z.displacementBias,R.wireframeLinewidth=z.wireframeLinewidth,R.linewidth=z.linewidth,W.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const nt=s.properties.get(R);nt.light=W}return R}function w(F,z,W,D,R){if(F.visible===!1)return;if(F.layers.test(z.layers)&&(F.isMesh||F.isLine||F.isPoints)&&(F.castShadow||F.receiveShadow&&R===ra)&&(!F.frustumCulled||a.intersectsObject(F))){F.modelViewMatrix.multiplyMatrices(W.matrixWorldInverse,F.matrixWorld);const $=t.update(F),lt=F.material;if(Array.isArray(lt)){const gt=$.groups;for(let U=0,V=gt.length;U<V;U++){const I=gt[U],ft=lt[I.materialIndex];if(ft&&ft.visible){const xt=L(F,ft,D,R);F.onBeforeShadow(s,F,z,W,$,xt,I),s.renderBufferDirect(W,null,$,xt,F,I),F.onAfterShadow(s,F,z,W,$,xt,I)}}}else if(lt.visible){const gt=L(F,lt,D,R);F.onBeforeShadow(s,F,z,W,$,gt,null),s.renderBufferDirect(W,null,$,gt,F,null),F.onAfterShadow(s,F,z,W,$,gt,null)}}const nt=F.children;for(let $=0,lt=nt.length;$<lt;$++)w(nt[$],z,W,D,R)}function X(F){F.target.removeEventListener("dispose",X);for(const W in m){const D=m[W],R=F.target.uuid;R in D&&(D[R].dispose(),delete D[R])}}}const k1={[Yh]:jh,[Zh]:Jh,[Kh]:$h,[Ts]:Qh,[jh]:Yh,[Jh]:Zh,[$h]:Kh,[Qh]:Ts};function X1(s,t){function i(){let j=!1;const wt=new tn;let ut=null;const yt=new tn(0,0,0,0);return{setMask:function(Rt){ut!==Rt&&!j&&(s.colorMask(Rt,Rt,Rt,Rt),ut=Rt)},setLocked:function(Rt){j=Rt},setClear:function(Rt,Dt,ne,Ye,cn){cn===!0&&(Rt*=Ye,Dt*=Ye,ne*=Ye),wt.set(Rt,Dt,ne,Ye),yt.equals(wt)===!1&&(s.clearColor(Rt,Dt,ne,Ye),yt.copy(wt))},reset:function(){j=!1,ut=null,yt.set(-1,0,0,0)}}}function a(){let j=!1,wt=!1,ut=null,yt=null,Rt=null;return{setReversed:function(Dt){if(wt!==Dt){const ne=t.get("EXT_clip_control");Dt?ne.clipControlEXT(ne.LOWER_LEFT_EXT,ne.ZERO_TO_ONE_EXT):ne.clipControlEXT(ne.LOWER_LEFT_EXT,ne.NEGATIVE_ONE_TO_ONE_EXT),wt=Dt;const Ye=Rt;Rt=null,this.setClear(Ye)}},getReversed:function(){return wt},setTest:function(Dt){Dt?Mt(s.DEPTH_TEST):Pt(s.DEPTH_TEST)},setMask:function(Dt){ut!==Dt&&!j&&(s.depthMask(Dt),ut=Dt)},setFunc:function(Dt){if(wt&&(Dt=k1[Dt]),yt!==Dt){switch(Dt){case Yh:s.depthFunc(s.NEVER);break;case jh:s.depthFunc(s.ALWAYS);break;case Zh:s.depthFunc(s.LESS);break;case Ts:s.depthFunc(s.LEQUAL);break;case Kh:s.depthFunc(s.EQUAL);break;case Qh:s.depthFunc(s.GEQUAL);break;case Jh:s.depthFunc(s.GREATER);break;case $h:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}yt=Dt}},setLocked:function(Dt){j=Dt},setClear:function(Dt){Rt!==Dt&&(wt&&(Dt=1-Dt),s.clearDepth(Dt),Rt=Dt)},reset:function(){j=!1,ut=null,yt=null,Rt=null,wt=!1}}}function l(){let j=!1,wt=null,ut=null,yt=null,Rt=null,Dt=null,ne=null,Ye=null,cn=null;return{setTest:function(Te){j||(Te?Mt(s.STENCIL_TEST):Pt(s.STENCIL_TEST))},setMask:function(Te){wt!==Te&&!j&&(s.stencilMask(Te),wt=Te)},setFunc:function(Te,_n,pi){(ut!==Te||yt!==_n||Rt!==pi)&&(s.stencilFunc(Te,_n,pi),ut=Te,yt=_n,Rt=pi)},setOp:function(Te,_n,pi){(Dt!==Te||ne!==_n||Ye!==pi)&&(s.stencilOp(Te,_n,pi),Dt=Te,ne=_n,Ye=pi)},setLocked:function(Te){j=Te},setClear:function(Te){cn!==Te&&(s.clearStencil(Te),cn=Te)},reset:function(){j=!1,wt=null,ut=null,yt=null,Rt=null,Dt=null,ne=null,Ye=null,cn=null}}}const c=new i,f=new a,h=new l,p=new WeakMap,m=new WeakMap;let g={},_={},v=new WeakMap,S=[],E=null,T=!1,M=null,y=null,P=null,L=null,w=null,X=null,F=null,z=new ze(0,0,0),W=0,D=!1,R=null,G=null,nt=null,$=null,lt=null;const gt=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,V=0;const I=s.getParameter(s.VERSION);I.indexOf("WebGL")!==-1?(V=parseFloat(/^WebGL (\d)/.exec(I)[1]),U=V>=1):I.indexOf("OpenGL ES")!==-1&&(V=parseFloat(/^OpenGL ES (\d)/.exec(I)[1]),U=V>=2);let ft=null,xt={};const O=s.getParameter(s.SCISSOR_BOX),J=s.getParameter(s.VIEWPORT),ht=new tn().fromArray(O),q=new tn().fromArray(J);function ct(j,wt,ut,yt){const Rt=new Uint8Array(4),Dt=s.createTexture();s.bindTexture(j,Dt),s.texParameteri(j,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(j,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let ne=0;ne<ut;ne++)j===s.TEXTURE_3D||j===s.TEXTURE_2D_ARRAY?s.texImage3D(wt,0,s.RGBA,1,1,yt,0,s.RGBA,s.UNSIGNED_BYTE,Rt):s.texImage2D(wt+ne,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Rt);return Dt}const St={};St[s.TEXTURE_2D]=ct(s.TEXTURE_2D,s.TEXTURE_2D,1),St[s.TEXTURE_CUBE_MAP]=ct(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),St[s.TEXTURE_2D_ARRAY]=ct(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),St[s.TEXTURE_3D]=ct(s.TEXTURE_3D,s.TEXTURE_3D,1,1),c.setClear(0,0,0,1),f.setClear(1),h.setClear(0),Mt(s.DEPTH_TEST),f.setFunc(Ts),he(!1),ge(W_),Mt(s.CULL_FACE),H(Va);function Mt(j){g[j]!==!0&&(s.enable(j),g[j]=!0)}function Pt(j){g[j]!==!1&&(s.disable(j),g[j]=!1)}function Ht(j,wt){return _[j]!==wt?(s.bindFramebuffer(j,wt),_[j]=wt,j===s.DRAW_FRAMEBUFFER&&(_[s.FRAMEBUFFER]=wt),j===s.FRAMEBUFFER&&(_[s.DRAW_FRAMEBUFFER]=wt),!0):!1}function qt(j,wt){let ut=S,yt=!1;if(j){ut=v.get(wt),ut===void 0&&(ut=[],v.set(wt,ut));const Rt=j.textures;if(ut.length!==Rt.length||ut[0]!==s.COLOR_ATTACHMENT0){for(let Dt=0,ne=Rt.length;Dt<ne;Dt++)ut[Dt]=s.COLOR_ATTACHMENT0+Dt;ut.length=Rt.length,yt=!0}}else ut[0]!==s.BACK&&(ut[0]=s.BACK,yt=!0);yt&&s.drawBuffers(ut)}function Ue(j){return E!==j?(s.useProgram(j),E=j,!0):!1}const be={[xr]:s.FUNC_ADD,[NS]:s.FUNC_SUBTRACT,[OS]:s.FUNC_REVERSE_SUBTRACT};be[zS]=s.MIN,be[PS]=s.MAX;const fe={[FS]:s.ZERO,[BS]:s.ONE,[IS]:s.SRC_COLOR,[Wh]:s.SRC_ALPHA,[WS]:s.SRC_ALPHA_SATURATE,[kS]:s.DST_COLOR,[GS]:s.DST_ALPHA,[HS]:s.ONE_MINUS_SRC_COLOR,[qh]:s.ONE_MINUS_SRC_ALPHA,[XS]:s.ONE_MINUS_DST_COLOR,[VS]:s.ONE_MINUS_DST_ALPHA,[qS]:s.CONSTANT_COLOR,[YS]:s.ONE_MINUS_CONSTANT_COLOR,[jS]:s.CONSTANT_ALPHA,[ZS]:s.ONE_MINUS_CONSTANT_ALPHA};function H(j,wt,ut,yt,Rt,Dt,ne,Ye,cn,Te){if(j===Va){T===!0&&(Pt(s.BLEND),T=!1);return}if(T===!1&&(Mt(s.BLEND),T=!0),j!==LS){if(j!==M||Te!==D){if((y!==xr||w!==xr)&&(s.blendEquation(s.FUNC_ADD),y=xr,w=xr),Te)switch(j){case Ms:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case q_:s.blendFunc(s.ONE,s.ONE);break;case Y_:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case j_:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",j);break}else switch(j){case Ms:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case q_:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case Y_:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case j_:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",j);break}P=null,L=null,X=null,F=null,z.set(0,0,0),W=0,M=j,D=Te}return}Rt=Rt||wt,Dt=Dt||ut,ne=ne||yt,(wt!==y||Rt!==w)&&(s.blendEquationSeparate(be[wt],be[Rt]),y=wt,w=Rt),(ut!==P||yt!==L||Dt!==X||ne!==F)&&(s.blendFuncSeparate(fe[ut],fe[yt],fe[Dt],fe[ne]),P=ut,L=yt,X=Dt,F=ne),(Ye.equals(z)===!1||cn!==W)&&(s.blendColor(Ye.r,Ye.g,Ye.b,cn),z.copy(Ye),W=cn),M=j,D=!1}function Tn(j,wt){j.side===Li?Pt(s.CULL_FACE):Mt(s.CULL_FACE);let ut=j.side===Xn;wt&&(ut=!ut),he(ut),j.blending===Ms&&j.transparent===!1?H(Va):H(j.blending,j.blendEquation,j.blendSrc,j.blendDst,j.blendEquationAlpha,j.blendSrcAlpha,j.blendDstAlpha,j.blendColor,j.blendAlpha,j.premultipliedAlpha),f.setFunc(j.depthFunc),f.setTest(j.depthTest),f.setMask(j.depthWrite),c.setMask(j.colorWrite);const yt=j.stencilWrite;h.setTest(yt),yt&&(h.setMask(j.stencilWriteMask),h.setFunc(j.stencilFunc,j.stencilRef,j.stencilFuncMask),h.setOp(j.stencilFail,j.stencilZFail,j.stencilZPass)),Le(j.polygonOffset,j.polygonOffsetFactor,j.polygonOffsetUnits),j.alphaToCoverage===!0?Mt(s.SAMPLE_ALPHA_TO_COVERAGE):Pt(s.SAMPLE_ALPHA_TO_COVERAGE)}function he(j){R!==j&&(j?s.frontFace(s.CW):s.frontFace(s.CCW),R=j)}function ge(j){j!==wS?(Mt(s.CULL_FACE),j!==G&&(j===W_?s.cullFace(s.BACK):j===DS?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Pt(s.CULL_FACE),G=j}function Yt(j){j!==nt&&(U&&s.lineWidth(j),nt=j)}function Le(j,wt,ut){j?(Mt(s.POLYGON_OFFSET_FILL),($!==wt||lt!==ut)&&(s.polygonOffset(wt,ut),$=wt,lt=ut)):Pt(s.POLYGON_OFFSET_FILL)}function Wt(j){j?Mt(s.SCISSOR_TEST):Pt(s.SCISSOR_TEST)}function N(j){j===void 0&&(j=s.TEXTURE0+gt-1),ft!==j&&(s.activeTexture(j),ft=j)}function A(j,wt,ut){ut===void 0&&(ft===null?ut=s.TEXTURE0+gt-1:ut=ft);let yt=xt[ut];yt===void 0&&(yt={type:void 0,texture:void 0},xt[ut]=yt),(yt.type!==j||yt.texture!==wt)&&(ft!==ut&&(s.activeTexture(ut),ft=ut),s.bindTexture(j,wt||St[j]),yt.type=j,yt.texture=wt)}function at(){const j=xt[ft];j!==void 0&&j.type!==void 0&&(s.bindTexture(j.type,null),j.type=void 0,j.texture=void 0)}function pt(){try{s.compressedTexImage2D(...arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function Et(){try{s.compressedTexImage3D(...arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function _t(){try{s.texSubImage2D(...arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function kt(){try{s.texSubImage3D(...arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function Ct(){try{s.compressedTexSubImage2D(...arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function Ft(){try{s.compressedTexSubImage3D(...arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function _e(){try{s.texStorage2D(...arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function bt(){try{s.texStorage3D(...arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function Bt(){try{s.texImage2D(...arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function Qt(){try{s.texImage3D(...arguments)}catch(j){console.error("THREE.WebGLState:",j)}}function Xt(j){ht.equals(j)===!1&&(s.scissor(j.x,j.y,j.z,j.w),ht.copy(j))}function Ot(j){q.equals(j)===!1&&(s.viewport(j.x,j.y,j.z,j.w),q.copy(j))}function ee(j,wt){let ut=m.get(wt);ut===void 0&&(ut=new WeakMap,m.set(wt,ut));let yt=ut.get(j);yt===void 0&&(yt=s.getUniformBlockIndex(wt,j.name),ut.set(j,yt))}function se(j,wt){const yt=m.get(wt).get(j);p.get(wt)!==yt&&(s.uniformBlockBinding(wt,yt,j.__bindingPointIndex),p.set(wt,yt))}function Pe(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),f.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),g={},ft=null,xt={},_={},v=new WeakMap,S=[],E=null,T=!1,M=null,y=null,P=null,L=null,w=null,X=null,F=null,z=new ze(0,0,0),W=0,D=!1,R=null,G=null,nt=null,$=null,lt=null,ht.set(0,0,s.canvas.width,s.canvas.height),q.set(0,0,s.canvas.width,s.canvas.height),c.reset(),f.reset(),h.reset()}return{buffers:{color:c,depth:f,stencil:h},enable:Mt,disable:Pt,bindFramebuffer:Ht,drawBuffers:qt,useProgram:Ue,setBlending:H,setMaterial:Tn,setFlipSided:he,setCullFace:ge,setLineWidth:Yt,setPolygonOffset:Le,setScissorTest:Wt,activeTexture:N,bindTexture:A,unbindTexture:at,compressedTexImage2D:pt,compressedTexImage3D:Et,texImage2D:Bt,texImage3D:Qt,updateUBOMapping:ee,uniformBlockBinding:se,texStorage2D:_e,texStorage3D:bt,texSubImage2D:_t,texSubImage3D:kt,compressedTexSubImage2D:Ct,compressedTexSubImage3D:Ft,scissor:Xt,viewport:Ot,reset:Pe}}function W1(s,t,i,a,l,c,f){const h=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),m=new te,g=new WeakMap;let _;const v=new WeakMap;let S=!1;try{S=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(N,A){return S?new OffscreenCanvas(N,A):Bc("canvas")}function T(N,A,at){let pt=1;const Et=Wt(N);if((Et.width>at||Et.height>at)&&(pt=at/Math.max(Et.width,Et.height)),pt<1)if(typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&N instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&N instanceof ImageBitmap||typeof VideoFrame<"u"&&N instanceof VideoFrame){const _t=Math.floor(pt*Et.width),kt=Math.floor(pt*Et.height);_===void 0&&(_=E(_t,kt));const Ct=A?E(_t,kt):_;return Ct.width=_t,Ct.height=kt,Ct.getContext("2d").drawImage(N,0,0,_t,kt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Et.width+"x"+Et.height+") to ("+_t+"x"+kt+")."),Ct}else return"data"in N&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Et.width+"x"+Et.height+")."),N;return N}function M(N){return N.generateMipmaps}function y(N){s.generateMipmap(N)}function P(N){return N.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:N.isWebGL3DRenderTarget?s.TEXTURE_3D:N.isWebGLArrayRenderTarget||N.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function L(N,A,at,pt,Et=!1){if(N!==null){if(s[N]!==void 0)return s[N];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+N+"'")}let _t=A;if(A===s.RED&&(at===s.FLOAT&&(_t=s.R32F),at===s.HALF_FLOAT&&(_t=s.R16F),at===s.UNSIGNED_BYTE&&(_t=s.R8)),A===s.RED_INTEGER&&(at===s.UNSIGNED_BYTE&&(_t=s.R8UI),at===s.UNSIGNED_SHORT&&(_t=s.R16UI),at===s.UNSIGNED_INT&&(_t=s.R32UI),at===s.BYTE&&(_t=s.R8I),at===s.SHORT&&(_t=s.R16I),at===s.INT&&(_t=s.R32I)),A===s.RG&&(at===s.FLOAT&&(_t=s.RG32F),at===s.HALF_FLOAT&&(_t=s.RG16F),at===s.UNSIGNED_BYTE&&(_t=s.RG8)),A===s.RG_INTEGER&&(at===s.UNSIGNED_BYTE&&(_t=s.RG8UI),at===s.UNSIGNED_SHORT&&(_t=s.RG16UI),at===s.UNSIGNED_INT&&(_t=s.RG32UI),at===s.BYTE&&(_t=s.RG8I),at===s.SHORT&&(_t=s.RG16I),at===s.INT&&(_t=s.RG32I)),A===s.RGB_INTEGER&&(at===s.UNSIGNED_BYTE&&(_t=s.RGB8UI),at===s.UNSIGNED_SHORT&&(_t=s.RGB16UI),at===s.UNSIGNED_INT&&(_t=s.RGB32UI),at===s.BYTE&&(_t=s.RGB8I),at===s.SHORT&&(_t=s.RGB16I),at===s.INT&&(_t=s.RGB32I)),A===s.RGBA_INTEGER&&(at===s.UNSIGNED_BYTE&&(_t=s.RGBA8UI),at===s.UNSIGNED_SHORT&&(_t=s.RGBA16UI),at===s.UNSIGNED_INT&&(_t=s.RGBA32UI),at===s.BYTE&&(_t=s.RGBA8I),at===s.SHORT&&(_t=s.RGBA16I),at===s.INT&&(_t=s.RGBA32I)),A===s.RGB&&at===s.UNSIGNED_INT_5_9_9_9_REV&&(_t=s.RGB9_E5),A===s.RGBA){const kt=Et?Pc:we.getTransfer(pt);at===s.FLOAT&&(_t=s.RGBA32F),at===s.HALF_FLOAT&&(_t=s.RGBA16F),at===s.UNSIGNED_BYTE&&(_t=kt===Ge?s.SRGB8_ALPHA8:s.RGBA8),at===s.UNSIGNED_SHORT_4_4_4_4&&(_t=s.RGBA4),at===s.UNSIGNED_SHORT_5_5_5_1&&(_t=s.RGB5_A1)}return(_t===s.R16F||_t===s.R32F||_t===s.RG16F||_t===s.RG32F||_t===s.RGBA16F||_t===s.RGBA32F)&&t.get("EXT_color_buffer_float"),_t}function w(N,A){let at;return N?A===null||A===br||A===Io?at=s.DEPTH24_STENCIL8:A===sa?at=s.DEPTH32F_STENCIL8:A===Bo&&(at=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):A===null||A===br||A===Io?at=s.DEPTH_COMPONENT24:A===sa?at=s.DEPTH_COMPONENT32F:A===Bo&&(at=s.DEPTH_COMPONENT16),at}function X(N,A){return M(N)===!0||N.isFramebufferTexture&&N.minFilter!==bi&&N.minFilter!==Ni?Math.log2(Math.max(A.width,A.height))+1:N.mipmaps!==void 0&&N.mipmaps.length>0?N.mipmaps.length:N.isCompressedTexture&&Array.isArray(N.image)?A.mipmaps.length:1}function F(N){const A=N.target;A.removeEventListener("dispose",F),W(A),A.isVideoTexture&&g.delete(A)}function z(N){const A=N.target;A.removeEventListener("dispose",z),R(A)}function W(N){const A=a.get(N);if(A.__webglInit===void 0)return;const at=N.source,pt=v.get(at);if(pt){const Et=pt[A.__cacheKey];Et.usedTimes--,Et.usedTimes===0&&D(N),Object.keys(pt).length===0&&v.delete(at)}a.remove(N)}function D(N){const A=a.get(N);s.deleteTexture(A.__webglTexture);const at=N.source,pt=v.get(at);delete pt[A.__cacheKey],f.memory.textures--}function R(N){const A=a.get(N);if(N.depthTexture&&(N.depthTexture.dispose(),a.remove(N.depthTexture)),N.isWebGLCubeRenderTarget)for(let pt=0;pt<6;pt++){if(Array.isArray(A.__webglFramebuffer[pt]))for(let Et=0;Et<A.__webglFramebuffer[pt].length;Et++)s.deleteFramebuffer(A.__webglFramebuffer[pt][Et]);else s.deleteFramebuffer(A.__webglFramebuffer[pt]);A.__webglDepthbuffer&&s.deleteRenderbuffer(A.__webglDepthbuffer[pt])}else{if(Array.isArray(A.__webglFramebuffer))for(let pt=0;pt<A.__webglFramebuffer.length;pt++)s.deleteFramebuffer(A.__webglFramebuffer[pt]);else s.deleteFramebuffer(A.__webglFramebuffer);if(A.__webglDepthbuffer&&s.deleteRenderbuffer(A.__webglDepthbuffer),A.__webglMultisampledFramebuffer&&s.deleteFramebuffer(A.__webglMultisampledFramebuffer),A.__webglColorRenderbuffer)for(let pt=0;pt<A.__webglColorRenderbuffer.length;pt++)A.__webglColorRenderbuffer[pt]&&s.deleteRenderbuffer(A.__webglColorRenderbuffer[pt]);A.__webglDepthRenderbuffer&&s.deleteRenderbuffer(A.__webglDepthRenderbuffer)}const at=N.textures;for(let pt=0,Et=at.length;pt<Et;pt++){const _t=a.get(at[pt]);_t.__webglTexture&&(s.deleteTexture(_t.__webglTexture),f.memory.textures--),a.remove(at[pt])}a.remove(N)}let G=0;function nt(){G=0}function $(){const N=G;return N>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+N+" texture units while this GPU supports only "+l.maxTextures),G+=1,N}function lt(N){const A=[];return A.push(N.wrapS),A.push(N.wrapT),A.push(N.wrapR||0),A.push(N.magFilter),A.push(N.minFilter),A.push(N.anisotropy),A.push(N.internalFormat),A.push(N.format),A.push(N.type),A.push(N.generateMipmaps),A.push(N.premultiplyAlpha),A.push(N.flipY),A.push(N.unpackAlignment),A.push(N.colorSpace),A.join()}function gt(N,A){const at=a.get(N);if(N.isVideoTexture&&Yt(N),N.isRenderTargetTexture===!1&&N.version>0&&at.__version!==N.version){const pt=N.image;if(pt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(pt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{q(at,N,A);return}}i.bindTexture(s.TEXTURE_2D,at.__webglTexture,s.TEXTURE0+A)}function U(N,A){const at=a.get(N);if(N.version>0&&at.__version!==N.version){q(at,N,A);return}i.bindTexture(s.TEXTURE_2D_ARRAY,at.__webglTexture,s.TEXTURE0+A)}function V(N,A){const at=a.get(N);if(N.version>0&&at.__version!==N.version){q(at,N,A);return}i.bindTexture(s.TEXTURE_3D,at.__webglTexture,s.TEXTURE0+A)}function I(N,A){const at=a.get(N);if(N.version>0&&at.__version!==N.version){ct(at,N,A);return}i.bindTexture(s.TEXTURE_CUBE_MAP,at.__webglTexture,s.TEXTURE0+A)}const ft={[nd]:s.REPEAT,[Mr]:s.CLAMP_TO_EDGE,[id]:s.MIRRORED_REPEAT},xt={[bi]:s.NEAREST,[rM]:s.NEAREST_MIPMAP_NEAREST,[rc]:s.NEAREST_MIPMAP_LINEAR,[Ni]:s.LINEAR,[ah]:s.LINEAR_MIPMAP_NEAREST,[Er]:s.LINEAR_MIPMAP_LINEAR},O={[uM]:s.NEVER,[gM]:s.ALWAYS,[fM]:s.LESS,[_0]:s.LEQUAL,[hM]:s.EQUAL,[mM]:s.GEQUAL,[dM]:s.GREATER,[pM]:s.NOTEQUAL};function J(N,A){if(A.type===sa&&t.has("OES_texture_float_linear")===!1&&(A.magFilter===Ni||A.magFilter===ah||A.magFilter===rc||A.magFilter===Er||A.minFilter===Ni||A.minFilter===ah||A.minFilter===rc||A.minFilter===Er)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(N,s.TEXTURE_WRAP_S,ft[A.wrapS]),s.texParameteri(N,s.TEXTURE_WRAP_T,ft[A.wrapT]),(N===s.TEXTURE_3D||N===s.TEXTURE_2D_ARRAY)&&s.texParameteri(N,s.TEXTURE_WRAP_R,ft[A.wrapR]),s.texParameteri(N,s.TEXTURE_MAG_FILTER,xt[A.magFilter]),s.texParameteri(N,s.TEXTURE_MIN_FILTER,xt[A.minFilter]),A.compareFunction&&(s.texParameteri(N,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(N,s.TEXTURE_COMPARE_FUNC,O[A.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(A.magFilter===bi||A.minFilter!==rc&&A.minFilter!==Er||A.type===sa&&t.has("OES_texture_float_linear")===!1)return;if(A.anisotropy>1||a.get(A).__currentAnisotropy){const at=t.get("EXT_texture_filter_anisotropic");s.texParameterf(N,at.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(A.anisotropy,l.getMaxAnisotropy())),a.get(A).__currentAnisotropy=A.anisotropy}}}function ht(N,A){let at=!1;N.__webglInit===void 0&&(N.__webglInit=!0,A.addEventListener("dispose",F));const pt=A.source;let Et=v.get(pt);Et===void 0&&(Et={},v.set(pt,Et));const _t=lt(A);if(_t!==N.__cacheKey){Et[_t]===void 0&&(Et[_t]={texture:s.createTexture(),usedTimes:0},f.memory.textures++,at=!0),Et[_t].usedTimes++;const kt=Et[N.__cacheKey];kt!==void 0&&(Et[N.__cacheKey].usedTimes--,kt.usedTimes===0&&D(A)),N.__cacheKey=_t,N.__webglTexture=Et[_t].texture}return at}function q(N,A,at){let pt=s.TEXTURE_2D;(A.isDataArrayTexture||A.isCompressedArrayTexture)&&(pt=s.TEXTURE_2D_ARRAY),A.isData3DTexture&&(pt=s.TEXTURE_3D);const Et=ht(N,A),_t=A.source;i.bindTexture(pt,N.__webglTexture,s.TEXTURE0+at);const kt=a.get(_t);if(_t.version!==kt.__version||Et===!0){i.activeTexture(s.TEXTURE0+at);const Ct=we.getPrimaries(we.workingColorSpace),Ft=A.colorSpace===Ga?null:we.getPrimaries(A.colorSpace),_e=A.colorSpace===Ga||Ct===Ft?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,A.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,A.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e);let bt=T(A.image,!1,l.maxTextureSize);bt=Le(A,bt);const Bt=c.convert(A.format,A.colorSpace),Qt=c.convert(A.type);let Xt=L(A.internalFormat,Bt,Qt,A.colorSpace,A.isVideoTexture);J(pt,A);let Ot;const ee=A.mipmaps,se=A.isVideoTexture!==!0,Pe=kt.__version===void 0||Et===!0,j=_t.dataReady,wt=X(A,bt);if(A.isDepthTexture)Xt=w(A.format===Go,A.type),Pe&&(se?i.texStorage2D(s.TEXTURE_2D,1,Xt,bt.width,bt.height):i.texImage2D(s.TEXTURE_2D,0,Xt,bt.width,bt.height,0,Bt,Qt,null));else if(A.isDataTexture)if(ee.length>0){se&&Pe&&i.texStorage2D(s.TEXTURE_2D,wt,Xt,ee[0].width,ee[0].height);for(let ut=0,yt=ee.length;ut<yt;ut++)Ot=ee[ut],se?j&&i.texSubImage2D(s.TEXTURE_2D,ut,0,0,Ot.width,Ot.height,Bt,Qt,Ot.data):i.texImage2D(s.TEXTURE_2D,ut,Xt,Ot.width,Ot.height,0,Bt,Qt,Ot.data);A.generateMipmaps=!1}else se?(Pe&&i.texStorage2D(s.TEXTURE_2D,wt,Xt,bt.width,bt.height),j&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,bt.width,bt.height,Bt,Qt,bt.data)):i.texImage2D(s.TEXTURE_2D,0,Xt,bt.width,bt.height,0,Bt,Qt,bt.data);else if(A.isCompressedTexture)if(A.isCompressedArrayTexture){se&&Pe&&i.texStorage3D(s.TEXTURE_2D_ARRAY,wt,Xt,ee[0].width,ee[0].height,bt.depth);for(let ut=0,yt=ee.length;ut<yt;ut++)if(Ot=ee[ut],A.format!==Ti)if(Bt!==null)if(se){if(j)if(A.layerUpdates.size>0){const Rt=vv(Ot.width,Ot.height,A.format,A.type);for(const Dt of A.layerUpdates){const ne=Ot.data.subarray(Dt*Rt/Ot.data.BYTES_PER_ELEMENT,(Dt+1)*Rt/Ot.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ut,0,0,Dt,Ot.width,Ot.height,1,Bt,ne)}A.clearLayerUpdates()}else i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,ut,0,0,0,Ot.width,Ot.height,bt.depth,Bt,Ot.data)}else i.compressedTexImage3D(s.TEXTURE_2D_ARRAY,ut,Xt,Ot.width,Ot.height,bt.depth,0,Ot.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else se?j&&i.texSubImage3D(s.TEXTURE_2D_ARRAY,ut,0,0,0,Ot.width,Ot.height,bt.depth,Bt,Qt,Ot.data):i.texImage3D(s.TEXTURE_2D_ARRAY,ut,Xt,Ot.width,Ot.height,bt.depth,0,Bt,Qt,Ot.data)}else{se&&Pe&&i.texStorage2D(s.TEXTURE_2D,wt,Xt,ee[0].width,ee[0].height);for(let ut=0,yt=ee.length;ut<yt;ut++)Ot=ee[ut],A.format!==Ti?Bt!==null?se?j&&i.compressedTexSubImage2D(s.TEXTURE_2D,ut,0,0,Ot.width,Ot.height,Bt,Ot.data):i.compressedTexImage2D(s.TEXTURE_2D,ut,Xt,Ot.width,Ot.height,0,Ot.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):se?j&&i.texSubImage2D(s.TEXTURE_2D,ut,0,0,Ot.width,Ot.height,Bt,Qt,Ot.data):i.texImage2D(s.TEXTURE_2D,ut,Xt,Ot.width,Ot.height,0,Bt,Qt,Ot.data)}else if(A.isDataArrayTexture)if(se){if(Pe&&i.texStorage3D(s.TEXTURE_2D_ARRAY,wt,Xt,bt.width,bt.height,bt.depth),j)if(A.layerUpdates.size>0){const ut=vv(bt.width,bt.height,A.format,A.type);for(const yt of A.layerUpdates){const Rt=bt.data.subarray(yt*ut/bt.data.BYTES_PER_ELEMENT,(yt+1)*ut/bt.data.BYTES_PER_ELEMENT);i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,yt,bt.width,bt.height,1,Bt,Qt,Rt)}A.clearLayerUpdates()}else i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,bt.width,bt.height,bt.depth,Bt,Qt,bt.data)}else i.texImage3D(s.TEXTURE_2D_ARRAY,0,Xt,bt.width,bt.height,bt.depth,0,Bt,Qt,bt.data);else if(A.isData3DTexture)se?(Pe&&i.texStorage3D(s.TEXTURE_3D,wt,Xt,bt.width,bt.height,bt.depth),j&&i.texSubImage3D(s.TEXTURE_3D,0,0,0,0,bt.width,bt.height,bt.depth,Bt,Qt,bt.data)):i.texImage3D(s.TEXTURE_3D,0,Xt,bt.width,bt.height,bt.depth,0,Bt,Qt,bt.data);else if(A.isFramebufferTexture){if(Pe)if(se)i.texStorage2D(s.TEXTURE_2D,wt,Xt,bt.width,bt.height);else{let ut=bt.width,yt=bt.height;for(let Rt=0;Rt<wt;Rt++)i.texImage2D(s.TEXTURE_2D,Rt,Xt,ut,yt,0,Bt,Qt,null),ut>>=1,yt>>=1}}else if(ee.length>0){if(se&&Pe){const ut=Wt(ee[0]);i.texStorage2D(s.TEXTURE_2D,wt,Xt,ut.width,ut.height)}for(let ut=0,yt=ee.length;ut<yt;ut++)Ot=ee[ut],se?j&&i.texSubImage2D(s.TEXTURE_2D,ut,0,0,Bt,Qt,Ot):i.texImage2D(s.TEXTURE_2D,ut,Xt,Bt,Qt,Ot);A.generateMipmaps=!1}else if(se){if(Pe){const ut=Wt(bt);i.texStorage2D(s.TEXTURE_2D,wt,Xt,ut.width,ut.height)}j&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,Bt,Qt,bt)}else i.texImage2D(s.TEXTURE_2D,0,Xt,Bt,Qt,bt);M(A)&&y(pt),kt.__version=_t.version,A.onUpdate&&A.onUpdate(A)}N.__version=A.version}function ct(N,A,at){if(A.image.length!==6)return;const pt=ht(N,A),Et=A.source;i.bindTexture(s.TEXTURE_CUBE_MAP,N.__webglTexture,s.TEXTURE0+at);const _t=a.get(Et);if(Et.version!==_t.__version||pt===!0){i.activeTexture(s.TEXTURE0+at);const kt=we.getPrimaries(we.workingColorSpace),Ct=A.colorSpace===Ga?null:we.getPrimaries(A.colorSpace),Ft=A.colorSpace===Ga||kt===Ct?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,A.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,A.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ft);const _e=A.isCompressedTexture||A.image[0].isCompressedTexture,bt=A.image[0]&&A.image[0].isDataTexture,Bt=[];for(let yt=0;yt<6;yt++)!_e&&!bt?Bt[yt]=T(A.image[yt],!0,l.maxCubemapSize):Bt[yt]=bt?A.image[yt].image:A.image[yt],Bt[yt]=Le(A,Bt[yt]);const Qt=Bt[0],Xt=c.convert(A.format,A.colorSpace),Ot=c.convert(A.type),ee=L(A.internalFormat,Xt,Ot,A.colorSpace),se=A.isVideoTexture!==!0,Pe=_t.__version===void 0||pt===!0,j=Et.dataReady;let wt=X(A,Qt);J(s.TEXTURE_CUBE_MAP,A);let ut;if(_e){se&&Pe&&i.texStorage2D(s.TEXTURE_CUBE_MAP,wt,ee,Qt.width,Qt.height);for(let yt=0;yt<6;yt++){ut=Bt[yt].mipmaps;for(let Rt=0;Rt<ut.length;Rt++){const Dt=ut[Rt];A.format!==Ti?Xt!==null?se?j&&i.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt,0,0,Dt.width,Dt.height,Xt,Dt.data):i.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt,ee,Dt.width,Dt.height,0,Dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):se?j&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt,0,0,Dt.width,Dt.height,Xt,Ot,Dt.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt,ee,Dt.width,Dt.height,0,Xt,Ot,Dt.data)}}}else{if(ut=A.mipmaps,se&&Pe){ut.length>0&&wt++;const yt=Wt(Bt[0]);i.texStorage2D(s.TEXTURE_CUBE_MAP,wt,ee,yt.width,yt.height)}for(let yt=0;yt<6;yt++)if(bt){se?j&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,0,0,Bt[yt].width,Bt[yt].height,Xt,Ot,Bt[yt].data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,ee,Bt[yt].width,Bt[yt].height,0,Xt,Ot,Bt[yt].data);for(let Rt=0;Rt<ut.length;Rt++){const ne=ut[Rt].image[yt].image;se?j&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt+1,0,0,ne.width,ne.height,Xt,Ot,ne.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt+1,ee,ne.width,ne.height,0,Xt,Ot,ne.data)}}else{se?j&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,0,0,Xt,Ot,Bt[yt]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,0,ee,Xt,Ot,Bt[yt]);for(let Rt=0;Rt<ut.length;Rt++){const Dt=ut[Rt];se?j&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt+1,0,0,Xt,Ot,Dt.image[yt]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+yt,Rt+1,ee,Xt,Ot,Dt.image[yt])}}}M(A)&&y(s.TEXTURE_CUBE_MAP),_t.__version=Et.version,A.onUpdate&&A.onUpdate(A)}N.__version=A.version}function St(N,A,at,pt,Et,_t){const kt=c.convert(at.format,at.colorSpace),Ct=c.convert(at.type),Ft=L(at.internalFormat,kt,Ct,at.colorSpace),_e=a.get(A),bt=a.get(at);if(bt.__renderTarget=A,!_e.__hasExternalTextures){const Bt=Math.max(1,A.width>>_t),Qt=Math.max(1,A.height>>_t);Et===s.TEXTURE_3D||Et===s.TEXTURE_2D_ARRAY?i.texImage3D(Et,_t,Ft,Bt,Qt,A.depth,0,kt,Ct,null):i.texImage2D(Et,_t,Ft,Bt,Qt,0,kt,Ct,null)}i.bindFramebuffer(s.FRAMEBUFFER,N),ge(A)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,pt,Et,bt.__webglTexture,0,he(A)):(Et===s.TEXTURE_2D||Et>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Et<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,pt,Et,bt.__webglTexture,_t),i.bindFramebuffer(s.FRAMEBUFFER,null)}function Mt(N,A,at){if(s.bindRenderbuffer(s.RENDERBUFFER,N),A.depthBuffer){const pt=A.depthTexture,Et=pt&&pt.isDepthTexture?pt.type:null,_t=w(A.stencilBuffer,Et),kt=A.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Ct=he(A);ge(A)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ct,_t,A.width,A.height):at?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ct,_t,A.width,A.height):s.renderbufferStorage(s.RENDERBUFFER,_t,A.width,A.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,kt,s.RENDERBUFFER,N)}else{const pt=A.textures;for(let Et=0;Et<pt.length;Et++){const _t=pt[Et],kt=c.convert(_t.format,_t.colorSpace),Ct=c.convert(_t.type),Ft=L(_t.internalFormat,kt,Ct,_t.colorSpace),_e=he(A);at&&ge(A)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,_e,Ft,A.width,A.height):ge(A)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,_e,Ft,A.width,A.height):s.renderbufferStorage(s.RENDERBUFFER,Ft,A.width,A.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Pt(N,A){if(A&&A.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(s.FRAMEBUFFER,N),!(A.depthTexture&&A.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const pt=a.get(A.depthTexture);pt.__renderTarget=A,(!pt.__webglTexture||A.depthTexture.image.width!==A.width||A.depthTexture.image.height!==A.height)&&(A.depthTexture.image.width=A.width,A.depthTexture.image.height=A.height,A.depthTexture.needsUpdate=!0),gt(A.depthTexture,0);const Et=pt.__webglTexture,_t=he(A);if(A.depthTexture.format===Ho)ge(A)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Et,0,_t):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Et,0);else if(A.depthTexture.format===Go)ge(A)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Et,0,_t):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Et,0);else throw new Error("Unknown depthTexture format")}function Ht(N){const A=a.get(N),at=N.isWebGLCubeRenderTarget===!0;if(A.__boundDepthTexture!==N.depthTexture){const pt=N.depthTexture;if(A.__depthDisposeCallback&&A.__depthDisposeCallback(),pt){const Et=()=>{delete A.__boundDepthTexture,delete A.__depthDisposeCallback,pt.removeEventListener("dispose",Et)};pt.addEventListener("dispose",Et),A.__depthDisposeCallback=Et}A.__boundDepthTexture=pt}if(N.depthTexture&&!A.__autoAllocateDepthBuffer){if(at)throw new Error("target.depthTexture not supported in Cube render targets");Pt(A.__webglFramebuffer,N)}else if(at){A.__webglDepthbuffer=[];for(let pt=0;pt<6;pt++)if(i.bindFramebuffer(s.FRAMEBUFFER,A.__webglFramebuffer[pt]),A.__webglDepthbuffer[pt]===void 0)A.__webglDepthbuffer[pt]=s.createRenderbuffer(),Mt(A.__webglDepthbuffer[pt],N,!1);else{const Et=N.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,_t=A.__webglDepthbuffer[pt];s.bindRenderbuffer(s.RENDERBUFFER,_t),s.framebufferRenderbuffer(s.FRAMEBUFFER,Et,s.RENDERBUFFER,_t)}}else if(i.bindFramebuffer(s.FRAMEBUFFER,A.__webglFramebuffer),A.__webglDepthbuffer===void 0)A.__webglDepthbuffer=s.createRenderbuffer(),Mt(A.__webglDepthbuffer,N,!1);else{const pt=N.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Et=A.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,Et),s.framebufferRenderbuffer(s.FRAMEBUFFER,pt,s.RENDERBUFFER,Et)}i.bindFramebuffer(s.FRAMEBUFFER,null)}function qt(N,A,at){const pt=a.get(N);A!==void 0&&St(pt.__webglFramebuffer,N,N.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),at!==void 0&&Ht(N)}function Ue(N){const A=N.texture,at=a.get(N),pt=a.get(A);N.addEventListener("dispose",z);const Et=N.textures,_t=N.isWebGLCubeRenderTarget===!0,kt=Et.length>1;if(kt||(pt.__webglTexture===void 0&&(pt.__webglTexture=s.createTexture()),pt.__version=A.version,f.memory.textures++),_t){at.__webglFramebuffer=[];for(let Ct=0;Ct<6;Ct++)if(A.mipmaps&&A.mipmaps.length>0){at.__webglFramebuffer[Ct]=[];for(let Ft=0;Ft<A.mipmaps.length;Ft++)at.__webglFramebuffer[Ct][Ft]=s.createFramebuffer()}else at.__webglFramebuffer[Ct]=s.createFramebuffer()}else{if(A.mipmaps&&A.mipmaps.length>0){at.__webglFramebuffer=[];for(let Ct=0;Ct<A.mipmaps.length;Ct++)at.__webglFramebuffer[Ct]=s.createFramebuffer()}else at.__webglFramebuffer=s.createFramebuffer();if(kt)for(let Ct=0,Ft=Et.length;Ct<Ft;Ct++){const _e=a.get(Et[Ct]);_e.__webglTexture===void 0&&(_e.__webglTexture=s.createTexture(),f.memory.textures++)}if(N.samples>0&&ge(N)===!1){at.__webglMultisampledFramebuffer=s.createFramebuffer(),at.__webglColorRenderbuffer=[],i.bindFramebuffer(s.FRAMEBUFFER,at.__webglMultisampledFramebuffer);for(let Ct=0;Ct<Et.length;Ct++){const Ft=Et[Ct];at.__webglColorRenderbuffer[Ct]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,at.__webglColorRenderbuffer[Ct]);const _e=c.convert(Ft.format,Ft.colorSpace),bt=c.convert(Ft.type),Bt=L(Ft.internalFormat,_e,bt,Ft.colorSpace,N.isXRRenderTarget===!0),Qt=he(N);s.renderbufferStorageMultisample(s.RENDERBUFFER,Qt,Bt,N.width,N.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ct,s.RENDERBUFFER,at.__webglColorRenderbuffer[Ct])}s.bindRenderbuffer(s.RENDERBUFFER,null),N.depthBuffer&&(at.__webglDepthRenderbuffer=s.createRenderbuffer(),Mt(at.__webglDepthRenderbuffer,N,!0)),i.bindFramebuffer(s.FRAMEBUFFER,null)}}if(_t){i.bindTexture(s.TEXTURE_CUBE_MAP,pt.__webglTexture),J(s.TEXTURE_CUBE_MAP,A);for(let Ct=0;Ct<6;Ct++)if(A.mipmaps&&A.mipmaps.length>0)for(let Ft=0;Ft<A.mipmaps.length;Ft++)St(at.__webglFramebuffer[Ct][Ft],N,A,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ct,Ft);else St(at.__webglFramebuffer[Ct],N,A,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ct,0);M(A)&&y(s.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(kt){for(let Ct=0,Ft=Et.length;Ct<Ft;Ct++){const _e=Et[Ct],bt=a.get(_e);i.bindTexture(s.TEXTURE_2D,bt.__webglTexture),J(s.TEXTURE_2D,_e),St(at.__webglFramebuffer,N,_e,s.COLOR_ATTACHMENT0+Ct,s.TEXTURE_2D,0),M(_e)&&y(s.TEXTURE_2D)}i.unbindTexture()}else{let Ct=s.TEXTURE_2D;if((N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(Ct=N.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Ct,pt.__webglTexture),J(Ct,A),A.mipmaps&&A.mipmaps.length>0)for(let Ft=0;Ft<A.mipmaps.length;Ft++)St(at.__webglFramebuffer[Ft],N,A,s.COLOR_ATTACHMENT0,Ct,Ft);else St(at.__webglFramebuffer,N,A,s.COLOR_ATTACHMENT0,Ct,0);M(A)&&y(Ct),i.unbindTexture()}N.depthBuffer&&Ht(N)}function be(N){const A=N.textures;for(let at=0,pt=A.length;at<pt;at++){const Et=A[at];if(M(Et)){const _t=P(N),kt=a.get(Et).__webglTexture;i.bindTexture(_t,kt),y(_t),i.unbindTexture()}}}const fe=[],H=[];function Tn(N){if(N.samples>0){if(ge(N)===!1){const A=N.textures,at=N.width,pt=N.height;let Et=s.COLOR_BUFFER_BIT;const _t=N.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,kt=a.get(N),Ct=A.length>1;if(Ct)for(let Ft=0;Ft<A.length;Ft++)i.bindFramebuffer(s.FRAMEBUFFER,kt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ft,s.RENDERBUFFER,null),i.bindFramebuffer(s.FRAMEBUFFER,kt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ft,s.TEXTURE_2D,null,0);i.bindFramebuffer(s.READ_FRAMEBUFFER,kt.__webglMultisampledFramebuffer),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,kt.__webglFramebuffer);for(let Ft=0;Ft<A.length;Ft++){if(N.resolveDepthBuffer&&(N.depthBuffer&&(Et|=s.DEPTH_BUFFER_BIT),N.stencilBuffer&&N.resolveStencilBuffer&&(Et|=s.STENCIL_BUFFER_BIT)),Ct){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,kt.__webglColorRenderbuffer[Ft]);const _e=a.get(A[Ft]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,_e,0)}s.blitFramebuffer(0,0,at,pt,0,0,at,pt,Et,s.NEAREST),p===!0&&(fe.length=0,H.length=0,fe.push(s.COLOR_ATTACHMENT0+Ft),N.depthBuffer&&N.resolveDepthBuffer===!1&&(fe.push(_t),H.push(_t),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,H)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,fe))}if(i.bindFramebuffer(s.READ_FRAMEBUFFER,null),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),Ct)for(let Ft=0;Ft<A.length;Ft++){i.bindFramebuffer(s.FRAMEBUFFER,kt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ft,s.RENDERBUFFER,kt.__webglColorRenderbuffer[Ft]);const _e=a.get(A[Ft]).__webglTexture;i.bindFramebuffer(s.FRAMEBUFFER,kt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ft,s.TEXTURE_2D,_e,0)}i.bindFramebuffer(s.DRAW_FRAMEBUFFER,kt.__webglMultisampledFramebuffer)}else if(N.depthBuffer&&N.resolveDepthBuffer===!1&&p){const A=N.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[A])}}}function he(N){return Math.min(l.maxSamples,N.samples)}function ge(N){const A=a.get(N);return N.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&A.__useRenderToTexture!==!1}function Yt(N){const A=f.render.frame;g.get(N)!==A&&(g.set(N,A),N.update())}function Le(N,A){const at=N.colorSpace,pt=N.format,Et=N.type;return N.isCompressedTexture===!0||N.isVideoTexture===!0||at!==Rs&&at!==Ga&&(we.getTransfer(at)===Ge?(pt!==Ti||Et!==ca)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",at)),A}function Wt(N){return typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement?(m.width=N.naturalWidth||N.width,m.height=N.naturalHeight||N.height):typeof VideoFrame<"u"&&N instanceof VideoFrame?(m.width=N.displayWidth,m.height=N.displayHeight):(m.width=N.width,m.height=N.height),m}this.allocateTextureUnit=$,this.resetTextureUnits=nt,this.setTexture2D=gt,this.setTexture2DArray=U,this.setTexture3D=V,this.setTextureCube=I,this.rebindTextures=qt,this.setupRenderTarget=Ue,this.updateRenderTargetMipmap=be,this.updateMultisampleRenderTarget=Tn,this.setupDepthRenderbuffer=Ht,this.setupFrameBufferTexture=St,this.useMultisampledRTT=ge}function q1(s,t){function i(a,l=Ga){let c;const f=we.getTransfer(l);if(a===ca)return s.UNSIGNED_BYTE;if(a===Pd)return s.UNSIGNED_SHORT_4_4_4_4;if(a===Fd)return s.UNSIGNED_SHORT_5_5_5_1;if(a===c0)return s.UNSIGNED_INT_5_9_9_9_REV;if(a===o0)return s.BYTE;if(a===l0)return s.SHORT;if(a===Bo)return s.UNSIGNED_SHORT;if(a===zd)return s.INT;if(a===br)return s.UNSIGNED_INT;if(a===sa)return s.FLOAT;if(a===Vo)return s.HALF_FLOAT;if(a===u0)return s.ALPHA;if(a===f0)return s.RGB;if(a===Ti)return s.RGBA;if(a===h0)return s.LUMINANCE;if(a===d0)return s.LUMINANCE_ALPHA;if(a===Ho)return s.DEPTH_COMPONENT;if(a===Go)return s.DEPTH_STENCIL;if(a===p0)return s.RED;if(a===Bd)return s.RED_INTEGER;if(a===m0)return s.RG;if(a===Id)return s.RG_INTEGER;if(a===Hd)return s.RGBA_INTEGER;if(a===wc||a===Dc||a===Uc||a===Lc)if(f===Ge)if(c=t.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(a===wc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(a===Dc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(a===Uc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(a===Lc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=t.get("WEBGL_compressed_texture_s3tc"),c!==null){if(a===wc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===Dc)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===Uc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===Lc)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(a===ad||a===rd||a===sd||a===od)if(c=t.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(a===ad)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(a===rd)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(a===sd)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(a===od)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(a===ld||a===cd||a===ud)if(c=t.get("WEBGL_compressed_texture_etc"),c!==null){if(a===ld||a===cd)return f===Ge?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(a===ud)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(a===fd||a===hd||a===dd||a===pd||a===md||a===gd||a===_d||a===vd||a===yd||a===xd||a===Sd||a===Md||a===Ed||a===Td)if(c=t.get("WEBGL_compressed_texture_astc"),c!==null){if(a===fd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(a===hd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(a===dd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(a===pd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(a===md)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(a===gd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(a===_d)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(a===vd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(a===yd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(a===xd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(a===Sd)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(a===Md)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(a===Ed)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(a===Td)return f===Ge?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(a===Nc||a===bd||a===Ad)if(c=t.get("EXT_texture_compression_bptc"),c!==null){if(a===Nc)return f===Ge?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(a===bd)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(a===Ad)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(a===g0||a===Rd||a===Cd||a===wd)if(c=t.get("EXT_texture_compression_rgtc"),c!==null){if(a===Nc)return c.COMPRESSED_RED_RGTC1_EXT;if(a===Rd)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(a===Cd)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(a===wd)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return a===Io?s.UNSIGNED_INT_24_8:s[a]!==void 0?s[a]:null}return{convert:i}}const Y1=`
void main() {
...
}`;class Z1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i,a){if(this.texture===null){const l=new Wn,c=t.properties.get(l);c.__webglTexture=i.texture,(i.depthNear!==a.depthNear||i.depthFar!==a.depthFar)&&(this.depthNear=i.depthNear,this.depthFar=i.depthFar),this.texture=l}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,a=new qa({vertexShader:Y1,fragmentShader:j1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new ei(new Vc(20,20),a)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class K1 extends Ds{constructor(t,i){super();const a=this;let l=null,c=1,f=null,h="local-floor",p=1,m=null,g=null,_=null,v=null,S=null,E=null;const T=new Z1,M=i.getContextAttributes();let y=null,P=null;const L=[],w=[],X=new te;let F=null;const z=new di;z.viewport=new tn;const W=new di;W.viewport=new tn;const D=[z,W],R=new _E;let G=null,nt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let ct=L[q];return ct===void 0&&(ct=new Ah,L[q]=ct),ct.getTargetRaySpace()},this.getControllerGrip=function(q){let ct=L[q];return ct===void 0&&(ct=new Ah,L[q]=ct),ct.getGripSpace()},this.getHand=function(q){let ct=L[q];return ct===void 0&&(ct=new Ah,L[q]=ct),ct.getHandSpace()};function $(q){const ct=w.indexOf(q.inputSource);if(ct===-1)return;const St=L[ct];St!==void 0&&(St.update(q.inputSource,q.frame,m||f),St.dispatchEvent({type:q.type,data:q.inputSource}))}function lt(){l.removeEventListener("select",$),l.removeEventListener("selectstart",$),l.removeEventListener("selectend",$),l.removeEventListener("squeeze",$),l.removeEventListener("squeezestart",$),l.removeEventListener("squeezeend",$),l.removeEventListener("end",lt),l.removeEventListener("inputsourceschange",gt);for(let q=0;q<L.length;q++){const ct=w[q];ct!==null&&(w[q]=null,L[q].disconnect(ct))}G=null,nt=null,T.reset(),t.setRenderTarget(y),S=null,v=null,_=null,l=null,P=null,ht.stop(),a.isPresenting=!1,t.setPixelRatio(F),t.setSize(X.width,X.height,!1),a.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){c=q,a.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){h=q,a.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return m||f},this.setReferenceSpace=function(q){m=q},this.getBaseLayer=function(){return v!==null?v:S},this.getBinding=function(){return _},this.getFrame=function(){return E},this.getSession=function(){return l},this.setSession=async function(q){if(l=q,l!==null){if(y=t.getRenderTarget(),l.addEventListener("select",$),l.addEventListener("selectstart",$),l.addEventListener("selectend",$),l.addEventListener("squeeze",$),l.addEventListener("squeezestart",$),l.addEventListener("squeezeend",$),l.addEventListener("end",lt),l.addEventListener("inputsourceschange",gt),M.xrCompatible!==!0&&await i.makeXRCompatible(),F=t.getPixelRatio(),t.getSize(X),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let St=null,Mt=null,Pt=null;M.depth&&(Pt=M.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,St=M.stencil?Go:Ho,Mt=M.stencil?Io:br);const Ht={colorFormat:i.RGBA8,depthFormat:Pt,scaleFactor:c};_=new XRWebGLBinding(l,i),v=_.createProjectionLayer(Ht),l.updateRenderState({layers:[v]}),t.setPixelRatio(1),t.setSize(v.textureWidth,v.textureHeight,!1),P=new Ar(v.textureWidth,v.textureHeight,{format:Ti,type:ca,depthTexture:new R0(v.textureWidth,v.textureHeight,Mt,void 0,void 0,void 0,void 0,void 0,void 0,St),stencilBuffer:M.stencil,colorSpace:t.outputColorSpace,samples:M.antialias?4:0,resolveDepthBuffer:v.ignoreDepthValues===!1,resolveStencilBuffer:v.ignoreDepthValues===!1})}else{const St={antialias:M.antialias,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:c};S=new XRWebGLLayer(l,i,St),l.updateRenderState({baseLayer:S}),t.setPixelRatio(1),t.setSize(S.framebufferWidth,S.framebufferHeight,!1),P=new Ar(S.framebufferWidth,S.framebufferHeight,{format:Ti,type:ca,colorSpace:t.outputColorSpace,stencilBuffer:M.stencil,resolveDepthBuffer:S.ignoreDepthValues===!1,resolveStencilBuffer:S.ignoreDepthValues===!1})}P.isXRRenderTarget=!0,this.setFoveation(p),m=null,f=await l.requestReferenceSpace(h),ht.setContext(l),ht.start(),a.isPresenting=!0,a.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return T.getDepthTexture()};function gt(q){for(let ct=0;ct<q.removed.length;ct++){const St=q.removed[ct],Mt=w.indexOf(St);Mt>=0&&(w[Mt]=null,L[Mt].disconnect(St))}for(let ct=0;ct<q.added.length;ct++){const St=q.added[ct];let Mt=w.indexOf(St);if(Mt===-1){for(let Ht=0;Ht<L.length;Ht++)if(Ht>=w.length){w.push(St),Mt=Ht;break}else if(w[Ht]===null){w[Ht]=St,Mt=Ht;break}if(Mt===-1)break}const Pt=L[Mt];Pt&&Pt.connect(St)}}const U=new Q,V=new Q;function I(q,ct,St){U.setFromMatrixPosition(ct.matrixWorld),V.setFromMatrixPosition(St.matrixWorld);const Mt=U.distanceTo(V),Pt=ct.projectionMatrix.elements,Ht=St.projectionMatrix.elements,qt=Pt[14]/(Pt[10]-1),Ue=Pt[14]/(Pt[10]+1),be=(Pt[9]+1)/Pt[5],fe=(Pt[9]-1)/Pt[5],H=(Pt[8]-1)/Pt[0],Tn=(Ht[8]+1)/Ht[0],he=qt*H,ge=qt*Tn,Yt=Mt/(-H+Tn),Le=Yt*-H;if(ct.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(Le),q.translateZ(Yt),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),Pt[10]===-1)q.projectionMatrix.copy(ct.projectionMatrix),q.projectionMatrixInverse.copy(ct.projectionMatrixInverse);else{const Wt=qt+Yt,N=Ue+Yt,A=he-Le,at=ge+(Mt-Le),pt=be*Ue/N*Wt,Et=fe*Ue/N*Wt;q.projectionMatrix.makePerspective(A,at,pt,Et,Wt,N),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function ft(q,ct){ct===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(ct.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(l===null)return;let ct=q.near,St=q.far;T.texture!==null&&(T.depthNear>0&&(ct=T.depthNear),T.depthFar>0&&(St=T.depthFar)),R.near=W.near=z.near=ct,R.far=W.far=z.far=St,(G!==R.near||nt!==R.far)&&(l.updateRenderState({depthNear:R.near,depthFar:R.far}),G=R.near,nt=R.far),z.layers.mask=q.layers.mask|2,W.layers.mask=q.layers.mask|4,R.layers.mask=z.layers.mask|W.layers.mask;const Mt=q.parent,Pt=R.cameras;ft(R,Mt);for(let Ht=0;Ht<Pt.length;Ht++)ft(Pt[Ht],Mt);Pt.length===2?I(R,z,W):R.projectionMatrix.copy(z.projectionMatrix),xt(q,R,Mt)};function xt(q,ct,St){St===null?q.matrix.copy(ct.matrixWorld):(q.matrix.copy(St.matrixWorld),q.matrix.invert(),q.matrix.multiply(ct.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(ct.projectionMatrix),q.projectionMatrixInverse.copy(ct.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=Dd*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return R},this.getFoveation=function(){if(!(v===null&&S===null))return p},this.setFoveation=function(q){p=q,v!==null&&(v.fixedFoveation=q),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=q)},this.hasDepthSensing=function(){return T.texture!==null},this.getDepthSensingMesh=function(){return T.getMesh(R)};let O=null;function J(q,ct){if(g=ct.getViewerPose(m||f),E=ct,g!==null){const St=g.views;S!==null&&(t.setRenderTargetFramebuffer(P,S.framebuffer),t.setRenderTarget(P));let Mt=!1;St.length!==R.cameras.length&&(R.cameras.length=0,Mt=!0);for(let qt=0;qt<St.length;qt++){const Ue=St[qt];let be=null;if(S!==null)be=S.getViewport(Ue);else{const H=_.getViewSubImage(v,Ue);be=H.viewport,qt===0&&(t.setRenderTargetTextures(P,H.colorTexture,H.depthStencilTexture),t.setRenderTarget(P))}let fe=D[qt];fe===void 0&&(fe=new di,fe.layers.enable(qt),fe.viewport=new tn,D[qt]=fe),fe.matrix.fromArray(Ue.transform.matrix),fe.matrix.decompose(fe.position,fe.quaternion,fe.scale),fe.projectionMatrix.fromArray(Ue.projectionMatrix),fe.projectionMatrixInverse.copy(fe.projectionMatrix).invert(),fe.viewport.set(be.x,be.y,be.width,be.height),qt===0&&(R.matrix.copy(fe.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale)),Mt===!0&&R.cameras.push(fe)}const Pt=l.enabledFeatures;if(Pt&&Pt.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&_){const qt=_.getDepthInformation(St[0]);qt&&qt.isValid&&qt.texture&&T.init(t,qt,l.renderState)}}for(let St=0;St<L.length;St++){const Mt=w[St],Pt=L[St];Mt!==null&&Pt!==void 0&&Pt.update(Mt,ct,m||f)}O&&O(q,ct),ct.detectedPlanes&&a.dispatchEvent({type:"planesdetected",data:ct}),E=null}const ht=new N0;ht.setAnimationLoop(J),this.setAnimationLoop=function(q){O=q},this.dispose=function(){}}}const _r=new ua,Q1=new Ze;function J1(s,t){function i(M,y){M.matrixAutoUpdate===!0&&M.updateMatrix(),y.value.copy(M.matrix)}function a(M,y){y.color.getRGB(M.fogColor.value,T0(s)),y.isFog?(M.fogNear.value=y.near,M.fogFar.value=y.far):y.isFogExp2&&(M.fogDensity.value=y.density)}function l(M,y,P,L,w){y.isMeshBasicMaterial||y.isMeshLambertMaterial?c(M,y):y.isMeshToonMaterial?(c(M,y),_(M,y)):y.isMeshPhongMaterial?(c(M,y),g(M,y)):y.isMeshStandardMaterial?(c(M,y),v(M,y),y.isMeshPhysicalMaterial&&S(M,y,w)):y.isMeshMatcapMaterial?(c(M,y),E(M,y)):y.isMeshDepthMaterial?c(M,y):y.isMeshDistanceMaterial?(c(M,y),T(M,y)):y.isMeshNormalMaterial?c(M,y):y.isLineBasicMaterial?(f(M,y),y.isLineDashedMaterial&&h(M,y)):y.isPointsMaterial?p(M,y,P,L):y.isSpriteMaterial?m(M,y):y.isShadowMaterial?(M.color.value.copy(y.color),M.opacity.value=y.opacity):y.isShaderMaterial&&(y.uniformsNeedUpdate=!1)}function c(M,y){M.opacity.value=y.opacity,y.color&&M.diffuse.value.copy(y.color),y.emissive&&M.emissive.value.copy(y.emissive).multiplyScalar(y.emissiveIntensity),y.map&&(M.map.value=y.map,i(y.map,M.mapTransform)),y.alphaMap&&(M.alphaMap.value=y.alphaMap,i(y.alphaMap,M.alphaMapTransform)),y.bumpMap&&(M.bumpMap.value=y.bumpMap,i(y.bumpMap,M.bumpMapTransform),M.bumpScale.value=y.bumpScale,y.side===Xn&&(M.bumpScale.value*=-1)),y.normalMap&&(M.normalMap.value=y.normalMap,i(y.normalMap,M.normalMapTransform),M.normalScale.value.copy(y.normalScale),y.side===Xn&&M.normalScale.value.negate()),y.displacementMap&&(M.displacementMap.value=y.displacementMap,i(y.displacementMap,M.displacementMapTransform),M.displacementScale.value=y.displacementScale,M.displacementBias.value=y.displacementBias),y.emissiveMap&&(M.emissiveMap.value=y.emissiveMap,i(y.emissiveMap,M.emissiveMapTransform)),y.specularMap&&(M.specularMap.value=y.specularMap,i(y.specularMap,M.specularMapTransform)),y.alphaTest>0&&(M.alphaTest.value=y.alphaTest);const P=t.get(y),L=P.envMap,w=P.envMapRotation;L&&(M.envMap.value=L,_r.copy(w),_r.x*=-1,_r.y*=-1,_r.z*=-1,L.isCubeTexture&&L.isRenderTargetTexture===!1&&(_r.y*=-1,_r.z*=-1),M.envMapRotation.value.setFromMatrix4(Q1.makeRotationFromEuler(_r)),M.flipEnvMap.value=L.isCubeTexture&&L.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=y.reflectivity,M.ior.value=y.ior,M.refractionRatio.value=y.refractionRatio),y.lightMap&&(M.lightMap.value=y.lightMap,M.lightMapIntensity.value=y.lightMapIntensity,i(y.lightMap,M.lightMapTransform)),y.aoMap&&(M.aoMap.value=y.aoMap,M.aoMapIntensity.value=y.aoMapIntensity,i(y.aoMap,M.aoMapTransform))}function f(M,y){M.diffuse.value.copy(y.color),M.opacity.value=y.opacity,y.map&&(M.map.value=y.map,i(y.map,M.mapTransform))}function h(M,y){M.dashSize.value=y.dashSize,M.totalSize.value=y.dashSize+y.gapSize,M.scale.value=y.scale}function p(M,y,P,L){M.diffuse.value.copy(y.color),M.opacity.value=y.opacity,M.size.value=y.size*P,M.scale.value=L*.5,y.map&&(M.map.value=y.map,i(y.map,M.uvTransform)),y.alphaMap&&(M.alphaMap.value=y.alphaMap,i(y.alphaMap,M.alphaMapTransform)),y.alphaTest>0&&(M.alphaTest.value=y.alphaTest)}function m(M,y){M.diffuse.value.copy(y.color),M.opacity.value=y.opacity,M.rotation.value=y.rotation,y.map&&(M.map.value=y.map,i(y.map,M.mapTransform)),y.alphaMap&&(M.alphaMap.value=y.alphaMap,i(y.alphaMap,M.alphaMapTransform)),y.alphaTest>0&&(M.alphaTest.value=y.alphaTest)}function g(M,y){M.specular.value.copy(y.specular),M.shininess.value=Math.max(y.shininess,1e-4)}function _(M,y){y.gradientMap&&(M.gradientMap.value=y.gradientMap)}function v(M,y){M.metalness.value=y.metalness,y.metalnessMap&&(M.metalnessMap.value=y.metalnessMap,i(y.metalnessMap,M.metalnessMapTransform)),M.roughness.value=y.roughness,y.roughnessMap&&(M.roughnessMap.value=y.roughnessMap,i(y.roughnessMap,M.roughnessMapTransform)),y.envMap&&(M.envMapIntensity.value=y.envMapIntensity)}function S(M,y,P){M.ior.value=y.ior,y.sheen>0&&(M.sheenColor.value.copy(y.sheenColor).multiplyScalar(y.sheen),M.sheenRoughness.value=y.sheenRoughness,y.sheenColorMap&&(M.sheenColorMap.value=y.sheenColorMap,i(y.sheenColorMap,M.sheenColorMapTransform)),y.sheenRoughnessMap&&(M.sheenRoughnessMap.value=y.sheenRoughnessMap,i(y.sheenRoughnessMap,M.sheenRoughnessMapTransform))),y.clearcoat>0&&(M.clearcoat.value=y.clearcoat,M.clearcoatRoughness.value=y.clearcoatRoughness,y.clearcoatMap&&(M.clearcoatMap.value=y.clearcoatMap,i(y.clearcoatMap,M.clearcoatMapTransform)),y.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=y.clearcoatRoughnessMap,i(y.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),y.clearcoatNormalMap&&(M.clearcoatNormalMap.value=y.clearcoatNormalMap,i(y.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(y.clearcoatNormalScale),y.side===Xn&&M.clearcoatNormalScale.value.negate())),y.dispersion>0&&(M.dispersion.value=y.dispersion),y.iridescence>0&&(M.iridescence.value=y.iridescence,M.iridescenceIOR.value=y.iridescenceIOR,M.iridescenceThicknessMinimum.value=y.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=y.iridescenceThicknessRange[1],y.iridescenceMap&&(M.iridescenceMap.value=y.iridescenceMap,i(y.iridescenceMap,M.iridescenceMapTransform)),y.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=y.iridescenceThicknessMap,i(y.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),y.transmission>0&&(M.transmission.value=y.transmission,M.transmissionSamplerMap.value=P.texture,M.transmissionSamplerSize.value.set(P.width,P.height),y.transmissionMap&&(M.transmissionMap.value=y.transmissionMap,i(y.transmissionMap,M.transmissionMapTransform)),M.thickness.value=y.thickness,y.thicknessMap&&(M.thicknessMap.value=y.thicknessMap,i(y.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=y.attenuationDistance,M.attenuationColor.value.copy(y.attenuationColor)),y.anisotropy>0&&(M.anisotropyVector.value.set(y.anisotropy*Math.cos(y.anisotropyRotation),y.anisotropy*Math.sin(y.anisotropyRotation)),y.anisotropyMap&&(M.anisotropyMap.value=y.anisotropyMap,i(y.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=y.specularIntensity,M.specularColor.value.copy(y.specularColor),y.specularColorMap&&(M.specularColorMap.value=y.specularColorMap,i(y.specularColorMap,M.specularColorMapTransform)),y.specularIntensityMap&&(M.specularIntensityMap.value=y.specularIntensityMap,i(y.specularIntensityMap,M.specularIntensityMapTransform))}function E(M,y){y.matcap&&(M.matcap.value=y.matcap)}function T(M,y){const P=t.get(y).light;M.referencePosition.value.setFromMatrixPosition(P.matrixWorld),M.nearDistance.value=P.shadow.camera.near,M.farDistance.value=P.shadow.camera.far}return{refreshFogUniforms:a,refreshMaterialUniforms:l}}function $1(s,t,i,a){let l={},c={},f=[];const h=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function p(P,L){const w=L.program;a.uniformBlockBinding(P,w)}function m(P,L){let w=l[P.id];w===void 0&&(E(P),w=g(P),l[P.id]=w,P.addEventListener("dispose",M));const X=L.program;a.updateUBOMapping(P,X);const F=t.render.frame;c[P.id]!==F&&(v(P),c[P.id]=F)}function g(P){const L=_();P.__bindingPointIndex=L;const w=s.createBuffer(),X=P.__size,F=P.usage;return s.bindBuffer(s.UNIFORM_BUFFER,w),s.bufferData(s.UNIFORM_BUFFER,X,F),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,L,w),w}function _(){for(let P=0;P<h;P++)if(f.indexOf(P)===-1)return f.push(P),P;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function v(P){const L=l[P.id],w=P.uniforms,X=P.__cache;s.bindBuffer(s.UNIFORM_BUFFER,L);for(let F=0,z=w.length;F<z;F++){const W=Array.isArray(w[F])?w[F]:[w[F]];for(let D=0,R=W.length;D<R;D++){const G=W[D];if(S(G,F,D,X)===!0){const nt=G.__offset,$=Array.isArray(G.value)?G.value:[G.value];let lt=0;for(let gt=0;gt<$.length;gt++){const U=$[gt],V=T(U);typeof U=="number"||typeof U=="boolean"?(G.__data[0]=U,s.bufferSubData(s.UNIFORM_BUFFER,nt+lt,G.__data)):U.isMatrix3?(G.__data[0]=U.elements[0],G.__data[1]=U.elements[1],G.__data[2]=U.elements[2],G.__data[3]=0,G.__data[4]=U.elements[3],G.__data[5]=U.elements[4],G.__data[6]=U.elements[5],G.__data[7]=0,G.__data[8]=U.elements[6],G.__data[9]=U.elements[7],G.__data[10]=U.elements[8],G.__data[11]=0):(U.toArray(G.__data,lt),lt+=V.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,nt,G.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function S(P,L,w,X){const F=P.value,z=L+"_"+w;if(X[z]===void 0)return typeof F=="number"||typeof F=="boolean"?X[z]=F:X[z]=F.clone(),!0;{const W=X[z];if(typeof F=="number"||typeof F=="boolean"){if(W!==F)return X[z]=F,!0}else if(W.equals(F)===!1)return W.copy(F),!0}return!1}function E(P){const L=P.uniforms;let w=0;const X=16;for(let z=0,W=L.length;z<W;z++){const D=Array.isArray(L[z])?L[z]:[L[z]];for(let R=0,G=D.length;R<G;R++){const nt=D[R],$=Array.isArray(nt.value)?nt.value:[nt.value];for(let lt=0,gt=$.length;lt<gt;lt++){const U=$[lt],V=T(U),I=w%X,ft=I%V.boundary,xt=I+ft;w+=ft,xt!==0&&X-xt<V.storage&&(w+=X-xt),nt.__data=new Float32Array(V.storage/Float32Array.BYTES_PER_ELEMENT),nt.__offset=w,w+=V.storage}}}const F=w%X;return F>0&&(w+=X-F),P.__size=w,P.__cache={},this}function T(P){const L={boundary:0,storage:0};return typeof P=="number"||typeof P=="boolean"?(L.boundary=4,L.storage=4):P.isVector2?(L.boundary=8,L.storage=8):P.isVector3||P.isColor?(L.boundary=16,L.storage=12):P.isVector4?(L.boundary=16,L.storage=16):P.isMatrix3?(L.boundary=48,L.storage=48):P.isMatrix4?(L.boundary=64,L.storage=64):P.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",P),L}function M(P){const L=P.target;L.removeEventListener("dispose",M);const w=f.indexOf(L.__bindingPointIndex);f.splice(w,1),s.deleteBuffer(l[L.id]),delete l[L.id],delete c[L.id]}function y(){for(const P in l)s.deleteBuffer(l[P]);f=[],l={},c={}}return{bind:p,update:m,dispose:y}}class tR{constructor(t={}){const{canvas:i=vM(),context:a=null,depth:l=!0,stencil:c=!1,alpha:f=!1,antialias:h=!1,premultipliedAlpha:p=!0,preserveDrawingBuffer:m=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1,reverseDepthBuffer:v=!1}=t;this.isWebGLRenderer=!0;let S;if(a!==null){if(typeof WebGLRenderingContext<"u"&&a instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");S=a.getContextAttributes().alpha}else S=f;const E=new Uint32Array(4),T=new Int32Array(4);let M=null,y=null;const P=[],L=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ka,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const w=this;let X=!1;this._outputColorSpace=hi;let F=0,z=0,W=null,D=-1,R=null;const G=new tn,nt=new tn;let $=null;const lt=new ze(0);let gt=0,U=i.width,V=i.height,I=1,ft=null,xt=null;const O=new tn(0,0,U,V),J=new tn(0,0,U,V);let ht=!1;const q=new kd;let ct=!1,St=!1;const Mt=new Ze,Pt=new Ze,Ht=new Q,qt=new tn,Ue={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let be=!1;function fe(){return W===null?I:1}let H=a;function Tn(C,Z){return i.getContext(C,Z)}try{const C={alpha:!0,depth:l,stencil:c,antialias:h,premultipliedAlpha:p,preserveDrawingBuffer:m,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${Od}`),i.addEventListener("webglcontextlost",yt,!1),i.addEventListener("webglcontextrestored",Rt,!1),i.addEventListener("webglcontextcreationerror",Dt,!1),H===null){const Z="webgl2";if(H=Tn(Z,C),H===null)throw Tn(Z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(C){throw console.error("THREE.WebGLRenderer: "+C.message),C}let he,ge,Yt,Le,Wt,N,A,at,pt,Et,_t,kt,Ct,Ft,_e,bt,Bt,Qt,Xt,Ot,ee,se,Pe,j;function wt(){he=new uA(H),he.init(),se=new q1(H,he),ge=new iA(H,he,t,se),Yt=new X1(H,he),ge.reverseDepthBuffer&&v&&Yt.buffers.depth.setReversed(!0),Le=new dA(H),Wt=new U1,N=new W1(H,he,Yt,Wt,ge,se,Le),A=new rA(w),at=new cA(w),pt=new yE(H),Pe=new eA(H,pt),Et=new fA(H,pt,Le,Pe),_t=new mA(H,Et,pt,Le),Xt=new pA(H,ge,N),bt=new aA(Wt),kt=new D1(w,A,at,he,ge,Pe,bt),Ct=new J1(w,Wt),Ft=new N1,_e=new I1(he),Qt=new tA(w,A,at,Yt,_t,S,p),Bt=new V1(w,_t,ge),j=new $1(H,Le,ge,Yt),Ot=new nA(H,he,Le),ee=new hA(H,he,Le),Le.programs=kt.programs,w.capabilities=ge,w.extensions=he,w.properties=Wt,w.renderLists=Ft,w.shadowMap=Bt,w.state=Yt,w.info=Le}wt();const ut=new K1(w,H);this.xr=ut,this.getContext=function(){return H},this.getContextAttributes=function(){return H.getContextAttributes()},this.forceContextLoss=function(){const C=he.get("WEBGL_lose_context");C&&C.loseContext()},this.forceContextRestore=function(){const C=he.get("WEBGL_lose_context");C&&C.restoreContext()},this.getPixelRatio=function(){return I},this.setPixelRatio=function(C){C!==void 0&&(I=C,this.setSize(U,V,!1))},this.getSize=function(C){return C.set(U,V)},this.setSize=function(C,Z,rt=!0){if(ut.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}U=C,V=Z,i.width=Math.floor(C*I),i.height=Math.floor(Z*I),rt===!0&&(i.style.width=C+"px",i.style.height=Z+"px"),this.setViewport(0,0,C,Z)},this.getDrawingBufferSize=function(C){return C.set(U*I,V*I).floor()},this.setDrawingBufferSize=function(C,Z,rt){U=C,V=Z,I=rt,i.width=Math.floor(C*rt),i.height=Math.floor(Z*rt),this.setViewport(0,0,C,Z)},this.getCurrentViewport=function(C){return C.copy(G)},this.getViewport=function(C){return C.copy(O)},this.setViewport=function(C,Z,rt,st){C.isVector4?O.set(C.x,C.y,C.z,C.w):O.set(C,Z,rt,st),Yt.viewport(G.copy(O).multiplyScalar(I).round())},this.getScissor=function(C){return C.copy(J)},this.setScissor=function(C,Z,rt,st){C.isVector4?J.set(C.x,C.y,C.z,C.w):J.set(C,Z,rt,st),Yt.scissor(nt.copy(J).multiplyScalar(I).round())},this.getScissorTest=function(){return ht},this.setScissorTest=function(C){Yt.setScissorTest(ht=C)},this.setOpaqueSort=function(C){ft=C},this.setTransparentSort=function(C){xt=C},this.getClearColor=function(C){return C.copy(Qt.getClearColor())},this.setClearColor=function(){Qt.setClearColor(...arguments)},this.getClearAlpha=function(){return Qt.getClearAlpha()},this.setClearAlpha=function(){Qt.setClearAlpha(...arguments)},this.clear=function(C=!0,Z=!0,rt=!0){let st=0;if(C){let Y=!1;if(W!==null){const Tt=W.texture.format;Y=Tt===Hd||Tt===Id||Tt===Bd}if(Y){const Tt=W.texture.type,Ut=Tt===ca||Tt===br||Tt===Bo||Tt===Io||Tt===Pd||Tt===Fd,Nt=Qt.getClearColor(),zt=Qt.getClearAlpha(),ie=Nt.r,$t=Nt.g,jt=Nt.b;Ut?(E[0]=ie,E[1]=$t,E[2]=jt,E[3]=zt,H.clearBufferuiv(H.COLOR,0,E)):(T[0]=ie,T[1]=$t,T[2]=jt,T[3]=zt,H.clearBufferiv(H.COLOR,0,T))}else st|=H.COLOR_BUFFER_BIT}Z&&(st|=H.DEPTH_BUFFER_BIT),rt&&(st|=H.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H.clear(st)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",yt,!1),i.removeEventListener("webglcontextrestored",Rt,!1),i.removeEventListener("webglcontextcreationerror",Dt,!1),Qt.dispose(),Ft.dispose(),_e.dispose(),Wt.dispose(),A.dispose(),at.dispose(),_t.dispose(),Pe.dispose(),j.dispose(),kt.dispose(),ut.dispose(),ut.removeEventListener("sessionstart",Ns),ut.removeEventListener("sessionend",Os),Ai.stop()};function yt(C){C.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),X=!0}function Rt(){console.log("THREE.WebGLRenderer: Context Restored."),X=!1;const C=Le.autoReset,Z=Bt.enabled,rt=Bt.autoUpdate,st=Bt.needsUpdate,Y=Bt.type;wt(),Le.autoReset=C,Bt.enabled=Z,Bt.autoUpdate=rt,Bt.needsUpdate=st,Bt.type=Y}function Dt(C){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",C.statusMessage)}function ne(C){const Z=C.target;Z.removeEventListener("dispose",ne),Ye(Z)}function Ye(C){cn(C),Wt.remove(C)}function cn(C){const Z=Wt.get(C).programs;Z!==void 0&&(Z.forEach(function(rt){kt.releaseProgram(rt)}),C.isShaderMaterial&&kt.releaseShaderCache(C))}this.renderBufferDirect=function(C,Z,rt,st,Y,Tt){Z===null&&(Z=Ue);const Ut=Y.isMesh&&Y.matrixWorld.determinant()<0,Nt=Ps(C,Z,rt,st,Y);Yt.setMaterial(st,Ut);let zt=rt.index,ie=1;if(st.wireframe===!0){if(zt=Et.getWireframeAttribute(rt),zt===void 0)return;ie=2}const $t=rt.drawRange,jt=rt.attributes.position;let xe=$t.start*ie,Se=($t.start+$t.count)*ie;Tt!==null&&(xe=Math.max(xe,Tt.start*ie),Se=Math.min(Se,(Tt.start+Tt.count)*ie)),zt!==null?(xe=Math.max(xe,0),Se=Math.min(Se,zt.count)):jt!=null&&(xe=Math.max(xe,0),Se=Math.min(Se,jt.count));const ke=Se-xe;if(ke<0||ke===1/0)return;Pe.setup(Y,st,Nt,rt,zt);let Ae,ae=Ot;if(zt!==null&&(Ae=pt.get(zt),ae=ee,ae.setIndex(Ae)),Y.isMesh)st.wireframe===!0?(Yt.setLineWidth(st.wireframeLinewidth*fe()),ae.setMode(H.LINES)):ae.setMode(H.TRIANGLES);else if(Y.isLine){let Kt=st.linewidth;Kt===void 0&&(Kt=1),Yt.setLineWidth(Kt*fe()),Y.isLineSegments?ae.setMode(H.LINES):Y.isLineLoop?ae.setMode(H.LINE_LOOP):ae.setMode(H.LINE_STRIP)}else Y.isPoints?ae.setMode(H.POINTS):Y.isSprite&&ae.setMode(H.TRIANGLES);if(Y.isBatchedMesh)if(Y._multiDrawInstances!==null)Oc("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ae.renderMultiDrawInstances(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount,Y._multiDrawInstances);else if(he.get("WEBGL_multi_draw"))ae.renderMultiDraw(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount);else{const Kt=Y._multiDrawStarts,un=Y._multiDrawCounts,Ee=Y._multiDrawCount,zn=zt?pt.get(zt).bytesPerElement:1,gi=Wt.get(st).currentProgram.getUniforms();for(let Un=0;Un<Ee;Un++)gi.setValue(H,"_gl_DrawID",Un),ae.render(Kt[Un]/zn,un[Un])}else if(Y.isInstancedMesh)ae.renderInstances(xe,ke,Y.count);else if(rt.isInstancedBufferGeometry){const Kt=rt._maxInstanceCount!==void 0?rt._maxInstanceCount:1/0,un=Math.min(rt.instanceCount,Kt);ae.renderInstances(xe,ke,un)}else ae.render(xe,ke)};function Te(C,Z,rt){C.transparent===!0&&C.side===Li&&C.forceSinglePass===!1?(C.side=Xn,C.needsUpdate=!0,Ke(C,Z,rt),C.side=Wa,C.needsUpdate=!0,Ke(C,Z,rt),C.side=Li):Ke(C,Z,rt)}this.compile=function(C,Z,rt=null){rt===null&&(rt=C),y=_e.get(rt),y.init(Z),L.push(y),rt.traverseVisible(function(Y){Y.isLight&&Y.layers.test(Z.layers)&&(y.pushLight(Y),Y.castShadow&&y.pushShadow(Y))}),C!==rt&&C.traverseVisible(function(Y){Y.isLight&&Y.layers.test(Z.layers)&&(y.pushLight(Y),Y.castShadow&&y.pushShadow(Y))}),y.setupLights();const st=new Set;return C.traverse(function(Y){if(!(Y.isMesh||Y.isPoints||Y.isLine||Y.isSprite))return;const Tt=Y.material;if(Tt)if(Array.isArray(Tt))for(let Ut=0;Ut<Tt.length;Ut++){const Nt=Tt[Ut];Te(Nt,rt,Y),st.add(Nt)}else Te(Tt,rt,Y),st.add(Tt)}),y=L.pop(),st},this.compileAsync=function(C,Z,rt=null){const st=this.compile(C,Z,rt);return new Promise(Y=>{function Tt(){if(st.forEach(function(Ut){Wt.get(Ut).currentProgram.isReady()&&st.delete(Ut)}),st.size===0){Y(C);return}setTimeout(Tt,10)}he.get("KHR_parallel_shader_compile")!==null?Tt():setTimeout(Tt,10)})};let _n=null;function pi(C){_n&&_n(C)}function Ns(){Ai.stop()}function Os(){Ai.start()}const Ai=new N0;Ai.setAnimationLoop(pi),typeof self<"u"&&Ai.setContext(self),this.setAnimationLoop=function(C){_n=C,ut.setAnimationLoop(C),C===null?Ai.stop():Ai.start()},ut.addEventListener("sessionstart",Ns),ut.addEventListener("sessionend",Os),this.render=function(C,Z){if(Z!==void 0&&Z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(X===!0)return;if(C.matrixWorldAutoUpdate===!0&&C.updateMatrixWorld(),Z.parent===null&&Z.matrixWorldAutoUpdate===!0&&Z.updateMatrixWorld(),ut.enabled===!0&&ut.isPresenting===!0&&(ut.cameraAutoUpdate===!0&&ut.updateCamera(Z),Z=ut.getCamera()),C.isScene===!0&&C.onBeforeRender(w,C,Z,W),y=_e.get(C,L.length),y.init(Z),L.push(y),Pt.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),q.setFromProjectionMatrix(Pt),St=this.localClippingEnabled,ct=bt.init(this.clippingPlanes,St),M=Ft.get(C,P.length),M.init(),P.push(M),ut.enabled===!0&&ut.isPresenting===!0){const Tt=w.xr.getDepthSensingMesh();Tt!==null&&Ya(Tt,Z,-1/0,w.sortObjects)}Ya(C,Z,0,w.sortObjects),M.finish(),w.sortObjects===!0&&M.sort(ft,xt),be=ut.enabled===!1||ut.isPresenting===!1||ut.hasDepthSensing()===!1,be&&Qt.addToRenderList(M,C),this.info.render.frame++,ct===!0&&bt.beginShadows();const rt=y.state.shadowsArray;Bt.render(rt,C,Z),ct===!0&&bt.endShadows(),this.info.autoReset===!0&&this.info.reset();const st=M.opaque,Y=M.transmissive;if(y.setupLights(),Z.isArrayCamera){const Tt=Z.cameras;if(Y.length>0)for(let Ut=0,Nt=Tt.length;Ut<Nt;Ut++){const zt=Tt[Ut];zs(st,Y,C,zt)}be&&Qt.render(C);for(let Ut=0,Nt=Tt.length;Ut<Nt;Ut++){const zt=Tt[Ut];Rr(M,C,zt,zt.viewport)}}else Y.length>0&&zs(st,Y,C,Z),be&&Qt.render(C),Rr(M,C,Z);W!==null&&z===0&&(N.updateMultisampleRenderTarget(W),N.updateRenderTargetMipmap(W)),C.isScene===!0&&C.onAfterRender(w,C,Z),Pe.resetDefaultState(),D=-1,R=null,L.pop(),L.length>0?(y=L[L.length-1],ct===!0&&bt.setGlobalState(w.clippingPlanes,y.state.camera)):y=null,P.pop(),P.length>0?M=P[P.length-1]:M=null};function Ya(C,Z,rt,st){if(C.visible===!1)return;if(C.layers.test(Z.layers)){if(C.isGroup)rt=C.renderOrder;else if(C.isLOD)C.autoUpdate===!0&&C.update(Z);else if(C.isLight)y.pushLight(C),C.castShadow&&y.pushShadow(C);else if(C.isSprite){if(!C.frustumCulled||q.intersectsSprite(C)){st&&qt.setFromMatrixPosition(C.matrixWorld).applyMatrix4(Pt);const Ut=_t.update(C),Nt=C.material;Nt.visible&&M.push(C,Ut,Nt,rt,qt.z,null)}}else if((C.isMesh||C.isLine||C.isPoints)&&(!C.frustumCulled||q.intersectsObject(C))){const Ut=_t.update(C),Nt=C.material;if(st&&(C.boundingSphere!==void 0?(C.boundingSphere===null&&C.computeBoundingSphere(),qt.copy(C.boundingSphere.center)):(Ut.boundingSphere===null&&Ut.computeBoundingSphere(),qt.copy(Ut.boundingSphere.center)),qt.applyMatrix4(C.matrixWorld).applyMatrix4(Pt)),Array.isArray(Nt)){const zt=Ut.groups;for(let ie=0,$t=zt.length;ie<$t;ie++){const jt=zt[ie],xe=Nt[jt.materialIndex];xe&&xe.visible&&M.push(C,Ut,xe,rt,qt.z,jt)}}else Nt.visible&&M.push(C,Ut,Nt,rt,qt.z,null)}}const Tt=C.children;for(let Ut=0,Nt=Tt.length;Ut<Nt;Ut++)Ya(Tt[Ut],Z,rt,st)}function Rr(C,Z,rt,st){const Y=C.opaque,Tt=C.transmissive,Ut=C.transparent;y.setupLightsView(rt),ct===!0&&bt.setGlobalState(w.clippingPlanes,rt),st&&Yt.viewport(G.copy(st)),Y.length>0&&ja(Y,Z,rt),Tt.length>0&&ja(Tt,Z,rt),Ut.length>0&&ja(Ut,Z,rt),Yt.buffers.depth.setTest(!0),Yt.buffers.depth.setMask(!0),Yt.buffers.color.setMask(!0),Yt.setPolygonOffset(!1)}function zs(C,Z,rt,st){if((rt.isScene===!0?rt.overrideMaterial:null)!==null)return;y.state.transmissionRenderTarget[st.id]===void 0&&(y.state.transmissionRenderTarget[st.id]=new Ar(1,1,{generateMipmaps:!0,type:he.has("EXT_color_buffer_half_float")||he.has("EXT_color_buffer_float")?Vo:ca,minFilter:Er,samples:4,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:we.workingColorSpace}));const Tt=y.state.transmissionRenderTarget[st.id],Ut=st.viewport||G;Tt.setSize(Ut.z*w.transmissionResolutionScale,Ut.w*w.transmissionResolutionScale);const Nt=w.getRenderTarget();w.setRenderTarget(Tt),w.getClearColor(lt),gt=w.getClearAlpha(),gt<1&&w.setClearColor(16777215,.5),w.clear(),be&&Qt.render(rt);const zt=w.toneMapping;w.toneMapping=ka;const ie=st.viewport;if(st.viewport!==void 0&&(st.viewport=void 0),y.setupLightsView(st),ct===!0&&bt.setGlobalState(w.clippingPlanes,st),ja(C,rt,st),N.updateMultisampleRenderTarget(Tt),N.updateRenderTargetMipmap(Tt),he.has("WEBGL_multisampled_render_to_texture")===!1){let $t=!1;for(let jt=0,xe=Z.length;jt<xe;jt++){const Se=Z[jt],ke=Se.object,Ae=Se.geometry,ae=Se.material,Kt=Se.group;if(ae.side===Li&&ke.layers.test(st.layers)){const un=ae.side;ae.side=Xn,ae.needsUpdate=!0,mi(ke,rt,st,Ae,ae,Kt),ae.side=un,ae.needsUpdate=!0,$t=!0}}$t===!0&&(N.updateMultisampleRenderTarget(Tt),N.updateRenderTargetMipmap(Tt))}w.setRenderTarget(Nt),w.setClearColor(lt,gt),ie!==void 0&&(st.viewport=ie),w.toneMapping=zt}function ja(C,Z,rt){const st=Z.isScene===!0?Z.overrideMaterial:null;for(let Y=0,Tt=C.length;Y<Tt;Y++){const Ut=C[Y],Nt=Ut.object,zt=Ut.geometry,ie=Ut.group;let $t=Ut.material;$t.allowOverride===!0&&st!==null&&($t=st),Nt.layers.test(rt.layers)&&mi(Nt,Z,rt,zt,$t,ie)}}function mi(C,Z,rt,st,Y,Tt){C.onBeforeRender(w,Z,rt,st,Y,Tt),C.modelViewMatrix.multiplyMatrices(rt.matrixWorldInverse,C.matrixWorld),C.normalMatrix.getNormalMatrix(C.modelViewMatrix),Y.onBeforeRender(w,Z,rt,st,C,Tt),Y.transparent===!0&&Y.side===Li&&Y.forceSinglePass===!1?(Y.side=Xn,Y.needsUpdate=!0,w.renderBufferDirect(rt,Z,st,Y,C,Tt),Y.side=Wa,Y.needsUpdate=!0,w.renderBufferDirect(rt,Z,st,Y,C,Tt),Y.side=Li):w.renderBufferDirect(rt,Z,st,Y,C,Tt),C.onAfterRender(w,Z,rt,st,Y,Tt)}function Ke(C,Z,rt){Z.isScene!==!0&&(Z=Ue);const st=Wt.get(C),Y=y.state.lights,Tt=y.state.shadowsArray,Ut=Y.state.version,Nt=kt.getParameters(C,Y.state,Tt,Z,rt),zt=kt.getProgramCacheKey(Nt);let ie=st.programs;st.environment=C.isMeshStandardMaterial?Z.environment:null,st.fog=Z.fog,st.envMap=(C.isMeshStandardMaterial?at:A).get(C.envMap||st.environment),st.envMapRotation=st.environment!==null&&C.envMap===null?Z.environmentRotation:C.envMapRotation,ie===void 0&&(C.addEventListener("dispose",ne),ie=new Map,st.programs=ie);let $t=ie.get(zt);if($t!==void 0){if(st.currentProgram===$t&&st.lightsStateVersion===Ut)return Pi(C,Nt),$t}else Nt.uniforms=kt.getUniforms(C),C.onBeforeCompile(Nt,w),$t=kt.acquireProgram(Nt,zt),ie.set(zt,$t),st.uniforms=Nt.uniforms;const jt=st.uniforms;return(!C.isShaderMaterial&&!C.isRawShaderMaterial||C.clipping===!0)&&(jt.clippingPlanes=bt.uniform),Pi(C,Nt),st.needsLights=qc(C),st.lightsStateVersion=Ut,st.needsLights&&(jt.ambientLightColor.value=Y.state.ambient,jt.lightProbe.value=Y.state.probe,jt.directionalLights.value=Y.state.directional,jt.directionalLightShadows.value=Y.state.directionalShadow,jt.spotLights.value=Y.state.spot,jt.spotLightShadows.value=Y.state.spotShadow,jt.rectAreaLights.value=Y.state.rectArea,jt.ltc_1.value=Y.state.rectAreaLTC1,jt.ltc_2.value=Y.state.rectAreaLTC2,jt.pointLights.value=Y.state.point,jt.pointLightShadows.value=Y.state.pointShadow,jt.hemisphereLights.value=Y.state.hemi,jt.directionalShadowMap.value=Y.state.directionalShadowMap,jt.directionalShadowMatrix.value=Y.state.directionalShadowMatrix,jt.spotShadowMap.value=Y.state.spotShadowMap,jt.spotLightMatrix.value=Y.state.spotLightMatrix,jt.spotLightMap.value=Y.state.spotLightMap,jt.pointShadowMap.value=Y.state.pointShadowMap,jt.pointShadowMatrix.value=Y.state.pointShadowMatrix),st.currentProgram=$t,st.uniformsList=null,$t}function vn(C){if(C.uniformsList===null){const Z=C.currentProgram.getUniforms();C.uniformsList=zc.seqWithValue(Z.seq,C.uniforms)}return C.uniformsList}function Pi(C,Z){const rt=Wt.get(C);rt.outputColorSpace=Z.outputColorSpace,rt.batching=Z.batching,rt.batchingColor=Z.batchingColor,rt.instancing=Z.instancing,rt.instancingColor=Z.instancingColor,rt.instancingMorph=Z.instancingMorph,rt.skinning=Z.skinning,rt.morphTargets=Z.morphTargets,rt.morphNormals=Z.morphNormals,rt.morphColors=Z.morphColors,rt.morphTargetsCount=Z.morphTargetsCount,rt.numClippingPlanes=Z.numClippingPlanes,rt.numIntersection=Z.numClipIntersection,rt.vertexAlphas=Z.vertexAlphas,rt.vertexTangents=Z.vertexTangents,rt.toneMapping=Z.toneMapping}function Ps(C,Z,rt,st,Y){Z.isScene!==!0&&(Z=Ue),N.resetTextureUnits();const Tt=Z.fog,Ut=st.isMeshStandardMaterial?Z.environment:null,Nt=W===null?w.outputColorSpace:W.isXRRenderTarget===!0?W.texture.colorSpace:Rs,zt=(st.isMeshStandardMaterial?at:A).get(st.envMap||Ut),ie=st.vertexColors===!0&&!!rt.attributes.color&&rt.attributes.color.itemSize===4,$t=!!rt.attributes.tangent&&(!!st.normalMap||st.anisotropy>0),jt=!!rt.morphAttributes.position,xe=!!rt.morphAttributes.normal,Se=!!rt.morphAttributes.color;let ke=ka;st.toneMapped&&(W===null||W.isXRRenderTarget===!0)&&(ke=w.toneMapping);const Ae=rt.morphAttributes.position||rt.morphAttributes.normal||rt.morphAttributes.color,ae=Ae!==void 0?Ae.length:0,Kt=Wt.get(st),un=y.state.lights;if(ct===!0&&(St===!0||C!==R)){const Qe=C===R&&st.id===D;bt.setState(st,C,Qe)}let Ee=!1;st.version===Kt.__version?(Kt.needsLights&&Kt.lightsStateVersion!==un.state.version||Kt.outputColorSpace!==Nt||Y.isBatchedMesh&&Kt.batching===!1||!Y.isBatchedMesh&&Kt.batching===!0||Y.isBatchedMesh&&Kt.batchingColor===!0&&Y.colorTexture===null||Y.isBatchedMesh&&Kt.batchingColor===!1&&Y.colorTexture!==null||Y.isInstancedMesh&&Kt.instancing===!1||!Y.isInstancedMesh&&Kt.instancing===!0||Y.isSkinnedMesh&&Kt.skinning===!1||!Y.isSkinnedMesh&&Kt.skinning===!0||Y.isInstancedMesh&&Kt.instancingColor===!0&&Y.instanceColor===null||Y.isInstancedMesh&&Kt.instancingColor===!1&&Y.instanceColor!==null||Y.isInstancedMesh&&Kt.instancingMorph===!0&&Y.morphTexture===null||Y.isInstancedMesh&&Kt.instancingMorph===!1&&Y.morphTexture!==null||Kt.envMap!==zt||st.fog===!0&&Kt.fog!==Tt||Kt.numClippingPlanes!==void 0&&(Kt.numClippingPlanes!==bt.numPlanes||Kt.numIntersection!==bt.numIntersection)||Kt.vertexAlphas!==ie||Kt.vertexTangents!==$t||Kt.morphTargets!==jt||Kt.morphNormals!==xe||Kt.morphColors!==Se||Kt.toneMapping!==ke||Kt.morphTargetsCount!==ae)&&(Ee=!0):(Ee=!0,Kt.__version=st.version);let zn=Kt.currentProgram;Ee===!0&&(zn=Ke(st,Z,Y));let gi=!1,Un=!1,pn=!1;const Fe=zn.getUniforms(),Ln=Kt.uniforms;if(Yt.useProgram(zn.program)&&(gi=!0,Un=!0,pn=!0),st.id!==D&&(D=st.id,Un=!0),gi||R!==C){Yt.buffers.depth.getReversed()?(Mt.copy(C.projectionMatrix),xM(Mt),SM(Mt),Fe.setValue(H,"projectionMatrix",Mt)):Fe.setValue(H,"projectionMatrix",C.projectionMatrix),Fe.setValue(H,"viewMatrix",C.matrixWorldInverse);const yn=Fe.map.cameraPosition;yn!==void 0&&yn.setValue(H,Ht.setFromMatrixPosition(C.matrixWorld)),ge.logarithmicDepthBuffer&&Fe.setValue(H,"logDepthBufFC",2/(Math.log(C.far+1)/Math.LN2)),(st.isMeshPhongMaterial||st.isMeshToonMaterial||st.isMeshLambertMaterial||st.isMeshBasicMaterial||st.isMeshStandardMaterial||st.isShaderMaterial)&&Fe.setValue(H,"isOrthographic",C.isOrthographicCamera===!0),R!==C&&(R=C,Un=!0,pn=!0)}if(Y.isSkinnedMesh){Fe.setOptional(H,Y,"bindMatrix"),Fe.setOptional(H,Y,"bindMatrixInverse");const Qe=Y.skeleton;Qe&&(Qe.boneTexture===null&&Qe.computeBoneTexture(),Fe.setValue(H,"boneTexture",Qe.boneTexture,N))}Y.isBatchedMesh&&(Fe.setOptional(H,Y,"batchingTexture"),Fe.setValue(H,"batchingTexture",Y._matricesTexture,N),Fe.setOptional(H,Y,"batchingIdTexture"),Fe.setValue(H,"batchingIdTexture",Y._indirectTexture,N),Fe.setOptional(H,Y,"batchingColorTexture"),Y._colorsTexture!==null&&Fe.setValue(H,"batchingColorTexture",Y._colorsTexture,N));const bn=rt.morphAttributes;if((bn.position!==void 0||bn.normal!==void 0||bn.color!==void 0)&&Xt.update(Y,rt,zn),(Un||Kt.receiveShadow!==Y.receiveShadow)&&(Kt.receiveShadow=Y.receiveShadow,Fe.setValue(H,"receiveShadow",Y.receiveShadow)),st.isMeshGouraudMaterial&&st.envMap!==null&&(Ln.envMap.value=zt,Ln.flipEnvMap.value=zt.isCubeTexture&&zt.isRenderTargetTexture===!1?-1:1),st.isMeshStandardMaterial&&st.envMap===null&&Z.environment!==null&&(Ln.envMapIntensity.value=Z.environmentIntensity),Un&&(Fe.setValue(H,"toneMappingExposure",w.toneMappingExposure),Kt.needsLights&&Wc(Ln,pn),Tt&&st.fog===!0&&Ct.refreshFogUniforms(Ln,Tt),Ct.refreshMaterialUniforms(Ln,st,I,V,y.state.transmissionRenderTarget[C.id]),zc.upload(H,vn(Kt),Ln,N)),st.isShaderMaterial&&st.uniformsNeedUpdate===!0&&(zc.upload(H,vn(Kt),Ln,N),st.uniformsNeedUpdate=!1),st.isSpriteMaterial&&Fe.setValue(H,"center",Y.center),Fe.setValue(H,"modelViewMatrix",Y.modelViewMatrix),Fe.setValue(H,"normalMatrix",Y.normalMatrix),Fe.setValue(H,"modelMatrix",Y.matrixWorld),st.isShaderMaterial||st.isRawShaderMaterial){const Qe=st.uniformsGroups;for(let yn=0,Cr=Qe.length;yn<Cr;yn++){const Pn=Qe[yn];j.update(Pn,zn),j.bind(Pn,zn)}}return zn}function Wc(C,Z){C.ambientLightColor.needsUpdate=Z,C.lightProbe.needsUpdate=Z,C.directionalLights.needsUpdate=Z,C.directionalLightShadows.needsUpdate=Z,C.pointLights.needsUpdate=Z,C.pointLightShadows.needsUpdate=Z,C.spotLights.needsUpdate=Z,C.spotLightShadows.needsUpdate=Z,C.rectAreaLights.needsUpdate=Z,C.hemisphereLights.needsUpdate=Z}function qc(C){return C.isMeshLambertMaterial||C.isMeshToonMaterial||C.isMeshPhongMaterial||C.isMeshStandardMaterial||C.isShadowMaterial||C.isShaderMaterial&&C.lights===!0}this.getActiveCubeFace=function(){return F},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return W},this.setRenderTargetTextures=function(C,Z,rt){const st=Wt.get(C);st.__autoAllocateDepthBuffer=C.resolveDepthBuffer===!1,st.__autoAllocateDepthBuffer===!1&&(st.__useRenderToTexture=!1),Wt.get(C.texture).__webglTexture=Z,Wt.get(C.depthTexture).__webglTexture=st.__autoAllocateDepthBuffer?void 0:rt,st.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(C,Z){const rt=Wt.get(C);rt.__webglFramebuffer=Z,rt.__useDefaultFramebuffer=Z===void 0};const Zo=H.createFramebuffer();this.setRenderTarget=function(C,Z=0,rt=0){W=C,F=Z,z=rt;let st=!0,Y=null,Tt=!1,Ut=!1;if(C){const zt=Wt.get(C);if(zt.__useDefaultFramebuffer!==void 0)Yt.bindFramebuffer(H.FRAMEBUFFER,null),st=!1;else if(zt.__webglFramebuffer===void 0)N.setupRenderTarget(C);else if(zt.__hasExternalTextures)N.rebindTextures(C,Wt.get(C.texture).__webglTexture,Wt.get(C.depthTexture).__webglTexture);else if(C.depthBuffer){const jt=C.depthTexture;if(zt.__boundDepthTexture!==jt){if(jt!==null&&Wt.has(jt)&&(C.width!==jt.image.width||C.height!==jt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");N.setupDepthRenderbuffer(C)}}const ie=C.texture;(ie.isData3DTexture||ie.isDataArrayTexture||ie.isCompressedArrayTexture)&&(Ut=!0);const $t=Wt.get(C).__webglFramebuffer;C.isWebGLCubeRenderTarget?(Array.isArray($t[Z])?Y=$t[Z][rt]:Y=$t[Z],Tt=!0):C.samples>0&&N.useMultisampledRTT(C)===!1?Y=Wt.get(C).__webglMultisampledFramebuffer:Array.isArray($t)?Y=$t[rt]:Y=$t,G.copy(C.viewport),nt.copy(C.scissor),$=C.scissorTest}else G.copy(O).multiplyScalar(I).floor(),nt.copy(J).multiplyScalar(I).floor(),$=ht;if(rt!==0&&(Y=Zo),Yt.bindFramebuffer(H.FRAMEBUFFER,Y)&&st&&Yt.drawBuffers(C,Y),Yt.viewport(G),Yt.scissor(nt),Yt.setScissorTest($),Tt){const zt=Wt.get(C.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_CUBE_MAP_POSITIVE_X+Z,zt.__webglTexture,rt)}else if(Ut){const zt=Wt.get(C.texture),ie=Z;H.framebufferTextureLayer(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,zt.__webglTexture,rt,ie)}else if(C!==null&&rt!==0){const zt=Wt.get(C.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,zt.__webglTexture,rt)}D=-1},this.readRenderTargetPixels=function(C,Z,rt,st,Y,Tt,Ut){if(!(C&&C.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Nt=Wt.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Ut!==void 0&&(Nt=Nt[Ut]),Nt){Yt.bindFramebuffer(H.FRAMEBUFFER,Nt);try{const zt=C.texture,ie=zt.format,$t=zt.type;if(!ge.textureFormatReadable(ie)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ge.textureTypeReadable($t)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Z>=0&&Z<=C.width-st&&rt>=0&&rt<=C.height-Y&&H.readPixels(Z,rt,st,Y,se.convert(ie),se.convert($t),Tt)}finally{const zt=W!==null?Wt.get(W).__webglFramebuffer:null;Yt.bindFramebuffer(H.FRAMEBUFFER,zt)}}},this.readRenderTargetPixelsAsync=async function(C,Z,rt,st,Y,Tt,Ut){if(!(C&&C.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Nt=Wt.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Ut!==void 0&&(Nt=Nt[Ut]),Nt)if(Z>=0&&Z<=C.width-st&&rt>=0&&rt<=C.height-Y){Yt.bindFramebuffer(H.FRAMEBUFFER,Nt);const zt=C.texture,ie=zt.format,$t=zt.type;if(!ge.textureFormatReadable(ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ge.textureTypeReadable($t))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const jt=H.createBuffer();H.bindBuffer(H.PIXEL_PACK_BUFFER,jt),H.bufferData(H.PIXEL_PACK_BUFFER,Tt.byteLength,H.STREAM_READ),H.readPixels(Z,rt,st,Y,se.convert(ie),se.convert($t),0);const xe=W!==null?Wt.get(W).__webglFramebuffer:null;Yt.bindFramebuffer(H.FRAMEBUFFER,xe);const Se=H.fenceSync(H.SYNC_GPU_COMMANDS_COMPLETE,0);return H.flush(),await yM(H,Se,4),H.bindBuffer(H.PIXEL_PACK_BUFFER,jt),H.getBufferSubData(H.PIXEL_PACK_BUFFER,0,Tt),H.deleteBuffer(jt),H.deleteSync(Se),Tt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(C,Z=null,rt=0){const st=Math.pow(2,-rt),Y=Math.floor(C.image.width*st),Tt=Math.floor(C.image.height*st),Ut=Z!==null?Z.x:0,Nt=Z!==null?Z.y:0;N.setTexture2D(C,0),H.copyTexSubImage2D(H.TEXTURE_2D,rt,0,0,Ut,Nt,Y,Tt),Yt.unbindTexture()};const Za=H.createFramebuffer(),Fs=H.createFramebuffer();this.copyTextureToTexture=function(C,Z,rt=null,st=null,Y=0,Tt=null){Tt===null&&(Y!==0?(Oc("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Tt=Y,Y=0):Tt=0);let Ut,Nt,zt,ie,$t,jt,xe,Se,ke;const Ae=C.isCompressedTexture?C.mipmaps[Tt]:C.image;if(rt!==null)Ut=rt.max.x-rt.min.x,Nt=rt.max.y-rt.min.y,zt=rt.isBox3?rt.max.z-rt.min.z:1,ie=rt.min.x,$t=rt.min.y,jt=rt.isBox3?rt.min.z:0;else{const bn=Math.pow(2,-Y);Ut=Math.floor(Ae.width*bn),Nt=Math.floor(Ae.height*bn),C.isDataArrayTexture?zt=Ae.depth:C.isData3DTexture?zt=Math.floor(Ae.depth*bn):zt=1,ie=0,$t=0,jt=0}st!==null?(xe=st.x,Se=st.y,ke=st.z):(xe=0,Se=0,ke=0);const ae=se.convert(Z.format),Kt=se.convert(Z.type);let un;Z.isData3DTexture?(N.setTexture3D(Z,0),un=H.TEXTURE_3D):Z.isDataArrayTexture||Z.isCompressedArrayTexture?(N.setTexture2DArray(Z,0),un=H.TEXTURE_2D_ARRAY):(N.setTexture2D(Z,0),un=H.TEXTURE_2D),H.pixelStorei(H.UNPACK_FLIP_Y_WEBGL,Z.flipY),H.pixelStorei(H.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Z.premultiplyAlpha),H.pixelStorei(H.UNPACK_ALIGNMENT,Z.unpackAlignment);const Ee=H.getParameter(H.UNPACK_ROW_LENGTH),zn=H.getParameter(H.UNPACK_IMAGE_HEIGHT),gi=H.getParameter(H.UNPACK_SKIP_PIXELS),Un=H.getParameter(H.UNPACK_SKIP_ROWS),pn=H.getParameter(H.UNPACK_SKIP_IMAGES);H.pixelStorei(H.UNPACK_ROW_LENGTH,Ae.width),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,Ae.height),H.pixelStorei(H.UNPACK_SKIP_PIXELS,ie),H.pixelStorei(H.UNPACK_SKIP_ROWS,$t),H.pixelStorei(H.UNPACK_SKIP_IMAGES,jt);const Fe=C.isDataArrayTexture||C.isData3DTexture,Ln=Z.isDataArrayTexture||Z.isData3DTexture;if(C.isDepthTexture){const bn=Wt.get(C),Qe=Wt.get(Z),yn=Wt.get(bn.__renderTarget),Cr=Wt.get(Qe.__renderTarget);Yt.bindFramebuffer(H.READ_FRAMEBUFFER,yn.__webglFramebuffer),Yt.bindFramebuffer(H.DRAW_FRAMEBUFFER,Cr.__webglFramebuffer);for(let Pn=0;Pn<zt;Pn++)Fe&&(H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,Wt.get(C).__webglTexture,Y,jt+Pn),H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,Wt.get(Z).__webglTexture,Tt,ke+Pn)),H.blitFramebuffer(ie,$t,Ut,Nt,xe,Se,Ut,Nt,H.DEPTH_BUFFER_BIT,H.NEAREST);Yt.bindFramebuffer(H.READ_FRAMEBUFFER,null),Yt.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else if(Y!==0||C.isRenderTargetTexture||Wt.has(C)){const bn=Wt.get(C),Qe=Wt.get(Z);Yt.bindFramebuffer(H.READ_FRAMEBUFFER,Za),Yt.bindFramebuffer(H.DRAW_FRAMEBUFFER,Fs);for(let yn=0;yn<zt;yn++)Fe?H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,bn.__webglTexture,Y,jt+yn):H.framebufferTexture2D(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,bn.__webglTexture,Y),Ln?H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,Qe.__webglTexture,Tt,ke+yn):H.framebufferTexture2D(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,Qe.__webglTexture,Tt),Y!==0?H.blitFramebuffer(ie,$t,Ut,Nt,xe,Se,Ut,Nt,H.COLOR_BUFFER_BIT,H.NEAREST):Ln?H.copyTexSubImage3D(un,Tt,xe,Se,ke+yn,ie,$t,Ut,Nt):H.copyTexSubImage2D(un,Tt,xe,Se,ie,$t,Ut,Nt);Yt.bindFramebuffer(H.READ_FRAMEBUFFER,null),Yt.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else Ln?C.isDataTexture||C.isData3DTexture?H.texSubImage3D(un,Tt,xe,Se,ke,Ut,Nt,zt,ae,Kt,Ae.data):Z.isCompressedArrayTexture?H.compressedTexSubImage3D(un,Tt,xe,Se,ke,Ut,Nt,zt,ae,Ae.data):H.texSubImage3D(un,Tt,xe,Se,ke,Ut,Nt,zt,ae,Kt,Ae):C.isDataTexture?H.texSubImage2D(H.TEXTURE_2D,Tt,xe,Se,Ut,Nt,ae,Kt,Ae.data):C.isCompressedTexture?H.compressedTexSubImage2D(H.TEXTURE_2D,Tt,xe,Se,Ae.width,Ae.height,ae,Ae.data):H.texSubImage2D(H.TEXTURE_2D,Tt,xe,Se,Ut,Nt,ae,Kt,Ae);H.pixelStorei(H.UNPACK_ROW_LENGTH,Ee),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,zn),H.pixelStorei(H.UNPACK_SKIP_PIXELS,gi),H.pixelStorei(H.UNPACK_SKIP_ROWS,Un),H.pixelStorei(H.UNPACK_SKIP_IMAGES,pn),Tt===0&&Z.generateMipmaps&&H.generateMipmap(un),Yt.unbindTexture()},this.copyTextureToTexture3D=function(C,Z,rt=null,st=null,Y=0){return Oc('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(C,Z,rt,st,Y)},this.initRenderTarget=function(C){Wt.get(C).__webglFramebuffer===void 0&&N.setupRenderTarget(C)},this.initTexture=function(C){C.isCubeTexture?N.setTextureCube(C,0):C.isData3DTexture?N.setTexture3D(C,0):C.isDataArrayTexture||C.isCompressedArrayTexture?N.setTexture2DArray(C,0):N.setTexture2D(C,0),Yt.unbindTexture()},this.resetState=function(){F=0,z=0,W=null,Yt.reset(),Pe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return oa}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=we._getDrawingBufferColorSpace(t),i.unpackColorSpace=we._getUnpackColorSpace()}}const eR={U:[0,1,0],D:[0,-1,0],F:[0,0,1],B:[0,0,-1],R:[1,0,0],L:[-1,0,0]},nR={R:[1,0,0],L:[1,0,0],U:[0,1,0],D:[0,1,0],F:[0,0,1],B:[0,0,1]};function B0(s){return s.endsWith("2")?Math.PI:s.endsWith("'")?-Math.PI/2:Math.PI/2}function I0(s){return s.replace("'","").replace("2","")}function kv(s){return s.endsWith("'")&&!s.endsWith("2")}function iR(s){return s.endsWith("2")}const Xv=16777215,aR=.022;class rR{constructor(t){qe(this,"renderer");qe(this,"scene");qe(this,"camera");qe(this,"arrowGroup");qe(this,"traceGroup",null);qe(this,"currentMove",null);qe(this,"traceProgress",0);qe(this,"width",1);qe(this,"height",1);this.renderer=new tR({canvas:t,alpha:!0,antialias:!0,powerPreference:"high-performance"}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setClearColor(0,0),this.scene=new YM,this.camera=new di(45,1,.01,100),this.camera.position.set(0,0,3);const i=new gE(16777215,.9),a=new mE(16777215,.6);a.position.set(2,3,4),this.scene.add(i,a),this.arrowGroup=new Tr,this.scene.add(this.arrowGroup)}resize(t,i){this.width=t,this.height=i,this.renderer.setSize(t,i,!1),this.camera.aspect=t/i,this.camera.updateProjectionMatrix()}setMove(t){t!==this.currentMove&&(this.currentMove=t,this.traceProgress=0,this.rebuildArrow(t))}tick(){this.currentMove&&(this.traceProgress+=aR,this.traceProgress>1.05&&(this.traceProgress=0),this.updateTrace())}render(t){if(!t||!this.currentMove){this.renderer.render(this.scene,this.camera);return}const i=new Tr,a=new Ze;a.set(t.rotationMatrix[0],t.rotationMatrix[1],t.rotationMatrix[2],0,t.rotationMatrix[3],t.rotationMatrix[4],t.rotationMatrix[5],0,t.rotationMatrix[6],t.rotationMatrix[7],t.rotationMatrix[8],0,0,0,0,1),i.setRotationFromMatrix(a);const l=t.size/this.width;i.position.set((t.translation[0]-this.width/2)*l,-(t.translation[1]-this.height/2)*l,t.translation[2]*l),i.scale.setScalar(l*2),this.arrowGroup.matrixAutoUpdate=!1,this.arrowGroup.matrix.copy(i.matrix),this.arrowGroup.matrixWorldNeedsUpdate=!0,this.renderer.render(this.scene,this.camera)}dispose(){this.renderer.dispose(),this.clearArrow()}rebuildArrow(t){if(this.clearArrow(),!t)return;const i=I0(t),a=new Q(...eR[i]),l=new Q(0,1,0);Math.abs(a.dot(l))>.9&&l.set(0,0,1);const c=new Q().crossVectors(l,a).normalize(),f=new Q().crossVectors(a,c).normalize(),h=a.clone().multiplyScalar(.52),p=new Tr;p.position.copy(h),p.userData={tangent:c,bitangent:f,move:t};const m=B0(t),g=.32,_=32,v=kv(t)?m:0,S=kv(t)?0:m,E=[];for(let M=0;M<=_;M++){const y=v+(S-v)*M/_,P=c.clone().multiplyScalar(Math.cos(y)*g).add(f.clone().multiplyScalar(Math.sin(y)*g));E.push(P)}p.userData.points=E,p.userData.segments=_;const T=new ei(new Yd(.34,.4,48),new Ic({color:Xv,transparent:!0,opacity:.35,side:Li,depthWrite:!1}));if(p.add(T),iR(t)){const M=T.clone();M.rotation.z=Math.PI,p.add(M)}this.traceGroup=p,this.arrowGroup.add(p),this.updateTrace()}updateTrace(){if(!this.traceGroup||!this.currentMove)return;const t=this.traceGroup.getObjectByName("trace");t&&(this.traceGroup.remove(t),Wv(t));const i=this.traceGroup.userData.points,a=this.traceGroup.userData.segments;if(!(i!=null&&i.length))return;const l=Math.max(2,Math.floor(a*this.traceProgress)),c=i.slice(0,l+1);if(c.length<2)return;const f=new w0(c),h=new jd(f,l,.028,8,!1),p=new Ic({color:Xv,transparent:!0,opacity:.88,depthTest:!0,depthWrite:!1}),m=new ei(h,p);m.name="trace",this.traceGroup.add(m);const g=c[c.length-1],_=c[c.length-2]??g,v=new Q().subVectors(g,_).normalize(),S=new ei(new qd(.065,.15,12),p.clone());S.name="trace",S.position.copy(g),S.quaternion.setFromUnitVectors(new Q(0,1,0),v),this.traceGroup.add(S)}clearArrow(){for(this.traceGroup=null;this.arrowGroup.children.length>0;){const t=this.arrowGroup.children[0];this.arrowGroup.remove(t),Wv(t)}}}function Wv(s){s.traverse(t=>{t instanceof ei&&(t.geometry.dispose(),Array.isArray(t.material)?t.material.forEach(i=>i.dispose()):t.material.dispose())})}function sR({pose:s,move:t,width:i,height:a,active:l}){const c=Vt.useRef(null),f=Vt.useRef(null);return Vt.useEffect(()=>{const h=c.current;if(!h)return;const p=new rR(h);return f.current=p,()=>{p.dispose(),f.current=null}},[]),Vt.useEffect(()=>{var h;(h=f.current)==null||h.resize(i,a)},[i,a]),Vt.useEffect(()=>{var h;(h=f.current)==null||h.setMove(t)},[t]),Vt.useEffect(()=>{if(!l)return;let h=0;const p=()=>{var m,g;(m=f.current)==null||m.tick(),(g=f.current)==null||g.render(s),h=requestAnimationFrame(p)};return h=requestAnimationFrame(p),()=>cancelAnimationFrame(h)},[s,l]),At.jsx("canvas",{ref:c,className:`ar-overlay${l?" active":""}`,"aria-hidden":"true"})}function oR({setVideoRef:s,onDimensions:t}){const i=Vt.useCallback(l=>{l.videoWidth&&l.videoHeight&&(t==null||t(l.videoWidth,l.videoHeight))},[t]),a=Vt.useCallback(l=>{s(l),l&&l.readyState>=1&&i(l)},[s,i]);return At.jsx("video",{ref:a,className:"camera-feed",playsInline:!0,muted:!0,autoPlay:!0,onLoadedMetadata:l=>i(l.currentTarget)})}const lR=.3,cR=.22;function Ls(s,t){const i=Math.min(s,t)*lR;return{x:(s-i)/2,y:(t-i)/2,size:i}}function H0(s){const t=s.size*cR;return{x:s.x+(s.size-t)/2,y:s.y+(s.size-t)/2,size:t}}function G0(s){const{x:t,y:i,size:a}=s;return[{x:t,y:i},{x:t+a,y:i},{x:t+a,y:i+a},{x:t,y:i+a}]}function uR(s,t,i){return s.map(a=>({x:a.x+t,y:a.y+i}))}const Xa=["R","O","Y","G","B","W"],fR={R:"Red",O:"Orange",Y:"Yellow",G:"Green",B:"Blue",W:"White"},Ld={R:"#ef4444",O:"#f97316",Y:"#facc15",G:"#22c55e",B:"#3b82f6",W:"#f5f5f5"},hR={W:[95,0,0],Y:[88,-4,82],R:[48,62,38],O:[62,42,62],G:[55,-48,32],B:[32,28,-52]};let ws={},Kd=!1;function Qd(){return Kd&&Xa.every(s=>ws[s])}function dR(){const s={...hR};for(const t of Xa)ws[t]&&(s[t]=ws[t]);return s}function qv(){ws={},Kd=!1}function pR(s,t){ws[s]=t,Xa.every(i=>ws[i])&&(Kd=!0)}function Bh(s){return s>.04045?((s+.055)/1.055)**2.4:s/12.92}function mR(s,t,i){const a=Bh(s/255),l=Bh(t/255),c=Bh(i/255),f=a*.4124564+l*.3575761+c*.1804375,h=a*.2126729+l*.7151522+c*.072175,p=a*.0193339+l*.119192+c*.9503041,m=f/.95047>.008856?(f/.95047)**(1/3):7.787*(f/.95047)+16/116,g=h>.008856?h**(1/3):7.787*h+16/116,_=p/1.08883>.008856?(p/1.08883)**(1/3):7.787*(p/1.08883)+16/116;return[116*g-16,500*(m-g),200*(g-_)]}function Ih(s){if(s.length===0)return 0;const t=[...s].sort((a,l)=>a-l),i=Math.floor(t.length/2);return t.length%2===1?t[i]:Math.round((t[i-1]+t[i])/2)}function gR(s,t,i){return Math.max(s,t,i)-Math.min(s,t,i)<28?"W":s>=t&&s>=i?t>s*.92?"O":"R":t>=s&&t>=i?"G":"B"}function _R(s,t,i,a){const l=Math.max(s,t,i);if(l<45)return!1;const c=(s+t+i)/3,f=l-Math.min(s,t,i);switch(a){case"W":return f<55&&c>95;case"Y":return s>75&&t>65&&c>80;case"R":return s>65&&s>=i;case"O":return s>70&&t>55&&s>=i-5;case"G":return t>45&&t>=s-12&&t>=i-5;case"B":return i>40&&i>=s-8&&i>=t-15;default:return!0}}function vR(s,t,i,a){if(a==="W")return Math.max(s,t,i)-Math.min(s,t,i)<60;if(a==="Y")return s>70&&t>60;const l=gR(s,t,i);return a==="O"?l==="O"||l==="R"||l==="Y":a==="R"?l==="R"||l==="O":l===a}function V0(s,t,i,a){const l=s.getContext("2d",{willReadFrequently:!0});if(!l)return null;const c=Ls(t,i),f=H0(c),h=Math.floor(f.x),p=Math.floor(f.y),m=Math.floor(f.size),g=Math.floor(f.size);if(m<=0||g<=0)return null;const _=l.getImageData(h,p,m,g).data,v=[],S=[],E=[],T=[],M=[],y=[];for(let R=0;R<_.length;R+=8){const G=_[R],nt=_[R+1],$=_[R+2];Math.max(G,nt,$)<40||(T.push(G),M.push(nt),y.push($),_R(G,nt,$,a)&&(v.push(G),S.push(nt),E.push($)))}const P=v.length>=4?v:T,L=v.length>=4?S:M,w=v.length>=4?E:y;if(P.length<4)return null;const X=Ih(P),F=Ih(L),z=Ih(w),W=mR(X,F,z),D=P.length;return{r:X,g:F,b:z,lab:W,ready:D>=6&&vR(X,F,z,a)}}function yR(s,t,i,a){const l=V0(s,t,i,a);return l!=null&&l.ready?(pR(a,l.lab),l):null}function k0(s,t){Vt.useEffect(()=>{if(!t)return;const i=a=>{var c;if(a.key!=="Enter"&&a.key!==" ")return;const l=(c=a.target)==null?void 0:c.tagName;l==="INPUT"||l==="TEXTAREA"||l==="BUTTON"||(a.preventDefault(),s())};return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[s,t])}function Jd({rect:s}){const t=s?{left:s.left,top:s.top,width:s.width,height:s.height,transform:"none"}:void 0;return At.jsx("div",{className:"guide-frame-css",style:t})}function xR({rect:s,strokeColor:t="#ffffff"}){const i=s?{left:s.left,top:s.top,width:s.width,height:s.height,transform:"none",borderColor:t,boxShadow:`0 0 0 2px rgba(0, 0, 0, 0.35), 0 0 12px ${t}55`}:void 0;return At.jsx("div",{className:"guide-spot-css",style:i})}function SR({visible:s,stepIndex:t,sample:i,ready:a,error:l,onConfirm:c,guideRect:f,spotRect:h}){const p=Xa[t]??"R";return k0(c,s&&a),s?At.jsxs("div",{className:"color-learn-overlay","aria-live":"polite",children:[At.jsx(Jd,{rect:f}),At.jsx(xR,{rect:h,strokeColor:Ld[p]}),At.jsxs("div",{className:"color-learn-panel",children:[At.jsx("p",{className:"color-learn-target",style:{color:Ld[p]},children:fR[p]}),At.jsxs("p",{className:"color-learn-step",children:[t+1," / ",Xa.length]}),i&&At.jsx("div",{className:"color-learn-swatch",style:{background:`rgb(${i.r},${i.g},${i.b})`}}),At.jsx("button",{type:"button",className:"capture-button",disabled:!a,onClick:c,children:a?"Confirm":"Hold steady…"}),l&&At.jsx("p",{className:"color-learn-error",children:l})]})]}):null}const X0="selfieDisplayMirror";function W0(){const s=sessionStorage.getItem(X0);return s==="true"}function MR(s){sessionStorage.setItem(X0,String(s))}function Yv(s,t,i,a){s.drawImage(t,0,0,i,a)}function ER(s){if(s.length!==9)return s;const t=[];for(let i=0;i<3;i++)for(let a=2;a>=0;a--)t.push(s[i*3+a]);return t}function q0(s){const t=new Map;for(const[i,a]of s)t.set(i,[...a]);return t}function Y0({colors:s,cellClassName:t,variant:i="overlay",displayMirror:a=W0()}){const l=t??(i==="mini"?"face-grid-mini-cell":"cell-grid-item"),c=a?ER(s):s;return At.jsx("div",{className:`face-color-grid face-color-grid--${i}`,children:c.map((f,h)=>At.jsx("span",{className:l,style:{background:Ld[f]}},h))})}const TR={searching:"…",detected:"OK",stabilizing:"…",captured:"✓",rotate:"Rotate"};function bR({feedback:s,visible:t,guideRect:i,displayMirror:a}){if(!t)return null;const l=s.cellColors.length===9;return At.jsxs("div",{className:"detection-overlay","aria-live":"polite",children:[At.jsx(Jd,{rect:i}),At.jsxs("div",{className:"scan-ui-panel scan-ui-panel--compact",children:[At.jsxs("div",{className:`detection-status ${s.status}`,children:[At.jsx("span",{className:"status-text",children:TR[s.status]}),s.status==="rotate"&&At.jsx("span",{className:"status-progress",children:"New face"}),s.status==="stabilizing"&&At.jsxs("span",{className:"status-progress",children:[s.stableProgress.toFixed(1),"/",s.stableTarget,"s"]})]}),l&&At.jsx(Y0,{colors:s.cellColors,variant:"overlay",displayMirror:a})]})]})}function AR({phase:s,knownFaces:t,progress:i,needsNewFace:a=!1,needsClearerCenter:l=!1}){return s!=="liveScan"?null:At.jsxs("div",{className:"calibration-overlay live-scan-overlay",children:[At.jsx("div",{className:"calibration-bar",children:At.jsx("div",{className:"calibration-fill",style:{width:`${i*100}%`}})}),At.jsxs("p",{className:"calibration-sub",children:[t.length," / 6"]}),At.jsx("p",{className:"calibration-hint calibration-hint--muted",children:"Any face order · same tilt each time"}),a&&At.jsx("p",{className:"calibration-hint",children:"Show a different face"}),l&&!a&&At.jsx("p",{className:"calibration-hint",children:"Center the face color in the guide"})]})}const jv=["U","F","R","B","L","D"],RR={W:"U",Y:"D",R:"R",O:"L",G:"F",B:"B"};function Fo(s){return RR[s]??null}function CR({colors:s,label:t,empty:i=!1,displayMirror:a}){const l=s&&s.length===9;return At.jsxs("div",{className:`face-grid-mini ${i?"face-grid-mini--empty":""}`,children:[l?At.jsx(Y0,{colors:s,variant:"mini",displayMirror:a}):At.jsx("div",{className:"face-color-grid face-color-grid--mini face-color-grid--placeholder",children:Array.from({length:9},(c,f)=>At.jsx("span",{className:"face-grid-mini-cell face-grid-mini-cell--placeholder"},f))}),At.jsx("span",{className:"face-grid-mini-label",children:t})]})}const wR={U:"W",D:"Y",F:"G",B:"B",R:"R",L:"O"};function Hh({visible:s,scannedFaces:t,displayMirror:i,onFlipPreview:a}){if(!s)return null;const l=jv.filter(c=>t[c]).length;return At.jsxs("div",{className:"scanned-faces-bar","aria-live":"polite",children:[At.jsxs("div",{className:"scanned-faces-bar-header",children:[At.jsxs("p",{className:"scanned-faces-bar-title",children:["Scanned ",l,"/6"]}),a&&At.jsx("button",{type:"button",className:"scanned-faces-flip",onClick:a,children:"Flip"})]}),At.jsx("div",{className:"scanned-faces-bar-grid",children:jv.map(c=>At.jsx(CR,{colors:t[c]??null,label:wR[c],empty:!t[c],displayMirror:i},c))})]})}function Zv({message:s="Loading…",overlay:t=!1}){return At.jsxs("div",{className:`loading-screen${t?" overlay":""}`,children:[At.jsx("div",{className:"loading-spinner"}),At.jsx("p",{children:s})]})}function DR({visible:s,feedback:t,guideRect:i,onStart:a}){const l=t.status==="detected"&&t.cellColors.length===9;return k0(a,s),s?At.jsxs("div",{className:"scan-ready-overlay","aria-live":"polite",children:[At.jsx(Jd,{rect:i}),At.jsxs("div",{className:"scan-ready-panel",children:[At.jsx("p",{className:"scan-ready-hint",children:l?"Cube detected":"Align cube in guide"}),At.jsx("button",{type:"button",className:"capture-button",onClick:a,children:"Start scan"})]})]}):null}function UR({phase:s,currentStep:t,totalSteps:i}){return s!=="solving"||i===0?null:At.jsxs("div",{className:"step-indicator","aria-live":"polite",children:["Step ",t," / ",i]})}function LR(s){const t=["U","R","F","D","L","B"];let i="";for(const a of t){const l=s.get(a);if(!l||l.length!==9)throw new Error(`Missing face data for ${a}`);for(const c of l)i+=NR(c)}return i}function NR(s){return{W:"U",Y:"D",R:"R",O:"L",G:"F",B:"B"}[s]}function OR(s,t){const i=new Array(9).fill(0);for(let a=0;a<3;a++)for(let l=0;l<3;l++){let c=0;for(let f=0;f<3;f++)c+=s[a*3+f]*t[f*3+l];i[a*3+l]=c}return i}function Kv(){return[1,0,0,0,1,0,0,0,1]}function zR(s,t){const[i,a,l]=s,c=Math.hypot(i,a,l)||1,f=i/c,h=a/c,p=l/c,m=Math.cos(t),g=Math.sin(t),_=1-m;return[_*f*f+m,_*f*h-g*p,_*f*p+g*h,_*f*h+g*p,_*h*h+m,_*h*p-g*f,_*f*p-g*h,_*h*p+g*f,_*p*p+m]}function PR(){return new Worker(new URL("/makemecubemaster/assets/solver.worker-D-KG6Koa.js",import.meta.url),{type:"module"})}const j0=["R","O","Y","G","B","W"],FR={W:[95,0,0],Y:[88,-4,82],R:[48,62,38],O:[62,42,62],G:[55,-48,32],B:[32,28,-52]};function Z0(){return Qd()?dR():FR}function BR(s,t,i){const a=Gh(s/255),l=Gh(t/255),c=Gh(i/255);return[a*.4124564+l*.3575761+c*.1804375,a*.2126729+l*.7151522+c*.072175,a*.0193339+l*.119192+c*.9503041]}function Gh(s){return s>.04045?((s+.055)/1.055)**2.4:s/12.92}function IR(s,t,i){const f=Vh(s/.95047),h=Vh(t/1),p=Vh(i/1.08883);return[116*h-16,500*(f-h),200*(h-p)]}function Vh(s){return s>.008856?s**(1/3):7.787*s+16/116}function K0(s,t,i){const[a,l,c]=BR(s,t,i);return IR(a,l,c)}function Q0(s,t){const i=s[0]-t[0],a=s[1]-t[1],l=s[2]-t[2];return Math.sqrt(i*i+a*a+l*l)}function HR(s,t,i){const a=s/255,l=t/255,c=i/255,f=Math.max(a,l,c),h=Math.min(a,l,c),p=f-h;let m=0;p>0&&(f===a?m=(l-c)/p%6:f===l?m=(c-a)/p+2:m=(a-l)/p+4,m*=60,m<0&&(m+=360));const g=f===0?0:p/f*255,_=f*255;return[m,g,_]}function Qv(s,t,i){const a=K0(s,t,i),l=Z0();let c="W",f=1/0;for(const h of j0){const p=Q0(a,l[h]);p<f&&(f=p,c=h)}return c}function J0(s,t,i){const a=Math.max(s,t,i),l=Math.min(s,t,i);return a<38||a<70&&a-l<22}function GR(s,t,i){const a=Math.max(s,t,i),l=Math.min(s,t,i),c=a-l,f=(s+t+i)/3;return a<125||c>42||i>s+22&&i>t+12||s>t+22&&s>i+22||t>s+18&&t>i+18?!1:f>145&&c<38}function VR(s,t,i,a){const l=K0(s,t,i);return 1/(1+Q0(l,Z0()[a]))}function kh(s,t,i){if(J0(s,t,i)||Qd())return Qv(s,t,i);const[a,l]=HR(s,t,i),c=l/255;if(GR(s,t,i))return"W";const f=new Map;for(const m of j0)f.set(m,VR(s,t,i,m));i>=s+14&&i>=t+10&&i>75&&f.set("B",(f.get("B")??0)+.55),s>=t+12&&s>=i+12&&s>85&&f.set("R",(f.get("R")??0)+.45),t>=s+10&&t>=i+10&&t>70&&f.set("G",(f.get("G")??0)+.45),s>95&&t>85&&i<Math.min(s,t)-18&&f.set("Y",(f.get("Y")??0)+.55),s>t+8&&t>i+5&&s>110&&a>=8&&a<42&&f.set("O",(f.get("O")??0)+.45),c>.18&&(a>=38&&a<=72&&f.set("Y",(f.get("Y")??0)+.25),a>=10&&a<38&&f.set("O",(f.get("O")??0)+.2),(a<=12||a>=345)&&f.set("R",(f.get("R")??0)+.2),a>=78&&a<=155&&f.set("G",(f.get("G")??0)+.2),a>=165&&a<=255&&f.set("B",(f.get("B")??0)+.3));let h="W",p=-1/0;for(const[m,g]of f)g>p&&(p=g,h=m);return h}function Xh(s){if(s.length===0)return 0;const t=[...s].sort((a,l)=>a-l),i=Math.floor(t.length/2);return t.length%2===1?t[i]:Math.round((t[i-1]+t[i])/2)}function kR(s,t){return s===1&&t===1?.12:(s===0||s===2)&&(t===0||t===2)?.32:.26}function XR(s,t,i){const a=Math.max(s,t,i)-Math.min(s,t,i);return a>52?.15:a>36?.55:1}function WR(s,t,i,a,l,c){const f=new Map,h=[],p=[],m=[],_=l-i>40?1:2;for(let T=Math.floor(a);T<Math.floor(c);T+=_)for(let M=Math.floor(i);M<Math.floor(l);M+=_){const y=(T*t+M)*4,P=s[y],L=s[y+1],w=s[y+2];if(J0(P,L,w))continue;h.push(P),p.push(L),m.push(w);const X=kh(P,L,w),F=XR(P,L,w);f.set(X,(f.get(X)??0)+F)}if(h.length===0){const T=Math.floor((i+l)/2),y=(Math.floor((a+c)/2)*t+T)*4;return kh(s[y],s[y+1],s[y+2])}const v=kh(Xh(h),Xh(p),Xh(m));f.set(v,(f.get(v)??0)+3);let S=v,E=0;for(const[T,M]of f)M>E&&(E=M,S=T);return S}function qR(s,t,i){const l=s.getImageData(0,0,t,i).data,c=[],f=t/3,h=i/3;for(let p=0;p<3;p++)for(let m=0;m<3;m++){const g=kR(p,m),_=m*f+f*g,v=m*f+f*(1-g),S=p*h+h*g,E=p*h+h*(1-g);c.push(WR(l,t,_,S,v,E))}return c}function Yo(){return{R:0,O:0,Y:0,G:0,B:0,W:0}}function YR(s){const t=Yo();for(const i of s)t[i]++;return t}function $0(s){return!!(s&&s.length===9)}function jR(s){if(!$0(s))return{valid:!1,colorCounts:Yo(),detectedCenter:null,uniqueColors:0};const t=YR(s),i=Object.values(t).filter(a=>a>0).length;return{valid:!0,colorCounts:t,detectedCenter:s[4]??null,uniqueColors:i}}const ZR={U:"W",D:"Y",F:"G",B:"B",R:"R",L:"O"},jo=["W","Y","R","O","G","B"],Xc=9,KR={W:{W:0,Y:1,O:2,R:4,G:5,B:5},Y:{W:1,Y:0,O:2,R:5,G:5,B:5},R:{R:0,O:1,W:4,Y:5,G:5,B:5},O:{O:0,R:1,Y:2,W:2,G:5,B:5},G:{G:0,B:2,W:5,Y:5,R:5,O:5},B:{B:0,G:2,W:5,Y:5,R:5,O:5}};function $d(s){const t=Yo();for(const i of s.values())for(const a of i)t[a]++;return t}function QR(s,t){return KR[s][t]??6}function JR(s){let t=null,i=0;for(const a of jo){const l=s[a]-Xc;l>i&&(i=l,t=a)}return t}function $R(s){let t=null,i=0;for(const a of jo){const l=Xc-s[a];l>i&&(i=l,t=a)}return t}function ty(s){return jo.every(t=>s[t]===Xc)}function tC(s){const t=new Map;for(const[a,l]of s){const c=[...l];c[4]=ZR[a],t.set(a,c)}const i=[];for(const[a,l]of t)for(let c=0;c<9;c++)c!==4&&i.push({faceId:a,index:c,color:l[c]});for(let a=0;a<256;a++){const l=$d(t);if(ty(l))break;const c=JR(l),f=$R(l);if(!c||!f)break;let h=null,p=1/0;for(const m of i){if(m.color!==c)continue;const g=QR(c,f);g<p&&(p=g,h=m)}if(!h){const m=i.find(g=>g.color===c);if(!m)break;h=m}h.color=f,t.get(h.faceId)[h.index]=f}return t}function eC(s){const t=$d(s),i=Yo();for(const a of jo)i[a]=t[a]-Xc;return i}function Jv(s){return ty($d(s))}function nC(s){const t=eC(s),i={W:"W",Y:"Y",R:"R",O:"O",G:"G",B:"B"},a=jo.filter(l=>t[l]!==0).map(l=>{const c=t[l];return`${i[l]}${c>0?`+${c}`:c}`});return a.length>0?a.join(", "):""}const xs=256;function ey(s,t){const i=document.createElement("canvas");i.width=xs,i.height=xs;const a=i.getContext("2d",{willReadFrequently:!0});return a?(a.drawImage(s,t.x,t.y,t.size,t.size,0,0,xs,xs),qR(a,xs,xs)):[]}function ny(s,t){const i=s.getContext("2d",{willReadFrequently:!0});if(!i)return 0;const{x:a,y:l,size:c}=t,f=i.getImageData(Math.floor(a),Math.floor(l),Math.floor(c),Math.floor(c)).data;let h=0,p=0,m=0;for(let _=0;_<f.length;_+=32){const v=(f[_]+f[_+1]+f[_+2])/3;h+=v,p+=v*v,m++}if(m===0)return 0;const g=h/m;return p/m-g*g}function iy(s,t){if(s.length!==9)return!1;const i=new Set(s),a=s.filter(l=>l!=="W").length;return t<120?!1:i.size===1?!0:i.size===2&&a<=3&&t<300?!1:i.size>=3&&a>=2||i.size>=2&&a>=4&&t>220}const fi=.5,iC=[[-fi,fi,fi],[fi,fi,fi],[fi,-fi,fi],[-fi,-fi,fi]];function aC(s){if(s.length<4)return null;const t=[...s].sort((l,c)=>l.y-c.y),i=t.slice(0,2).sort((l,c)=>l.x-c.x),a=t.slice(2,4).sort((l,c)=>l.x-c.x);return[i[0],i[1],a[1],a[0]]}function ay(s,t,i){try{return sC(s,t,i)}catch{return rC(s,t)}}function rC(s,t,i){const a={x:s.reduce((c,f)=>c+f.x,0)/4,y:s.reduce((c,f)=>c+f.y,0)/4},l=(Math.hypot(s[1].x-s[0].x,s[1].y-s[0].y)+Math.hypot(s[2].x-s[3].x,s[2].y-s[3].y))/2;return{corners:s,center:a,size:l,rotationMatrix:[1,0,0,0,1,0,0,0,1],translation:[a.x-t/2,a.y,l*3],confidence:.65}}function sC(s,t,i){const a=window.cv,l=t*.9,c=t*.9,f=t/2,h=i/2,p=a.matFromArray(4,1,a.CV_32FC1,iC.flat()),m=a.matFromArray(4,1,a.CV_32FC1,[s[0].x,s[0].y,s[1].x,s[1].y,s[2].x,s[2].y,s[3].x,s[3].y]),g=a.matFromArray(3,3,a.CV_32FC1,[l,0,f,0,c,h,0,0,1]),_=a.matFromArray(4,1,a.CV_32FC1,[0,0,0,0]),v=new a.Mat,S=new a.Mat,E=new a.Mat;a.solvePnP(p,m,g,_,v,S),a.Rodrigues(v,E);const T=[];for(let L=0;L<9;L++)T.push(E.data32F[L]??E.floatAt(Math.floor(L/3),L%3));const M=[S.data32F[0]??S.floatAt(0,0),S.data32F[1]??S.floatAt(1,0),S.data32F[2]??S.floatAt(2,0)],y={x:s.reduce((L,w)=>L+w.x,0)/4,y:s.reduce((L,w)=>L+w.y,0)/4},P=(Math.hypot(s[1].x-s[0].x,s[1].y-s[0].y)+Math.hypot(s[2].x-s[3].x,s[2].y-s[3].y))/2;return p.delete(),m.delete(),g.delete(),_.delete(),v.delete(),S.delete(),E.delete(),{corners:s,center:y,size:P,rotationMatrix:T,translation:M,confidence:.8}}function oC(s){const t=(l,c)=>Math.hypot(l.x-c.x,l.y-c.y),i=[t(s[0],s[1]),t(s[1],s[2]),t(s[2],s[3]),t(s[3],s[0])],a=i.reduce((l,c)=>l+c,0)/4;return a<1?!1:i.every(l=>Math.abs(l-a)/a<.55)}function lC(s,t,i,a){const l=i*a;let c=null,f=0;for(let h=0;h<s.size();h++){const p=s.get(h),m=t.contourArea(p);if(m<l*.02){p.delete();continue}const g=t.arcLength(p,!0);for(const _ of[.02,.035,.05,.08]){const v=new t.Mat;if(t.approxPolyDP(p,v,_*g,!0),v.rows===4){const S=[];for(let T=0;T<4;T++)S.push({x:v.data32S[T*2],y:v.data32S[T*2+1]});const E=aC(S);E&&oC(E)&&m>f&&(f=m,c=E)}v.delete()}p.delete()}return c}function $v(s,t,i){var a;if(!((a=window.cv)!=null&&a.Mat))return null;try{const l=window.cv,c=l.imread(s),f=new l.Mat,h=new l.Mat,p=new l.Mat,m=new l.Mat,g=new l.MatVector,_=new l.Mat;l.cvtColor(c,f,l.COLOR_RGBA2RGB),l.cvtColor(f,h,l.COLOR_RGB2GRAY),l.GaussianBlur(h,p,new l.Size(5,5),0),l.Canny(p,m,20,80),l.findContours(m,g,_,l.RETR_LIST,l.CHAIN_APPROX_SIMPLE);const v=lC(g,l,t,i);return c.delete(),f.delete(),h.delete(),p.delete(),m.delete(),g.delete(),_.delete(),v}catch{return null}}function cC(s,t,i){const a=Ls(t,i),l=ey(s,a),c=ny(s,a);return iy(l,c)?{corners:G0(a),colors:l}:null}function ry(s,t,i){const a=Ls(t,i),l=document.createElement("canvas");l.width=a.size,l.height=a.size;const c=l.getContext("2d");if(c){c.drawImage(s,a.x,a.y,a.size,a.size,0,0,a.size,a.size);const p=$v(l,a.size,a.size);if(p)return uR(p,a.x,a.y)}const f=$v(s,t,i);if(f)return f;const h=cC(s,t,i);return(h==null?void 0:h.corners)??null}function t0(s,t,i){const a=Ls(t,i),l=ey(s,a),c=ny(s,a);if(!iy(l,c))return null;const f=ry(s,t,i),h=ay(f??G0(a),t,i);return h.confidence=f?.85:.7,{colors:l,pose:h}}function uC(s){const t=window.cv,i=t.imread(s),a=new t.Mat;return t.cvtColor(i,a,t.COLOR_RGBA2GRAY),i.delete(),a}const e0=45;class fC{constructor(){qe(this,"prevGray",null);qe(this,"trackedCorners",null);qe(this,"lostFrames",0)}getLostFrames(){return this.lostFrames}reset(){var t;(t=this.prevGray)==null||t.delete(),this.prevGray=null,this.trackedCorners=null,this.lostFrames=0}update(t,i){var g;const a=window.cv;if(i)return this.trackedCorners=i,this.lostFrames=0,(g=this.prevGray)==null||g.delete(),this.prevGray=t.clone(),i;if(!this.prevGray||!this.trackedCorners)return null;const l=a.matFromArray(4,1,a.CV_32FC2,hC(this.trackedCorners)),c=new a.Mat,f=new a.Mat,h=new a.Mat;a.calcOpticalFlowPyrLK(this.prevGray,t,l,c,f,h);const p=[];let m=0;for(let _=0;_<4;_++){const v=f.data[_]===1,S=c.data32F[_*2],E=c.data32F[_*2+1];v&&Number.isFinite(S)&&Number.isFinite(E)?(p.push({x:S,y:E}),m++):p.push(this.trackedCorners[_])}return l.delete(),c.delete(),f.delete(),h.delete(),this.prevGray.delete(),this.prevGray=t.clone(),m<2?(this.lostFrames++,this.lostFrames>e0?(this.reset(),null):this.trackedCorners):(this.trackedCorners=p,this.lostFrames++,this.lostFrames>e0?(this.reset(),null):this.trackedCorners)}}function hC(s){return s.flatMap(t=>[t.x,t.y])}const dC=.65,pC=4;class mC{constructor(){qe(this,"state",{lastMatrix:Kv(),stableCount:0,pendingMove:null});qe(this,"initialized",!1)}reset(){this.state={lastMatrix:Kv(),stableCount:0,pendingMove:null},this.initialized=!1}update(t){if(!this.initialized)return this.state.lastMatrix=[...t],this.initialized=!0,null;const i=OR(gC(t),this.state.lastMatrix),a=vC(i);if(a)if(this.state.pendingMove===a){if(this.state.stableCount++,this.state.stableCount>=pC)return this.state.lastMatrix=[...t],this.state.pendingMove=null,this.state.stableCount=0,a}else this.state.pendingMove=a,this.state.stableCount=1;else this.state.pendingMove=null,this.state.stableCount=0,this.state.lastMatrix=_C(this.state.lastMatrix,t,.15);return null}sync(t){this.state.lastMatrix=[...t],this.state.pendingMove=null,this.state.stableCount=0,this.initialized=!0}}function gC(s){return[s[0],s[3],s[6],s[1],s[4],s[7],s[2],s[5],s[8]]}function _C(s,t,i){return s.map((a,l)=>a*(1-i)+t[l]*i)}function vC(s){const t=["R","R'","R2","L","L'","L2","U","U'","U2","D","D'","D2","F","F'","F2","B","B'","B2"];let i=null,a=dC;for(const l of t){const c=I0(l);let f=nR[c];(c==="L"||c==="D"||c==="B")&&(f=[-f[0],-f[1],-f[2]]);const h=zR(f,B0(l)),p=yC(s,h);p>a&&(a=p,i=l)}return i}function yC(s,t){let i=0;for(let a=0;a<9;a++)i+=1-Math.abs(s[a]-t[a])/2;return i/9}class xC{constructor(){qe(this,"rotationDetector",new mC);qe(this,"flowTracker",new fC);qe(this,"trackingEnabled",!1);qe(this,"processCanvas");qe(this,"processCtx");qe(this,"lastColors",null);this.processCanvas=document.createElement("canvas");const t=this.processCanvas.getContext("2d",{willReadFrequently:!0});if(!t)throw new Error("Canvas 2D context unavailable");this.processCtx=t}enableTracking(){this.trackingEnabled=!0,this.rotationDetector.reset(),this.flowTracker.reset()}disableTracking(){this.trackingEnabled=!1,this.rotationDetector.reset(),this.flowTracker.reset(),this.lastColors=null}syncPose(t){this.rotationDetector.sync(t.rotationMatrix)}getFrameCanvas(){return this.processCanvas}captureFrame(t){const i=t.videoWidth,a=t.videoHeight;return!i||!a?!1:(this.processCanvas.width=i,this.processCanvas.height=a,Yv(this.processCtx,t,i,a),!0)}getColorLearnSample(t,i,a){return V0(this.processCanvas,t,i,a)}process(t){const i=t.videoWidth,a=t.videoHeight;if(!i||!a)return{pose:null,detectedFace:null,rotationMove:null};this.processCanvas.width=i,this.processCanvas.height=a,Yv(this.processCtx,t,i,a);try{return this.trackingEnabled?this.processWithTracking(i,a):this.processDetectionOnly(i,a)}catch{return{pose:null,detectedFace:null,rotationMove:null}}}processDetectionOnly(t,i){const a=t0(this.processCanvas,t,i);return a?(this.lastColors=a.colors,{pose:a.pose,detectedFace:a,rotationMove:null}):{pose:null,detectedFace:null,rotationMove:null}}processWithTracking(t,i){const a=ry(this.processCanvas,t,i),l=uC(this.processCanvas),c=this.flowTracker.update(l,a);if(l.delete(),!c)return{pose:null,detectedFace:null,rotationMove:null};let f=this.lastColors;if(a){const g=t0(this.processCanvas,t,i);g&&(f=g.colors,this.lastColors=f)}const h=ay(c,t,i);h.confidence=a?.85:Math.max(.35,.85-this.flowTracker.getLostFrames()*.01);const p=f?{colors:f,pose:h}:null,m=this.rotationDetector.update(h.rotationMatrix);return{pose:h,detectedFace:p,rotationMove:m}}readStableFace(t,i=5){const a=[];let l=null;for(let f=0;f<i;f++){const h=this.process(t);if(!h.detectedFace)return null;a.push(h.detectedFace.colors),l=h.detectedFace.pose}return l?{colors:SC(a),pose:l}:null}}function SC(s){const t=[];for(let i=0;i<9;i++){const a=new Map;for(const f of s){const h=f[i];a.set(h,(a.get(h)??0)+1)}let l="W",c=0;for(const[f,h]of a)h>c&&(c=h,l=f);t.push(l)}return t}const MC=[0,1,2,3,5,6,7,8],Rc=2e3,EC=10,TC=7,bC=6;function AC(s,t){let i=0;for(const a of MC)s[a]===t[a]&&i++;return i}function RC(s,t){let i=0;for(let a=0;a<9;a++)s[a]===t[a]&&i++;return i}function CC(s,t){return AC(s,t)>=TC}function sy(s,t){for(const[i,a]of t)if(CC(s,a))return i;return null}function wC(s){const t=[];for(let i=0;i<9;i++){const a=new Map;for(const f of s){const h=f[i];a.set(h,(a.get(h)??0)+1)}let l="W",c=0;for(const[f,h]of a)h>c&&(c=h,l=f);t.push(l)}return t}function DC(s){if(s.length===0)return null;const t=new Map;for(const l of s){const c=l[4];t.set(c,(t.get(c)??0)+1)}let i=null,a=0;for(const[l,c]of t)c>a&&(a=c,i=l);return i}function UC(s,t,i){if(sy(s,t))return null;for(const a of[DC(i),s[4]]){if(!a)continue;const l=Fo(a);if(l&&!t.has(l))return l}return null}function n0(s){if(s.size!==6)return s;const t=new Map,i=new Set,a=[...s.entries()].sort((l,c)=>{const f=Fo(l[1][4])===l[0]?0:1,h=Fo(c[1][4])===c[0]?0:1;return f-h});for(const[,l]of a){const c=Fo(l[4]);c&&!i.has(c)&&(t.set(c,[...l]),i.add(c))}return t.size===6?t:s}class LC{constructor(){qe(this,"faces",new Map);qe(this,"pendingReadings",[]);qe(this,"stableSinceMs",null);qe(this,"stabilityAnchor",null)}reset(){this.faces.clear(),this.pendingReadings=[],this.stableSinceMs=null,this.stabilityAnchor=null}update(t,i=Date.now()){const a=Rc/1e3,l={faces:this.faces,knownFaces:[...this.faces.keys()],currentFace:null,stableProgress:0,stableTarget:a,isComplete:this.faces.size===6,newlyCaptured:null,needsNewFace:!1,needsClearerCenter:!1};if(!t||t.length!==9)return this.stableSinceMs=null,this.stabilityAnchor=null,this.pendingReadings=[],l;const c=Fo(t[4]),f=sy(t,this.faces);if(f)return this.stableSinceMs=null,this.stabilityAnchor=null,this.pendingReadings=[],{...l,currentFace:f,needsNewFace:!0};!this.stabilityAnchor||RC(t,this.stabilityAnchor)<bC?(this.stabilityAnchor=[...t],this.stableSinceMs=i,this.pendingReadings=[]):this.stableSinceMs===null&&(this.stableSinceMs=i);const h=this.stableSinceMs!==null?i-this.stableSinceMs:0,p=Math.min(h,Rc)/1e3;let m=null,g=!1;if(h>=Rc){const _=[...this.pendingReadings,[...t]];_.length>EC&&_.shift(),this.pendingReadings=_;const v=wC(_),S=UC(v,this.faces,_);if(S){const E=!this.faces.has(S);this.faces.set(S,[...v]),E&&(m=S),this.stableSinceMs=null,this.stabilityAnchor=null,this.pendingReadings=[]}else g=!0,this.stableSinceMs=i-Rc+400}return{faces:this.faces,knownFaces:[...this.faces.keys()],currentFace:c,stableProgress:Math.round(p*10)/10,stableTarget:a,isComplete:this.faces.size===6,newlyCaptured:m,needsNewFace:!1,needsClearerCenter:g}}}const NC="https://docs.opencv.org/4.9.0/opencv.js";let Cc=null;function OC(){return Cc||(Cc=new Promise((s,t)=>{var a;if((a=window.cv)!=null&&a.Mat){s();return}const i=document.createElement("script");i.src=NC,i.async=!0,i.onload=()=>{(()=>{var c;(c=window.cv)!=null&&c.Mat?s():(window.cv=window.cv??{},window.cv.onRuntimeInitialized=()=>s())})()},i.onerror=()=>t(new Error("Failed to load OpenCV.js")),document.head.appendChild(i)}),Cc)}function i0(s){return Object.fromEntries(q0(s))}const Oo={status:"searching",stableProgress:0,stableTarget:0,detectedCenter:null,colorCounts:Yo(),cellColors:[]},zC={phase:"loading",error:null,knownFaces:[],scannedFaceColors:{},currentVisibleFace:null,liveScanProgress:0,solution:null,currentPose:null,solverReady:!1,detectionFeedback:Oo,colorLearnIndex:0,colorLearnSample:null,colorLearnReady:!1,colorLearnError:null,colorsCalibrated:!1,liveScanNeedsClearerCenter:!1};function PC(s){const[t,i]=Vt.useState(zC),a=Vt.useRef(null),l=Vt.useRef(null),c=Vt.useRef(new LC),f=Vt.useRef(""),h=Vt.useRef(0),p=Vt.useRef(0),m=Vt.useRef("loading"),g=Vt.useRef(0),_=Vt.useRef(null),v=Vt.useRef(0),S=Vt.useRef(null),E=Vt.useRef(null),T=Vt.useRef(!1),M=Vt.useCallback(()=>{S.current&&(clearTimeout(S.current),S.current=null)},[]),y=Vt.useCallback((U,V,I,ft)=>{var J;const xt=l.current;if(!xt){i(ht=>({...ht,phase:"error",error:"Solver failed to start. Refresh the page and try again."}));return}M();const O=++p.current;xt.postMessage({type:"solve",facelet:U,scannedFaces:Object.fromEntries(I),captures:ft,id:O}),(J=a.current)==null||J.syncPose(V),S.current=setTimeout(()=>{i(ht=>ht.phase!=="computing"?ht:{...ht,phase:"error",error:"Solve timed out. Colors may have been misread — re-scan in steady light."})},45e3)},[M]);Vt.useEffect(()=>{m.current=t.phase,_.current=t.solution,g.current=t.colorLearnIndex},[t.phase,t.solution,t.colorLearnIndex]);const P=Vt.useCallback(U=>{var I;const V=++p.current;(I=l.current)==null||I.postMessage({type:"apply",move:U,facelet:f.current,id:V}),i(ft=>{if(!ft.solution)return ft;const xt=ft.solution.moves[ft.solution.currentIndex];if(U!==xt)return ft;const O=ft.solution.currentIndex+1;return O>=ft.solution.moves.length?{...ft,phase:"solved",solution:{...ft.solution,currentIndex:O}}:{...ft,solution:{...ft.solution,currentIndex:O}}})},[]),L=Vt.useCallback((U,V,I,ft,xt,O)=>{const{detectedCenter:J,colorCounts:ht}=jR(V),q=$0(V);let ct="searching";return!U||!q?ct="searching":O?ct="rotate":xt?ct="captured":I>0&&I<ft?ct="stabilizing":ct="detected",{status:ct,stableProgress:I,stableTarget:ft,detectedCenter:J,colorCounts:ht,cellColors:q&&V?[...V]:[]}},[]),w=Vt.useCallback(()=>{var U;c.current.reset(),T.current=!1,E.current=null,i(V=>({...V,phase:"scanReady",error:null,knownFaces:[],scannedFaceColors:{},currentVisibleFace:null,liveScanProgress:0,detectionFeedback:Oo,liveScanNeedsClearerCenter:!1})),(U=a.current)==null||U.disableTracking()},[]),X=Vt.useCallback(()=>{var U;c.current.reset(),T.current=!1,E.current=null,i(V=>({...V,phase:"liveScan",error:null,knownFaces:[],scannedFaceColors:{},currentVisibleFace:null,liveScanProgress:0,detectionFeedback:Oo,liveScanNeedsClearerCenter:!1})),(U=a.current)==null||U.disableTracking()},[]),F=Vt.useCallback(async()=>{try{await OC(),a.current=new xC;const U=PR();l.current=U,U.onmessage=V=>{var ft;const I=V.data;if(I.type==="ready")i(xt=>({...xt,solverReady:!0}));else if(I.type==="solution"){if(I.id!==p.current)return;M(),f.current=I.facelet,v.current=Date.now(),i(xt=>({...xt,phase:I.moves.length===0?"solved":"solving",solution:{moves:I.moves,currentIndex:0},detectionFeedback:Oo})),I.moves.length>0&&((ft=a.current)==null||ft.enableTracking())}else if(I.type==="facelet"){if(I.id!==p.current)return;f.current=I.facelet}else if(I.type==="error"){if(I.id!==void 0&&I.id!==p.current)return;M(),T.current=!1,i(xt=>({...xt,phase:"error",error:I.message}))}},U.onerror=()=>{M(),i(V=>({...V,phase:"error",error:"Solver failed to load. Refresh the page and try again."}))},U.postMessage({type:"init"}),qv(),c.current.reset(),i(V=>({...V,phase:"colorLearn",colorLearnIndex:0,colorLearnSample:null,colorLearnReady:!1,colorLearnError:null,colorsCalibrated:!1}))}catch(U){i(V=>({...V,phase:"error",error:U instanceof Error?U.message:"Init failed"}))}},[M]);Vt.useEffect(()=>(F(),()=>{var U,V;cancelAnimationFrame(h.current),M(),(U=l.current)==null||U.terminate(),(V=a.current)==null||V.disableTracking()}),[F,M]);const z=Vt.useCallback(()=>{const U=s.current,V=a.current;if(!U||!V||U.readyState<2||!V.captureFrame(U))return;const I=g.current,ft=Xa[I];if(!ft)return;const xt=V.getFrameCanvas();if(!yR(xt,U.videoWidth,U.videoHeight,ft)){i(ht=>({...ht,colorLearnError:`Could not read ${ft}. Center the sticker in the circle.`}));return}const J=I+1;if(J>=Xa.length){w(),i(ht=>({...ht,colorsCalibrated:!0,colorLearnError:null}));return}i(ht=>({...ht,colorLearnIndex:J,colorLearnSample:null,colorLearnReady:!1,colorLearnError:null}))},[s,w]),W=Vt.useCallback(()=>{X()},[X]),D=Vt.useCallback(()=>{var xt,O;const U=s.current,V=a.current;if(!U||!V||U.readyState<2)return;const I=V.process(U),ft=m.current;if(ft==="colorLearn"){V.captureFrame(U);const J=Xa[g.current];if(J){const ht=V.getColorLearnSample(U.videoWidth,U.videoHeight,J);i(q=>({...q,colorLearnSample:ht,colorLearnReady:(ht==null?void 0:ht.ready)??!1,colorLearnError:null}))}return}if(ft==="scanReady"){const J=((xt=I.detectedFace)==null?void 0:xt.colors)??null,ht=!!I.pose;i(q=>({...q,detectionFeedback:L(ht,J,0,0,!1,!1)}));return}if(ft==="liveScan"){if(!Qd()){i(St=>({...St,phase:"colorLearn",colorsCalibrated:!1,colorLearnIndex:0}));return}const J=((O=I.detectedFace)==null?void 0:O.colors)??null,ht=!!I.pose;I.pose&&(E.current=I.pose);const q=c.current.update(J),ct=!!q.newlyCaptured;if(q.isComplete&&E.current&&!T.current){T.current=!0;const St=n0(q0(q.faces)),Mt=i0(St),Pt=[...St.values()].map(Ht=>[...Ht]);try{let Ht=St;if(!Jv(Ht)&&(Ht=tC(St),!Jv(Ht))){const be=nC(St);i(fe=>({...fe,phase:"error",scannedFaceColors:Mt,error:be?`Color mismatch (${be}). Re-learn colors or re-scan.`:"Color mismatch. Scan all 6 unique faces."}));return}const qt=LR(Ht),Ue=E.current;i(be=>({...be,phase:"computing",knownFaces:q.knownFaces,scannedFaceColors:Mt,liveScanProgress:1,currentPose:Ue})),queueMicrotask(()=>y(qt,Ue,St,Pt))}catch(Ht){i(qt=>({...qt,phase:"error",scannedFaceColors:Mt,error:Ht instanceof Error?Ht.message:"Failed to build cube state"}))}return}i(St=>({...St,currentPose:I.pose,knownFaces:q.knownFaces,scannedFaceColors:i0(n0(q.faces)),currentVisibleFace:q.currentFace,liveScanProgress:q.knownFaces.length/6,liveScanNeedsClearerCenter:q.needsClearerCenter,detectionFeedback:L(ht,J,q.stableProgress,q.stableTarget,ct,q.needsNewFace)}));return}if(i(J=>({...J,currentPose:I.pose})),ft==="solving"&&I.rotationMove){if(Date.now()-v.current<3e3)return;const J=_.current;if(J){const ht=J.moves[J.currentIndex];I.rotationMove===ht&&(P(I.rotationMove),I.pose&&V.syncPose(I.pose))}}},[s,P,L,y]),R=Vt.useCallback(()=>{D(),h.current=requestAnimationFrame(R)},[D]),G=Vt.useCallback(()=>{cancelAnimationFrame(h.current),h.current=requestAnimationFrame(R)},[R]),nt=Vt.useCallback(()=>{cancelAnimationFrame(h.current)},[]),$=Vt.useCallback(()=>{M(),w(),i(U=>({...U,solution:null}))},[M,w]),lt=Vt.useCallback(()=>{var U;M(),T.current=!1,c.current.reset(),E.current=null,qv(),(U=a.current)==null||U.disableTracking(),i(V=>({...V,phase:"colorLearn",error:null,solution:null,knownFaces:[],scannedFaceColors:{},currentVisibleFace:null,liveScanProgress:0,colorLearnIndex:0,colorLearnSample:null,colorLearnReady:!1,colorLearnError:null,colorsCalibrated:!1,detectionFeedback:Oo,liveScanNeedsClearerCenter:!1}))},[M]),gt=t.solution&&t.solution.currentIndex<t.solution.moves.length?t.solution.moves[t.solution.currentIndex]??null:null;return{state:t,currentMove:gt,confirmColorLearn:z,startLiveScan:W,retryLiveScan:$,retryColorLearn:lt,startTracking:G,stopTracking:nt}}function FC(){const s=Vt.useRef(null),t=Vt.useRef(null),[i,a]=Vt.useState({stream:null,error:null,isReady:!1}),l=Vt.useCallback(async p=>{const m=t.current;if(!(!m||p.srcObject===m)){p.srcObject=m;try{await p.play()}catch{}}},[]),c=Vt.useCallback(p=>{s.current=p,p&&l(p)},[l]),f=Vt.useCallback(async()=>{try{const p=await navigator.mediaDevices.getUserMedia({video:{facingMode:{ideal:"user"},width:{ideal:1280},height:{ideal:720},frameRate:{ideal:60}},audio:!1});t.current=p;const m=s.current;m&&await l(m),a({stream:p,error:null,isReady:!0})}catch(p){t.current=null,a({stream:null,error:p instanceof Error?p.message:"Camera access failed",isReady:!1})}},[l]),h=Vt.useCallback(()=>{var p;(p=t.current)==null||p.getTracks().forEach(m=>m.stop()),t.current=null,s.current&&(s.current.srcObject=null),a({stream:null,error:null,isReady:!1})},[]);return Vt.useEffect(()=>()=>h(),[h]),{videoRef:s,setVideoRef:c,state:i,start:f,stop:h}}function oy(s,t,i,a){const l=Math.max(i/s,a/t),c=s*l,f=t*l;return{scale:l,offsetX:(i-c)/2,offsetY:(a-f)/2}}function BC(s,t,i,a){if(!s||!t||!i||!a)return null;const l=Ls(s,t),{scale:c,offsetX:f,offsetY:h}=oy(s,t,i,a);return{left:f+l.x*c,top:h+l.y*c,width:l.size*c,height:l.size*c}}function IC(s,t,i,a){if(!s||!t||!i||!a)return null;const l=Ls(s,t),c=H0(l),{scale:f,offsetX:h,offsetY:p}=oy(s,t,i,a);return{left:h+c.x*f,top:p+c.y*f,width:c.size*f,height:c.size*f}}const HC="1.0.3";function GC(){var lt,gt;const{videoRef:s,setVideoRef:t,state:i,start:a}=FC(),{state:l,currentMove:c,confirmColorLearn:f,startLiveScan:h,retryLiveScan:p,retryColorLearn:m,startTracking:g,stopTracking:_}=PC(s),v=Vt.useRef(null),[S,E]=Vt.useState({width:0,height:0}),[T,M]=Vt.useState({width:0,height:0}),[y,P]=Vt.useState(W0),L=Vt.useCallback(()=>{P(U=>{const V=!U;return MR(V),V})},[]);Vt.useEffect(()=>{a()},[a]),Vt.useEffect(()=>{if(i.isReady&&l.phase!=="loading")return g(),_},[i.isReady,l.phase,g,_]);const w=Vt.useCallback((U,V)=>{E({width:U,height:V})},[]);Vt.useEffect(()=>{const U=v.current;if(!U)return;const V=()=>{M({width:U.clientWidth,height:U.clientHeight})};V();const I=new ResizeObserver(V);return I.observe(U),()=>I.disconnect()},[]);const X=Vt.useMemo(()=>BC(S.width,S.height,T.width,T.height),[S.width,S.height,T.width,T.height]),F=Vt.useMemo(()=>IC(S.width,S.height,T.width,T.height),[S.width,S.height,T.width,T.height]),z=l.phase==="loading"||!i.isReady,W=!!(l.error||i.error),D=l.phase==="computing",R=l.phase==="solving",G=((lt=l.solution)==null?void 0:lt.moves.length)??0,nt=(((gt=l.solution)==null?void 0:gt.currentIndex)??0)+1,$=l.phase==="liveScan"||l.phase==="computing"||W&&Object.keys(l.scannedFaceColors).length>0;return At.jsxs("main",{className:"app",children:[At.jsxs("div",{className:`viewport${l.phase==="liveScan"?" viewport--scanning":""}`,ref:v,children:[At.jsx(oR,{setVideoRef:t,onDimensions:w}),!z&&!W&&At.jsxs(At.Fragment,{children:[At.jsx(sR,{pose:l.currentPose,move:c,width:S.width,height:S.height,active:R}),At.jsx(SR,{visible:l.phase==="colorLearn",stepIndex:l.colorLearnIndex,sample:l.colorLearnSample,ready:l.colorLearnReady,error:l.colorLearnError,onConfirm:f,guideRect:X,spotRect:F}),At.jsx(DR,{visible:l.phase==="scanReady",feedback:l.detectionFeedback,guideRect:X,onStart:h}),At.jsx(Hh,{visible:$,scannedFaces:l.scannedFaceColors,displayMirror:y,onFlipPreview:L}),At.jsx(bR,{feedback:l.detectionFeedback,visible:l.phase==="liveScan",guideRect:X,displayMirror:y}),At.jsx(UR,{phase:l.phase,currentStep:nt,totalSteps:G}),At.jsx(AR,{phase:l.phase,knownFaces:l.knownFaces,progress:l.liveScanProgress,needsNewFace:l.detectionFeedback.status==="rotate",needsClearerCenter:l.liveScanNeedsClearerCenter}),l.phase==="solving"&&c&&At.jsx("div",{className:"solving-banner",children:At.jsx("p",{className:"solving-move",children:c})}),l.phase==="solved"&&At.jsx("div",{className:"solved-banner",children:At.jsx("p",{children:"Done"})})]}),D&&At.jsxs(At.Fragment,{children:[At.jsx(Hh,{visible:$,scannedFaces:l.scannedFaceColors,displayMirror:y,onFlipPreview:L}),At.jsx(Zv,{overlay:!0,message:"Computing…"})]}),z&&At.jsx(Zv,{overlay:!0,message:l.phase==="loading"?"Loading…":"Camera…"}),W&&!z&&At.jsxs("div",{className:"error-screen overlay",children:[At.jsx(Hh,{visible:$,scannedFaces:l.scannedFaceColors,displayMirror:y,onFlipPreview:L}),At.jsx("p",{children:l.error??i.error}),At.jsxs("div",{className:"error-actions",children:[l.colorsCalibrated&&At.jsx("button",{type:"button",className:"error-button primary",onClick:p,children:"Re-scan"}),At.jsx("button",{type:"button",className:"error-button secondary",onClick:m,children:"Re-learn colors"})]})]})]}),At.jsxs("p",{className:"app-version","aria-hidden":"true",children:["v",HC]})]})}CS({immediate:!0});TS.createRoot(document.getElementById("root")).render(At.jsx(Vt.StrictMode,{children:At.jsx(GC,{})}));
