 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var B_;function lS(){if(B_)return re;B_=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.for("react.activity"),v=Symbol.iterator;function S(O){return O===null||typeof O!="object"?null:(O=v&&O[v]||O["@@iterator"],typeof O=="function"?O:null)}var E={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,M={};function y(O,J,dt){this.props=O,this.context=J,this.refs=M,this.updater=dt||E}y.prototype.isReactComponent={},y.prototype.setState=function(O,J){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,J,"setState")},y.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function P(){}P.prototype=y.prototype;function L(O,J,dt){this.props=O,this.context=J,this.refs=M,this.updater=dt||E}var w=L.prototype=new P;w.constructor=L,T(w,y.prototype),w.isPureReactComponent=!0;var k=Array.isArray;function B(){}var z={H:null,A:null,T:null,S:null},X=Object.prototype.hasOwnProperty;function D(O,J,dt){var q=dt.ref;return{$$typeof:s,type:O,key:J,ref:q!==void 0?q:null,props:dt}}function R(O,J){return D(O.type,J,O.props)}function G(O){return typeof O=="object"&&O!==null&&O.$$typeof===s}function nt(O){var J={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(dt){return J[dt]})}var $=/\/+/g;function lt(O,J){return typeof O=="object"&&O!==null&&O.key!=null?nt(""+O.key):J.toString(36)}function vt(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(B,B):(O.status="pending",O.then(function(J){O.status==="pending"&&(O.status="fulfilled",O.value=J)},function(J){O.status==="pending"&&(O.status="rejected",O.reason=J)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function U(O,J,dt,q,ct){var St=typeof O;(St==="undefined"||St==="boolean")&&(O=null);var Mt=!1;if(O===null)Mt=!0;else switch(St){case"bigint":case"string":case"number":Mt=!0;break;case"object":switch(O.$$typeof){case s:case t:Mt=!0;break;case g:return Mt=O._init,U(Mt(O._payload),J,dt,q,ct)}}if(Mt)return ct=ct(O),Mt=q===""?"."+lt(O,0):q,k(ct)?(dt="",Mt!=null&&(dt=Mt.replace($,"$&/")+"/"),U(ct,J,dt,"",function(Gt){return Gt})):ct!=null&&(G(ct)&&(ct=R(ct,dt+(ct.key==null||O&&O.key===ct.key?"":(""+ct.key).replace($,"$&/")+"/")+Mt)),J.push(ct)),1;Mt=0;var zt=q===""?".":q+":";if(k(O))for(var qt=0;qt<O.length;qt++)q=O[qt],St=zt+lt(q,qt),Mt+=U(q,J,dt,St,ct);else if(qt=S(O),typeof qt=="function")for(O=qt.call(O),qt=0;!(q=O.next()).done;)q=q.value,St=zt+lt(q,qt++),Mt+=U(q,J,dt,St,ct);else if(St==="object"){if(typeof O.then=="function")return U(vt(O),J,dt,q,ct);throw J=String(O),Error("Objects are not valid as a React child (found: "+(J==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":J)+"). If you meant to render a collection of children, use an array instead.")}return Mt}function W(O,J,dt){if(O==null)return O;var q=[],ct=0;return U(O,q,"","",function(St){return J.call(dt,St,ct++)}),q}function I(O){if(O._status===-1){var J=O._result;J=J(),J.then(function(dt){(O._status===0||O._status===-1)&&(O._status=1,O._result=dt)},function(dt){(O._status===0||O._status===-1)&&(O._status=2,O._result=dt)}),O._status===-1&&(O._status=0,O._result=J)}if(O._status===1)return O._result.default;throw O._result}var ft=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var J=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(J))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)},xt={map:W,forEach:function(O,J,dt){W(O,function(){J.apply(this,arguments)},dt)},count:function(O){var J=0;return W(O,function(){J++}),J},toArray:function(O){return W(O,function(J){return J})||[]},only:function(O){if(!G(O))throw Error("React.Children.only expected to receive a single React element child.");return O}};return re.Activity=_,re.Children=xt,re.Component=y,re.Fragment=i,re.Profiler=l,re.PureComponent=L,re.StrictMode=a,re.Suspense=p,re.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,re.__COMPILER_RUNTIME={__proto__:null,c:function(O){return z.H.useMemoCache(O)}},re.cache=function(O){return function(){return O.apply(null,arguments)}},re.cacheSignal=function(){return null},re.cloneElement=function(O,J,dt){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var q=T({},O.props),ct=O.key;if(J!=null)for(St in J.key!==void 0&&(ct=""+J.key),J)!X.call(J,St)||St==="key"||St==="__self"||St==="__source"||St==="ref"&&J.ref===void 0||(q[St]=J[St]);var St=arguments.length-2;if(St===1)q.children=dt;else if(1<St){for(var Mt=Array(St),zt=0;zt<St;zt++)Mt[zt]=arguments[zt+2];q.children=Mt}return D(O.type,ct,q)},re.createContext=function(O){return O={$$typeof:f,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:c,_context:O},O},re.createElement=function(O,J,dt){var q,ct={},St=null;if(J!=null)for(q in J.key!==void 0&&(St=""+J.key),J)X.call(J,q)&&q!=="key"&&q!=="__self"&&q!=="__source"&&(ct[q]=J[q]);var Mt=arguments.length-2;if(Mt===1)ct.children=dt;else if(1<Mt){for(var zt=Array(Mt),qt=0;qt<Mt;qt++)zt[qt]=arguments[qt+2];ct.children=zt}if(O&&O.defaultProps)for(q in Mt=O.defaultProps,Mt)ct[q]===void 0&&(ct[q]=Mt[q]);return D(O,St,ct)},re.createRef=function(){return{current:null}},re.forwardRef=function(O){return{$$typeof:h,render:O}},re.isValidElement=G,re.lazy=function(O){return{$$typeof:g,_payload:{_status:-1,_result:O},_init:I}},re.memo=function(O,J){return{$$typeof:m,type:O,compare:J===void 0?null:J}},re.startTransition=function(O){var J=z.T,dt={};z.T=dt;try{var q=O(),ct=z.S;ct!==null&&ct(dt,q),typeof q=="object"&&q!==null&&typeof q.then=="function"&&q.then(B,ft)}catch(St){ft(St)}finally{J!==null&&dt.types!==null&&(J.types=dt.types),z.T=J}},re.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},re.use=function(O){return z.H.use(O)},re.useActionState=function(O,J,dt){return z.H.useActionState(O,J,dt)},re.useCallback=function(O,J){return z.H.useCallback(O,J)},re.useContext=function(O){return z.H.useContext(O)},re.useDebugValue=function(){},re.useDeferredValue=function(O,J){return z.H.useDeferredValue(O,J)},re.useEffect=function(O,J){return z.H.useEffect(O,J)},re.useEffectEvent=function(O){return z.H.useEffectEvent(O)},re.useId=function(){return z.H.useId()},re.useImperativeHandle=function(O,J,dt){return z.H.useImperativeHandle(O,J,dt)},re.useInsertionEffect=function(O,J){return z.H.useInsertionEffect(O,J)},re.useLayoutEffect=function(O,J){return z.H.useLayoutEffect(O,J)},re.useMemo=function(O,J){return z.H.useMemo(O,J)},re.useOptimistic=function(O,J){return z.H.useOptimistic(O,J)},re.useReducer=function(O,J,dt){return z.H.useReducer(O,J,dt)},re.useRef=function(O){return z.H.useRef(O)},re.useState=function(O){return z.H.useState(O)},re.useSyncExternalStore=function(O,J,dt){return z.H.useSyncExternalStore(O,J,dt)},re.useTransition=function(){return z.H.useTransition()},re.version="19.2.7",re}var F_;function Od(){return F_||(F_=1,$f.exports=lS()),$f.exports}var Wt=Od(),th={exports:{}},Co={},eh={exports:{}},nh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var k_;function dS(){if(k_)return Co;k_=1;var s=uS(),t=Od(),i=hS();function a(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var r=2;r<arguments.length;r++)n+="&args[]="+encodeURIComponent(arguments[r])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function c(e){var n=e,r=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(r=n.return),e=n.return;while(e)}return n.tag===3?r:null}function f(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function h(e){if(e.tag===31){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function p(e){if(c(e)!==e)throw Error(a(188))}function m(e){var n=e.alternate;if(!n){if(n=c(e),n===null)throw Error(a(188));return n!==e?null:e}for(var r=e,o=n;;){var u=r.return;if(u===null)break;var d=u.alternate;if(d===null){if(o=u.return,o!==null){r=o;continue}break}if(u.child===d.child){for(d=u.child;d;){if(d===r)return p(u),e;if(d===o)return p(u),n;d=d.sibling}throw Error(a(188))}if(r.return!==o.return)r=u,o=d;else{for(var x=!1,b=u.child;b;){if(b===r){x=!0,r=u,o=d;break}if(b===o){x=!0,o=u,r=d;break}b=b.sibling}if(!x){for(b=d.child;b;){if(b===r){x=!0,r=d,o=u;break}if(b===o){x=!0,o=d,r=u;break}b=b.sibling}if(!x)throw Error(a(189))}}if(r.alternate!==o)throw Error(a(190))}if(r.tag!==3)throw Error(a(188));return r.stateNode.current===r?e:n}function g(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=g(e),n!==null)return n;e=e.sibling}return null}var _=Object.assign,v=Symbol.for("react.element"),S=Symbol.for("react.transitional.element"),E=Symbol.for("react.portal"),T=Symbol.for("react.fragment"),M=Symbol.for("react.strict_mode"),y=Symbol.for("react.profiler"),P=Symbol.for("react.consumer"),L=Symbol.for("react.context"),w=Symbol.for("react.forward_ref"),k=Symbol.for("react.suspense"),B=Symbol.for("react.suspense_list"),z=Symbol.for("react.memo"),X=Symbol.for("react.lazy"),D=Symbol.for("react.activity"),R=Symbol.for("react.memo_cache_sentinel"),G=Symbol.iterator;function nt(e){return e===null||typeof e!="object"?null:(e=G&&e[G]||e["@@iterator"],typeof e=="function"?e:null)}var $=Symbol.for("react.client.reference");function lt(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===$?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case T:return"Fragment";case y:return"Profiler";case M:return"StrictMode";case k:return"Suspense";case B:return"SuspenseList";case D:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case E:return"Portal";case L:return e.displayName||"Context";case P:return(e._context.displayName||"Context")+".Consumer";case w:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case z:return n=e.displayName||null,n!==null?n:lt(e.type)||"Memo";case X:n=e._payload,e=e._init;try{return lt(e(n))}catch{}}return null}var vt=Array.isArray,U=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,W=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,I={pending:!1,data:null,method:null,action:null},ft=[],xt=-1;function O(e){return{current:e}}function J(e){0>xt||(e.current=ft[xt],ft[xt]=null,xt--)}function dt(e,n){xt++,ft[xt]=e.current,e.current=n}var q=O(null),ct=O(null),St=O(null),Mt=O(null);function zt(e,n){switch(dt(St,n),dt(ct,e),dt(q,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?a_(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=a_(n),e=r_(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}J(q),dt(q,e)}function qt(){J(q),J(ct),J(St)}function Gt(e){e.memoizedState!==null&&dt(Mt,e);var n=q.current,r=r_(n,e.type);n!==r&&(dt(ct,e),dt(q,r))}function De(e){ct.current===e&&(J(q),J(ct)),Mt.current===e&&(J(Mt),Eo._currentValue=I)}var Ge,fe;function H(e){if(Ge===void 0)try{throw Error()}catch(r){var n=r.stack.trim().match(/\n( *(at )?)/);Ge=n&&n[1]||"",fe=-1<r.stack.indexOf(`
...
void main() {
	...
	`}function tA(s){let t=new WeakMap,i=null;function a(h){if(h&&h.isTexture){const p=h.mapping,m=p===td||p===ed,g=p===Rs||p===Cs;if(m||g){let _=t.get(h);const v=_!==void 0?_.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==v)return i===null&&(i=new Ev(s)),_=m?i.fromEquirectangular(h,_):i.fromCubemap(h,_),_.texture.pmremVersion=h.pmremVersion,t.set(h,_),_.texture;if(_!==void 0)return _.texture;{const S=h.image;return m&&S&&S.height>0||g&&S&&l(S)?(i===null&&(i=new Ev(s)),_=m?i.fromEquirectangular(h):i.fromCubemap(h),_.texture.pmremVersion=h.pmremVersion,t.set(h,_),h.addEventListener("dispose",c),_.texture):null}}}return h}function l(h){let p=0;const m=6;for(let g=0;g<m;g++)h[g]!==void 0&&p++;return p===m}function c(h){const p=h.target;p.removeEventListener("dispose",c);const m=t.get(p);m!==void 0&&(t.delete(p),m.dispose())}function f(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:a,dispose:f}}function eA(s){const t={};function i(a){if(t[a]!==void 0)return t[a];let l;switch(a){case"WEBGL_depth_texture":l=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":l=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":l=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":l=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:l=s.getExtension(a)}return t[a]=l,l}return{has:function(a){return i(a)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(a){const l=i(a);return l===null&&Nc("THREE.WebGLRenderer: "+a+" extension not supported."),l}}}function nA(s,t,i,a){const l={},c=new WeakMap;function f(_){const v=_.target;v.index!==null&&t.remove(v.index);for(const E in v.attributes)t.remove(v.attributes[E]);v.removeEventListener("dispose",f),delete l[v.id];const S=c.get(v);S&&(t.remove(S),c.delete(v)),a.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,i.memory.geometries--}function h(_,v){return l[v.id]===!0||(v.addEventListener("dispose",f),l[v.id]=!0,i.memory.geometries++),v}function p(_){const v=_.attributes;for(const S in v)t.update(v[S],s.ARRAY_BUFFER)}function m(_){const v=[],S=_.index,E=_.attributes.position;let T=0;if(S!==null){const P=S.array;T=S.version;for(let L=0,w=P.length;L<w;L+=3){const k=P[L+0],B=P[L+1],z=P[L+2];v.push(k,B,B,z,z,k)}}else if(E!==void 0){const P=E.array;T=E.version;for(let L=0,w=P.length/3-1;L<w;L+=3){const k=L+0,B=L+1,z=L+2;v.push(k,B,B,z,z,k)}}else return;const M=new(m0(v)?x0:y0)(v,1);M.version=T;const y=c.get(_);y&&t.remove(y),c.set(_,M)}function g(_){const v=c.get(_);if(v){const S=_.index;S!==null&&v.version<S.version&&m(_)}else m(_);return c.get(_)}return{get:h,update:p,getWireframeAttribute:g}}function iA(s,t,i){let a;function l(v){a=v}let c,f;function h(v){c=v.type,f=v.bytesPerElement}function p(v,S){s.drawElements(a,S,c,v*f),i.update(S,a,1)}function m(v,S,E){E!==0&&(s.drawElementsInstanced(a,S,c,v*f,E),i.update(S,a,E))}function g(v,S,E){if(E===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(a,S,0,c,v,0,E);let M=0;for(let y=0;y<E;y++)M+=S[y];i.update(M,a,1)}function _(v,S,E,T){if(E===0)return;const M=t.get("WEBGL_multi_draw");if(M===null)for(let y=0;y<v.length;y++)m(v[y]/f,S[y],T[y]);else{M.multiDrawElementsInstancedWEBGL(a,S,0,c,v,0,T,0,E);let y=0;for(let P=0;P<E;P++)y+=S[P]*T[P];i.update(y,a,1)}}this.setMode=l,this.setIndex=h,this.render=p,this.renderInstances=m,this.renderMultiDraw=g,this.renderMultiDrawInstances=_}function aA(s){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function a(c,f,h){switch(i.calls++,f){case s.TRIANGLES:i.triangles+=h*(c/3);break;case s.LINES:i.lines+=h*(c/2);break;case s.LINE_STRIP:i.lines+=h*(c-1);break;case s.LINE_LOOP:i.lines+=h*c;break;case s.POINTS:i.points+=h*c;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:a}}function rA(s,t,i){const a=new WeakMap,l=new tn;function c(f,h,p){const m=f.morphTargetInfluences,g=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,_=g!==void 0?g.length:0;let v=a.get(h);if(v===void 0||v.count!==_){let D=function(){z.dispose(),a.delete(h),h.removeEventListener("dispose",D)};v!==void 0&&v.texture.dispose();const S=h.morphAttributes.position!==void 0,E=h.morphAttributes.normal!==void 0,T=h.morphAttributes.color!==void 0,M=h.morphAttributes.position||[],y=h.morphAttributes.normal||[],P=h.morphAttributes.color||[];let L=0;S===!0&&(L=1),E===!0&&(L=2),T===!0&&(L=3);let w=h.attributes.position.count*L,k=1;w>t.maxTextureSize&&(k=Math.ceil(w/t.maxTextureSize),w=t.maxTextureSize);const B=new Float32Array(w*k*4*_),z=new g0(B,w,k,_);z.type=oa,z.needsUpdate=!0;const X=L*4;for(let R=0;R<_;R++){const G=M[R],nt=y[R],$=P[R],lt=w*k*4*R;for(let vt=0;vt<G.count;vt++){const U=vt*X;S===!0&&(l.fromBufferAttribute(G,vt),B[lt+U+0]=l.x,B[lt+U+1]=l.y,B[lt+U+2]=l.z,B[lt+U+3]=0),E===!0&&(l.fromBufferAttribute(nt,vt),B[lt+U+4]=l.x,B[lt+U+5]=l.y,B[lt+U+6]=l.z,B[lt+U+7]=0),T===!0&&(l.fromBufferAttribute($,vt),B[lt+U+8]=l.x,B[lt+U+9]=l.y,B[lt+U+10]=l.z,B[lt+U+11]=$.itemSize===4?l.w:1)}}v={count:_,texture:z,size:new te(w,k)},a.set(h,v),h.addEventListener("dispose",D)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)p.getUniforms().setValue(s,"morphTexture",f.morphTexture,i);else{let S=0;for(let T=0;T<m.length;T++)S+=m[T];const E=h.morphTargetsRelative?1:1-S;p.getUniforms().setValue(s,"morphTargetBaseInfluence",E),p.getUniforms().setValue(s,"morphTargetInfluences",m)}p.getUniforms().setValue(s,"morphTargetsTexture",v.texture,i),p.getUniforms().setValue(s,"morphTargetsTextureSize",v.size)}return{update:c}}function sA(s,t,i,a){let l=new WeakMap;function c(p){const m=a.render.frame,g=p.geometry,_=t.get(p,g);if(l.get(_)!==m&&(t.update(_),l.set(_,m)),p.isInstancedMesh&&(p.hasEventListener("dispose",h)===!1&&p.addEventListener("dispose",h),l.get(p)!==m&&(i.update(p.instanceMatrix,s.ARRAY_BUFFER),p.instanceColor!==null&&i.update(p.instanceColor,s.ARRAY_BUFFER),l.set(p,m))),p.isSkinnedMesh){const v=p.skeleton;l.get(v)!==m&&(v.update(),l.set(v,m))}return _}function f(){l=new WeakMap}function h(p){const m=p.target;m.removeEventListener("dispose",h),i.remove(m.instanceMatrix),m.instanceColor!==null&&i.remove(m.instanceColor)}return{update:c,dispose:f}}const U0=new Wn,Rv=new T0(1,1),L0=new g0,N0=new vM,O0=new E0,Cv=[],wv=[],Dv=new Float32Array(16),Uv=new Float32Array(9),Lv=new Float32Array(4);function Ns(s,t,i){const a=s[0];if(a<=0||a>0)return s;const l=t*i;let c=Cv[l];if(c===void 0&&(c=new Float32Array(l),Cv[l]=c),t!==0){a.toArray(c,0);for(let f=1,h=0;f!==t;++f)h+=i,s[f].toArray(c,h)}return c}function hn(s,t){if(s.length!==t.length)return!1;for(let i=0,a=s.length;i<a;i++)if(s[i]!==t[i])return!1;return!0}function dn(s,t){for(let i=0,a=t.length;i<a;i++)s[i]=t[i]}function kc(s,t){let i=wv[t];i===void 0&&(i=new Int32Array(t),wv[t]=i);for(let a=0;a!==t;++a)i[a]=s.allocateTextureUnit();return i}function oA(s,t){const i=this.cache;i[0]!==t&&(s.uniform1f(this.addr,t),i[0]=t)}function lA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2f(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(hn(i,t))return;s.uniform2fv(this.addr,t),dn(i,t)}}function cA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3f(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else if(t.r!==void 0)(i[0]!==t.r||i[1]!==t.g||i[2]!==t.b)&&(s.uniform3f(this.addr,t.r,t.g,t.b),i[0]=t.r,i[1]=t.g,i[2]=t.b);else{if(hn(i,t))return;s.uniform3fv(this.addr,t),dn(i,t)}}function uA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4f(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(hn(i,t))return;s.uniform4fv(this.addr,t),dn(i,t)}}function fA(s,t){const i=this.cache,a=t.elements;if(a===void 0){if(hn(i,t))return;s.uniformMatrix2fv(this.addr,!1,t),dn(i,t)}else{if(hn(i,a))return;Lv.set(a),s.uniformMatrix2fv(this.addr,!1,Lv),dn(i,a)}}function hA(s,t){const i=this.cache,a=t.elements;if(a===void 0){if(hn(i,t))return;s.uniformMatrix3fv(this.addr,!1,t),dn(i,t)}else{if(hn(i,a))return;Uv.set(a),s.uniformMatrix3fv(this.addr,!1,Uv),dn(i,a)}}function dA(s,t){const i=this.cache,a=t.elements;if(a===void 0){if(hn(i,t))return;s.uniformMatrix4fv(this.addr,!1,t),dn(i,t)}else{if(hn(i,a))return;Dv.set(a),s.uniformMatrix4fv(this.addr,!1,Dv),dn(i,a)}}function pA(s,t){const i=this.cache;i[0]!==t&&(s.uniform1i(this.addr,t),i[0]=t)}function mA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2i(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(hn(i,t))return;s.uniform2iv(this.addr,t),dn(i,t)}}function gA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3i(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(hn(i,t))return;s.uniform3iv(this.addr,t),dn(i,t)}}function _A(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4i(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(hn(i,t))return;s.uniform4iv(this.addr,t),dn(i,t)}}function vA(s,t){const i=this.cache;i[0]!==t&&(s.uniform1ui(this.addr,t),i[0]=t)}function yA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(s.uniform2ui(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(hn(i,t))return;s.uniform2uiv(this.addr,t),dn(i,t)}}function xA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(s.uniform3ui(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(hn(i,t))return;s.uniform3uiv(this.addr,t),dn(i,t)}}function SA(s,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(s.uniform4ui(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(hn(i,t))return;s.uniform4uiv(this.addr,t),dn(i,t)}}function MA(s,t,i){const a=this.cache,l=i.allocateTextureUnit();a[0]!==l&&(s.uniform1i(this.addr,l),a[0]=l);let c;this.type===s.SAMPLER_2D_SHADOW?(Rv.compareFunction=p0,c=Rv):c=U0,i.setTexture2D(t||c,l)}function EA(s,t,i){const a=this.cache,l=i.allocateTextureUnit();a[0]!==l&&(s.uniform1i(this.addr,l),a[0]=l),i.setTexture3D(t||N0,l)}function TA(s,t,i){const a=this.cache,l=i.allocateTextureUnit();a[0]!==l&&(s.uniform1i(this.addr,l),a[0]=l),i.setTextureCube(t||O0,l)}function bA(s,t,i){const a=this.cache,l=i.allocateTextureUnit();a[0]!==l&&(s.uniform1i(this.addr,l),a[0]=l),i.setTexture2DArray(t||L0,l)}function AA(s){switch(s){case 5126:return oA;case 35664:return lA;case 35665:return cA;case 35666:return uA;case 35674:return fA;case 35675:return hA;case 35676:return dA;case 5124:case 35670:return pA;case 35667:case 35671:return mA;case 35668:case 35672:return gA;case 35669:case 35673:return _A;case 5125:return vA;case 36294:return yA;case 36295:return xA;case 36296:return SA;case 35678:case 36198:case 36298:case 36306:case 35682:return MA;case 35679:case 36299:case 36307:return EA;case 35680:case 36300:case 36308:case 36293:return TA;case 36289:case 36303:case 36311:case 36292:return bA}}function RA(s,t){s.uniform1fv(this.addr,t)}function CA(s,t){const i=Ns(t,this.size,2);s.uniform2fv(this.addr,i)}function wA(s,t){const i=Ns(t,this.size,3);s.uniform3fv(this.addr,i)}function DA(s,t){const i=Ns(t,this.size,4);s.uniform4fv(this.addr,i)}function UA(s,t){const i=Ns(t,this.size,4);s.uniformMatrix2fv(this.addr,!1,i)}function LA(s,t){const i=Ns(t,this.size,9);s.uniformMatrix3fv(this.addr,!1,i)}function NA(s,t){const i=Ns(t,this.size,16);s.uniformMatrix4fv(this.addr,!1,i)}function OA(s,t){s.uniform1iv(this.addr,t)}function zA(s,t){s.uniform2iv(this.addr,t)}function PA(s,t){s.uniform3iv(this.addr,t)}function BA(s,t){s.uniform4iv(this.addr,t)}function FA(s,t){s.uniform1uiv(this.addr,t)}function IA(s,t){s.uniform2uiv(this.addr,t)}function HA(s,t){s.uniform3uiv(this.addr,t)}function GA(s,t){s.uniform4uiv(this.addr,t)}function VA(s,t,i){const a=this.cache,l=t.length,c=kc(i,l);hn(a,c)||(s.uniform1iv(this.addr,c),dn(a,c));for(let f=0;f!==l;++f)i.setTexture2D(t[f]||U0,c[f])}function kA(s,t,i){const a=this.cache,l=t.length,c=kc(i,l);hn(a,c)||(s.uniform1iv(this.addr,c),dn(a,c));for(let f=0;f!==l;++f)i.setTexture3D(t[f]||N0,c[f])}function XA(s,t,i){const a=this.cache,l=t.length,c=kc(i,l);hn(a,c)||(s.uniform1iv(this.addr,c),dn(a,c));for(let f=0;f!==l;++f)i.setTextureCube(t[f]||O0,c[f])}function WA(s,t,i){const a=this.cache,l=t.length,c=kc(i,l);hn(a,c)||(s.uniform1iv(this.addr,c),dn(a,c));for(let f=0;f!==l;++f)i.setTexture2DArray(t[f]||L0,c[f])}function qA(s){switch(s){case 5126:return RA;case 35664:return CA;case 35665:return wA;case 35666:return DA;case 35674:return UA;case 35675:return LA;case 35676:return NA;case 5124:case 35670:return OA;case 35667:case 35671:return zA;case 35668:case 35672:return PA;case 35669:case 35673:return BA;case 5125:return FA;case 36294:return IA;case 36295:return HA;case 36296:return GA;case 35678:case 36198:case 36298:case 36306:case 35682:return VA;case 35679:case 36299:case 36307:return kA;case 35680:case 36300:case 36308:case 36293:return XA;case 36289:case 36303:case 36311:case 36292:return WA}}class YA{constructor(t,i,a){this.id=t,this.addr=a,this.cache=[],this.type=i.type,this.setValue=AA(i.type)}}class jA{constructor(t,i,a){this.id=t,this.addr=a,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=qA(i.type)}}class ZA{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,i,a){const l=this.seq;for(let c=0,f=l.length;c!==f;++c){const h=l[c];h.setValue(t,i[h.id],a)}}}const Bh=/(\w+)(\])?(\[|\.)?/g;function Nv(s,t){s.seq.push(t),s.map[t.id]=t}function KA(s,t,i){const a=s.name,l=a.length;for(Bh.lastIndex=0;;){const c=Bh.exec(a),f=Bh.lastIndex;let h=c[1];const p=c[2]==="]",m=c[3];if(p&&(h=h|0),m===void 0||m==="["&&f+2===l){Nv(i,m===void 0?new YA(h,s,t):new jA(h,s,t));break}else{let _=i.map[h];_===void 0&&(_=new ZA(h),Nv(i,_)),i=_}}}class Oc{constructor(t,i){this.seq=[],this.map={};const a=t.getProgramParameter(i,t.ACTIVE_UNIFORMS);for(let l=0;l<a;++l){const c=t.getActiveUniform(i,l),f=t.getUniformLocation(i,c.name);KA(c,f,this)}}setValue(t,i,a,l){const c=this.map[i];c!==void 0&&c.setValue(t,a,l)}setOptional(t,i,a){const l=i[a];l!==void 0&&this.setValue(t,a,l)}static upload(t,i,a,l){for(let c=0,f=i.length;c!==f;++c){const h=i[c],p=a[h.id];p.needsUpdate!==!1&&h.setValue(t,p.value,l)}}static seqWithValue(t,i){const a=[];for(let l=0,c=t.length;l!==c;++l){const f=t[l];f.id in i&&a.push(f)}return a}}function Ov(s,t,i){const a=s.createShader(t);return s.shaderSource(a,i),s.compileShader(a),a}const QA=37297;let JA=0;function $A(s,t){const i=s.split(`
`),a=[],l=Math.max(t-6,0),c=Math.min(t+6,i.length);for(let f=l;f<c;f++){const h=f+1;a.push(`${h===t?">":" "} ${h}: ${i[f]}`)}return a.join(`
`)}const zv=new ce;function t1(s){Ce._getMatrix(zv,Ce.workingColorSpace,s);const t=`mat3( ${zv.elements.map(i=>i.toFixed(4))} )`;switch(Ce.getTransfer(s)){case Pc:return[t,"LinearTransferOETF"];case He:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[t,"LinearTransferOETF"]}}function Pv(s,t,i){const a=s.getShaderParameter(t,s.COMPILE_STATUS),l=s.getShaderInfoLog(t).trim();if(a&&l==="")return"";const c=/ERROR: 0:(\d+)/.exec(l);if(c){const f=parseInt(c[1]);return i.toUpperCase()+`

`+l+`

`+$A(s.getShaderSource(t),f)}else return l}function e1(s,t){const i=t1(t);return[`vec4 ${s}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}function n1(s,t){let i;switch(t){case kS:i="Linear";break;case XS:i="Reinhard";break;case WS:i="Cineon";break;case qS:i="ACESFilmic";break;case jS:i="AgX";break;case ZS:i="Neutral";break;case YS:i="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),i="Linear"}return"vec3 "+s+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Ac=new Q;function i1(){Ce.getLuminanceCoefficients(Ac);const s=Ac.x.toFixed(4),t=Ac.y.toFixed(4),i=Ac.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${t}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function a1(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Oo).join(`
`)}function r1(s){const t=[];for(const i in s){const a=s[i];a!==!1&&t.push("#define "+i+" "+a)}return t.join(`
`)}function s1(s,t){const i={},a=s.getProgramParameter(t,s.ACTIVE_ATTRIBUTES);for(let l=0;l<a;l++){const c=s.getActiveAttrib(t,l),f=c.name;let h=1;c.type===s.FLOAT_MAT2&&(h=2),c.type===s.FLOAT_MAT3&&(h=3),c.type===s.FLOAT_MAT4&&(h=4),i[f]={type:c.type,location:s.getAttribLocation(t,f),locationSize:h}}return i}function Oo(s){return s!==""}function Bv(s,t){const i=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Fv(s,t){return s.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const o1=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ud(s){return s.replace(o1,c1)}const l1=new Map;function c1(s,t){let i=ue[t];if(i===void 0){const a=l1.get(t);if(a!==void 0)i=ue[a],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,a);else throw new Error("Can not resolve #include <"+t+">")}return Ud(i)}const u1=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Iv(s){return s.replace(u1,f1)}function f1(s,t,i,a){let l="";for(let c=parseInt(t);c<parseInt(i);c++)l+=a.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function Hv(s){let t=`precision ${s.precision} float;
...
#define LOW_PRECISION`),t}function h1(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===e0?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===MS?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===sa&&(t="SHADOWMAP_TYPE_VSM"),t}function d1(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Rs:case Cs:t="ENVMAP_TYPE_CUBE";break;case Hc:t="ENVMAP_TYPE_CUBE_UV";break}return t}function p1(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Cs:t="ENVMAP_MODE_REFRACTION";break}return t}function m1(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case n0:t="ENVMAP_BLENDING_MULTIPLY";break;case GS:t="ENVMAP_BLENDING_MIX";break;case VS:t="ENVMAP_BLENDING_ADD";break}return t}function g1(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,a=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:a,maxMip:i}}function _1(s,t,i,a){const l=s.getContext(),c=i.defines;let f=i.vertexShader,h=i.fragmentShader;const p=h1(i),m=d1(i),g=p1(i),_=m1(i),v=g1(i),S=a1(i),E=r1(c),T=l.createProgram();let M,y,P=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+y);const L=P+M+f,w=P+y+h,k=Ov(l,l.VERTEX_SHADER,L),B=Ov(l,l.FRAGMENT_SHADER,w);l.attachShader(T,k),l.attachShader(T,B),i.index0AttributeName!==void 0?l.bindAttribLocation(T,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(T,0,"position"),l.linkProgram(T);function z(G){if(s.debug.checkShaderErrors){const nt=l.getProgramInfoLog(T).trim(),$=l.getShaderInfoLog(k).trim(),lt=l.getShaderInfoLog(B).trim();let vt=!0,U=!0;if(l.getProgramParameter(T,l.LINK_STATUS)===!1)if(vt=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,T,k,B);else{const W=Pv(l,k,"vertex"),I=Pv(l,B,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(T,l.VALIDATE_STATUS)+`
...
}`;class H1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i,a){if(this.texture===null){const l=new Wn,c=t.properties.get(l);c.__webglTexture=i.texture,(i.depthNear!==a.depthNear||i.depthFar!==a.depthFar)&&(this.depthNear=i.depthNear,this.depthFar=i.depthFar),this.texture=l}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,a=new ja({vertexShader:F1,fragmentShader:I1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new ei(new Vc(20,20),a)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class G1 extends Ls{constructor(t,i){super();const a=this;let l=null,c=1,f=null,h="local-floor",p=1,m=null,g=null,_=null,v=null,S=null,E=null;const T=new H1,M=i.getContextAttributes();let y=null,P=null;const L=[],w=[],k=new te;let B=null;const z=new di;z.viewport=new tn;const X=new di;X.viewport=new tn;const D=[z,X],R=new lE;let G=null,nt=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let ct=L[q];return ct===void 0&&(ct=new Ah,L[q]=ct),ct.getTargetRaySpace()},this.getControllerGrip=function(q){let ct=L[q];return ct===void 0&&(ct=new Ah,L[q]=ct),ct.getGripSpace()},this.getHand=function(q){let ct=L[q];return ct===void 0&&(ct=new Ah,L[q]=ct),ct.getHandSpace()};function $(q){const ct=w.indexOf(q.inputSource);if(ct===-1)return;const St=L[ct];St!==void 0&&(St.update(q.inputSource,q.frame,m||f),St.dispatchEvent({type:q.type,data:q.inputSource}))}function lt(){l.removeEventListener("select",$),l.removeEventListener("selectstart",$),l.removeEventListener("selectend",$),l.removeEventListener("squeeze",$),l.removeEventListener("squeezestart",$),l.removeEventListener("squeezeend",$),l.removeEventListener("end",lt),l.removeEventListener("inputsourceschange",vt);for(let q=0;q<L.length;q++){const ct=w[q];ct!==null&&(w[q]=null,L[q].disconnect(ct))}G=null,nt=null,T.reset(),t.setRenderTarget(y),S=null,v=null,_=null,l=null,P=null,dt.stop(),a.isPresenting=!1,t.setPixelRatio(B),t.setSize(k.width,k.height,!1),a.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){c=q,a.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){h=q,a.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return m||f},this.setReferenceSpace=function(q){m=q},this.getBaseLayer=function(){return v!==null?v:S},this.getBinding=function(){return _},this.getFrame=function(){return E},this.getSession=function(){return l},this.setSession=async function(q){if(l=q,l!==null){if(y=t.getRenderTarget(),l.addEventListener("select",$),l.addEventListener("selectstart",$),l.addEventListener("selectend",$),l.addEventListener("squeeze",$),l.addEventListener("squeezestart",$),l.addEventListener("squeezeend",$),l.addEventListener("end",lt),l.addEventListener("inputsourceschange",vt),M.xrCompatible!==!0&&await i.makeXRCompatible(),B=t.getPixelRatio(),t.getSize(k),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let St=null,Mt=null,zt=null;M.depth&&(zt=M.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,St=M.stencil?Go:Ho,Mt=M.stencil?Io:Rr);const qt={colorFormat:i.RGBA8,depthFormat:zt,scaleFactor:c};_=new XRWebGLBinding(l,i),v=_.createProjectionLayer(qt),l.updateRenderState({layers:[v]}),t.setPixelRatio(1),t.setSize(v.textureWidth,v.textureHeight,!1),P=new Cr(v.textureWidth,v.textureHeight,{format:Ti,type:ua,depthTexture:new T0(v.textureWidth,v.textureHeight,Mt,void 0,void 0,void 0,void 0,void 0,void 0,St),stencilBuffer:M.stencil,colorSpace:t.outputColorSpace,samples:M.antialias?4:0,resolveDepthBuffer:v.ignoreDepthValues===!1,resolveStencilBuffer:v.ignoreDepthValues===!1})}else{const St={antialias:M.antialias,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:c};S=new XRWebGLLayer(l,i,St),l.updateRenderState({baseLayer:S}),t.setPixelRatio(1),t.setSize(S.framebufferWidth,S.framebufferHeight,!1),P=new Cr(S.framebufferWidth,S.framebufferHeight,{format:Ti,type:ua,colorSpace:t.outputColorSpace,stencilBuffer:M.stencil,resolveDepthBuffer:S.ignoreDepthValues===!1,resolveStencilBuffer:S.ignoreDepthValues===!1})}P.isXRRenderTarget=!0,this.setFoveation(p),m=null,f=await l.requestReferenceSpace(h),dt.setContext(l),dt.start(),a.isPresenting=!0,a.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return T.getDepthTexture()};function vt(q){for(let ct=0;ct<q.removed.length;ct++){const St=q.removed[ct],Mt=w.indexOf(St);Mt>=0&&(w[Mt]=null,L[Mt].disconnect(St))}for(let ct=0;ct<q.added.length;ct++){const St=q.added[ct];let Mt=w.indexOf(St);if(Mt===-1){for(let qt=0;qt<L.length;qt++)if(qt>=w.length){w.push(St),Mt=qt;break}else if(w[qt]===null){w[qt]=St,Mt=qt;break}if(Mt===-1)break}const zt=L[Mt];zt&&zt.connect(St)}}const U=new Q,W=new Q;function I(q,ct,St){U.setFromMatrixPosition(ct.matrixWorld),W.setFromMatrixPosition(St.matrixWorld);const Mt=U.distanceTo(W),zt=ct.projectionMatrix.elements,qt=St.projectionMatrix.elements,Gt=zt[14]/(zt[10]-1),De=zt[14]/(zt[10]+1),Ge=(zt[9]+1)/zt[5],fe=(zt[9]-1)/zt[5],H=(zt[8]-1)/zt[0],Tn=(qt[8]+1)/qt[0],he=Gt*H,ge=Gt*Tn,Yt=Mt/(-H+Tn),Ue=Yt*-H;if(ct.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(Ue),q.translateZ(Yt),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),zt[10]===-1)q.projectionMatrix.copy(ct.projectionMatrix),q.projectionMatrixInverse.copy(ct.projectionMatrixInverse);else{const Xt=Gt+Yt,N=De+Yt,A=he-Ue,at=ge+(Mt-Ue),pt=Ge*De/N*Xt,Et=fe*De/N*Xt;q.projectionMatrix.makePerspective(A,at,pt,Et,Xt,N),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function ft(q,ct){ct===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(ct.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(l===null)return;let ct=q.near,St=q.far;T.texture!==null&&(T.depthNear>0&&(ct=T.depthNear),T.depthFar>0&&(St=T.depthFar)),R.near=X.near=z.near=ct,R.far=X.far=z.far=St,(G!==R.near||nt!==R.far)&&(l.updateRenderState({depthNear:R.near,depthFar:R.far}),G=R.near,nt=R.far),z.layers.mask=q.layers.mask|2,X.layers.mask=q.layers.mask|4,R.layers.mask=z.layers.mask|X.layers.mask;const Mt=q.parent,zt=R.cameras;ft(R,Mt);for(let qt=0;qt<zt.length;qt++)ft(zt[qt],Mt);zt.length===2?I(R,z,X):R.projectionMatrix.copy(z.projectionMatrix),xt(q,R,Mt)};function xt(q,ct,St){St===null?q.matrix.copy(ct.matrixWorld):(q.matrix.copy(St.matrixWorld),q.matrix.invert(),q.matrix.multiply(ct.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(ct.projectionMatrix),q.projectionMatrixInverse.copy(ct.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=Dd*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return R},this.getFoveation=function(){if(!(v===null&&S===null))return p},this.setFoveation=function(q){p=q,v!==null&&(v.fixedFoveation=q),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=q)},this.hasDepthSensing=function(){return T.texture!==null},this.getDepthSensingMesh=function(){return T.getMesh(R)};let O=null;function J(q,ct){if(g=ct.getViewerPose(m||f),E=ct,g!==null){const St=g.views;S!==null&&(t.setRenderTargetFramebuffer(P,S.framebuffer),t.setRenderTarget(P));let Mt=!1;St.length!==R.cameras.length&&(R.cameras.length=0,Mt=!0);for(let Gt=0;Gt<St.length;Gt++){const De=St[Gt];let Ge=null;if(S!==null)Ge=S.getViewport(De);else{const H=_.getViewSubImage(v,De);Ge=H.viewport,Gt===0&&(t.setRenderTargetTextures(P,H.colorTexture,H.depthStencilTexture),t.setRenderTarget(P))}let fe=D[Gt];fe===void 0&&(fe=new di,fe.layers.enable(Gt),fe.viewport=new tn,D[Gt]=fe),fe.matrix.fromArray(De.transform.matrix),fe.matrix.decompose(fe.position,fe.quaternion,fe.scale),fe.projectionMatrix.fromArray(De.projectionMatrix),fe.projectionMatrixInverse.copy(fe.projectionMatrix).invert(),fe.viewport.set(Ge.x,Ge.y,Ge.width,Ge.height),Gt===0&&(R.matrix.copy(fe.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale)),Mt===!0&&R.cameras.push(fe)}const zt=l.enabledFeatures;if(zt&&zt.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&_){const Gt=_.getDepthInformation(St[0]);Gt&&Gt.isValid&&Gt.texture&&T.init(t,Gt,l.renderState)}}for(let St=0;St<L.length;St++){const Mt=w[St],zt=L[St];Mt!==null&&zt!==void 0&&zt.update(Mt,ct,m||f)}O&&O(q,ct),ct.detectedPlanes&&a.dispatchEvent({type:"planesdetected",data:ct}),E=null}const dt=new D0;dt.setAnimationLoop(J),this.setAnimationLoop=function(q){O=q},this.dispose=function(){}}}const yr=new fa,V1=new Ze;function k1(s,t){function i(M,y){M.matrixAutoUpdate===!0&&M.updateMatrix(),y.value.copy(M.matrix)}function a(M,y){y.color.getRGB(M.fogColor.value,S0(s)),y.isFog?(M.fogNear.value=y.near,M.fogFar.value=y.far):y.isFogExp2&&(M.fogDensity.value=y.density)}function l(M,y,P,L,w){y.isMeshBasicMaterial||y.isMeshLambertMaterial?c(M,y):y.isMeshToonMaterial?(c(M,y),_(M,y)):y.isMeshPhongMaterial?(c(M,y),g(M,y)):y.isMeshStandardMaterial?(c(M,y),v(M,y),y.isMeshPhysicalMaterial&&S(M,y,w)):y.isMeshMatcapMaterial?(c(M,y),E(M,y)):y.isMeshDepthMaterial?c(M,y):y.isMeshDistanceMaterial?(c(M,y),T(M,y)):y.isMeshNormalMaterial?c(M,y):y.isLineBasicMaterial?(f(M,y),y.isLineDashedMaterial&&h(M,y)):y.isPointsMaterial?p(M,y,P,L):y.isSpriteMaterial?m(M,y):y.isShadowMaterial?(M.color.value.copy(y.color),M.opacity.value=y.opacity):y.isShaderMaterial&&(y.uniformsNeedUpdate=!1)}function c(M,y){M.opacity.value=y.opacity,y.color&&M.diffuse.value.copy(y.color),y.emissive&&M.emissive.value.copy(y.emissive).multiplyScalar(y.emissiveIntensity),y.map&&(M.map.value=y.map,i(y.map,M.mapTransform)),y.alphaMap&&(M.alphaMap.value=y.alphaMap,i(y.alphaMap,M.alphaMapTransform)),y.bumpMap&&(M.bumpMap.value=y.bumpMap,i(y.bumpMap,M.bumpMapTransform),M.bumpScale.value=y.bumpScale,y.side===Xn&&(M.bumpScale.value*=-1)),y.normalMap&&(M.normalMap.value=y.normalMap,i(y.normalMap,M.normalMapTransform),M.normalScale.value.copy(y.normalScale),y.side===Xn&&M.normalScale.value.negate()),y.displacementMap&&(M.displacementMap.value=y.displacementMap,i(y.displacementMap,M.displacementMapTransform),M.displacementScale.value=y.displacementScale,M.displacementBias.value=y.displacementBias),y.emissiveMap&&(M.emissiveMap.value=y.emissiveMap,i(y.emissiveMap,M.emissiveMapTransform)),y.specularMap&&(M.specularMap.value=y.specularMap,i(y.specularMap,M.specularMapTransform)),y.alphaTest>0&&(M.alphaTest.value=y.alphaTest);const P=t.get(y),L=P.envMap,w=P.envMapRotation;L&&(M.envMap.value=L,yr.copy(w),yr.x*=-1,yr.y*=-1,yr.z*=-1,L.isCubeTexture&&L.isRenderTargetTexture===!1&&(yr.y*=-1,yr.z*=-1),M.envMapRotation.value.setFromMatrix4(V1.makeRotationFromEuler(yr)),M.flipEnvMap.value=L.isCubeTexture&&L.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=y.reflectivity,M.ior.value=y.ior,M.refractionRatio.value=y.refractionRatio),y.lightMap&&(M.lightMap.value=y.lightMap,M.lightMapIntensity.value=y.lightMapIntensity,i(y.lightMap,M.lightMapTransform)),y.aoMap&&(M.aoMap.value=y.aoMap,M.aoMapIntensity.value=y.aoMapIntensity,i(y.aoMap,M.aoMapTransform))}function f(M,y){M.diffuse.value.copy(y.color),M.opacity.value=y.opacity,y.map&&(M.map.value=y.map,i(y.map,M.mapTransform))}function h(M,y){M.dashSize.value=y.dashSize,M.totalSize.value=y.dashSize+y.gapSize,M.scale.value=y.scale}function p(M,y,P,L){M.diffuse.value.copy(y.color),M.opacity.value=y.opacity,M.size.value=y.size*P,M.scale.value=L*.5,y.map&&(M.map.value=y.map,i(y.map,M.uvTransform)),y.alphaMap&&(M.alphaMap.value=y.alphaMap,i(y.alphaMap,M.alphaMapTransform)),y.alphaTest>0&&(M.alphaTest.value=y.alphaTest)}function m(M,y){M.diffuse.value.copy(y.color),M.opacity.value=y.opacity,M.rotation.value=y.rotation,y.map&&(M.map.value=y.map,i(y.map,M.mapTransform)),y.alphaMap&&(M.alphaMap.value=y.alphaMap,i(y.alphaMap,M.alphaMapTransform)),y.alphaTest>0&&(M.alphaTest.value=y.alphaTest)}function g(M,y){M.specular.value.copy(y.specular),M.shininess.value=Math.max(y.shininess,1e-4)}function _(M,y){y.gradientMap&&(M.gradientMap.value=y.gradientMap)}function v(M,y){M.metalness.value=y.metalness,y.metalnessMap&&(M.metalnessMap.value=y.metalnessMap,i(y.metalnessMap,M.metalnessMapTransform)),M.roughness.value=y.roughness,y.roughnessMap&&(M.roughnessMap.value=y.roughnessMap,i(y.roughnessMap,M.roughnessMapTransform)),y.envMap&&(M.envMapIntensity.value=y.envMapIntensity)}function S(M,y,P){M.ior.value=y.ior,y.sheen>0&&(M.sheenColor.value.copy(y.sheenColor).multiplyScalar(y.sheen),M.sheenRoughness.value=y.sheenRoughness,y.sheenColorMap&&(M.sheenColorMap.value=y.sheenColorMap,i(y.sheenColorMap,M.sheenColorMapTransform)),y.sheenRoughnessMap&&(M.sheenRoughnessMap.value=y.sheenRoughnessMap,i(y.sheenRoughnessMap,M.sheenRoughnessMapTransform))),y.clearcoat>0&&(M.clearcoat.value=y.clearcoat,M.clearcoatRoughness.value=y.clearcoatRoughness,y.clearcoatMap&&(M.clearcoatMap.value=y.clearcoatMap,i(y.clearcoatMap,M.clearcoatMapTransform)),y.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=y.clearcoatRoughnessMap,i(y.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),y.clearcoatNormalMap&&(M.clearcoatNormalMap.value=y.clearcoatNormalMap,i(y.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(y.clearcoatNormalScale),y.side===Xn&&M.clearcoatNormalScale.value.negate())),y.dispersion>0&&(M.dispersion.value=y.dispersion),y.iridescence>0&&(M.iridescence.value=y.iridescence,M.iridescenceIOR.value=y.iridescenceIOR,M.iridescenceThicknessMinimum.value=y.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=y.iridescenceThicknessRange[1],y.iridescenceMap&&(M.iridescenceMap.value=y.iridescenceMap,i(y.iridescenceMap,M.iridescenceMapTransform)),y.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=y.iridescenceThicknessMap,i(y.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),y.transmission>0&&(M.transmission.value=y.transmission,M.transmissionSamplerMap.value=P.texture,M.transmissionSamplerSize.value.set(P.width,P.height),y.transmissionMap&&(M.transmissionMap.value=y.transmissionMap,i(y.transmissionMap,M.transmissionMapTransform)),M.thickness.value=y.thickness,y.thicknessMap&&(M.thicknessMap.value=y.thicknessMap,i(y.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=y.attenuationDistance,M.attenuationColor.value.copy(y.attenuationColor)),y.anisotropy>0&&(M.anisotropyVector.value.set(y.anisotropy*Math.cos(y.anisotropyRotation),y.anisotropy*Math.sin(y.anisotropyRotation)),y.anisotropyMap&&(M.anisotropyMap.value=y.anisotropyMap,i(y.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=y.specularIntensity,M.specularColor.value.copy(y.specularColor),y.specularColorMap&&(M.specularColorMap.value=y.specularColorMap,i(y.specularColorMap,M.specularColorMapTransform)),y.specularIntensityMap&&(M.specularIntensityMap.value=y.specularIntensityMap,i(y.specularIntensityMap,M.specularIntensityMapTransform))}function E(M,y){y.matcap&&(M.matcap.value=y.matcap)}function T(M,y){const P=t.get(y).light;M.referencePosition.value.setFromMatrixPosition(P.matrixWorld),M.nearDistance.value=P.shadow.camera.near,M.farDistance.value=P.shadow.camera.far}return{refreshFogUniforms:a,refreshMaterialUniforms:l}}function X1(s,t,i,a){let l={},c={},f=[];const h=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function p(P,L){const w=L.program;a.uniformBlockBinding(P,w)}function m(P,L){let w=l[P.id];w===void 0&&(E(P),w=g(P),l[P.id]=w,P.addEventListener("dispose",M));const k=L.program;a.updateUBOMapping(P,k);const B=t.render.frame;c[P.id]!==B&&(v(P),c[P.id]=B)}function g(P){const L=_();P.__bindingPointIndex=L;const w=s.createBuffer(),k=P.__size,B=P.usage;return s.bindBuffer(s.UNIFORM_BUFFER,w),s.bufferData(s.UNIFORM_BUFFER,k,B),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,L,w),w}function _(){for(let P=0;P<h;P++)if(f.indexOf(P)===-1)return f.push(P),P;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function v(P){const L=l[P.id],w=P.uniforms,k=P.__cache;s.bindBuffer(s.UNIFORM_BUFFER,L);for(let B=0,z=w.length;B<z;B++){const X=Array.isArray(w[B])?w[B]:[w[B]];for(let D=0,R=X.length;D<R;D++){const G=X[D];if(S(G,B,D,k)===!0){const nt=G.__offset,$=Array.isArray(G.value)?G.value:[G.value];let lt=0;for(let vt=0;vt<$.length;vt++){const U=$[vt],W=T(U);typeof U=="number"||typeof U=="boolean"?(G.__data[0]=U,s.bufferSubData(s.UNIFORM_BUFFER,nt+lt,G.__data)):U.isMatrix3?(G.__data[0]=U.elements[0],G.__data[1]=U.elements[1],G.__data[2]=U.elements[2],G.__data[3]=0,G.__data[4]=U.elements[3],G.__data[5]=U.elements[4],G.__data[6]=U.elements[5],G.__data[7]=0,G.__data[8]=U.elements[6],G.__data[9]=U.elements[7],G.__data[10]=U.elements[8],G.__data[11]=0):(U.toArray(G.__data,lt),lt+=W.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,nt,G.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function S(P,L,w,k){const B=P.value,z=L+"_"+w;if(k[z]===void 0)return typeof B=="number"||typeof B=="boolean"?k[z]=B:k[z]=B.clone(),!0;{const X=k[z];if(typeof B=="number"||typeof B=="boolean"){if(X!==B)return k[z]=B,!0}else if(X.equals(B)===!1)return X.copy(B),!0}return!1}function E(P){const L=P.uniforms;let w=0;const k=16;for(let z=0,X=L.length;z<X;z++){const D=Array.isArray(L[z])?L[z]:[L[z]];for(let R=0,G=D.length;R<G;R++){const nt=D[R],$=Array.isArray(nt.value)?nt.value:[nt.value];for(let lt=0,vt=$.length;lt<vt;lt++){const U=$[lt],W=T(U),I=w%k,ft=I%W.boundary,xt=I+ft;w+=ft,xt!==0&&k-xt<W.storage&&(w+=k-xt),nt.__data=new Float32Array(W.storage/Float32Array.BYTES_PER_ELEMENT),nt.__offset=w,w+=W.storage}}}const B=w%k;return B>0&&(w+=k-B),P.__size=w,P.__cache={},this}function T(P){const L={boundary:0,storage:0};return typeof P=="number"||typeof P=="boolean"?(L.boundary=4,L.storage=4):P.isVector2?(L.boundary=8,L.storage=8):P.isVector3||P.isColor?(L.boundary=16,L.storage=12):P.isVector4?(L.boundary=16,L.storage=16):P.isMatrix3?(L.boundary=48,L.storage=48):P.isMatrix4?(L.boundary=64,L.storage=64):P.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",P),L}function M(P){const L=P.target;L.removeEventListener("dispose",M);const w=f.indexOf(L.__bindingPointIndex);f.splice(w,1),s.deleteBuffer(l[L.id]),delete l[L.id],delete c[L.id]}function y(){for(const P in l)s.deleteBuffer(l[P]);f=[],l={},c={}}return{bind:p,update:m,dispose:y}}class W1{constructor(t={}){const{canvas:i=cM(),context:a=null,depth:l=!0,stencil:c=!1,alpha:f=!1,antialias:h=!1,premultipliedAlpha:p=!0,preserveDrawingBuffer:m=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1,reverseDepthBuffer:v=!1}=t;this.isWebGLRenderer=!0;let S;if(a!==null){if(typeof WebGLRenderingContext<"u"&&a instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");S=a.getContextAttributes().alpha}else S=f;const E=new Uint32Array(4),T=new Int32Array(4);let M=null,y=null;const P=[],L=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Xa,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const w=this;let k=!1;this._outputColorSpace=hi;let B=0,z=0,X=null,D=-1,R=null;const G=new tn,nt=new tn;let $=null;const lt=new Oe(0);let vt=0,U=i.width,W=i.height,I=1,ft=null,xt=null;const O=new tn(0,0,U,W),J=new tn(0,0,U,W);let dt=!1;const q=new Xd;let ct=!1,St=!1;const Mt=new Ze,zt=new Ze,qt=new Q,Gt=new tn,De={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ge=!1;function fe(){return X===null?I:1}let H=a;function Tn(C,Z){return i.getContext(C,Z)}try{const C={alpha:!0,depth:l,stencil:c,antialias:h,premultipliedAlpha:p,preserveDrawingBuffer:m,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${zd}`),i.addEventListener("webglcontextlost",yt,!1),i.addEventListener("webglcontextrestored",At,!1),i.addEventListener("webglcontextcreationerror",wt,!1),H===null){const Z="webgl2";if(H=Tn(Z,C),H===null)throw Tn(Z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(C){throw console.error("THREE.WebGLRenderer: "+C.message),C}let he,ge,Yt,Ue,Xt,N,A,at,pt,Et,gt,Vt,Rt,Pt,_e,bt,Bt,Qt,kt,Nt,ee,se,ze,j;function Ct(){he=new eA(H),he.init(),se=new B1(H,he),ge=new jb(H,he,t,se),Yt=new z1(H,he),ge.reverseDepthBuffer&&v&&Yt.buffers.depth.setReversed(!0),Ue=new aA(H),Xt=new M1,N=new P1(H,he,Yt,Xt,ge,se,Ue),A=new Kb(w),at=new tA(w),pt=new uE(H),ze=new qb(H,pt),Et=new nA(H,pt,Ue,ze),gt=new sA(H,Et,pt,Ue),kt=new rA(H,ge,N),bt=new Zb(Xt),Vt=new S1(w,A,at,he,ge,ze,bt),Rt=new k1(w,Xt),Pt=new T1,_e=new D1(he),Qt=new Wb(w,A,at,Yt,gt,S,p),Bt=new N1(w,gt,ge),j=new X1(H,Ue,ge,Yt),Nt=new Yb(H,he,Ue),ee=new iA(H,he,Ue),Ue.programs=Vt.programs,w.capabilities=ge,w.extensions=he,w.properties=Xt,w.renderLists=Pt,w.shadowMap=Bt,w.state=Yt,w.info=Ue}Ct();const ut=new G1(w,H);this.xr=ut,this.getContext=function(){return H},this.getContextAttributes=function(){return H.getContextAttributes()},this.forceContextLoss=function(){const C=he.get("WEBGL_lose_context");C&&C.loseContext()},this.forceContextRestore=function(){const C=he.get("WEBGL_lose_context");C&&C.restoreContext()},this.getPixelRatio=function(){return I},this.setPixelRatio=function(C){C!==void 0&&(I=C,this.setSize(U,W,!1))},this.getSize=function(C){return C.set(U,W)},this.setSize=function(C,Z,rt=!0){if(ut.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}U=C,W=Z,i.width=Math.floor(C*I),i.height=Math.floor(Z*I),rt===!0&&(i.style.width=C+"px",i.style.height=Z+"px"),this.setViewport(0,0,C,Z)},this.getDrawingBufferSize=function(C){return C.set(U*I,W*I).floor()},this.setDrawingBufferSize=function(C,Z,rt){U=C,W=Z,I=rt,i.width=Math.floor(C*rt),i.height=Math.floor(Z*rt),this.setViewport(0,0,C,Z)},this.getCurrentViewport=function(C){return C.copy(G)},this.getViewport=function(C){return C.copy(O)},this.setViewport=function(C,Z,rt,st){C.isVector4?O.set(C.x,C.y,C.z,C.w):O.set(C,Z,rt,st),Yt.viewport(G.copy(O).multiplyScalar(I).round())},this.getScissor=function(C){return C.copy(J)},this.setScissor=function(C,Z,rt,st){C.isVector4?J.set(C.x,C.y,C.z,C.w):J.set(C,Z,rt,st),Yt.scissor(nt.copy(J).multiplyScalar(I).round())},this.getScissorTest=function(){return dt},this.setScissorTest=function(C){Yt.setScissorTest(dt=C)},this.setOpaqueSort=function(C){ft=C},this.setTransparentSort=function(C){xt=C},this.getClearColor=function(C){return C.copy(Qt.getClearColor())},this.setClearColor=function(){Qt.setClearColor(...arguments)},this.getClearAlpha=function(){return Qt.getClearAlpha()},this.setClearAlpha=function(){Qt.setClearAlpha(...arguments)},this.clear=function(C=!0,Z=!0,rt=!0){let st=0;if(C){let Y=!1;if(X!==null){const Tt=X.texture.format;Y=Tt===Gd||Tt===Hd||Tt===Id}if(Y){const Tt=X.texture.type,Dt=Tt===ua||Tt===Rr||Tt===Fo||Tt===Io||Tt===Bd||Tt===Fd,Lt=Qt.getClearColor(),Ot=Qt.getClearAlpha(),ie=Lt.r,$t=Lt.g,jt=Lt.b;Dt?(E[0]=ie,E[1]=$t,E[2]=jt,E[3]=Ot,H.clearBufferuiv(H.COLOR,0,E)):(T[0]=ie,T[1]=$t,T[2]=jt,T[3]=Ot,H.clearBufferiv(H.COLOR,0,T))}else st|=H.COLOR_BUFFER_BIT}Z&&(st|=H.DEPTH_BUFFER_BIT),rt&&(st|=H.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),H.clear(st)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",yt,!1),i.removeEventListener("webglcontextrestored",At,!1),i.removeEventListener("webglcontextcreationerror",wt,!1),Qt.dispose(),Pt.dispose(),_e.dispose(),Xt.dispose(),A.dispose(),at.dispose(),gt.dispose(),ze.dispose(),j.dispose(),Vt.dispose(),ut.dispose(),ut.removeEventListener("sessionstart",Os),ut.removeEventListener("sessionend",zs),Ai.stop()};function yt(C){C.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),k=!0}function At(){console.log("THREE.WebGLRenderer: Context Restored."),k=!1;const C=Ue.autoReset,Z=Bt.enabled,rt=Bt.autoUpdate,st=Bt.needsUpdate,Y=Bt.type;Ct(),Ue.autoReset=C,Bt.enabled=Z,Bt.autoUpdate=rt,Bt.needsUpdate=st,Bt.type=Y}function wt(C){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",C.statusMessage)}function ne(C){const Z=C.target;Z.removeEventListener("dispose",ne),Ye(Z)}function Ye(C){cn(C),Xt.remove(C)}function cn(C){const Z=Xt.get(C).programs;Z!==void 0&&(Z.forEach(function(rt){Vt.releaseProgram(rt)}),C.isShaderMaterial&&Vt.releaseShaderCache(C))}this.renderBufferDirect=function(C,Z,rt,st,Y,Tt){Z===null&&(Z=De);const Dt=Y.isMesh&&Y.matrixWorld.determinant()<0,Lt=Bs(C,Z,rt,st,Y);Yt.setMaterial(st,Dt);let Ot=rt.index,ie=1;if(st.wireframe===!0){if(Ot=Et.getWireframeAttribute(rt),Ot===void 0)return;ie=2}const $t=rt.drawRange,jt=rt.attributes.position;let xe=$t.start*ie,Se=($t.start+$t.count)*ie;Tt!==null&&(xe=Math.max(xe,Tt.start*ie),Se=Math.min(Se,(Tt.start+Tt.count)*ie)),Ot!==null?(xe=Math.max(xe,0),Se=Math.min(Se,Ot.count)):jt!=null&&(xe=Math.max(xe,0),Se=Math.min(Se,jt.count));const ke=Se-xe;if(ke<0||ke===1/0)return;ze.setup(Y,st,Lt,rt,Ot);let be,ae=Nt;if(Ot!==null&&(be=pt.get(Ot),ae=ee,ae.setIndex(be)),Y.isMesh)st.wireframe===!0?(Yt.setLineWidth(st.wireframeLinewidth*fe()),ae.setMode(H.LINES)):ae.setMode(H.TRIANGLES);else if(Y.isLine){let Kt=st.linewidth;Kt===void 0&&(Kt=1),Yt.setLineWidth(Kt*fe()),Y.isLineSegments?ae.setMode(H.LINES):Y.isLineLoop?ae.setMode(H.LINE_LOOP):ae.setMode(H.LINE_STRIP)}else Y.isPoints?ae.setMode(H.POINTS):Y.isSprite&&ae.setMode(H.TRIANGLES);if(Y.isBatchedMesh)if(Y._multiDrawInstances!==null)Nc("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ae.renderMultiDrawInstances(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount,Y._multiDrawInstances);else if(he.get("WEBGL_multi_draw"))ae.renderMultiDraw(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount);else{const Kt=Y._multiDrawStarts,un=Y._multiDrawCounts,Ee=Y._multiDrawCount,zn=Ot?pt.get(Ot).bytesPerElement:1,gi=Xt.get(st).currentProgram.getUniforms();for(let Un=0;Un<Ee;Un++)gi.setValue(H,"_gl_DrawID",Un),ae.render(Kt[Un]/zn,un[Un])}else if(Y.isInstancedMesh)ae.renderInstances(xe,ke,Y.count);else if(rt.isInstancedBufferGeometry){const Kt=rt._maxInstanceCount!==void 0?rt._maxInstanceCount:1/0,un=Math.min(rt.instanceCount,Kt);ae.renderInstances(xe,ke,un)}else ae.render(xe,ke)};function Te(C,Z,rt){C.transparent===!0&&C.side===Ni&&C.forceSinglePass===!1?(C.side=Xn,C.needsUpdate=!0,Ke(C,Z,rt),C.side=Ya,C.needsUpdate=!0,Ke(C,Z,rt),C.side=Ni):Ke(C,Z,rt)}this.compile=function(C,Z,rt=null){rt===null&&(rt=C),y=_e.get(rt),y.init(Z),L.push(y),rt.traverseVisible(function(Y){Y.isLight&&Y.layers.test(Z.layers)&&(y.pushLight(Y),Y.castShadow&&y.pushShadow(Y))}),C!==rt&&C.traverseVisible(function(Y){Y.isLight&&Y.layers.test(Z.layers)&&(y.pushLight(Y),Y.castShadow&&y.pushShadow(Y))}),y.setupLights();const st=new Set;return C.traverse(function(Y){if(!(Y.isMesh||Y.isPoints||Y.isLine||Y.isSprite))return;const Tt=Y.material;if(Tt)if(Array.isArray(Tt))for(let Dt=0;Dt<Tt.length;Dt++){const Lt=Tt[Dt];Te(Lt,rt,Y),st.add(Lt)}else Te(Tt,rt,Y),st.add(Tt)}),y=L.pop(),st},this.compileAsync=function(C,Z,rt=null){const st=this.compile(C,Z,rt);return new Promise(Y=>{function Tt(){if(st.forEach(function(Dt){Xt.get(Dt).currentProgram.isReady()&&st.delete(Dt)}),st.size===0){Y(C);return}setTimeout(Tt,10)}he.get("KHR_parallel_shader_compile")!==null?Tt():setTimeout(Tt,10)})};let _n=null;function pi(C){_n&&_n(C)}function Os(){Ai.stop()}function zs(){Ai.start()}const Ai=new D0;Ai.setAnimationLoop(pi),typeof self<"u"&&Ai.setContext(self),this.setAnimationLoop=function(C){_n=C,ut.setAnimationLoop(C),C===null?Ai.stop():Ai.start()},ut.addEventListener("sessionstart",Os),ut.addEventListener("sessionend",zs),this.render=function(C,Z){if(Z!==void 0&&Z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(k===!0)return;if(C.matrixWorldAutoUpdate===!0&&C.updateMatrixWorld(),Z.parent===null&&Z.matrixWorldAutoUpdate===!0&&Z.updateMatrixWorld(),ut.enabled===!0&&ut.isPresenting===!0&&(ut.cameraAutoUpdate===!0&&ut.updateCamera(Z),Z=ut.getCamera()),C.isScene===!0&&C.onBeforeRender(w,C,Z,X),y=_e.get(C,L.length),y.init(Z),L.push(y),zt.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),q.setFromProjectionMatrix(zt),St=this.localClippingEnabled,ct=bt.init(this.clippingPlanes,St),M=Pt.get(C,P.length),M.init(),P.push(M),ut.enabled===!0&&ut.isPresenting===!0){const Tt=w.xr.getDepthSensingMesh();Tt!==null&&Za(Tt,Z,-1/0,w.sortObjects)}Za(C,Z,0,w.sortObjects),M.finish(),w.sortObjects===!0&&M.sort(ft,xt),Ge=ut.enabled===!1||ut.isPresenting===!1||ut.hasDepthSensing()===!1,Ge&&Qt.addToRenderList(M,C),this.info.render.frame++,ct===!0&&bt.beginShadows();const rt=y.state.shadowsArray;Bt.render(rt,C,Z),ct===!0&&bt.endShadows(),this.info.autoReset===!0&&this.info.reset();const st=M.opaque,Y=M.transmissive;if(y.setupLights(),Z.isArrayCamera){const Tt=Z.cameras;if(Y.length>0)for(let Dt=0,Lt=Tt.length;Dt<Lt;Dt++){const Ot=Tt[Dt];Ps(st,Y,C,Ot)}Ge&&Qt.render(C);for(let Dt=0,Lt=Tt.length;Dt<Lt;Dt++){const Ot=Tt[Dt];wr(M,C,Ot,Ot.viewport)}}else Y.length>0&&Ps(st,Y,C,Z),Ge&&Qt.render(C),wr(M,C,Z);X!==null&&z===0&&(N.updateMultisampleRenderTarget(X),N.updateRenderTargetMipmap(X)),C.isScene===!0&&C.onAfterRender(w,C,Z),ze.resetDefaultState(),D=-1,R=null,L.pop(),L.length>0?(y=L[L.length-1],ct===!0&&bt.setGlobalState(w.clippingPlanes,y.state.camera)):y=null,P.pop(),P.length>0?M=P[P.length-1]:M=null};function Za(C,Z,rt,st){if(C.visible===!1)return;if(C.layers.test(Z.layers)){if(C.isGroup)rt=C.renderOrder;else if(C.isLOD)C.autoUpdate===!0&&C.update(Z);else if(C.isLight)y.pushLight(C),C.castShadow&&y.pushShadow(C);else if(C.isSprite){if(!C.frustumCulled||q.intersectsSprite(C)){st&&Gt.setFromMatrixPosition(C.matrixWorld).applyMatrix4(zt);const Dt=gt.update(C),Lt=C.material;Lt.visible&&M.push(C,Dt,Lt,rt,Gt.z,null)}}else if((C.isMesh||C.isLine||C.isPoints)&&(!C.frustumCulled||q.intersectsObject(C))){const Dt=gt.update(C),Lt=C.material;if(st&&(C.boundingSphere!==void 0?(C.boundingSphere===null&&C.computeBoundingSphere(),Gt.copy(C.boundingSphere.center)):(Dt.boundingSphere===null&&Dt.computeBoundingSphere(),Gt.copy(Dt.boundingSphere.center)),Gt.applyMatrix4(C.matrixWorld).applyMatrix4(zt)),Array.isArray(Lt)){const Ot=Dt.groups;for(let ie=0,$t=Ot.length;ie<$t;ie++){const jt=Ot[ie],xe=Lt[jt.materialIndex];xe&&xe.visible&&M.push(C,Dt,xe,rt,Gt.z,jt)}}else Lt.visible&&M.push(C,Dt,Lt,rt,Gt.z,null)}}const Tt=C.children;for(let Dt=0,Lt=Tt.length;Dt<Lt;Dt++)Za(Tt[Dt],Z,rt,st)}function wr(C,Z,rt,st){const Y=C.opaque,Tt=C.transmissive,Dt=C.transparent;y.setupLightsView(rt),ct===!0&&bt.setGlobalState(w.clippingPlanes,rt),st&&Yt.viewport(G.copy(st)),Y.length>0&&Ka(Y,Z,rt),Tt.length>0&&Ka(Tt,Z,rt),Dt.length>0&&Ka(Dt,Z,rt),Yt.buffers.depth.setTest(!0),Yt.buffers.depth.setMask(!0),Yt.buffers.color.setMask(!0),Yt.setPolygonOffset(!1)}function Ps(C,Z,rt,st){if((rt.isScene===!0?rt.overrideMaterial:null)!==null)return;y.state.transmissionRenderTarget[st.id]===void 0&&(y.state.transmissionRenderTarget[st.id]=new Cr(1,1,{generateMipmaps:!0,type:he.has("EXT_color_buffer_half_float")||he.has("EXT_color_buffer_float")?Vo:ua,minFilter:br,samples:4,stencilBuffer:c,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ce.workingColorSpace}));const Tt=y.state.transmissionRenderTarget[st.id],Dt=st.viewport||G;Tt.setSize(Dt.z*w.transmissionResolutionScale,Dt.w*w.transmissionResolutionScale);const Lt=w.getRenderTarget();w.setRenderTarget(Tt),w.getClearColor(lt),vt=w.getClearAlpha(),vt<1&&w.setClearColor(16777215,.5),w.clear(),Ge&&Qt.render(rt);const Ot=w.toneMapping;w.toneMapping=Xa;const ie=st.viewport;if(st.viewport!==void 0&&(st.viewport=void 0),y.setupLightsView(st),ct===!0&&bt.setGlobalState(w.clippingPlanes,st),Ka(C,rt,st),N.updateMultisampleRenderTarget(Tt),N.updateRenderTargetMipmap(Tt),he.has("WEBGL_multisampled_render_to_texture")===!1){let $t=!1;for(let jt=0,xe=Z.length;jt<xe;jt++){const Se=Z[jt],ke=Se.object,be=Se.geometry,ae=Se.material,Kt=Se.group;if(ae.side===Ni&&ke.layers.test(st.layers)){const un=ae.side;ae.side=Xn,ae.needsUpdate=!0,mi(ke,rt,st,be,ae,Kt),ae.side=un,ae.needsUpdate=!0,$t=!0}}$t===!0&&(N.updateMultisampleRenderTarget(Tt),N.updateRenderTargetMipmap(Tt))}w.setRenderTarget(Lt),w.setClearColor(lt,vt),ie!==void 0&&(st.viewport=ie),w.toneMapping=Ot}function Ka(C,Z,rt){const st=Z.isScene===!0?Z.overrideMaterial:null;for(let Y=0,Tt=C.length;Y<Tt;Y++){const Dt=C[Y],Lt=Dt.object,Ot=Dt.geometry,ie=Dt.group;let $t=Dt.material;$t.allowOverride===!0&&st!==null&&($t=st),Lt.layers.test(rt.layers)&&mi(Lt,Z,rt,Ot,$t,ie)}}function mi(C,Z,rt,st,Y,Tt){C.onBeforeRender(w,Z,rt,st,Y,Tt),C.modelViewMatrix.multiplyMatrices(rt.matrixWorldInverse,C.matrixWorld),C.normalMatrix.getNormalMatrix(C.modelViewMatrix),Y.onBeforeRender(w,Z,rt,st,C,Tt),Y.transparent===!0&&Y.side===Ni&&Y.forceSinglePass===!1?(Y.side=Xn,Y.needsUpdate=!0,w.renderBufferDirect(rt,Z,st,Y,C,Tt),Y.side=Ya,Y.needsUpdate=!0,w.renderBufferDirect(rt,Z,st,Y,C,Tt),Y.side=Ni):w.renderBufferDirect(rt,Z,st,Y,C,Tt),C.onAfterRender(w,Z,rt,st,Y,Tt)}function Ke(C,Z,rt){Z.isScene!==!0&&(Z=De);const st=Xt.get(C),Y=y.state.lights,Tt=y.state.shadowsArray,Dt=Y.state.version,Lt=Vt.getParameters(C,Y.state,Tt,Z,rt),Ot=Vt.getProgramCacheKey(Lt);let ie=st.programs;st.environment=C.isMeshStandardMaterial?Z.environment:null,st.fog=Z.fog,st.envMap=(C.isMeshStandardMaterial?at:A).get(C.envMap||st.environment),st.envMapRotation=st.environment!==null&&C.envMap===null?Z.environmentRotation:C.envMapRotation,ie===void 0&&(C.addEventListener("dispose",ne),ie=new Map,st.programs=ie);let $t=ie.get(Ot);if($t!==void 0){if(st.currentProgram===$t&&st.lightsStateVersion===Dt)return Bi(C,Lt),$t}else Lt.uniforms=Vt.getUniforms(C),C.onBeforeCompile(Lt,w),$t=Vt.acquireProgram(Lt,Ot),ie.set(Ot,$t),st.uniforms=Lt.uniforms;const jt=st.uniforms;return(!C.isShaderMaterial&&!C.isRawShaderMaterial||C.clipping===!0)&&(jt.clippingPlanes=bt.uniform),Bi(C,Lt),st.needsLights=qc(C),st.lightsStateVersion=Dt,st.needsLights&&(jt.ambientLightColor.value=Y.state.ambient,jt.lightProbe.value=Y.state.probe,jt.directionalLights.value=Y.state.directional,jt.directionalLightShadows.value=Y.state.directionalShadow,jt.spotLights.value=Y.state.spot,jt.spotLightShadows.value=Y.state.spotShadow,jt.rectAreaLights.value=Y.state.rectArea,jt.ltc_1.value=Y.state.rectAreaLTC1,jt.ltc_2.value=Y.state.rectAreaLTC2,jt.pointLights.value=Y.state.point,jt.pointLightShadows.value=Y.state.pointShadow,jt.hemisphereLights.value=Y.state.hemi,jt.directionalShadowMap.value=Y.state.directionalShadowMap,jt.directionalShadowMatrix.value=Y.state.directionalShadowMatrix,jt.spotShadowMap.value=Y.state.spotShadowMap,jt.spotLightMatrix.value=Y.state.spotLightMatrix,jt.spotLightMap.value=Y.state.spotLightMap,jt.pointShadowMap.value=Y.state.pointShadowMap,jt.pointShadowMatrix.value=Y.state.pointShadowMatrix),st.currentProgram=$t,st.uniformsList=null,$t}function vn(C){if(C.uniformsList===null){const Z=C.currentProgram.getUniforms();C.uniformsList=Oc.seqWithValue(Z.seq,C.uniforms)}return C.uniformsList}function Bi(C,Z){const rt=Xt.get(C);rt.outputColorSpace=Z.outputColorSpace,rt.batching=Z.batching,rt.batchingColor=Z.batchingColor,rt.instancing=Z.instancing,rt.instancingColor=Z.instancingColor,rt.instancingMorph=Z.instancingMorph,rt.skinning=Z.skinning,rt.morphTargets=Z.morphTargets,rt.morphNormals=Z.morphNormals,rt.morphColors=Z.morphColors,rt.morphTargetsCount=Z.morphTargetsCount,rt.numClippingPlanes=Z.numClippingPlanes,rt.numIntersection=Z.numClipIntersection,rt.vertexAlphas=Z.vertexAlphas,rt.vertexTangents=Z.vertexTangents,rt.toneMapping=Z.toneMapping}function Bs(C,Z,rt,st,Y){Z.isScene!==!0&&(Z=De),N.resetTextureUnits();const Tt=Z.fog,Dt=st.isMeshStandardMaterial?Z.environment:null,Lt=X===null?w.outputColorSpace:X.isXRRenderTarget===!0?X.texture.colorSpace:ws,Ot=(st.isMeshStandardMaterial?at:A).get(st.envMap||Dt),ie=st.vertexColors===!0&&!!rt.attributes.color&&rt.attributes.color.itemSize===4,$t=!!rt.attributes.tangent&&(!!st.normalMap||st.anisotropy>0),jt=!!rt.morphAttributes.position,xe=!!rt.morphAttributes.normal,Se=!!rt.morphAttributes.color;let ke=Xa;st.toneMapped&&(X===null||X.isXRRenderTarget===!0)&&(ke=w.toneMapping);const be=rt.morphAttributes.position||rt.morphAttributes.normal||rt.morphAttributes.color,ae=be!==void 0?be.length:0,Kt=Xt.get(st),un=y.state.lights;if(ct===!0&&(St===!0||C!==R)){const Qe=C===R&&st.id===D;bt.setState(st,C,Qe)}let Ee=!1;st.version===Kt.__version?(Kt.needsLights&&Kt.lightsStateVersion!==un.state.version||Kt.outputColorSpace!==Lt||Y.isBatchedMesh&&Kt.batching===!1||!Y.isBatchedMesh&&Kt.batching===!0||Y.isBatchedMesh&&Kt.batchingColor===!0&&Y.colorTexture===null||Y.isBatchedMesh&&Kt.batchingColor===!1&&Y.colorTexture!==null||Y.isInstancedMesh&&Kt.instancing===!1||!Y.isInstancedMesh&&Kt.instancing===!0||Y.isSkinnedMesh&&Kt.skinning===!1||!Y.isSkinnedMesh&&Kt.skinning===!0||Y.isInstancedMesh&&Kt.instancingColor===!0&&Y.instanceColor===null||Y.isInstancedMesh&&Kt.instancingColor===!1&&Y.instanceColor!==null||Y.isInstancedMesh&&Kt.instancingMorph===!0&&Y.morphTexture===null||Y.isInstancedMesh&&Kt.instancingMorph===!1&&Y.morphTexture!==null||Kt.envMap!==Ot||st.fog===!0&&Kt.fog!==Tt||Kt.numClippingPlanes!==void 0&&(Kt.numClippingPlanes!==bt.numPlanes||Kt.numIntersection!==bt.numIntersection)||Kt.vertexAlphas!==ie||Kt.vertexTangents!==$t||Kt.morphTargets!==jt||Kt.morphNormals!==xe||Kt.morphColors!==Se||Kt.toneMapping!==ke||Kt.morphTargetsCount!==ae)&&(Ee=!0):(Ee=!0,Kt.__version=st.version);let zn=Kt.currentProgram;Ee===!0&&(zn=Ke(st,Z,Y));let gi=!1,Un=!1,pn=!1;const Pe=zn.getUniforms(),Ln=Kt.uniforms;if(Yt.useProgram(zn.program)&&(gi=!0,Un=!0,pn=!0),st.id!==D&&(D=st.id,Un=!0),gi||R!==C){Yt.buffers.depth.getReversed()?(Mt.copy(C.projectionMatrix),fM(Mt),hM(Mt),Pe.setValue(H,"projectionMatrix",Mt)):Pe.setValue(H,"projectionMatrix",C.projectionMatrix),Pe.setValue(H,"viewMatrix",C.matrixWorldInverse);const yn=Pe.map.cameraPosition;yn!==void 0&&yn.setValue(H,qt.setFromMatrixPosition(C.matrixWorld)),ge.logarithmicDepthBuffer&&Pe.setValue(H,"logDepthBufFC",2/(Math.log(C.far+1)/Math.LN2)),(st.isMeshPhongMaterial||st.isMeshToonMaterial||st.isMeshLambertMaterial||st.isMeshBasicMaterial||st.isMeshStandardMaterial||st.isShaderMaterial)&&Pe.setValue(H,"isOrthographic",C.isOrthographicCamera===!0),R!==C&&(R=C,Un=!0,pn=!0)}if(Y.isSkinnedMesh){Pe.setOptional(H,Y,"bindMatrix"),Pe.setOptional(H,Y,"bindMatrixInverse");const Qe=Y.skeleton;Qe&&(Qe.boneTexture===null&&Qe.computeBoneTexture(),Pe.setValue(H,"boneTexture",Qe.boneTexture,N))}Y.isBatchedMesh&&(Pe.setOptional(H,Y,"batchingTexture"),Pe.setValue(H,"batchingTexture",Y._matricesTexture,N),Pe.setOptional(H,Y,"batchingIdTexture"),Pe.setValue(H,"batchingIdTexture",Y._indirectTexture,N),Pe.setOptional(H,Y,"batchingColorTexture"),Y._colorsTexture!==null&&Pe.setValue(H,"batchingColorTexture",Y._colorsTexture,N));const bn=rt.morphAttributes;if((bn.position!==void 0||bn.normal!==void 0||bn.color!==void 0)&&kt.update(Y,rt,zn),(Un||Kt.receiveShadow!==Y.receiveShadow)&&(Kt.receiveShadow=Y.receiveShadow,Pe.setValue(H,"receiveShadow",Y.receiveShadow)),st.isMeshGouraudMaterial&&st.envMap!==null&&(Ln.envMap.value=Ot,Ln.flipEnvMap.value=Ot.isCubeTexture&&Ot.isRenderTargetTexture===!1?-1:1),st.isMeshStandardMaterial&&st.envMap===null&&Z.environment!==null&&(Ln.envMapIntensity.value=Z.environmentIntensity),Un&&(Pe.setValue(H,"toneMappingExposure",w.toneMappingExposure),Kt.needsLights&&Wc(Ln,pn),Tt&&st.fog===!0&&Rt.refreshFogUniforms(Ln,Tt),Rt.refreshMaterialUniforms(Ln,st,I,W,y.state.transmissionRenderTarget[C.id]),Oc.upload(H,vn(Kt),Ln,N)),st.isShaderMaterial&&st.uniformsNeedUpdate===!0&&(Oc.upload(H,vn(Kt),Ln,N),st.uniformsNeedUpdate=!1),st.isSpriteMaterial&&Pe.setValue(H,"center",Y.center),Pe.setValue(H,"modelViewMatrix",Y.modelViewMatrix),Pe.setValue(H,"normalMatrix",Y.normalMatrix),Pe.setValue(H,"modelMatrix",Y.matrixWorld),st.isShaderMaterial||st.isRawShaderMaterial){const Qe=st.uniformsGroups;for(let yn=0,Dr=Qe.length;yn<Dr;yn++){const Pn=Qe[yn];j.update(Pn,zn),j.bind(Pn,zn)}}return zn}function Wc(C,Z){C.ambientLightColor.needsUpdate=Z,C.lightProbe.needsUpdate=Z,C.directionalLights.needsUpdate=Z,C.directionalLightShadows.needsUpdate=Z,C.pointLights.needsUpdate=Z,C.pointLightShadows.needsUpdate=Z,C.spotLights.needsUpdate=Z,C.spotLightShadows.needsUpdate=Z,C.rectAreaLights.needsUpdate=Z,C.hemisphereLights.needsUpdate=Z}function qc(C){return C.isMeshLambertMaterial||C.isMeshToonMaterial||C.isMeshPhongMaterial||C.isMeshStandardMaterial||C.isShadowMaterial||C.isShaderMaterial&&C.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return X},this.setRenderTargetTextures=function(C,Z,rt){const st=Xt.get(C);st.__autoAllocateDepthBuffer=C.resolveDepthBuffer===!1,st.__autoAllocateDepthBuffer===!1&&(st.__useRenderToTexture=!1),Xt.get(C.texture).__webglTexture=Z,Xt.get(C.depthTexture).__webglTexture=st.__autoAllocateDepthBuffer?void 0:rt,st.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(C,Z){const rt=Xt.get(C);rt.__webglFramebuffer=Z,rt.__useDefaultFramebuffer=Z===void 0};const Zo=H.createFramebuffer();this.setRenderTarget=function(C,Z=0,rt=0){X=C,B=Z,z=rt;let st=!0,Y=null,Tt=!1,Dt=!1;if(C){const Ot=Xt.get(C);if(Ot.__useDefaultFramebuffer!==void 0)Yt.bindFramebuffer(H.FRAMEBUFFER,null),st=!1;else if(Ot.__webglFramebuffer===void 0)N.setupRenderTarget(C);else if(Ot.__hasExternalTextures)N.rebindTextures(C,Xt.get(C.texture).__webglTexture,Xt.get(C.depthTexture).__webglTexture);else if(C.depthBuffer){const jt=C.depthTexture;if(Ot.__boundDepthTexture!==jt){if(jt!==null&&Xt.has(jt)&&(C.width!==jt.image.width||C.height!==jt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");N.setupDepthRenderbuffer(C)}}const ie=C.texture;(ie.isData3DTexture||ie.isDataArrayTexture||ie.isCompressedArrayTexture)&&(Dt=!0);const $t=Xt.get(C).__webglFramebuffer;C.isWebGLCubeRenderTarget?(Array.isArray($t[Z])?Y=$t[Z][rt]:Y=$t[Z],Tt=!0):C.samples>0&&N.useMultisampledRTT(C)===!1?Y=Xt.get(C).__webglMultisampledFramebuffer:Array.isArray($t)?Y=$t[rt]:Y=$t,G.copy(C.viewport),nt.copy(C.scissor),$=C.scissorTest}else G.copy(O).multiplyScalar(I).floor(),nt.copy(J).multiplyScalar(I).floor(),$=dt;if(rt!==0&&(Y=Zo),Yt.bindFramebuffer(H.FRAMEBUFFER,Y)&&st&&Yt.drawBuffers(C,Y),Yt.viewport(G),Yt.scissor(nt),Yt.setScissorTest($),Tt){const Ot=Xt.get(C.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Ot.__webglTexture,rt)}else if(Dt){const Ot=Xt.get(C.texture),ie=Z;H.framebufferTextureLayer(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,Ot.__webglTexture,rt,ie)}else if(C!==null&&rt!==0){const Ot=Xt.get(C.texture);H.framebufferTexture2D(H.FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,Ot.__webglTexture,rt)}D=-1},this.readRenderTargetPixels=function(C,Z,rt,st,Y,Tt,Dt){if(!(C&&C.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Lt=Xt.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Dt!==void 0&&(Lt=Lt[Dt]),Lt){Yt.bindFramebuffer(H.FRAMEBUFFER,Lt);try{const Ot=C.texture,ie=Ot.format,$t=Ot.type;if(!ge.textureFormatReadable(ie)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ge.textureTypeReadable($t)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Z>=0&&Z<=C.width-st&&rt>=0&&rt<=C.height-Y&&H.readPixels(Z,rt,st,Y,se.convert(ie),se.convert($t),Tt)}finally{const Ot=X!==null?Xt.get(X).__webglFramebuffer:null;Yt.bindFramebuffer(H.FRAMEBUFFER,Ot)}}},this.readRenderTargetPixelsAsync=async function(C,Z,rt,st,Y,Tt,Dt){if(!(C&&C.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Lt=Xt.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Dt!==void 0&&(Lt=Lt[Dt]),Lt)if(Z>=0&&Z<=C.width-st&&rt>=0&&rt<=C.height-Y){Yt.bindFramebuffer(H.FRAMEBUFFER,Lt);const Ot=C.texture,ie=Ot.format,$t=Ot.type;if(!ge.textureFormatReadable(ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ge.textureTypeReadable($t))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const jt=H.createBuffer();H.bindBuffer(H.PIXEL_PACK_BUFFER,jt),H.bufferData(H.PIXEL_PACK_BUFFER,Tt.byteLength,H.STREAM_READ),H.readPixels(Z,rt,st,Y,se.convert(ie),se.convert($t),0);const xe=X!==null?Xt.get(X).__webglFramebuffer:null;Yt.bindFramebuffer(H.FRAMEBUFFER,xe);const Se=H.fenceSync(H.SYNC_GPU_COMMANDS_COMPLETE,0);return H.flush(),await uM(H,Se,4),H.bindBuffer(H.PIXEL_PACK_BUFFER,jt),H.getBufferSubData(H.PIXEL_PACK_BUFFER,0,Tt),H.deleteBuffer(jt),H.deleteSync(Se),Tt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(C,Z=null,rt=0){const st=Math.pow(2,-rt),Y=Math.floor(C.image.width*st),Tt=Math.floor(C.image.height*st),Dt=Z!==null?Z.x:0,Lt=Z!==null?Z.y:0;N.setTexture2D(C,0),H.copyTexSubImage2D(H.TEXTURE_2D,rt,0,0,Dt,Lt,Y,Tt),Yt.unbindTexture()};const Qa=H.createFramebuffer(),Fs=H.createFramebuffer();this.copyTextureToTexture=function(C,Z,rt=null,st=null,Y=0,Tt=null){Tt===null&&(Y!==0?(Nc("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Tt=Y,Y=0):Tt=0);let Dt,Lt,Ot,ie,$t,jt,xe,Se,ke;const be=C.isCompressedTexture?C.mipmaps[Tt]:C.image;if(rt!==null)Dt=rt.max.x-rt.min.x,Lt=rt.max.y-rt.min.y,Ot=rt.isBox3?rt.max.z-rt.min.z:1,ie=rt.min.x,$t=rt.min.y,jt=rt.isBox3?rt.min.z:0;else{const bn=Math.pow(2,-Y);Dt=Math.floor(be.width*bn),Lt=Math.floor(be.height*bn),C.isDataArrayTexture?Ot=be.depth:C.isData3DTexture?Ot=Math.floor(be.depth*bn):Ot=1,ie=0,$t=0,jt=0}st!==null?(xe=st.x,Se=st.y,ke=st.z):(xe=0,Se=0,ke=0);const ae=se.convert(Z.format),Kt=se.convert(Z.type);let un;Z.isData3DTexture?(N.setTexture3D(Z,0),un=H.TEXTURE_3D):Z.isDataArrayTexture||Z.isCompressedArrayTexture?(N.setTexture2DArray(Z,0),un=H.TEXTURE_2D_ARRAY):(N.setTexture2D(Z,0),un=H.TEXTURE_2D),H.pixelStorei(H.UNPACK_FLIP_Y_WEBGL,Z.flipY),H.pixelStorei(H.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Z.premultiplyAlpha),H.pixelStorei(H.UNPACK_ALIGNMENT,Z.unpackAlignment);const Ee=H.getParameter(H.UNPACK_ROW_LENGTH),zn=H.getParameter(H.UNPACK_IMAGE_HEIGHT),gi=H.getParameter(H.UNPACK_SKIP_PIXELS),Un=H.getParameter(H.UNPACK_SKIP_ROWS),pn=H.getParameter(H.UNPACK_SKIP_IMAGES);H.pixelStorei(H.UNPACK_ROW_LENGTH,be.width),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,be.height),H.pixelStorei(H.UNPACK_SKIP_PIXELS,ie),H.pixelStorei(H.UNPACK_SKIP_ROWS,$t),H.pixelStorei(H.UNPACK_SKIP_IMAGES,jt);const Pe=C.isDataArrayTexture||C.isData3DTexture,Ln=Z.isDataArrayTexture||Z.isData3DTexture;if(C.isDepthTexture){const bn=Xt.get(C),Qe=Xt.get(Z),yn=Xt.get(bn.__renderTarget),Dr=Xt.get(Qe.__renderTarget);Yt.bindFramebuffer(H.READ_FRAMEBUFFER,yn.__webglFramebuffer),Yt.bindFramebuffer(H.DRAW_FRAMEBUFFER,Dr.__webglFramebuffer);for(let Pn=0;Pn<Ot;Pn++)Pe&&(H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,Xt.get(C).__webglTexture,Y,jt+Pn),H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,Xt.get(Z).__webglTexture,Tt,ke+Pn)),H.blitFramebuffer(ie,$t,Dt,Lt,xe,Se,Dt,Lt,H.DEPTH_BUFFER_BIT,H.NEAREST);Yt.bindFramebuffer(H.READ_FRAMEBUFFER,null),Yt.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else if(Y!==0||C.isRenderTargetTexture||Xt.has(C)){const bn=Xt.get(C),Qe=Xt.get(Z);Yt.bindFramebuffer(H.READ_FRAMEBUFFER,Qa),Yt.bindFramebuffer(H.DRAW_FRAMEBUFFER,Fs);for(let yn=0;yn<Ot;yn++)Pe?H.framebufferTextureLayer(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,bn.__webglTexture,Y,jt+yn):H.framebufferTexture2D(H.READ_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,bn.__webglTexture,Y),Ln?H.framebufferTextureLayer(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,Qe.__webglTexture,Tt,ke+yn):H.framebufferTexture2D(H.DRAW_FRAMEBUFFER,H.COLOR_ATTACHMENT0,H.TEXTURE_2D,Qe.__webglTexture,Tt),Y!==0?H.blitFramebuffer(ie,$t,Dt,Lt,xe,Se,Dt,Lt,H.COLOR_BUFFER_BIT,H.NEAREST):Ln?H.copyTexSubImage3D(un,Tt,xe,Se,ke+yn,ie,$t,Dt,Lt):H.copyTexSubImage2D(un,Tt,xe,Se,ie,$t,Dt,Lt);Yt.bindFramebuffer(H.READ_FRAMEBUFFER,null),Yt.bindFramebuffer(H.DRAW_FRAMEBUFFER,null)}else Ln?C.isDataTexture||C.isData3DTexture?H.texSubImage3D(un,Tt,xe,Se,ke,Dt,Lt,Ot,ae,Kt,be.data):Z.isCompressedArrayTexture?H.compressedTexSubImage3D(un,Tt,xe,Se,ke,Dt,Lt,Ot,ae,be.data):H.texSubImage3D(un,Tt,xe,Se,ke,Dt,Lt,Ot,ae,Kt,be):C.isDataTexture?H.texSubImage2D(H.TEXTURE_2D,Tt,xe,Se,Dt,Lt,ae,Kt,be.data):C.isCompressedTexture?H.compressedTexSubImage2D(H.TEXTURE_2D,Tt,xe,Se,be.width,be.height,ae,be.data):H.texSubImage2D(H.TEXTURE_2D,Tt,xe,Se,Dt,Lt,ae,Kt,be);H.pixelStorei(H.UNPACK_ROW_LENGTH,Ee),H.pixelStorei(H.UNPACK_IMAGE_HEIGHT,zn),H.pixelStorei(H.UNPACK_SKIP_PIXELS,gi),H.pixelStorei(H.UNPACK_SKIP_ROWS,Un),H.pixelStorei(H.UNPACK_SKIP_IMAGES,pn),Tt===0&&Z.generateMipmaps&&H.generateMipmap(un),Yt.unbindTexture()},this.copyTextureToTexture3D=function(C,Z,rt=null,st=null,Y=0){return Nc('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(C,Z,rt,st,Y)},this.initRenderTarget=function(C){Xt.get(C).__webglFramebuffer===void 0&&N.setupRenderTarget(C)},this.initTexture=function(C){C.isCubeTexture?N.setTextureCube(C,0):C.isData3DTexture?N.setTexture3D(C,0):C.isDataArrayTexture||C.isCompressedArrayTexture?N.setTexture2DArray(C,0):N.setTexture2D(C,0),Yt.unbindTexture()},this.resetState=function(){B=0,z=0,X=null,Yt.reset(),ze.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return la}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=Ce._getDrawingBufferColorSpace(t),i.unpackColorSpace=Ce._getUnpackColorSpace()}}const q1={U:[0,1,0],D:[0,-1,0],F:[0,0,1],B:[0,0,-1],R:[1,0,0],L:[-1,0,0]},Y1={R:[1,0,0],L:[1,0,0],U:[0,1,0],D:[0,1,0],F:[0,0,1],B:[0,0,1]};function z0(s){return s.endsWith("2")?Math.PI:s.endsWith("'")?-Math.PI/2:Math.PI/2}function P0(s){return s.replace("'","").replace("2","")}function Xv(s){return s.endsWith("'")&&!s.endsWith("2")}function j1(s){return s.endsWith("2")}const Wv=16777215,Z1=.022;class K1{constructor(t){qe(this,"renderer");qe(this,"scene");qe(this,"camera");qe(this,"arrowGroup");qe(this,"traceGroup",null);qe(this,"currentMove",null);qe(this,"traceProgress",0);qe(this,"width",1);qe(this,"height",1);this.renderer=new W1({canvas:t,alpha:!0,antialias:!0,powerPreference:"high-performance"}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.setClearColor(0,0),this.scene=new FM,this.camera=new di(45,1,.01,100),this.camera.position.set(0,0,3);const i=new oE(16777215,.9),a=new sE(16777215,.6);a.position.set(2,3,4),this.scene.add(i,a),this.arrowGroup=new Ar,this.scene.add(this.arrowGroup)}resize(t,i){this.width=t,this.height=i,this.renderer.setSize(t,i,!1),this.camera.aspect=t/i,this.camera.updateProjectionMatrix()}setMove(t){t!==this.currentMove&&(this.currentMove=t,this.traceProgress=0,this.rebuildArrow(t))}tick(){this.currentMove&&(this.traceProgress+=Z1,this.traceProgress>1.05&&(this.traceProgress=0),this.updateTrace())}render(t){if(!t||!this.currentMove){this.renderer.render(this.scene,this.camera);return}const i=new Ar,a=new Ze;a.set(t.rotationMatrix[0],t.rotationMatrix[1],t.rotationMatrix[2],0,t.rotationMatrix[3],t.rotationMatrix[4],t.rotationMatrix[5],0,t.rotationMatrix[6],t.rotationMatrix[7],t.rotationMatrix[8],0,0,0,0,1),i.setRotationFromMatrix(a);const l=t.size/this.width;i.position.set((t.translation[0]-this.width/2)*l,-(t.translation[1]-this.height/2)*l,t.translation[2]*l),i.scale.setScalar(l*2),this.arrowGroup.matrixAutoUpdate=!1,this.arrowGroup.matrix.copy(i.matrix),this.arrowGroup.matrixWorldNeedsUpdate=!0,this.renderer.render(this.scene,this.camera)}dispose(){this.renderer.dispose(),this.clearArrow()}rebuildArrow(t){if(this.clearArrow(),!t)return;const i=P0(t),a=new Q(...q1[i]),l=new Q(0,1,0);Math.abs(a.dot(l))>.9&&l.set(0,0,1);const c=new Q().crossVectors(l,a).normalize(),f=new Q().crossVectors(a,c).normalize(),h=a.clone().multiplyScalar(.52),p=new Ar;p.position.copy(h),p.userData={tangent:c,bitangent:f,move:t};const m=z0(t),g=.32,_=32,v=Xv(t)?m:0,S=Xv(t)?0:m,E=[];for(let M=0;M<=_;M++){const y=v+(S-v)*M/_,P=c.clone().multiplyScalar(Math.cos(y)*g).add(f.clone().multiplyScalar(Math.sin(y)*g));E.push(P)}p.userData.points=E,p.userData.segments=_;const T=new ei(new jd(.34,.4,48),new Ic({color:Wv,transparent:!0,opacity:.35,side:Ni,depthWrite:!1}));if(p.add(T),j1(t)){const M=T.clone();M.rotation.z=Math.PI,p.add(M)}this.traceGroup=p,this.arrowGroup.add(p),this.updateTrace()}updateTrace(){if(!this.traceGroup||!this.currentMove)return;const t=this.traceGroup.getObjectByName("trace");t&&(this.traceGroup.remove(t),qv(t));const i=this.traceGroup.userData.points,a=this.traceGroup.userData.segments;if(!(i!=null&&i.length))return;const l=Math.max(2,Math.floor(a*this.traceProgress)),c=i.slice(0,l+1);if(c.length<2)return;const f=new A0(c),h=new Zd(f,l,.028,8,!1),p=new Ic({color:Wv,transparent:!0,opacity:.88,depthTest:!0,depthWrite:!1}),m=new ei(h,p);m.name="trace",this.traceGroup.add(m);const g=c[c.length-1],_=c[c.length-2]??g,v=new Q().subVectors(g,_).normalize(),S=new ei(new Yd(.065,.15,12),p.clone());S.name="trace",S.position.copy(g),S.quaternion.setFromUnitVectors(new Q(0,1,0),v),this.traceGroup.add(S)}clearArrow(){for(this.traceGroup=null;this.arrowGroup.children.length>0;){const t=this.arrowGroup.children[0];this.arrowGroup.remove(t),qv(t)}}}function qv(s){s.traverse(t=>{t instanceof ei&&(t.geometry.dispose(),Array.isArray(t.material)?t.material.forEach(i=>i.dispose()):t.material.dispose())})}function Q1({pose:s,move:t,width:i,height:a,active:l}){const c=Wt.useRef(null),f=Wt.useRef(null);return Wt.useEffect(()=>{const h=c.current;if(!h)return;const p=new K1(h);return f.current=p,()=>{p.dispose(),f.current=null}},[]),Wt.useEffect(()=>{var h;(h=f.current)==null||h.resize(i,a)},[i,a]),Wt.useEffect(()=>{var h;(h=f.current)==null||h.setMove(t)},[t]),Wt.useEffect(()=>{if(!l)return;let h=0;const p=()=>{var m,g;(m=f.current)==null||m.tick(),(g=f.current)==null||g.render(s),h=requestAnimationFrame(p)};return h=requestAnimationFrame(p),()=>cancelAnimationFrame(h)},[s,l]),Ht.jsx("canvas",{ref:c,className:`ar-overlay${l?" active":""}`,"aria-hidden":"true"})}function J1({setVideoRef:s,onDimensions:t}){const i=Wt.useCallback(l=>{l.videoWidth&&l.videoHeight&&(t==null||t(l.videoWidth,l.videoHeight))},[t]),a=Wt.useCallback(l=>{s(l),l&&l.readyState>=1&&i(l)},[s,i]);return Ht.jsx("video",{ref:a,className:"camera-feed",playsInline:!0,muted:!0,autoPlay:!0,onLoadedMetadata:l=>i(l.currentTarget)})}const $1=.3,tR=.22;function Wa(s,t){const i=Math.min(s,t)*$1;return{x:(s-i)/2,y:(t-i)/2,size:i}}function B0(s){const t=s.size*tR;return{x:s.x+(s.size-t)/2,y:s.y+(s.size-t)/2,size:t}}function eR(s){const{x:t,y:i,size:a}=s;return[{x:t,y:i},{x:t+a,y:i},{x:t+a,y:i+a},{x:t,y:i+a}]}function nR(s,t,i){return s.map(a=>({x:a.x+t,y:a.y+i}))}const qa=["R","O","Y","G","B","W"],iR={R:"Red",O:"Orange",Y:"Yellow",G:"Green",B:"Blue",W:"White"},Ld={R:"#ef4444",O:"#f97316",Y:"#facc15",G:"#22c55e",B:"#3b82f6",W:"#f5f5f5"},aR={W:[95,0,0],Y:[88,-4,82],R:[48,62,38],O:[62,42,62],G:[55,-48,32],B:[32,28,-52]};let Us={},Qd=!1;function Jd(){return Qd&&qa.every(s=>Us[s])}function rR(){const s={...aR};for(const t of qa)Us[t]&&(s[t]=Us[t]);return s}function Yv(){Us={},Qd=!1}function sR(s,t){Us[s]=t,qa.every(i=>Us[i])&&(Qd=!0)}function Fh(s){return s>.04045?((s+.055)/1.055)**2.4:s/12.92}function oR(s,t,i){const a=Fh(s/255),l=Fh(t/255),c=Fh(i/255),f=a*.4124564+l*.3575761+c*.1804375,h=a*.2126729+l*.7151522+c*.072175,p=a*.0193339+l*.119192+c*.9503041,m=f/.95047>.008856?(f/.95047)**(1/3):7.787*(f/.95047)+16/116,g=h>.008856?h**(1/3):7.787*h+16/116,_=p/1.08883>.008856?(p/1.08883)**(1/3):7.787*(p/1.08883)+16/116;return[116*g-16,500*(m-g),200*(g-_)]}function Ih(s){if(s.length===0)return 0;const t=[...s].sort((a,l)=>a-l),i=Math.floor(t.length/2);return t.length%2===1?t[i]:Math.round((t[i-1]+t[i])/2)}function lR(s,t,i){return Math.max(s,t,i)-Math.min(s,t,i)<28?"W":s>=t&&s>=i?t>s*.92?"O":"R":t>=s&&t>=i?"G":"B"}function cR(s,t,i,a){const l=Math.max(s,t,i);if(l<45)return!1;const c=(s+t+i)/3,f=l-Math.min(s,t,i);switch(a){case"W":return f<55&&c>95;case"Y":return s>75&&t>65&&c>80;case"R":return s>65&&s>=i;case"O":return s>70&&t>55&&s>=i-5;case"G":return t>45&&t>=s-12&&t>=i-5;case"B":return i>40&&i>=s-8&&i>=t-15;default:return!0}}function uR(s,t,i,a){if(a==="W")return Math.max(s,t,i)-Math.min(s,t,i)<60;if(a==="Y")return s>70&&t>60;const l=lR(s,t,i);return a==="O"?l==="O"||l==="R"||l==="Y":a==="R"?l==="R"||l==="O":l===a}function F0(s,t,i,a){const l=s.getContext("2d",{willReadFrequently:!0});if(!l)return null;const c=Wa(t,i),f=B0(c),h=Math.floor(f.x),p=Math.floor(f.y),m=Math.floor(f.size),g=Math.floor(f.size);if(m<=0||g<=0)return null;const _=l.getImageData(h,p,m,g).data,v=[],S=[],E=[],T=[],M=[],y=[];for(let R=0;R<_.length;R+=8){const G=_[R],nt=_[R+1],$=_[R+2];Math.max(G,nt,$)<40||(T.push(G),M.push(nt),y.push($),cR(G,nt,$,a)&&(v.push(G),S.push(nt),E.push($)))}const P=v.length>=4?v:T,L=v.length>=4?S:M,w=v.length>=4?E:y;if(P.length<4)return null;const k=Ih(P),B=Ih(L),z=Ih(w),X=oR(k,B,z),D=P.length;return{r:k,g:B,b:z,lab:X,ready:D>=6&&uR(k,B,z,a)}}function fR(s,t,i,a){const l=F0(s,t,i,a);return l!=null&&l.ready?(sR(a,l.lab),l):null}function I0(s,t){Wt.useEffect(()=>{if(!t)return;const i=a=>{var c;if(a.key!=="Enter"&&a.key!==" ")return;const l=(c=a.target)==null?void 0:c.tagName;l==="INPUT"||l==="TEXTAREA"||l==="BUTTON"||(a.preventDefault(),s())};return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[s,t])}function $d({rect:s}){const t=s?{left:s.left,top:s.top,width:s.width,height:s.height,transform:"none"}:void 0;return Ht.jsx("div",{className:"guide-frame-css",style:t})}function hR({rect:s,strokeColor:t="#ffffff"}){const i=s?{left:s.left,top:s.top,width:s.width,height:s.height,transform:"none",borderColor:t,boxShadow:`0 0 0 2px rgba(0, 0, 0, 0.35), 0 0 12px ${t}55`}:void 0;return Ht.jsx("div",{className:"guide-spot-css",style:i})}function dR({visible:s,stepIndex:t,sample:i,ready:a,error:l,onConfirm:c,guideRect:f,spotRect:h}){const p=qa[t]??"R";return I0(c,s&&a),s?Ht.jsxs("div",{className:"color-learn-overlay","aria-live":"polite",children:[Ht.jsx($d,{rect:f}),Ht.jsx(hR,{rect:h,strokeColor:Ld[p]}),Ht.jsxs("div",{className:"color-learn-panel",children:[Ht.jsx("p",{className:"color-learn-target",style:{color:Ld[p]},children:iR[p]}),Ht.jsxs("p",{className:"color-learn-step",children:[t+1," / ",qa.length]}),i&&Ht.jsx("div",{className:"color-learn-swatch",style:{background:`rgb(${i.r},${i.g},${i.b})`}}),Ht.jsx("button",{type:"button",className:"capture-button",disabled:!a,onClick:c,children:a?"Confirm":"Hold steady…"}),l&&Ht.jsx("p",{className:"color-learn-error",children:l})]})]}):null}function pR(s){if(s.length!==9)return s;const t=[];for(let i=0;i<3;i++)for(let a=2;a>=0;a--)t.push(s[i*3+a]);return t}const mR={searching:"…",detected:"OK",stabilizing:"…",captured:"✓",rotate:"Rotate"};function gR({feedback:s,visible:t,guideRect:i}){if(!t)return null;const a=s.cellColors.length===9,l=a?pR(s.cellColors):[];return Ht.jsxs("div",{className:"detection-overlay","aria-live":"polite",children:[Ht.jsx($d,{rect:i}),Ht.jsxs("div",{className:"scan-ui-panel scan-ui-panel--compact",children:[Ht.jsxs("div",{className:`detection-status ${s.status}`,children:[Ht.jsx("span",{className:"status-text",children:mR[s.status]}),s.status==="rotate"&&Ht.jsx("span",{className:"status-progress",children:"New face"}),s.status==="stabilizing"&&Ht.jsxs("span",{className:"status-progress",children:[s.stableProgress.toFixed(1),"/",s.stableTarget,"s"]})]}),a&&Ht.jsx("div",{className:"cell-grid",children:l.map((c,f)=>Ht.jsx("span",{className:"cell-grid-item",style:{background:Ld[c]}},f))})]})]})}function _R({phase:s,knownFaces:t,progress:i,needsNewFace:a=!1}){return s!=="liveScan"?null:Ht.jsxs("div",{className:"calibration-overlay live-scan-overlay",children:[Ht.jsx("div",{className:"calibration-bar",children:Ht.jsx("div",{className:"calibration-fill",style:{width:`${i*100}%`}})}),Ht.jsxs("p",{className:"calibration-sub",children:[t.length," / 6"]}),Ht.jsx("p",{className:"calibration-hint calibration-hint--muted",children:"Any face order · same tilt each time"}),a&&Ht.jsx("p",{className:"calibration-hint",children:"Show a different face"})]})}function jv({message:s="Loading…",overlay:t=!1}){return Ht.jsxs("div",{className:`loading-screen${t?" overlay":""}`,children:[Ht.jsx("div",{className:"loading-spinner"}),Ht.jsx("p",{children:s})]})}function vR({visible:s,feedback:t,guideRect:i,onStart:a}){const l=t.status==="detected"&&t.cellColors.length===9;return I0(a,s),s?Ht.jsxs("div",{className:"scan-ready-overlay","aria-live":"polite",children:[Ht.jsx($d,{rect:i}),Ht.jsxs("div",{className:"scan-ready-panel",children:[Ht.jsx("p",{className:"scan-ready-hint",children:l?"Cube detected":"Align cube in guide"}),Ht.jsx("button",{type:"button",className:"capture-button",onClick:a,children:"Start scan"})]})]}):null}function yR({phase:s,currentStep:t,totalSteps:i}){return s!=="solving"||i===0?null:Ht.jsxs("div",{className:"step-indicator","aria-live":"polite",children:["Step ",t," / ",i]})}function xR(s){const t=["U","R","F","D","L","B"];let i="";for(const a of t){const l=s.get(a);if(!l||l.length!==9)throw new Error(`Missing face data for ${a}`);for(const c of l)i+=SR(c)}return i}function SR(s){return{W:"U",Y:"D",R:"R",O:"L",G:"F",B:"B"}[s]}function MR(s,t){const i=new Array(9).fill(0);for(let a=0;a<3;a++)for(let l=0;l<3;l++){let c=0;for(let f=0;f<3;f++)c+=s[a*3+f]*t[f*3+l];i[a*3+l]=c}return i}function Zv(){return[1,0,0,0,1,0,0,0,1]}function ER(s,t){const[i,a,l]=s,c=Math.hypot(i,a,l)||1,f=i/c,h=a/c,p=l/c,m=Math.cos(t),g=Math.sin(t),_=1-m;return[_*f*f+m,_*f*h-g*p,_*f*p+g*h,_*f*h+g*p,_*h*h+m,_*h*p-g*f,_*f*p-g*h,_*h*p+g*f,_*p*p+m]}function TR(){return new Worker(new URL("/makemecubemaster/assets/solver.worker-rq2mPGzb.js",import.meta.url),{type:"module"})}const H0=["R","O","Y","G","B","W"],bR={W:[95,0,0],Y:[88,-4,82],R:[48,62,38],O:[62,42,62],G:[55,-48,32],B:[32,28,-52]};function G0(){return Jd()?rR():bR}function AR(s,t,i){const a=Hh(s/255),l=Hh(t/255),c=Hh(i/255);return[a*.4124564+l*.3575761+c*.1804375,a*.2126729+l*.7151522+c*.072175,a*.0193339+l*.119192+c*.9503041]}function Hh(s){return s>.04045?((s+.055)/1.055)**2.4:s/12.92}function RR(s,t,i){const f=Gh(s/.95047),h=Gh(t/1),p=Gh(i/1.08883);return[116*h-16,500*(f-h),200*(h-p)]}function Gh(s){return s>.008856?s**(1/3):7.787*s+16/116}function V0(s,t,i){const[a,l,c]=AR(s,t,i);return RR(a,l,c)}function k0(s,t){const i=s[0]-t[0],a=s[1]-t[1],l=s[2]-t[2];return Math.sqrt(i*i+a*a+l*l)}function CR(s,t,i){const a=s/255,l=t/255,c=i/255,f=Math.max(a,l,c),h=Math.min(a,l,c),p=f-h;let m=0;p>0&&(f===a?m=(l-c)/p%6:f===l?m=(c-a)/p+2:m=(a-l)/p+4,m*=60,m<0&&(m+=360));const g=f===0?0:p/f*255,_=f*255;return[m,g,_]}function Kv(s,t,i){const a=V0(s,t,i),l=G0();let c="W",f=1/0;for(const h of H0){const p=k0(a,l[h]);p<f&&(f=p,c=h)}return c}function X0(s,t,i){const a=Math.max(s,t,i),l=Math.min(s,t,i);return a<38||a<70&&a-l<22}function wR(s,t,i){const a=Math.max(s,t,i),l=Math.min(s,t,i),c=a-l,f=(s+t+i)/3;return a<125||c>42||i>s+22&&i>t+12||s>t+22&&s>i+22||t>s+18&&t>i+18?!1:f>145&&c<38}function DR(s,t,i,a){const l=V0(s,t,i);return 1/(1+k0(l,G0()[a]))}function Vh(s,t,i){if(X0(s,t,i)||Jd())return Kv(s,t,i);const[a,l]=CR(s,t,i),c=l/255;if(wR(s,t,i))return"W";const f=new Map;for(const m of H0)f.set(m,DR(s,t,i,m));i>=s+14&&i>=t+10&&i>75&&f.set("B",(f.get("B")??0)+.55),s>=t+12&&s>=i+12&&s>85&&f.set("R",(f.get("R")??0)+.45),t>=s+10&&t>=i+10&&t>70&&f.set("G",(f.get("G")??0)+.45),s>95&&t>85&&i<Math.min(s,t)-18&&f.set("Y",(f.get("Y")??0)+.55),s>t+8&&t>i+5&&s>110&&a>=8&&a<42&&f.set("O",(f.get("O")??0)+.45),c>.18&&(a>=38&&a<=72&&f.set("Y",(f.get("Y")??0)+.25),a>=10&&a<38&&f.set("O",(f.get("O")??0)+.2),(a<=12||a>=345)&&f.set("R",(f.get("R")??0)+.2),a>=78&&a<=155&&f.set("G",(f.get("G")??0)+.2),a>=165&&a<=255&&f.set("B",(f.get("B")??0)+.3));let h="W",p=-1/0;for(const[m,g]of f)g>p&&(p=g,h=m);return h}function kh(s){if(s.length===0)return 0;const t=[...s].sort((a,l)=>a-l),i=Math.floor(t.length/2);return t.length%2===1?t[i]:Math.round((t[i-1]+t[i])/2)}function UR(s,t){return s===1&&t===1?.12:(s===0||s===2)&&(t===0||t===2)?.32:.26}function LR(s,t,i){const a=Math.max(s,t,i)-Math.min(s,t,i);return a>52?.15:a>36?.55:1}function NR(s,t,i,a,l,c){const f=new Map,h=[],p=[],m=[],_=l-i>40?1:2;for(let T=Math.floor(a);T<Math.floor(c);T+=_)for(let M=Math.floor(i);M<Math.floor(l);M+=_){const y=(T*t+M)*4,P=s[y],L=s[y+1],w=s[y+2];if(X0(P,L,w))continue;h.push(P),p.push(L),m.push(w);const k=Vh(P,L,w),B=LR(P,L,w);f.set(k,(f.get(k)??0)+B)}if(h.length===0){const T=Math.floor((i+l)/2),y=(Math.floor((a+c)/2)*t+T)*4;return Vh(s[y],s[y+1],s[y+2])}const v=Vh(kh(h),kh(p),kh(m));f.set(v,(f.get(v)??0)+3);let S=v,E=0;for(const[T,M]of f)M>E&&(E=M,S=T);return S}function W0(s,t,i){const l=s.getImageData(0,0,t,i).data,c=[],f=t/3,h=i/3;for(let p=0;p<3;p++)for(let m=0;m<3;m++){const g=UR(p,m),_=m*f+f*g,v=m*f+f*(1-g),S=p*h+h*g,E=p*h+h*(1-g);c.push(NR(l,t,_,S,v,E))}return c}function Yo(){return{R:0,O:0,Y:0,G:0,B:0,W:0}}function OR(s){const t=Yo();for(const i of s)t[i]++;return t}function q0(s){return!!(s&&s.length===9)}function zR(s){if(!q0(s))return{valid:!1,colorCounts:Yo(),detectedCenter:null,uniqueColors:0};const t=OR(s),i=Object.values(t).filter(a=>a>0).length;return{valid:!0,colorCounts:t,detectedCenter:s[4]??null,uniqueColors:i}}const PR={U:"W",D:"Y",F:"G",B:"B",R:"R",L:"O"},jo=["W","Y","R","O","G","B"],Xc=9,BR={W:{W:0,Y:1,O:2,R:4,G:5,B:5},Y:{W:1,Y:0,O:2,R:5,G:5,B:5},R:{R:0,O:1,W:4,Y:5,G:5,B:5},O:{O:0,R:1,Y:2,W:2,G:5,B:5},G:{G:0,B:2,W:5,Y:5,R:5,O:5},B:{B:0,G:2,W:5,Y:5,R:5,O:5}};function tp(s){const t=Yo();for(const i of s.values())for(const a of i)t[a]++;return t}function FR(s,t){return BR[s][t]??6}function IR(s){let t=null,i=0;for(const a of jo){const l=s[a]-Xc;l>i&&(i=l,t=a)}return t}function HR(s){let t=null,i=0;for(const a of jo){const l=Xc-s[a];l>i&&(i=l,t=a)}return t}function Y0(s){return jo.every(t=>s[t]===Xc)}function GR(s){const t=new Map;for(const[a,l]of s){const c=[...l];c[4]=PR[a],t.set(a,c)}const i=[];for(const[a,l]of t)for(let c=0;c<9;c++)c!==4&&i.push({faceId:a,index:c,color:l[c]});for(let a=0;a<256;a++){const l=tp(t);if(Y0(l))break;const c=IR(l),f=HR(l);if(!c||!f)break;let h=null,p=1/0;for(const m of i){if(m.color!==c)continue;const g=FR(c,f);g<p&&(p=g,h=m)}if(!h){const m=i.find(g=>g.color===c);if(!m)break;h=m}h.color=f,t.get(h.faceId)[h.index]=f}return t}function VR(s){const t=tp(s),i=Yo();for(const a of jo)i[a]=t[a]-Xc;return i}function kR(s){return Y0(tp(s))}function Qv(s){const t=VR(s),i={W:"W",Y:"Y",R:"R",O:"O",G:"G",B:"B"},a=jo.filter(l=>t[l]!==0).map(l=>{const c=t[l];return`${i[l]}${c>0?`+${c}`:c}`});return a.length>0?a.join(", "):""}const Ms=256;function zc(s,t){const i=document.createElement("canvas");i.width=Ms,i.height=Ms;const a=i.getContext("2d",{willReadFrequently:!0});return a?(a.drawImage(s,t.x,t.y,t.size,t.size,0,0,Ms,Ms),W0(a,Ms,Ms)):[]}function XR(s,t){const i=s.getContext("2d",{willReadFrequently:!0});if(!i)return 0;const{x:a,y:l,size:c}=t,f=i.getImageData(Math.floor(a),Math.floor(l),Math.floor(c),Math.floor(c)).data;let h=0,p=0,m=0;for(let _=0;_<f.length;_+=32){const v=(f[_]+f[_+1]+f[_+2])/3;h+=v,p+=v*v,m++}if(m===0)return 0;const g=h/m;return p/m-g*g}function WR(s,t){if(s.length!==9)return!1;const i=new Set(s),a=s.filter(l=>l!=="W").length;return t<120?!1:i.size===1?!0:i.size===2&&a<=3&&t<300?!1:i.size>=3&&a>=2||i.size>=2&&a>=4&&t>220}const fi=.5,qR=[[-fi,fi,fi],[fi,fi,fi],[fi,-fi,fi],[-fi,-fi,fi]];function YR(s){if(s.length<4)return null;const t=[...s].sort((l,c)=>l.y-c.y),i=t.slice(0,2).sort((l,c)=>l.x-c.x),a=t.slice(2,4).sort((l,c)=>l.x-c.x);return[i[0],i[1],a[1],a[0]]}function Nd(s,t,i){try{return ZR(s,t,i)}catch{return jR(s,t)}}function jR(s,t,i){const a={x:s.reduce((c,f)=>c+f.x,0)/4,y:s.reduce((c,f)=>c+f.y,0)/4},l=(Math.hypot(s[1].x-s[0].x,s[1].y-s[0].y)+Math.hypot(s[2].x-s[3].x,s[2].y-s[3].y))/2;return{corners:s,center:a,size:l,rotationMatrix:[1,0,0,0,1,0,0,0,1],translation:[a.x-t/2,a.y,l*3],confidence:.65}}function ZR(s,t,i){const a=window.cv,l=t*.9,c=t*.9,f=t/2,h=i/2,p=a.matFromArray(4,1,a.CV_32FC1,qR.flat()),m=a.matFromArray(4,1,a.CV_32FC1,[s[0].x,s[0].y,s[1].x,s[1].y,s[2].x,s[2].y,s[3].x,s[3].y]),g=a.matFromArray(3,3,a.CV_32FC1,[l,0,f,0,c,h,0,0,1]),_=a.matFromArray(4,1,a.CV_32FC1,[0,0,0,0]),v=new a.Mat,S=new a.Mat,E=new a.Mat;a.solvePnP(p,m,g,_,v,S),a.Rodrigues(v,E);const T=[];for(let L=0;L<9;L++)T.push(E.data32F[L]??E.floatAt(Math.floor(L/3),L%3));const M=[S.data32F[0]??S.floatAt(0,0),S.data32F[1]??S.floatAt(1,0),S.data32F[2]??S.floatAt(2,0)],y={x:s.reduce((L,w)=>L+w.x,0)/4,y:s.reduce((L,w)=>L+w.y,0)/4},P=(Math.hypot(s[1].x-s[0].x,s[1].y-s[0].y)+Math.hypot(s[2].x-s[3].x,s[2].y-s[3].y))/2;return p.delete(),m.delete(),g.delete(),_.delete(),v.delete(),S.delete(),E.delete(),{corners:s,center:y,size:P,rotationMatrix:T,translation:M,confidence:.8}}const Ui=256;function KR(s){const t=(l,c)=>Math.hypot(l.x-c.x,l.y-c.y),i=[t(s[0],s[1]),t(s[1],s[2]),t(s[2],s[3]),t(s[3],s[0])],a=i.reduce((l,c)=>l+c,0)/4;return a<1?!1:i.every(l=>Math.abs(l-a)/a<.55)}function QR(s,t,i,a){const l=i*a;let c=null,f=0;for(let h=0;h<s.size();h++){const p=s.get(h),m=t.contourArea(p);if(m<l*.02){p.delete();continue}const g=t.arcLength(p,!0);for(const _ of[.02,.035,.05,.08]){const v=new t.Mat;if(t.approxPolyDP(p,v,_*g,!0),v.rows===4){const S=[];for(let T=0;T<4;T++)S.push({x:v.data32S[T*2],y:v.data32S[T*2+1]});const E=YR(S);E&&KR(E)&&m>f&&(f=m,c=E)}v.delete()}p.delete()}return c}function Jv(s,t,i){var a;if(!((a=window.cv)!=null&&a.Mat))return null;try{const l=window.cv,c=l.imread(s),f=new l.Mat,h=new l.Mat,p=new l.Mat,m=new l.Mat,g=new l.MatVector,_=new l.Mat;l.cvtColor(c,f,l.COLOR_RGBA2RGB),l.cvtColor(f,h,l.COLOR_RGB2GRAY),l.GaussianBlur(h,p,new l.Size(5,5),0),l.Canny(p,m,20,80),l.findContours(m,g,_,l.RETR_LIST,l.CHAIN_APPROX_SIMPLE);const v=QR(g,l,t,i);return c.delete(),f.delete(),h.delete(),p.delete(),m.delete(),g.delete(),_.delete(),v}catch{return null}}function j0(s,t,i){const a=Wa(t,i),l=zc(s,a),c=XR(s,a);return WR(l,c)?{corners:eR(a),colors:l}:null}function Z0(s,t,i){const a=Wa(t,i),l=document.createElement("canvas");l.width=a.size,l.height=a.size;const c=l.getContext("2d");if(c){c.drawImage(s,a.x,a.y,a.size,a.size,0,0,a.size,a.size);const p=Jv(l,a.size,a.size);if(p)return nR(p,a.x,a.y)}const f=Jv(s,t,i);if(f)return f;const h=j0(s,t,i);return(h==null?void 0:h.corners)??null}function $v(s,t,i){const a=Z0(s,t,i);if(a){const c=$R(s,a),f=Nd(a,t,i);return{colors:c,pose:f}}const l=j0(s,t,i);if(l){const c=Nd(l.corners,t,i);return c.confidence=.7,{colors:l.colors,pose:c}}return null}function JR(s){const t=window.cv,i=t.imread(s),a=new t.Mat;return t.cvtColor(i,a,t.COLOR_RGBA2GRAY),i.delete(),a}function $R(s,t){var i;if(!((i=window.cv)!=null&&i.Mat)){const a=Wa(s.width,s.height);return zc(s,a)}try{const a=window.cv,l=a.imread(s),c=new a.Mat;a.cvtColor(l,c,a.COLOR_RGBA2RGB);const f=a.matFromArray(4,1,a.CV_32FC1,[t[0].x,t[0].y,t[1].x,t[1].y,t[2].x,t[2].y,t[3].x,t[3].y]),h=a.matFromArray(4,1,a.CV_32FC1,[0,0,Ui,0,Ui,Ui,0,Ui]),p=a.getPerspectiveTransform(f,h),m=new a.Mat;a.warpPerspective(c,m,p,new a.Size(Ui,Ui));const g=document.createElement("canvas");g.width=Ui,g.height=Ui,a.imshow(g,m);const _=g.getContext("2d",{willReadFrequently:!0}),v=_?W0(_,Ui,Ui):[];return l.delete(),c.delete(),f.delete(),h.delete(),p.delete(),m.delete(),v.length===9?v:zc(s,Wa(s.width,s.height))}catch{return zc(s,Wa(s.width,s.height))}}const t0=45;class tC{constructor(){qe(this,"prevGray",null);qe(this,"trackedCorners",null);qe(this,"lostFrames",0)}getLostFrames(){return this.lostFrames}reset(){var t;(t=this.prevGray)==null||t.delete(),this.prevGray=null,this.trackedCorners=null,this.lostFrames=0}update(t,i){var g;const a=window.cv;if(i)return this.trackedCorners=i,this.lostFrames=0,(g=this.prevGray)==null||g.delete(),this.prevGray=t.clone(),i;if(!this.prevGray||!this.trackedCorners)return null;const l=a.matFromArray(4,1,a.CV_32FC2,eC(this.trackedCorners)),c=new a.Mat,f=new a.Mat,h=new a.Mat;a.calcOpticalFlowPyrLK(this.prevGray,t,l,c,f,h);const p=[];let m=0;for(let _=0;_<4;_++){const v=f.data[_]===1,S=c.data32F[_*2],E=c.data32F[_*2+1];v&&Number.isFinite(S)&&Number.isFinite(E)?(p.push({x:S,y:E}),m++):p.push(this.trackedCorners[_])}return l.delete(),c.delete(),f.delete(),h.delete(),this.prevGray.delete(),this.prevGray=t.clone(),m<2?(this.lostFrames++,this.lostFrames>t0?(this.reset(),null):this.trackedCorners):(this.trackedCorners=p,this.lostFrames++,this.lostFrames>t0?(this.reset(),null):this.trackedCorners)}}function eC(s){return s.flatMap(t=>[t.x,t.y])}const nC=.65,iC=4;class aC{constructor(){qe(this,"state",{lastMatrix:Zv(),stableCount:0,pendingMove:null});qe(this,"initialized",!1)}reset(){this.state={lastMatrix:Zv(),stableCount:0,pendingMove:null},this.initialized=!1}update(t){if(!this.initialized)return this.state.lastMatrix=[...t],this.initialized=!0,null;const i=MR(rC(t),this.state.lastMatrix),a=oC(i);if(a)if(this.state.pendingMove===a){if(this.state.stableCount++,this.state.stableCount>=iC)return this.state.lastMatrix=[...t],this.state.pendingMove=null,this.state.stableCount=0,a}else this.state.pendingMove=a,this.state.stableCount=1;else this.state.pendingMove=null,this.state.stableCount=0,this.state.lastMatrix=sC(this.state.lastMatrix,t,.15);return null}sync(t){this.state.lastMatrix=[...t],this.state.pendingMove=null,this.state.stableCount=0,this.initialized=!0}}function rC(s){return[s[0],s[3],s[6],s[1],s[4],s[7],s[2],s[5],s[8]]}function sC(s,t,i){return s.map((a,l)=>a*(1-i)+t[l]*i)}function oC(s){const t=["R","R'","R2","L","L'","L2","U","U'","U2","D","D'","D2","F","F'","F2","B","B'","B2"];let i=null,a=nC;for(const l of t){const c=P0(l);let f=Y1[c];(c==="L"||c==="D"||c==="B")&&(f=[-f[0],-f[1],-f[2]]);const h=ER(f,z0(l)),p=lC(s,h);p>a&&(a=p,i=l)}return i}function lC(s,t){let i=0;for(let a=0;a<9;a++)i+=1-Math.abs(s[a]-t[a])/2;return i/9}class cC{constructor(){qe(this,"rotationDetector",new aC);qe(this,"flowTracker",new tC);qe(this,"trackingEnabled",!1);qe(this,"processCanvas");qe(this,"processCtx");qe(this,"lastColors",null);this.processCanvas=document.createElement("canvas");const t=this.processCanvas.getContext("2d",{willReadFrequently:!0});if(!t)throw new Error("Canvas 2D context unavailable");this.processCtx=t}enableTracking(){this.trackingEnabled=!0,this.rotationDetector.reset(),this.flowTracker.reset()}disableTracking(){this.trackingEnabled=!1,this.rotationDetector.reset(),this.flowTracker.reset(),this.lastColors=null}syncPose(t){this.rotationDetector.sync(t.rotationMatrix)}getFrameCanvas(){return this.processCanvas}captureFrame(t){const i=t.videoWidth,a=t.videoHeight;return!i||!a?!1:(this.processCanvas.width=i,this.processCanvas.height=a,this.processCtx.drawImage(t,0,0,i,a),!0)}getColorLearnSample(t,i,a){return F0(this.processCanvas,t,i,a)}process(t){const i=t.videoWidth,a=t.videoHeight;if(!i||!a)return{pose:null,detectedFace:null,rotationMove:null};this.processCanvas.width=i,this.processCanvas.height=a,this.processCtx.drawImage(t,0,0,i,a);try{return this.trackingEnabled?this.processWithTracking(i,a):this.processDetectionOnly(i,a)}catch{return{pose:null,detectedFace:null,rotationMove:null}}}processDetectionOnly(t,i){const a=$v(this.processCanvas,t,i);return a?(this.lastColors=a.colors,{pose:a.pose,detectedFace:a,rotationMove:null}):{pose:null,detectedFace:null,rotationMove:null}}processWithTracking(t,i){const a=Z0(this.processCanvas,t,i),l=JR(this.processCanvas),c=this.flowTracker.update(l,a);if(l.delete(),!c)return{pose:null,detectedFace:null,rotationMove:null};let f=this.lastColors;if(a){const g=$v(this.processCanvas,t,i);g&&(f=g.colors,this.lastColors=f)}const h=Nd(c,t,i);h.confidence=a?.85:Math.max(.35,.85-this.flowTracker.getLostFrames()*.01);const p=f?{colors:f,pose:h}:null,m=this.rotationDetector.update(h.rotationMatrix);return{pose:h,detectedFace:p,rotationMove:m}}readStableFace(t,i=5){const a=[];let l=null;for(let f=0;f<i;f++){const h=this.process(t);if(!h.detectedFace)return null;a.push(h.detectedFace.colors),l=h.detectedFace.pose}return l?{colors:uC(a),pose:l}:null}}function uC(s){const t=[];for(let i=0;i<9;i++){const a=new Map;for(const f of s){const h=f[i];a.set(h,(a.get(h)??0)+1)}let l="W",c=0;for(const[f,h]of a)h>c&&(c=h,l=f);t.push(l)}return t}const fC=["U","F","R","B","L","D"],hC={W:"U",Y:"D",R:"R",O:"L",G:"F",B:"B"};function K0(s){return hC[s]??null}const dC={U:"W",D:"Y",F:"G",B:"B",R:"R",L:"O"},pC=[0,1,2,3,5,6,7,8],Xh=2e3,mC=10,gC=7,_C=6;function vC(s,t){let i=0;for(const a of pC)s[a]===t[a]&&i++;return i}function yC(s,t){let i=0;for(let a=0;a<9;a++)s[a]===t[a]&&i++;return i}function xC(s,t){return vC(s,t)>=gC}function Q0(s,t){for(const[i,a]of t)if(xC(s,a))return i;return null}function SC(s){for(const t of fC)if(!s.has(t))return t;return null}function MC(s){const t=[];for(let i=0;i<9;i++){const a=new Map;for(const f of s){const h=f[i];a.set(h,(a.get(h)??0)+1)}let l="W",c=0;for(const[f,h]of a)h>c&&(c=h,l=f);t.push(l)}return t}function EC(s,t){if(Q0(s,t))return null;const i=K0(s[4]);return i&&!t.has(i)?i:SC(t)}function TC(s,t){const i=[...s];return i[4]=dC[t],i}class bC{constructor(){qe(this,"faces",new Map);qe(this,"pendingReadings",[]);qe(this,"stableSinceMs",null);qe(this,"stabilityAnchor",null)}reset(){this.faces.clear(),this.pendingReadings=[],this.stableSinceMs=null,this.stabilityAnchor=null}update(t,i=Date.now()){const a=Xh/1e3,l={faces:this.faces,knownFaces:[...this.faces.keys()],currentFace:null,stableProgress:0,stableTarget:a,isComplete:this.faces.size===6,newlyCaptured:null,needsNewFace:!1};if(!t||t.length!==9)return this.stableSinceMs=null,this.stabilityAnchor=null,this.pendingReadings=[],l;const c=K0(t[4]),f=Q0(t,this.faces);if(f)return this.stableSinceMs=null,this.stabilityAnchor=null,this.pendingReadings=[],{...l,currentFace:f,needsNewFace:!0};!this.stabilityAnchor||yC(t,this.stabilityAnchor)<_C?(this.stabilityAnchor=[...t],this.stableSinceMs=i,this.pendingReadings=[]):this.stableSinceMs===null&&(this.stableSinceMs=i);const h=this.stableSinceMs!==null?i-this.stableSinceMs:0,p=Math.min(h,Xh)/1e3;let m=null;if(h>=Xh){const g=[...this.pendingReadings,[...t]];g.length>mC&&g.shift(),this.pendingReadings=g;const _=MC(g),v=EC(_,this.faces);if(v){const S=TC(_,v),E=!this.faces.has(v);this.faces.set(v,S),E&&(m=v)}this.stableSinceMs=null,this.stabilityAnchor=null,this.pendingReadings=[]}return{faces:this.faces,knownFaces:[...this.faces.keys()],currentFace:c,stableProgress:Math.round(p*10)/10,stableTarget:a,isComplete:this.faces.size===6,newlyCaptured:m,needsNewFace:!1}}}const AC="https://docs.opencv.org/4.9.0/opencv.js";let Rc=null;function RC(){return Rc||(Rc=new Promise((s,t)=>{var a;if((a=window.cv)!=null&&a.Mat){s();return}const i=document.createElement("script");i.src=AC,i.async=!0,i.onload=()=>{(()=>{var c;(c=window.cv)!=null&&c.Mat?s():(window.cv=window.cv??{},window.cv.onRuntimeInitialized=()=>s())})()},i.onerror=()=>t(new Error("Failed to load OpenCV.js")),document.head.appendChild(i)}),Rc)}function CC(s){if(s.length!==54)return"Incomplete scan. Scan all 6 faces.";const t=new Map;for(const a of s)t.set(a,(t.get(a)??0)+1);const i=["U","R","F","D","L","B"];for(const a of i)if(t.get(a)!==9)return"Color count mismatch. Re-scan in good light.";return null}const zo={status:"searching",stableProgress:0,stableTarget:0,detectedCenter:null,colorCounts:Yo(),cellColors:[]},wC={phase:"loading",error:null,knownFaces:[],currentVisibleFace:null,liveScanProgress:0,solution:null,currentPose:null,solverReady:!1,detectionFeedback:zo,colorLearnIndex:0,colorLearnSample:null,colorLearnReady:!1,colorLearnError:null,colorsCalibrated:!1};function DC(s){const[t,i]=Wt.useState(wC),a=Wt.useRef(null),l=Wt.useRef(null),c=Wt.useRef(new bC),f=Wt.useRef(""),h=Wt.useRef(0),p=Wt.useRef(0),m=Wt.useRef("loading"),g=Wt.useRef(0),_=Wt.useRef(null),v=Wt.useRef(0),S=Wt.useRef(null),E=Wt.useRef(null),T=Wt.useRef(!1),M=Wt.useCallback(()=>{S.current&&(clearTimeout(S.current),S.current=null)},[]),y=Wt.useCallback((U,W,I)=>{var O;const ft=l.current;if(!ft){i(J=>({...J,phase:"error",error:"Solver failed to start. Refresh the page and try again."}));return}M();const xt=++p.current;ft.postMessage({type:"solve",facelet:U,scannedFaces:Object.fromEntries(I),id:xt}),(O=a.current)==null||O.syncPose(W),S.current=setTimeout(()=>{i(J=>J.phase!=="computing"?J:{...J,phase:"error",error:"Solve timed out. Colors may have been misread — re-scan in steady light."})},45e3)},[M]);Wt.useEffect(()=>{m.current=t.phase,_.current=t.solution,g.current=t.colorLearnIndex},[t.phase,t.solution,t.colorLearnIndex]);const P=Wt.useCallback(U=>{var I;const W=++p.current;(I=l.current)==null||I.postMessage({type:"apply",move:U,facelet:f.current,id:W}),i(ft=>{if(!ft.solution)return ft;const xt=ft.solution.moves[ft.solution.currentIndex];if(U!==xt)return ft;const O=ft.solution.currentIndex+1;return O>=ft.solution.moves.length?{...ft,phase:"solved",solution:{...ft.solution,currentIndex:O}}:{...ft,solution:{...ft.solution,currentIndex:O}}})},[]),L=Wt.useCallback((U,W,I,ft,xt,O)=>{const{detectedCenter:J,colorCounts:dt}=zR(W),q=q0(W);let ct="searching";return!U||!q?ct="searching":O?ct="rotate":xt?ct="captured":I>0&&I<ft?ct="stabilizing":ct="detected",{status:ct,stableProgress:I,stableTarget:ft,detectedCenter:J,colorCounts:dt,cellColors:q&&W?[...W]:[]}},[]),w=Wt.useCallback(()=>{var U;c.current.reset(),T.current=!1,E.current=null,i(W=>({...W,phase:"scanReady",error:null,knownFaces:[],currentVisibleFace:null,liveScanProgress:0,detectionFeedback:zo})),(U=a.current)==null||U.disableTracking()},[]),k=Wt.useCallback(()=>{var U;c.current.reset(),T.current=!1,E.current=null,i(W=>({...W,phase:"liveScan",error:null,knownFaces:[],currentVisibleFace:null,liveScanProgress:0,detectionFeedback:zo})),(U=a.current)==null||U.disableTracking()},[]),B=Wt.useCallback(async()=>{try{await RC(),a.current=new cC;const U=TR();l.current=U,U.onmessage=W=>{var ft;const I=W.data;if(I.type==="ready")i(xt=>({...xt,solverReady:!0}));else if(I.type==="solution"){if(I.id!==p.current)return;M(),f.current=I.facelet,v.current=Date.now(),i(xt=>({...xt,phase:I.moves.length===0?"solved":"solving",solution:{moves:I.moves,currentIndex:0},detectionFeedback:zo})),I.moves.length>0&&((ft=a.current)==null||ft.enableTracking())}else if(I.type==="facelet"){if(I.id!==p.current)return;f.current=I.facelet}else if(I.type==="error"){if(I.id!==void 0&&I.id!==p.current)return;M(),T.current=!1,i(xt=>({...xt,phase:"error",error:I.message}))}},U.onerror=()=>{M(),i(W=>({...W,phase:"error",error:"Solver failed to load. Refresh the page and try again."}))},U.postMessage({type:"init"}),Yv(),c.current.reset(),i(W=>({...W,phase:"colorLearn",colorLearnIndex:0,colorLearnSample:null,colorLearnReady:!1,colorLearnError:null,colorsCalibrated:!1}))}catch(U){i(W=>({...W,phase:"error",error:U instanceof Error?U.message:"Init failed"}))}},[M]);Wt.useEffect(()=>(B(),()=>{var U,W;cancelAnimationFrame(h.current),M(),(U=l.current)==null||U.terminate(),(W=a.current)==null||W.disableTracking()}),[B,M]);const z=Wt.useCallback(()=>{const U=s.current,W=a.current;if(!U||!W||U.readyState<2||!W.captureFrame(U))return;const I=g.current,ft=qa[I];if(!ft)return;const xt=W.getFrameCanvas();if(!fR(xt,U.videoWidth,U.videoHeight,ft)){i(dt=>({...dt,colorLearnError:`Could not read ${ft}. Center the sticker in the circle.`}));return}const J=I+1;if(J>=qa.length){w(),i(dt=>({...dt,colorsCalibrated:!0,colorLearnError:null}));return}i(dt=>({...dt,colorLearnIndex:J,colorLearnSample:null,colorLearnReady:!1,colorLearnError:null}))},[s,w]),X=Wt.useCallback(()=>{k()},[k]),D=Wt.useCallback(()=>{var xt,O;const U=s.current,W=a.current;if(!U||!W||U.readyState<2)return;const I=W.process(U),ft=m.current;if(ft==="colorLearn"){W.captureFrame(U);const J=qa[g.current];if(J){const dt=W.getColorLearnSample(U.videoWidth,U.videoHeight,J);i(q=>({...q,colorLearnSample:dt,colorLearnReady:(dt==null?void 0:dt.ready)??!1,colorLearnError:null}))}return}if(ft==="scanReady"){const J=((xt=I.detectedFace)==null?void 0:xt.colors)??null,dt=!!I.pose;i(q=>({...q,detectionFeedback:L(dt,J,0,0,!1,!1)}));return}if(ft==="liveScan"){if(!Jd()){i(St=>({...St,phase:"colorLearn",colorsCalibrated:!1,colorLearnIndex:0}));return}const J=((O=I.detectedFace)==null?void 0:O.colors)??null,dt=!!I.pose;I.pose&&(E.current=I.pose);const q=c.current.update(J),ct=!!q.newlyCaptured;if(q.isComplete&&E.current&&!T.current){T.current=!0;try{const St=GR(q.faces);if(!kR(St)){const Gt=Qv(q.faces);i(De=>({...De,phase:"error",error:Gt?`Color mismatch (${Gt}). Re-learn colors or re-scan.`:"Color mismatch. Scan all 6 unique faces."}));return}const Mt=xR(St),zt=CC(Mt);if(zt){const Gt=Qv(St);i(De=>({...De,phase:"error",error:Gt?`${zt} (${Gt})`:zt}));return}f.current=Mt;const qt=E.current;i(Gt=>({...Gt,phase:"computing",knownFaces:q.knownFaces,liveScanProgress:1,currentPose:qt})),queueMicrotask(()=>y(Mt,qt,St))}catch(St){i(Mt=>({...Mt,phase:"error",error:St instanceof Error?St.message:"Failed to build cube state"}))}return}i(St=>({...St,currentPose:I.pose,knownFaces:q.knownFaces,currentVisibleFace:q.currentFace,liveScanProgress:q.knownFaces.length/6,detectionFeedback:L(dt,J,q.stableProgress,q.stableTarget,ct,q.needsNewFace)}));return}if(i(J=>({...J,currentPose:I.pose})),ft==="solving"&&I.rotationMove){if(Date.now()-v.current<3e3)return;const J=_.current;if(J){const dt=J.moves[J.currentIndex];I.rotationMove===dt&&(P(I.rotationMove),I.pose&&W.syncPose(I.pose))}}},[s,P,L,y]),R=Wt.useCallback(()=>{D(),h.current=requestAnimationFrame(R)},[D]),G=Wt.useCallback(()=>{cancelAnimationFrame(h.current),h.current=requestAnimationFrame(R)},[R]),nt=Wt.useCallback(()=>{cancelAnimationFrame(h.current)},[]),$=Wt.useCallback(()=>{M(),w(),i(U=>({...U,solution:null}))},[M,w]),lt=Wt.useCallback(()=>{var U;M(),T.current=!1,c.current.reset(),E.current=null,Yv(),(U=a.current)==null||U.disableTracking(),i(W=>({...W,phase:"colorLearn",error:null,solution:null,knownFaces:[],currentVisibleFace:null,liveScanProgress:0,colorLearnIndex:0,colorLearnSample:null,colorLearnReady:!1,colorLearnError:null,colorsCalibrated:!1,detectionFeedback:zo}))},[M]),vt=t.solution&&t.solution.currentIndex<t.solution.moves.length?t.solution.moves[t.solution.currentIndex]??null:null;return{state:t,currentMove:vt,confirmColorLearn:z,startLiveScan:X,retryLiveScan:$,retryColorLearn:lt,startTracking:G,stopTracking:nt}}function UC(){const s=Wt.useRef(null),t=Wt.useRef(null),[i,a]=Wt.useState({stream:null,error:null,isReady:!1}),l=Wt.useCallback(async p=>{const m=t.current;if(!(!m||p.srcObject===m)){p.srcObject=m;try{await p.play()}catch{}}},[]),c=Wt.useCallback(p=>{s.current=p,p&&l(p)},[l]),f=Wt.useCallback(async()=>{try{const p=await navigator.mediaDevices.getUserMedia({video:{facingMode:{ideal:"environment"},width:{ideal:1280},height:{ideal:720},frameRate:{ideal:60}},audio:!1});t.current=p;const m=s.current;m&&await l(m),a({stream:p,error:null,isReady:!0})}catch(p){t.current=null,a({stream:null,error:p instanceof Error?p.message:"Camera access failed",isReady:!1})}},[l]),h=Wt.useCallback(()=>{var p;(p=t.current)==null||p.getTracks().forEach(m=>m.stop()),t.current=null,s.current&&(s.current.srcObject=null),a({stream:null,error:null,isReady:!1})},[]);return Wt.useEffect(()=>()=>h(),[h]),{videoRef:s,setVideoRef:c,state:i,start:f,stop:h}}function J0(s,t,i,a){const l=Math.max(i/s,a/t),c=s*l,f=t*l;return{scale:l,offsetX:(i-c)/2,offsetY:(a-f)/2}}function LC(s,t,i,a){if(!s||!t||!i||!a)return null;const l=Wa(s,t),{scale:c,offsetX:f,offsetY:h}=J0(s,t,i,a);return{left:f+l.x*c,top:h+l.y*c,width:l.size*c,height:l.size*c}}function NC(s,t,i,a){if(!s||!t||!i||!a)return null;const l=Wa(s,t),c=B0(l),{scale:f,offsetX:h,offsetY:p}=J0(s,t,i,a);return{left:h+c.x*f,top:p+c.y*f,width:c.size*f,height:c.size*f}}function OC(){var R,G;const{videoRef:s,setVideoRef:t,state:i,start:a}=UC(),{state:l,currentMove:c,confirmColorLearn:f,startLiveScan:h,retryLiveScan:p,retryColorLearn:m,startTracking:g,stopTracking:_}=DC(s),v=Wt.useRef(null),[S,E]=Wt.useState({width:0,height:0}),[T,M]=Wt.useState({width:0,height:0});Wt.useEffect(()=>{a()},[a]),Wt.useEffect(()=>{if(i.isReady&&l.phase!=="loading")return g(),_},[i.isReady,l.phase,g,_]);const y=Wt.useCallback((nt,$)=>{E({width:nt,height:$})},[]);Wt.useEffect(()=>{const nt=v.current;if(!nt)return;const $=()=>{M({width:nt.clientWidth,height:nt.clientHeight})};$();const lt=new ResizeObserver($);return lt.observe(nt),()=>lt.disconnect()},[]);const P=Wt.useMemo(()=>LC(S.width,S.height,T.width,T.height),[S.width,S.height,T.width,T.height]),L=Wt.useMemo(()=>NC(S.width,S.height,T.width,T.height),[S.width,S.height,T.width,T.height]),w=l.phase==="loading"||!i.isReady,k=!!(l.error||i.error),B=l.phase==="computing",z=l.phase==="solving",X=((R=l.solution)==null?void 0:R.moves.length)??0,D=(((G=l.solution)==null?void 0:G.currentIndex)??0)+1;return Ht.jsx("main",{className:"app",children:Ht.jsxs("div",{className:"viewport",ref:v,children:[Ht.jsx(J1,{setVideoRef:t,onDimensions:y}),!w&&!k&&Ht.jsxs(Ht.Fragment,{children:[Ht.jsx(Q1,{pose:l.currentPose,move:c,width:S.width,height:S.height,active:z}),Ht.jsx(dR,{visible:l.phase==="colorLearn",stepIndex:l.colorLearnIndex,sample:l.colorLearnSample,ready:l.colorLearnReady,error:l.colorLearnError,onConfirm:f,guideRect:P,spotRect:L}),Ht.jsx(vR,{visible:l.phase==="scanReady",feedback:l.detectionFeedback,guideRect:P,onStart:h}),Ht.jsx(gR,{feedback:l.detectionFeedback,visible:l.phase==="liveScan",guideRect:P}),Ht.jsx(yR,{phase:l.phase,currentStep:D,totalSteps:X}),Ht.jsx(_R,{phase:l.phase,knownFaces:l.knownFaces,progress:l.liveScanProgress,needsNewFace:l.detectionFeedback.status==="rotate"}),l.phase==="solving"&&c&&Ht.jsx("div",{className:"solving-banner",children:Ht.jsx("p",{className:"solving-move",children:c})}),l.phase==="solved"&&Ht.jsx("div",{className:"solved-banner",children:Ht.jsx("p",{children:"Done"})})]}),B&&Ht.jsx(jv,{overlay:!0,message:"Computing…"}),w&&Ht.jsx(jv,{overlay:!0,message:l.phase==="loading"?"Loading…":"Camera…"}),k&&!w&&Ht.jsxs("div",{className:"error-screen overlay",children:[Ht.jsx("p",{children:l.error??i.error}),Ht.jsxs("div",{className:"error-actions",children:[l.colorsCalibrated&&Ht.jsx("button",{type:"button",className:"error-button primary",onClick:p,children:"Re-scan"}),Ht.jsx("button",{type:"button",className:"error-button secondary",onClick:m,children:"Re-learn colors"})]})]})]})})}yS({immediate:!0});mS.createRoot(document.getElementById("root")).render(Ht.jsx(Wt.StrictMode,{children:Ht.jsx(OC,{})}));
